...
class _PartialForExpression:
	...
	__slots__ = ["_prev", "_varname"]

	def __init__(self, prev, varname):
		self._prev = prev
		self._varname = varname

	def in_(self, expr):
		return ForExpression(self._prev, self._varname, expr)
...
class _PartialStatement:
	...
	def for_(self, varname):
		return _PartialForExpression(self, varname)
