...
class ProcurementProductsIdPickingshippingdetailsIdEndpoint(ConnectWiseEndpoint):
    ...
    def patch(self, data: dict[str, Any] = {}, params: dict[str, int | str] = {}) -> list[ProductPickingShippingDetail]:
        """
