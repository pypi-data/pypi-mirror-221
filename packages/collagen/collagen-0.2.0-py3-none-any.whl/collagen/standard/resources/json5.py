...
@cvm.getter(schemes=['http', 'https'], media_type='application/json5')
def fetch_json5_http(state: cvm.State, url: str):
    """
...
@cvm.getter(schemes=['file'], media_type='application/json5')
def fetch_json5_file(state: cvm.State, url: str):
    """
...
@cvm.putter(schemes=['file'], media_type='application/json5')
def store_json5_file(state: cvm.State, data, uri: str):
    """
    Loads a JSON5 file from a local file.
