...
setup(
    ...
    packages=["botiverse", "botiverse.bots", "botiverse.bots.BasicBot", 
                "botiverse.bots.ConverseBot", "botiverse.bots.VoiceBot",
                "botiverse.bots.WhizBot", "botiverse.bots.basic_TODS",
                "botiverse.bots.deep_TODS", "botiverse.models",
                "botiverse.preprocessors", "botiverse.gui"],
