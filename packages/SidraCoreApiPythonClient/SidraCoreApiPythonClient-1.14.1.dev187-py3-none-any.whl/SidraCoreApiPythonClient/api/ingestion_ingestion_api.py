...
class IngestionIngestionApi(object):
    ...
    def api_ingestion_asset_asset_id_loaded_post(self, asset_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int asset_id: Id of the asset (required)
        :param IngestionAssetLoadedDTO body: Includes the number of validations errors detected in the asset and the number of entities contained in it
        :param str api_version: The requested API version
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_ingestion_registersetassets_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[IngestionRegisterAssetDTO] body: Assets to be registered
        :param str api_version: The requested API version
        :return: APIDataIngestionModelAssetFromLanding
                 If the method is called asynchronously,
                 returns the request thread.
