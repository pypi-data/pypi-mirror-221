...
class PIIPIIApi(object):
    ...
    def api_pii_add_pii_tags_post(self, **kwargs):  # noqa: E501
        ...
        :param dict(str, str) body: Dictionary where Key property values will be attribute ids and Value
            property values will be the name of the tag to associate the attribute with.
            All the attributes are expected to be related with the same entity because this is gonna be call for
            each loaded table once.
    ...
    def api_pii_entities_for_pii_detection_by_dip_dip_item_id_get(self, dip_item_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str dip_item_id: Data Intake Process ItemId (required)
        :param datetime _date: Date to compare with Asset LastUpdated field
    ...
    def api_piiis_pii_detection_enabled_by_dip_dip_item_id_get(self, dip_item_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str dip_item_id: Data Intake Process ItemId (required)
        :param datetime _date: Date since Assets of the Entity must had been generated
        :param str api_version: The requested API version
        :return: bool
                 If the method is called asynchronously,
                 returns the request thread.
