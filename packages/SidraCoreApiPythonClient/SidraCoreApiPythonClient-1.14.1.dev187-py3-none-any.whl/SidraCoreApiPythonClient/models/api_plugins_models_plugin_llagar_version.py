...
class APIPluginsModelsPluginLlagarVersion(object):
    ...
    def __init__(self, id=None, id_plugin=None, plugin_public_storage=None, name=None, title=None, version_number=None, notes=None, enabled=None, editable=None):  # noqa: E501
