...
from utilities import getTimestamp, writeToFile, updateLogFolder, readYaml
...
class Jira():
    def __init__(self, logFile=None, logFolder=None, loginCredentialKey=None):
        ...
        updateLogFolder(logFolderSearchPath=logFolder, removeAfterDays=os.environ.get('keystack_removeLogsAfterDays', 3))
...
if __name__ == "__main__":       
    try:
        ...
        issueList = [                
                ...
                'issuetype': {'name': 'Bug'},
                'assignee': {'name': os.environ['keystack_jiraAssignee']},
                'priority': {'name': os.environ['keystack_jiraPriority']}
                }]
        ...
        jiraObj.updateIssue(issueKey='KEYS-43', description='Dev test', setStatus=os.environ['keystack_jiraSetActiveStatus'])
