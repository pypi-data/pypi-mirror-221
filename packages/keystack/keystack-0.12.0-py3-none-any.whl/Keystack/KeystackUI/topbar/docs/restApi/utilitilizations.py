    ...
    def post(self,request):
        ...
        if remoteControllerIp and remoteControllerIp != mainControllerIp:
            ...
            if errorMsg:
                ...
                utilizations = response.json()['utilizations']
            ...
            try:
                ...
                for index,env in enumerate(envList):
                    utilizations.append(envCounters[env]['usageCounter'])
        ...
        return Response({'envs':envList, 'utilizations':utilizations, 'colors':colors,
