...
_RequiredDomainInformationOutputTypeDef = TypedDict(
    "_RequiredDomainInformationOutputTypeDef",
    {
        "DomainName": str,
    },
)
_OptionalDomainInformationOutputTypeDef = TypedDict(
    "_OptionalDomainInformationOutputTypeDef",
    {
        "OwnerId": str,
        "Region": str,
    },
...
class DomainInformationOutputTypeDef(
    _RequiredDomainInformationOutputTypeDef, _OptionalDomainInformationOutputTypeDef
):
    pass
...
CreateOutboundCrossClusterSearchConnectionResponseTypeDef = TypedDict(
    "CreateOutboundCrossClusterSearchConnectionResponseTypeDef",
    {
        "SourceDomainInfo": DomainInformationOutputTypeDef,
        "DestinationDomainInfo": DomainInformationOutputTypeDef,
        "ConnectionAlias": str,
...
ElasticsearchClusterConfigOutputTypeDef = TypedDict(
    "ElasticsearchClusterConfigOutputTypeDef",
    {
        "InstanceType": ESPartitionInstanceTypeType,
        "InstanceCount": int,
...
ElasticsearchClusterConfigStatusTypeDef = TypedDict(
    "ElasticsearchClusterConfigStatusTypeDef",
    {
        "Options": ElasticsearchClusterConfigOutputTypeDef,
        "Status": OptionStatusTypeDef,
    },
)
...
_RequiredElasticsearchDomainStatusTypeDef = TypedDict(
    "_RequiredElasticsearchDomainStatusTypeDef",
    {
        ...
        "DomainName": str,
        "ARN": str,
        "ElasticsearchClusterConfig": ElasticsearchClusterConfigOutputTypeDef,
    },
)
