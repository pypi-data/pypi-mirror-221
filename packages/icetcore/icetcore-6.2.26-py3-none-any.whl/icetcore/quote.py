    ...
    def OnQuoteData(self, SymbolType, DataType, QuoteData):
        ...
        if DataType==820 or DataType==800:
            ...
            for i in range(quote.GetValueData("Count")):  
                ...
                if "TC.O" in symbol:
                    dogshis.append({"DateTime":datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,1)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    "Symbol":quote.GetStringData("Symbol"),
                    ...
                    'Bid_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,76)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Bid1_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,77)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Bid2_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,78)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Bid3_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,79)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Bid4_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,80)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    ...
                    'Ask_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,106)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Ask1_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,107)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Ask2_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,108)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Ask3_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,109)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'Ask4_UpdateDatetime':datetime.strptime(str(quote.GetItemValue(i,0))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,110)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    'us':quote.GetItemString(i,111),
                    'us_datetime':datetime.strptime(str(quote.GetItemValue(i,123))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,124)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    ...
                    'uf_datetime':datetime.strptime(str(quote.GetItemValue(i,140))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,141)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
                    ...
                    'usf_datetime':datetime.strptime(str(quote.GetItemValue(i,157))+" "+"{:0>6d}".format(int(quote.GetItemValue(i,158)/1000)),"%Y%m%d %H%M%S").replace(tzinfo=self.tz)+timedelta(hours=8),
