...
from CXRunner.htmlrunner.result import _TestResult
from CXRunner.config import RunResult, Config
from CXRunner.version import get_version
from CXRunner._email import SMTP



# default tile
DEFAULT_TITLE = 'CXRunner Test Report'
