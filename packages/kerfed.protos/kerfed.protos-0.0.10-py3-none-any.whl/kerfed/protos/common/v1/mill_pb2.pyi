...
class MillFabrication(google.protobuf.message.Message):
    ...
    def plan(self) -> kerfed.protos.common.v1.path_pb2.MillPlan:
        """The "G-code" for the milled part."""
    @property
    ...
    def HasField(self, field_name: typing_extensions.Literal["machine", b"machine", "plan", b"plan", "pre", b"pre", "stock", b"stock", "volume", b"volume"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cuts", b"cuts", "fixtures", b"fixtures", "machine", b"machine", "plan", b"plan", "pre", b"pre", "stock", b"stock", "volume", b"volume"]) -> None: ...
