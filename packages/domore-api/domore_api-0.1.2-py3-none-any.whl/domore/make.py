...
from domore import __version__, exceptions
from domore.compat import (convert_variables, ensure_path_sep,
                               ensure_testcase_v3, ensure_testcase_v3_api)
from domore.loader import (convert_relative_project_root_dir,
                               load_folder_files, load_project_meta,
                               load_test_file, load_testcase, load_testsuite)
from domore.response import uniform_validator
from domore.utils import (ga_client, is_support_multiprocessing,
                              merge_variables)
...
__TEMPLATE__ = jinja2.Template(
    """# NOTE: Generated By DoMore v{{ version }}
# FROM: {{ testcase_path }}
...
{% if parameters %}
import pytest
from domore import Parameters
{% endif %}

from domore import DoMore, Config, Step, RunRequest, RunTestCase
{% for import_str in imports_list %}
{{ import_str }}
{% endfor %}

class {{ class_name }}(DoMore):
...
def __ensure_testcase_module(path: Text):
    ...
    with open(init_file, "w", encoding="utf-8") as f:
        f.write("# NOTICE: Generated By DoMore. DO NOT EDIT!\n")
