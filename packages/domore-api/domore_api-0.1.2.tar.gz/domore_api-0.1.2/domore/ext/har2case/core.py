...
from domore.compat import ensure_path_sep
from loguru import logger
from sentry_sdk import capture_exception

from domore.ext.har2case import utils
from domore.make import make_testcase, format_pytest_with_black
from domore.loader import load_test_file
...
class HarParser(object):
    ...
    def __make_request_url(self, teststep_dict, entry_json):
        ...
        Args:
            entry_json (dict):
                {
                    "request": {
                        "url": "https://domore.top/home?v=1&w=2",
                        "queryString": [
                            {"name": "v", "value": "1"},
                            {"name": "w", "value": "2"}
                        ],
    ...
    def _make_validate(self, teststep_dict, entry_json):
        ...
        # Remove "content-type" validation
            ...
            entry_json (dict):
                {
                    "request": {
                        "method": "POST",
                        "url": "https://domore.top/api/v1/Account/Login",
                        "headers": [],
                        "queryString": [],
                        "postData": {},
                    },
