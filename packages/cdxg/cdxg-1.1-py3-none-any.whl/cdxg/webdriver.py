...
from cdxg.running.config import Cdxg
from cdxg.logging.exceptions import NotFindElementError
from cdxg.utils.webdriver_manager_extend import ChromeDriverManager
from cdxg.testdata import get_timestamp
...
class WebElement:
    ...
    def get_elements(self, index: int = None, empty=False):
        ...
        for _ in range(Cdxg.timeout):
            elems = Cdxg.driver.find_elements(by=self.by, value=self.value)
            if len(elems) >= 1:
        ...
        elem = Cdxg.driver.find_elements(self.by, self.value)
    ...
    def show_element(elem) -> None:
        ...
        :param elem:
        """
        if (Cdxg.app_server is not None) and (Cdxg.app_info is not None):
            return None
        ...
        if Cdxg.debug is True:
            for _ in range(2):
                Cdxg.driver.execute_script(style_red, elem)
                time.sleep(0.2)
                Cdxg.driver.execute_script(style_blue, elem)
                time.sleep(0.2)
            Cdxg.driver.execute_script(style_blue, elem)
            time.sleep(0.2)
            Cdxg.driver.execute_script(style_null, elem)
...
class WebDriver:
    ...
    class Alert:
        ...
        def text(self) -> str:
            ...
            """
            log.info(f"✅ alert text: {Cdxg.driver.switch_to.alert.text}.")
            return Cdxg.driver.switch_to.alert.text
        ...
        def dismiss() -> None:
            ...
            return Cdxg.driver.switch_to.alert.dismiss()
        ...
        def accept():
            ...
            return Cdxg.driver.switch_to.alert.accept()
        ...
        def send_keys(text: str) -> None:
            ...
            return Cdxg.driver.switch_to.alert.send_keys(text)
    ...
    def visit(url: str) -> None:
        ...
        """
        log.info(f"📖 {url}")
        if isinstance(Cdxg.driver, SeleniumWebDriver) is False:
            Cdxg.driver = Chrome(service=cService(ChromeDriverManager().install()))
        Cdxg.driver.get(url)
    ...
    def get_log(log_type: str):
        ...
        :Usage:
            ...
            self.get_log('server')
        """
        return Cdxg.driver.get_log(log_type)
    ...
    def set_window(wide: int = 0, high: int = 0) -> None:
        ...
        """
        Cdxg.driver.set_window_size(wide, high)
    ...
    def get_windows() -> dict:
        ...
        :Usage:
            driver.get_windows()
        """
        return Cdxg.driver.get_window_size()
    ...
    def slow_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(Cdxg.driver).move_to_element(elem).click(elem).perform()
    ...
    def right_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(Cdxg.driver).context_click(elem).perform()
    ...
    def move_to_element(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(Cdxg.driver).move_to_element(elem).perform()
    ...
    def click_and_hold(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(Cdxg.driver).click_and_hold(elem).perform()
    ...
    def drag_and_drop_by_offset(index: int = 0, x: int = 0, y: int = 0, **kwargs) -> None:
        ...
        elem = web_elem.get_elements(index)
        web_elem.show_element(elem)
        action = ActionChains(Cdxg.driver)
    ...
    def double_click(index: int = 0, **kwargs) -> None:
        ...
        ActionChains(Cdxg.driver).double_click(elem).perform()
    ...
    def close() -> None:
        ...
        Usage:
            self.close()
        """
        if isinstance(Cdxg.driver, SeleniumWebDriver) is True:
            Cdxg.driver.close()
    ...
    def execute_script(script: str, *args):
        ...
        """
        return Cdxg.driver.execute_script(script, *args)
    ...
    def get_title(self) -> str:
        ...
        Usage:
            self.get_title()
        """
        log.info(f"✅ get title: {Cdxg.driver.title}.")
        return Cdxg.driver.title
    ...
    def get_url(self) -> str:
        ...
        Usage:
            self.get_url()
        """
        log.info(f"✅ get current url: {Cdxg.driver.current_url}.")
        return Cdxg.driver.current_url
    ...
    def wait(secs: int = 10) -> None:
        ...
        Cdxg.driver.implicitly_wait(secs)
    ...
    def accept_alert() -> None:
        ...
        log.info("✅ accept alert.")
        Cdxg.driver.switch_to.alert.accept()
    ...
    def dismiss_alert() -> None:
        ...
        log.info("✅ dismiss alert.")
        Cdxg.driver.switch_to.alert.dismiss()
    ...
    def switch_to_frame(index: int = 0, **kwargs) -> None:
        ...
        Cdxg.driver.switch_to.frame(elem)
    ...
    def switch_to_frame_parent() -> None:
        ...
        Cdxg.driver.switch_to.parent_frame()
    ...
    def switch_to_frame_out() -> None:
        ...
        Cdxg.driver.switch_to.default_content()
    ...
    def switch_to_window(window: int) -> None:
        ...
        all_handles = Cdxg.driver.window_handles
        Cdxg.driver.switch_to.window(all_handles[window])
    ...
    def switch_to_new_window(type_hint=None) -> None:
        ...
        Cdxg.driver.switch_to.new_window(type_hint=type_hint)
    ...
    def save_screenshot(file_path: str = None, index: int = 0, **kwargs) -> None:
        ...
        if len(kwargs) == 0:
            ...
            Cdxg.driver.save_screenshot(file_path)
        else:
    ...
    def screenshots(self) -> None:
        ...
        if Cdxg.debug is True:
            ...
            self.images.append(Cdxg.driver.get_screenshot_as_base64())
    ...
    def get_cookies() -> list:
        ...
        Usage:
            self.get_cookies()
        """
        return Cdxg.driver.get_cookies()
    ...
    def get_cookie(name: str) -> dict:
        ...
        """
        return Cdxg.driver.get_cookie(name)
    ...
    def add_cookie(cookie_dict: dict) -> None:
        ...
        if isinstance(cookie_dict, dict):
            Cdxg.driver.add_cookie(cookie_dict)
        else:
    ...
    def delete_cookie(name: str) -> None:
        ...
        """
        Cdxg.driver.delete_cookie(name)
    ...
    def delete_all_cookies() -> None:
        ...
        """
        Cdxg.driver.delete_all_cookies()
    ...
    def check_element(css: str = None) -> None:
        ...
        ret = Cdxg.driver.execute_script(js)
        if len(ret) > 0:
    ...
    def switch_to_app() -> None:
        ...
        current_context = Cdxg.driver.current_context
        if current_context != "NATIVE_APP":
            Cdxg.driver.switch_to.context('NATIVE_APP')
    ...
    def switch_to_web(context=None) -> None:
        ...
        if context is not None:
            Cdxg.driver.switch_to.context(context)
        elif "WEBVIEW" in current_context:
            return
        else:
            all_context = Cdxg.driver.contexts
    ...
    def switch_to_flutter() -> None:
        ...
        current_context = Cdxg.driver.current_context
        if current_context != "NATIVE_APP":
            Cdxg.driver.switch_to.context('FLUTTER')
