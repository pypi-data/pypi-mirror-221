...
from cdxg import SeldomTestLoader
from cdxg import TestMainExtend
from cdxg.logging import log, log_cfg
from cdxg.utils import file
from cdxg.utils import cache
from cdxg.har2case.core import HarParser
from webdriver_manager.firefox import GeckoDriverManager
from webdriver_manager.microsoft import IEDriverManager
from webdriver_manager.microsoft import EdgeChromiumDriverManager
from cdxg.utils.webdriver_manager_extend import ChromeDriverManager
from cdxg.running.loader_hook import loader
from cdxg import __version__
...
@click.option('-cc', "--clear-cache", default=False, help="Clear all caches of cdxg.")
...
'''
    test_web_sample = '''import cdxg
from cdxg import file_data


class SampleTest(cdxg.TestCase):
...
if __name__ == '__main__':
    cdxg.main(debug=True)

'''
    test_api_sample = '''import cdxg


class TestRequest(cdxg.TestCase):
    """api test case"""
...
if __name__ == '__main__':
    cdxg.main(base_url="http://httpbin.org")

    '''

    run_test = '''"""
cdxg confrun.py hooks function
"""
