...
from CXRunner import HTMLTestRunner
from CXRunner import XMLTestRunner
from selenium.webdriver.remote.webdriver import WebDriver as SeleniumWebDriver
from selenium.common.exceptions import InvalidSessionIdException
from cdxg.driver import Browser
from cdxg.logging import log
from cdxg.logging import log_cfg
from cdxg.logging.exceptions import SeldomException
from cdxg.running.DebugTestRunner import DebugTestRunner
from cdxg.running.config import Cdxg, BrowserConfig
from cdxg.running.loader_extend import seldomTestLoader
...
class TestMain:
    """
    Reimplemented Sdd Runner, Support for Web and API
    """
    TestSuits = []
    ...
    def __init__(
        ...
        self.open = open
        self.auto = auto
        Cdxg.app_server = app_server
        Cdxg.app_info = app_info
        ...
        Cdxg.timeout = timeout
        Cdxg.debug = debug
        Cdxg.base_url = base_url
    ...
    def open_browser(self) -> None:
        ...
        if self.browser is not None:
            ...
            Cdxg.driver = Browser(BrowserConfig.NAME)
    ...
    def close_browser() -> None:
        ...
        """
        if isinstance(Cdxg.driver, SeleniumWebDriver):
            try:
                Cdxg.driver.quit()
