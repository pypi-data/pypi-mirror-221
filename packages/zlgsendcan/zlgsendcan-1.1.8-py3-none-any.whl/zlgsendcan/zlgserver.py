...
if __name__ == '__main__':
    data2 = {'signal': {'SRS_AirbagFaultSt': '1'}, 'msg_name': 'GW_SRS_2_B'}
    # ob = get_signal_data1(data2, 'D:\自动化-qt\data\\a13.dbc')
    # result, l = ob.dbc_parser()
    # print('11111', result)
    # ob1 = MessageDate()
    # ob1.send_canfd_msg(ob.msg_id, result, l)
    # zlg_send(data2,'D:\自动化-qt\data\\a13.dbc')
    # {"GW_EMS_1_B": {
    #     "GW_EMS_1_B": {"EMS_EngSt": 1, "EMS_FuelPulse": {"步长": '1000', "最大值": '65535', "最小值": '0'}},
    #     "send_num": '300', "cycle_time": 100}}
