...
setup(
    ...
    data_files=[('', ['./01-verify_registry_windows.exe', './02-create_new_registry_windows_runas.exe'])],
    include_package_data=True,
    package_data={'idftools': ['idftools/Roboto-Regular.ttf', 'idftools/logging.conf', './01-verify_registry_windows.exe', './02-create_new_registry_windows_runas.exe']}
)
