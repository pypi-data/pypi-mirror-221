...
def download_madrigal(sessions, outputDir = ''):
    ...
    for session in sessions: 
        ...
        fileList.append('gps'+date1.strftime('%y')+date1.strftime('%m')+date1.strftime('%d')+';')
        fileList.append('gps'+date2.strftime('%y')+date2.strftime('%m')+date2.strftime('%d')+';')
