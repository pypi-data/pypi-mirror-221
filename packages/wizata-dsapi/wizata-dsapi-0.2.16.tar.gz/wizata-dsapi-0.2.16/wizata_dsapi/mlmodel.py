...
class MLModelConfig(ApiDto):
    ...
    :ivar store_property: name of function referencing the script to train the model.
    ...
    def __init__(self,
        ...
        self.store_property = store_property
    ...
    def from_json(self, obj):
        ...
        if "store_property" in obj.keys() and obj["store_property"] is not None:
            self.store_property = obj["store_property"]
        if "model_key" in obj.keys() and obj["model_key"] is not None:
            self.model_key = obj["model_key"]
        if self.model_key is None and self.store_property is None:
            raise KeyError('either model_key or store_property must be present in the config.')
    ...
    def to_json(self):
        ...
        if self.store_property is not None:
            obj["store_property"] = self.store_property
