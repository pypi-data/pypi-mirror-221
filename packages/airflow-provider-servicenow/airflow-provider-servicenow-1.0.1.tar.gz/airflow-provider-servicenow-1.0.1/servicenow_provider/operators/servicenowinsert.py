...
class ServiceNowInsertOperator(PythonVirtualenvOperator):
    """
    ...
    def execute(self, context):
        ...
        for i in result:
            try:
                insert_id = hook.Insert(
                    table=self.table,
                    data=i,
                )
                print(insert_id)
                if insert_id:
                    insert_result[str(insert_id)] = i
            except Exception as e:
                self.log.error(e)
        return insert_result

class _ServiceNowInsertDecoratedOperator(DecoratedOperator, ServiceNowInsertOperator):
    """
    ...
    custom_operator_name: str = "@task.servicenowinsert"
...
def servicenowinsert(
    ...
    **kwargs,
    ...
    return task_decorator_factory(
        ...
        decorated_operator_class=_ServiceNowInsertDecoratedOperator,
        **kwargs,
    )
