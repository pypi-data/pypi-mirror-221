...
class ServiceNowRecordOperator(PythonVirtualenvOperator):
    """
...
class _ServiceNowRecordDecoratedOperator(DecoratedOperator, ServiceNowRecordOperator):
    """
    ...
    custom_operator_name: str = "@task.servicenowrecord"
...
def servicenowrecord(
    ...
    **kwargs,
    ...
    return task_decorator_factory(
        ...
        decorated_operator_class=_ServiceNowRecordDecoratedOperator,
        **kwargs,
    )
