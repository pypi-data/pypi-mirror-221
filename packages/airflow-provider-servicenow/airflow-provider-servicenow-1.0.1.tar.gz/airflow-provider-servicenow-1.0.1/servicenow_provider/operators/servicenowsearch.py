...
class ServiceNowSearchOperator(PythonVirtualenvOperator):
    """
    ...
    def __init__(
        ...
        *,
        ...
        table: str,
        query: list[list[str]],
        or_condition: list[list[str]] = None,
        join_querys: list(dict[str, str]) = [],
        batch_size: int = 100,
    ...
    def execute(self, context):
        ...
        response = hook.SearchRecord(
            table=self.table,
            query=self.query,
            or_condition=self.or_condition,
            join_querys=self.join_querys,
            display_value=self.display_value,
            feilds=self.feilds,
        )
        self.op_kwargs["servicenow_response"] = response
        result = super().execute_callable()
        return result

class _ServiceNowSearchDecoratedOperator(DecoratedOperator, ServiceNowSearchOperator):
    """
    ...
    custom_operator_name: str = "@task.servicenowsearch"
...
def servicenowsearch(
    ...
    **kwargs,
    ...
    return task_decorator_factory(
        ...
        decorated_operator_class=_ServiceNowSearchDecoratedOperator,
        **kwargs,
    )
