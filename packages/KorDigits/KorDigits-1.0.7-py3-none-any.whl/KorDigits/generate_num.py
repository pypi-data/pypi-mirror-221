...
from utils.convert_num_unit import (
...
class Label2Num:
    ...
    def generate(self, sentence):
        ...
        with open(kor_pronun_unit, 'r') as f:
        ...
        if is_num:
            ...
            for i in range(len(self.sentence_list)):
                ...
                for w, p in self.mecab.pos(self.sentence_list[i]):
                    if p == 'SN' and re.search('\d+', w):
                        ...
                        if w in kor_unit_list:
                            tagging, pred = self.convert_unit.change_unit(self.sentence_list[i])
                            is_korean = True
                            break
                ...
                # print(sentence,":", tagging,":",pred)
                # sentence = sentence.replace(tagging, "</N>"+pred+"</N>", 1)
    ...
    def _label_7(self, tagging):
        ...
        if wave_match:
            ...
            for c in zip(start, end):
                num_words = self.num2word.number_to_kor2(c)
...
if __name__ == '__main__':
    ...
    print(label2num.generate('연간 2만km를 주행했다고'))
