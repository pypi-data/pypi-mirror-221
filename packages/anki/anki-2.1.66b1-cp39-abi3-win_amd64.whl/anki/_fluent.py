...
You can help us complete this help page on {$link}. '''
    ...
    def importing_first_field_matched(self, val: FluentVariable) -> str:
        ...
        return self._translate(20, 26, {"val": val})
    ...
    def importing_note_updated(self, count: int) -> str:
        r''' {$count} notes updated '''
        return self._translate(20, 48, {"count": count})
    ...
    def importing_processed_notes(self, count: int) -> str:
        ...
        return self._translate(20, 62, {"count": count})
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 63, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 77, {"filename": filename})
...
({$secs-per-card}s/card) '''
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 88, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 92, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
...
class LegacyTranslationEnum:
    ...
    IMPORTING_FILE_EMPTY = (20, 23)
    IMPORTING_FILE_MUST_CONTAIN_FIELD_COLUMN = (20, 24)
    IMPORTING_FILE_VERSION_UNKNOWN_TRYING_IMPORT_ANYWAY = (20, 25)
    IMPORTING_FIRST_FIELD_MATCHED = (20, 26)
    IMPORTING_GATHERING = (20, 27)
    IMPORTING_IDENTICAL = (20, 28)
    IMPORTING_IGNORE_FIELD = (20, 29)
    IMPORTING_IGNORE_LINES_WHERE_FIRST_FIELD_MATCHES = (20, 30)
    IMPORTING_IGNORED = (20, 31)
    IMPORTING_IMPORT_EVEN_IF_EXISTING_NOTE_HAS = (20, 32)
    IMPORTING_IMPORT_OPTIONS = (20, 33)
    IMPORTING_IMPORTING_COLLECTION = (20, 34)
    IMPORTING_IMPORTING_COMPLETE = (20, 35)
    IMPORTING_IMPORTING_FILE = (20, 36)
    IMPORTING_INVALID_FILE_PLEASE_RESTORE_FROM_BACKUP = (20, 37)
    IMPORTING_MAP_TO = (20, 38)
    IMPORTING_MAP_TO_TAGS = (20, 39)
    IMPORTING_MAPPED_TO = (20, 40)
    IMPORTING_MAPPED_TO_TAGS = (20, 41)
    IMPORTING_MATCH_SCOPE = (20, 42)
    IMPORTING_MNEMOSYNE_20_DECK_DB = (20, 43)
    IMPORTING_MULTICHARACTER_SEPARATORS_ARE_NOT_SUPPORTED_PLEASE = (20, 44)
    IMPORTING_NOTE_ADDED = (20, 45)
    IMPORTING_NOTE_IMPORTED = (20, 46)
    IMPORTING_NOTE_UNCHANGED = (20, 47)
    IMPORTING_NOTE_UPDATED = (20, 48)
    IMPORTING_NOTES_ADDED_FROM_FILE = (20, 49)
    IMPORTING_NOTES_FOUND_IN_FILE = (20, 50)
    IMPORTING_NOTES_SKIPPED_AS_THEYRE_ALREADY_IN = (20, 51)
    IMPORTING_NOTES_SKIPPED_UPDATE_DUE_TO_NOTETYPE = (20, 52)
    IMPORTING_NOTES_THAT_COULD_NOT_BE_IMPORTED = (20, 53)
    IMPORTING_NOTES_UPDATED_AS_FILE_HAD_NEWER = (20, 54)
    IMPORTING_NOTETYPE_AND_DECK = (20, 55)
    IMPORTING_PACKAGED_ANKI_DECKCOLLECTION_APKG_COLPKG_ZIP = (20, 56)
    IMPORTING_PAUKER_18_LESSON_PAUGZ = (20, 57)
    IMPORTING_PIPE = (20, 58)
    IMPORTING_PRESERVE = (20, 59)
    IMPORTING_PROCESSED_CARDS = (20, 60)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 61)
    IMPORTING_PROCESSED_NOTES = (20, 62)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 63)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 64)
    IMPORTING_SEMICOLON = (20, 65)
    IMPORTING_SKIPPED = (20, 66)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 67)
    IMPORTING_TAB = (20, 68)
    IMPORTING_TAG_ALL_NOTES = (20, 69)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 70)
    IMPORTING_TAG_UPDATED_NOTES = (20, 71)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 72)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 73)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 74)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 75)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 76)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 77)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 78)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 79)
    IMPORTING_UPDATE = (20, 80)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 81)
    IMPORTING_UPDATED = (20, 82)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    STATISTICS_TITLE = (32, 86)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 87)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 88)
    STATISTICS_TODAY_NO_CARDS = (32, 89)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 90)
    STATISTICS_TODAY_TITLE = (32, 91)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 92)
    STATISTICS_TOTAL = (32, 93)
    STUDYING_AGAIN = (33, 0)
