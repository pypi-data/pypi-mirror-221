...
class YoutubeDL:
    ...
    def process_ie_result(self, ie_result, download=False, extra_info=None):
        ...
        if result_type == 'video':
            ...
            ie_result = self.process_video_result(ie_result, download=False)
            ...
            return self.process_ie_result(
                new_result, download=False, extra_info=extra_info)
    ...
    def __process_iterable_entry(self, entry, download, extra_info):
        return self.process_ie_result(
            entry, download=False, extra_info=extra_info)
    ...
    def process_video_result(self, info_dict, download=False):
        ...
        while True:
            ...
            if format_selector is None:
                req_format = self._default_format_spec(info_dict, download=False)
