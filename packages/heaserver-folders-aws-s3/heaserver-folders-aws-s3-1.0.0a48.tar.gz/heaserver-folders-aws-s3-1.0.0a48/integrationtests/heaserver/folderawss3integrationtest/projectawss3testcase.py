...
from heaserver.service.testcase.mockawsdockermongo import MockS3WithDockerMongoManager
...
HEASERVER_ACTIVITY_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-activity:1.0.0a14'
...
class MyMockS3WithDockerMongoManager(MockS3WithDockerMongoManager):
...
AWSS3ProjectTestCase = \
    get_test_case_cls_default(
        ...
        coll='awss3projects',
        fixtures=db_values,
        db_manager_cls=MyMockS3WithDockerMongoManager,
        get_all_actions=[
            ...
            expectedvalues.Action(
                ...
                url='http://localhost:8080/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/duplicator',
                rel=['hea-dynamic-standard', 'hea-icon-duplicator', 'hea-context-menu']),
            expectedvalues.Action(
                name='heaserver-awss3folders-project-move',
                url='http://localhost:8080/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/mover',
            ...
            expectedvalues.Action(
                ...
                url='http://localhost:8080/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/archive',
        ...
        duplicate_action_actions=[
            expectedvalues.Action(
                name='heaserver-awss3folders-project-get-target',
                url='http://localhost:8080/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/VGVzdEZvbGRlci8=',
                rel=['headata-target']
            )
        ],
