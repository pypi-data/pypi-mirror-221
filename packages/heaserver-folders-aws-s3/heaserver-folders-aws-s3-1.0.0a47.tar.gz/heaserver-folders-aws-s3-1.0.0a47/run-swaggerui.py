...
from heaserver.service.testcase.mockaws import S3WithDockerMongoManager
    ...
    swaggerui.run(project_slug='heaserver-folders-aws-s3', desktop_objects=db_values,
                  ...
                  routes=[# Folders
                          ...
                          (delete, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{folder_id}/items/{id}',
                           service.delete_item),
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}', service.get_folder),
                          (options, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}',
                           service.get_folder_options),
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/', service.get_folders),
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/byname/{name}',
                           service.get_folder_by_name),
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/presignedurl', service.get_presigned_url_form),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/presignedurl', service.post_presigned_url_form),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/', service.post_folder),
                          ...
                          (options, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects',
                           service.get_folders_options),
                          (delete, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}', service.delete_folder),
                          ...
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/mover',
                           service.post_folder_mover),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/unarchive', service.unarchive_folder),
                          (get, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/archive', service.get_folder_archive),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/archive', service.post_folder_archive),
                          (post, '/volumes/{volume_id}/buckets/{bucket_id}/awss3projects/{id}/uploader', service.post_folder_uploader)
