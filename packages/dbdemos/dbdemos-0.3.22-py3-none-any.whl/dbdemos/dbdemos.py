        ...
        displayHTML("""<style>
            ...
            <div class="dbdemos_install">
              ...
              <ul>
                ...
                <li>
                  <div class="code">dbdemos.install(demo_name: str, path: str = "./", overwrite: bool = False, use_current_cluster = False, username: str = None, pat_token: str = None, workspace_url: str = None, skip_dashboards: bool = False, cloud: str = "AWS", catalog: str = "dbdemos", schema: str = None)</div>: install the given demo to the given path.<br/><br/>
                  ...
                  catalog and schema options are in beta and not supported for all demos.<br/>
