...
def anyscale_login() -> None:
    ...
    r = api_client.create_one_time_password_api_v2_users_create_otp_token_get().result
    token = r.otp
    ...
    for _i in range(60):
        ...
        if check_result.valid:
            ...
            log.info(
                "Successfully logged in to Anyscale. The authentication will expire in 7 days."
            )
            return
        time.sleep(3)
