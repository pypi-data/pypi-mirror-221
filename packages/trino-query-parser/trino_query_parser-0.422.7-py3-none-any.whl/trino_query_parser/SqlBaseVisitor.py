...
class SqlBaseVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SqlBaseParser#commentView.
    def visitCommentView(self, ctx:SqlBaseParser.CommentViewContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SqlBaseParser#setColumnType.
    def visitSetColumnType(self, ctx:SqlBaseParser.SetColumnTypeContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by SqlBaseParser#jsonTable.
    def visitJsonTable(self, ctx:SqlBaseParser.JsonTableContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#ordinalityColumn.
    def visitOrdinalityColumn(self, ctx:SqlBaseParser.OrdinalityColumnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#valueColumn.
    def visitValueColumn(self, ctx:SqlBaseParser.ValueColumnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#queryColumn.
    def visitQueryColumn(self, ctx:SqlBaseParser.QueryColumnContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#nestedColumns.
    def visitNestedColumns(self, ctx:SqlBaseParser.NestedColumnsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#leafPlan.
    def visitLeafPlan(self, ctx:SqlBaseParser.LeafPlanContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#joinPlan.
    def visitJoinPlan(self, ctx:SqlBaseParser.JoinPlanContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#unionPlan.
    def visitUnionPlan(self, ctx:SqlBaseParser.UnionPlanContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#crossPlan.
    def visitCrossPlan(self, ctx:SqlBaseParser.CrossPlanContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#jsonTablePathName.
    def visitJsonTablePathName(self, ctx:SqlBaseParser.JsonTablePathNameContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#planPrimary.
    def visitPlanPrimary(self, ctx:SqlBaseParser.PlanPrimaryContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#jsonTableDefaultPlan.
    def visitJsonTableDefaultPlan(self, ctx:SqlBaseParser.JsonTableDefaultPlanContext):
        return self.visitChildren(ctx)
    ...
    def visitOr(self, ctx:SqlBaseParser.OrContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SqlBaseParser#and.
    def visitAnd(self, ctx:SqlBaseParser.AndContext):
        return self.visitChildren(ctx)
