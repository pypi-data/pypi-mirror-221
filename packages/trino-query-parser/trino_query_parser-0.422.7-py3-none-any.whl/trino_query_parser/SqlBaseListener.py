...
class SqlBaseListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SqlBaseParser#commentView.
    def enterCommentView(self, ctx:SqlBaseParser.CommentViewContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#commentView.
    def exitCommentView(self, ctx:SqlBaseParser.CommentViewContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#setColumnType.
    def enterSetColumnType(self, ctx:SqlBaseParser.SetColumnTypeContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#setColumnType.
    def exitSetColumnType(self, ctx:SqlBaseParser.SetColumnTypeContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#tableExecute.
    def enterTableExecute(self, ctx:SqlBaseParser.TableExecuteContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#tableExecute.
    def exitTableExecute(self, ctx:SqlBaseParser.TableExecuteContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#renameMaterializedView.
    def enterRenameMaterializedView(self, ctx:SqlBaseParser.RenameMaterializedViewContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#deny.
    def enterDeny(self, ctx:SqlBaseParser.DenyContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#deny.
    def exitDeny(self, ctx:SqlBaseParser.DenyContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#explainAnalyze.
    def enterExplainAnalyze(self, ctx:SqlBaseParser.ExplainAnalyzeContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#explainAnalyze.
    def exitExplainAnalyze(self, ctx:SqlBaseParser.ExplainAnalyzeContext):
        pass
    ...
    def enterPropertyAssignments(self, ctx:SqlBaseParser.PropertyAssignmentsContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#propertyAssignments.
    def exitPropertyAssignments(self, ctx:SqlBaseParser.PropertyAssignmentsContext):
        pass
    ...
    def exitListAggOverflowBehavior(self, ctx:SqlBaseParser.ListAggOverflowBehaviorContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#listaggCountIndication.
    def enterListaggCountIndication(self, ctx:SqlBaseParser.ListaggCountIndicationContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#listaggCountIndication.
    def exitListaggCountIndication(self, ctx:SqlBaseParser.ListaggCountIndicationContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#jsonTable.
    def enterJsonTable(self, ctx:SqlBaseParser.JsonTableContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#jsonTable.
    def exitJsonTable(self, ctx:SqlBaseParser.JsonTableContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#ordinalityColumn.
    def enterOrdinalityColumn(self, ctx:SqlBaseParser.OrdinalityColumnContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#ordinalityColumn.
    def exitOrdinalityColumn(self, ctx:SqlBaseParser.OrdinalityColumnContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#valueColumn.
    def enterValueColumn(self, ctx:SqlBaseParser.ValueColumnContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#valueColumn.
    def exitValueColumn(self, ctx:SqlBaseParser.ValueColumnContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#queryColumn.
    def enterQueryColumn(self, ctx:SqlBaseParser.QueryColumnContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#queryColumn.
    def exitQueryColumn(self, ctx:SqlBaseParser.QueryColumnContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#nestedColumns.
    def enterNestedColumns(self, ctx:SqlBaseParser.NestedColumnsContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#nestedColumns.
    def exitNestedColumns(self, ctx:SqlBaseParser.NestedColumnsContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#leafPlan.
    def enterLeafPlan(self, ctx:SqlBaseParser.LeafPlanContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#leafPlan.
    def exitLeafPlan(self, ctx:SqlBaseParser.LeafPlanContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#joinPlan.
    def enterJoinPlan(self, ctx:SqlBaseParser.JoinPlanContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#joinPlan.
    def exitJoinPlan(self, ctx:SqlBaseParser.JoinPlanContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#unionPlan.
    def enterUnionPlan(self, ctx:SqlBaseParser.UnionPlanContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#unionPlan.
    def exitUnionPlan(self, ctx:SqlBaseParser.UnionPlanContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#crossPlan.
    def enterCrossPlan(self, ctx:SqlBaseParser.CrossPlanContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#crossPlan.
    def exitCrossPlan(self, ctx:SqlBaseParser.CrossPlanContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#jsonTablePathName.
    def enterJsonTablePathName(self, ctx:SqlBaseParser.JsonTablePathNameContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#jsonTablePathName.
    def exitJsonTablePathName(self, ctx:SqlBaseParser.JsonTablePathNameContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#planPrimary.
    def enterPlanPrimary(self, ctx:SqlBaseParser.PlanPrimaryContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#planPrimary.
    def exitPlanPrimary(self, ctx:SqlBaseParser.PlanPrimaryContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#jsonTableDefaultPlan.
    def enterJsonTableDefaultPlan(self, ctx:SqlBaseParser.JsonTableDefaultPlanContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#jsonTableDefaultPlan.
    def exitJsonTableDefaultPlan(self, ctx:SqlBaseParser.JsonTableDefaultPlanContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#or.
    def enterOr(self, ctx:SqlBaseParser.OrContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#or.
    def exitOr(self, ctx:SqlBaseParser.OrContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#and.
    def enterAnd(self, ctx:SqlBaseParser.AndContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#and.
    def exitAnd(self, ctx:SqlBaseParser.AndContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#measure.
    def enterMeasure(self, ctx:SqlBaseParser.MeasureContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#measure.
    def exitMeasure(self, ctx:SqlBaseParser.MeasureContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#listagg.
    def enterListagg(self, ctx:SqlBaseParser.ListaggContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#listagg.
    def exitListagg(self, ctx:SqlBaseParser.ListaggContext):
        pass
    ...
    def enterFrameExtent(self, ctx:SqlBaseParser.FrameExtentContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#frameExtent.
    def exitFrameExtent(self, ctx:SqlBaseParser.FrameExtentContext):
        pass
    ...
    def enterQueryPeriod(self, ctx:SqlBaseParser.QueryPeriodContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#queryPeriod.
    def exitQueryPeriod(self, ctx:SqlBaseParser.QueryPeriodContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#rangeType.
    def enterRangeType(self, ctx:SqlBaseParser.RangeTypeContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#rangeType.
    def exitRangeType(self, ctx:SqlBaseParser.RangeTypeContext):
        pass
