...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[564], {
    61564: function(e, t, n) {
        ...
        function v(e) {
            ...
            s.useEffect)(function() {
                ...
                l && function e(t, a, o, r) {
                    w.current = y(function() {
                        if (a.length !== o.length) {
                            var n = a + o.slice(t, t + r);
                            p(n),
                            null == u || u(),
                            e(t + r, n, o, r)
                        }
            ...
            r.jsx)("span", {
                className: (0,
                i.Z)("whitespace-pre-wrap", f.length < h.length && "result-streaming", "dark" === v ? "dark" : "light"),
                children: (0,
                r.jsx)("span", {
                    children: f
                })
        ...
        function k() {
            var e = (0,
            o._)(["w-full h-full overflow-auto"]);
            return k = function() {
                return e
            }
            ,
        ...
        function T() {
            var e = (0,
            o._)(["flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none"]);
            return T = function() {
                return e
            }
            ,
        ...
        function x() {
            var e = (0,
            o._)(["absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform\n", ""]);
            return x = function() {
                return e
            }
            ,
        ...
        function C() {
            ...
            g.Z)()
              , T = (0,
            s.useRef)(A[Math.floor(Math.random() * A.length)])
              , x = (0,
            a._)((0,
            s.useState)(!1), 2)
              , C = x[0]
            ...
            s.useCallback)(function(e) {
                ...
                var t = e.target
                  , n = c()(t.email.value);
                N(!0),
                d.ZP.getLoginLink(n).catch(function(e) {
                    y.m.forError(e)
                }).finally(function() {
                    N(!1),
                    j(!0)
                ...
                r.jsxs)("div", {
                    ...
                    r.jsxs)(G, {
                        ...
                        r.jsx)("div", {
                            ...
                            children: "ChatGPT is at capacity right now"
                        }), (0,
                        r.jsx)("a", {
                            ...
                            rel: "noreferrer",
                            className: "underline",
                            children: "Get notified when we're back"
                        }), (0,
                        r.jsx)("div", {
                            className: "flex",
                            children: (0,
                    ...
                    r.jsx)(I, {
                        ...
                        children: (0,
                        r.jsxs)("div", {
                            className: "relative m-6 flex w-full flex-col justify-center gap-4 text-gray-800 lg:max-w-sm lg:rounded-lg lg:border lg:p-6",
                            children: [M && (0,
                            r.jsx)("h3", {
                                children: "ChatGPT Plus subscriber login"
                            }), !M && (0,
                            r.jsxs)("button", {
                                ...
                                children: ["ChatGPT Plus subscriber login", (0,
                                r.jsx)(w.ZP, {
                                    icon: h.bTu,
                                    size: "medium",
                                    className: (0,
                                    i.Z)("absolute right-0 top-0", !_ && "rotate-180")
                                })]
                            }), (0,
                            r.jsxs)("div", {
                                className: "m-auto flex w-full max-w-md flex-col gap-4 rounded-md border p-6 lg:border-0 lg:p-0",
                                children: [!C && (0,
                                r.jsx)("p", {
                                    children: "Add your email for a personalized login link"
                                }), C && (0,
                                r.jsxs)("p", {
                                    children: ["You're all set! If you're a ", (0,
                                    r.jsx)("a", {
                                        className: "underline",
                                        href: "https://openai.com/blog/chatgpt-plus/",
                                        children: "ChatGPT Plus"
                                    }), " ", "subscriber, check your email for a login link."]
                                }), (0,
                                r.jsxs)("form", {
                                    onSubmit: O,
                                    children: [(0,
                                    ...
                                    r.jsxs)("div", {
                                        ...
                                        r.jsx)("div", {
                                            ...
                                            r.jsx)("input", {
                                                ...
                                                id: "email",
                                                className: (0,
                                                i.Z)("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm", {
                                                    "opacity-50": C
                                                }),
                                                required: !0,
                                                disabled: C,
    ...
    33669: function(e, t, n) {
        ...
        var a, o, r, i = n(96237), s = n(22830), h = n(70079);
        (a = o || (o = {})).Mobile = "mobile",
        a.Small = "small",
        a.Medium = "medium",
        a.Large = "large",
        ...
        function c() {
            return u("(min-width: ".concat(l[o.Small], "px)"))
        }
        function d() {
            return u("(min-width: ".concat(l[o.Medium], "px)"))
        }
        function m() {
            return u("(min-width: ".concat(l[o.Large], "px)"))
        }
        function f() {
        ...
        function g() {
            var e = c()
              , t = d()
              , n = m();
            return f() ? o.XLarge : n ? o.Large : t ? o.Medium : e ? o.Small : o.Mobile
        }
    },
    21817: function(e, t, n) {
        ...
        function o() {
            ...
            a.useRef)([])
              , t = (0,
            a.useRef)(function(t, n) {
                var a = setTimeout(t, n);
                return e.current.push(a),
                a
            });
            return (0,
