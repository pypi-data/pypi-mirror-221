...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[297], {
    ...
    63857: function(e, n, r) {
        ...
        function d() {
            var e = (0,
            t._)(["text-xs flex items-center justify-center gap-1"]);
            return d = function() {
                return e
            }
            ,
        ...
        function u() {
            var e = (0,
            t._)(["dark:text-white disabled:text-gray-300 dark:disabled:text-gray-400"]);
            return u = function() {
                return e
            }
            ,
    ...
    82277: function(e, n, r) {
        ...
        function u() {
            var e = (0,
            t._)(["overflow-hidden w-full h-full relative flex z-0"]);
            return u = function() {
                return e
            }
            ,
        ...
        function f() {
            var e = (0,
            t._)(["relative h-full w-full transition-width flex flex-col overflow-auto items-stretch"]);
            return f = function() {
                return e
            }
            ,
        ...
        function v(e) {
            ...
            return a.Children.forEach(n, function(e) {
                a.isValidElement(e) && (e.type === v.Sidebars ? g = e : m.push(e))
            }),
            (0,
            i.jsxs)(h, {
                children: [f && r && (0,
    ...
    13090: function(e, n, r) {
        ...
        function N() {
            ...
            a.jsx)(b.u, {
                side: "right",
                label: e.formatMessage(_.closeSidebar),
                children: (0,
                a.jsxs)(k.zV, {
            ...
            a.jsxs)(a.Fragment, {
                ...
                a.jsx)(d.M, {
                    ...
                    a.jsx)(c.E.div, {
                        ...
                        a.jsx)(b.u, {
                            side: "right",
                            label: r.formatMessage(_.openSidebar),
                            children: (0,
                            a.jsx)(j.O, {
                                onClick: m.vm.toggleDesktopNavCollapsed,
                                "aria-label": r.formatMessage(_.openSidebar),
                                children: (0,
                                a.jsx)(p.ZP, {
    ...
    92160: function(e, n, r) {
        ...
        function x() {
            var e = (0,
            t._)(["flex p-3 items-center gap-3 transition-colors duration-200 text-white cursor-pointer text-sm rounded-md border bg-white dark:bg-gray-800 border-black/10 dark:border-white/20 hover:bg-gray-50 dark:hover:bg-gray-700 h-11"]);
            return x = function() {
                return e
            }
            ,
    ...
    52696: function(e, n, r) {
        ...
        function d() {
            var e = (0,
            a.Z)()
              , n = e.formatMessage(x.adminRoleName)
              , r = e.formatMessage(x.standardRoleName);
            return (0,
            i.useMemo)(function() {
                var e;
                return e = {},
        ...
        function u(e) {
            var n = (0,
            a.Z)();
            return e ? "personal" === e.structure ? n.formatMessage(x.personalPlanName) : n.formatMessage(x.businessPlanName) : n.formatMessage(x.personalPlanName)
        }
        function f(e) {
            var n, r, t, i, o, l, d = (0,
            s.kP)().session, u = (0,
            ...
            c.ec)(c.F_.isPersonalWorkspace), v = (0,
            c.$T)(), h = (r = (0,
            a.Z)(),
            null !== (n = null == u ? void 0 : u.name) && void 0 !== n ? n : r.formatMessage(x.defaultWorkspaceTitle)), m = null !== (l = null !== (o = null == d ? void 0 : null === (t = d.user) || void 0 === t ? void 0 : t.name) && void 0 !== o ? o : null == d ? void 0 : null === (i = d.user) || void 0 === i ? void 0 : i.email) && void 0 !== l ? l : null;
            return e && !v ? "personal" === e.structure ? m : e.name : u ? f ? m : h : m
        }
        function v() {
            return (0,
            c.ec)(function(e) {
    ...
    55629: function(e, n, r) {
        ...
        n.Z = {
            Root: function(e) {
                ...
                l.useEffect)(function() {
                    ...
                    if (e && n) {
                        var r = new ResizeObserver(function() {
                            v(n.scrollHeight > e.clientHeight)
                        }
                        );
                        return r.observe(e),
                        function() {
                ...
                o.jsx)("div", {
                    className: (0,
                    s.Z)("overflow-y-auto text-gray-600 dark:text-gray-300", "normal" === (void 0 === i ? "normal" : i) ? "text-base" : "text-sm", f && "pr-1", t),
                    ref: c,
                    children: (0,
                    o.jsx)("table", {
                        className: (0,
                        s.Z)("w-full border-separate border-spacing-0", void 0 !== r && r && "table-fixed"),
                        ref: d,
                        children: n
                    })
                })
            ...
            HeaderCell: function(e) {
                ...
                o.jsx)("th", {
                    className: (0,
                    s.Z)("sticky top-0 z-10 border-b border-black/10 bg-white py-2 pr-4 font-medium last:pr-0 dark:border-white/10", "left" === (void 0 === n ? "left" : n) ? "text-left" : "text-right", void 0 === t ? "dark:bg-gray-900" : t),
                    children: r
                })
            },
            Body: function(e) {
            ...
            Cell: function(e) {
                ...
                o.jsx)("td", {
                    className: (0,
                    s.Z)("border-b border-black/10  pr-4 last:pr-0 dark:border-white/10 [tr:last-child_&]:border-b-0", "left" === (void 0 === n ? "left" : n) ? "text-left" : "text-right", t),
                    children: (0,
                    o.jsx)("div", {
    ...
    45635: function(e, n, r) {
        ...
        function l() {
            var e = (0,
            t._)(["relative top-[-3px] h-2 w-2 rotate-45 transform border-r border-b border-black/10 bg-black shadow-xs"]);
            return l = function() {
                return e
            }
            ,
        ...
        var c = function(e) {
            ...
            i.jsxs)(a.VY, {
                ...
                className: (0,
                o.Z)("relative rounded-lg border border-black/10 bg-black p-1 shadow-xs transition-opacity", void 0 !== l && l ? "max-w-sm" : "max-w-xs", h),
                children: [(0,
                i.jsx)("span", {
                    className: (0,
                    o.Z)("flex items-center whitespace-pre-wrap px-2 py-1 text-center font-medium normal-case text-white", {
                        "text-xs": "xsmall" === u,
                        "text-sm": "small" === u
                    }),
                    children: n
    ...
    15329: function(e, n, r) {
        ...
        function h() {
            var e = (0,
            i._)(["p-2 rounded-md hover:bg-black/10 hover:dark:bg-white/10 cursor-pointer"]);
            return h = function() {
                return e
            }
            ,
        ...
        function x() {
            var e = (0,
            i._)(["flex p-3 items-center gap-3 transition-colors duration-200 text-white cursor-pointer text-sm"]);
            return x = function() {
                return e
            }
            ,
        ...
        function m() {
            var e = (0,
            i._)(["rounded-md border border-white/20 hover:bg-gray-500/10 h-11"]);
            return m = function() {
                return e
            }
            ,
            ...
            a.jsx)(o.v.Item, {
                children: function(e) {
                    ...
                    a.jsx)(j, {
                        ...
                        target: t,
                        className: (0,
                        s.Z)(o ? "bg-gray-700" : "hover:bg-gray-700"),
                        children: i
                    })
                }
            })
        ...
        function k(e) {
            var n = e.onDeleteHistory
              , r = e.isConfirmingDeleteHistory
              , i = (0,
            v.LC)();
            return (0,
            a.jsx)(a.Fragment, {
                ...
                a.jsxs)(p, {
                    ...
                    a.jsx)(c.Z, (0,
                    t._)({}, C.confirmClearConversations)) : (0,
                    a.jsx)(c.Z, (0,
                    t._)({}, C.clearConversations))]
                })
            })
        }
        u.Z.a(h());
    ...
    50828: function(e, n, r) {
        ...
        var t = r(44009)
          ...
          , c = r(32877)
          , d = r(78931)
          , u = "oai/apps/hasSeenHistoryFilteredDisclosure/".concat("2023-03-21")
          , f = "conversationHistory";
        function v() {
            var e, n = (0,
            d.hz)().has(c.Ud), r = (0,
            d.$T)(), i = (0,
            o.kP)().session, s = null == i ? void 0 : i.accessToken, u = !n && !!s && !r, v = (0,
            t.N)({
                queryKey: [f],
                queryFn: function(e) {
                    var n = e.pageParam;
                    return l.ZP.getConversations(n || 0, 28, null == i ? void 0 : i.accessToken)
                },
                ...
                enabled: u
            }), h = v.data, x = v.fetchNextPage, m = v.hasNextPage, g = v.isInitialLoading, b = v.isFetchingNextPage, p = v.isError, k = (0,
            a.useMemo)(function() {
    ...
    46020: function(e, n, r) {
        ...
        var t, i, a, o = r(39324), s = r(78103), l = r(6948);
        ...
        var c = "UiState.isNavigationCollapsed.1"
          , d = {
            isThreadHeaderVisible: !0,
            isDesktopNavCollapsed: null !== (a = l.m.getItem(c)) && void 0 !== a && a,
    ...
    33669: function(e, n, r) {
        ...
        var t, i, a, o = r(96237), s = r(22830), l = r(70079);
        (t = i || (i = {})).Mobile = "mobile",
        t.Small = "small",
        t.Medium = "medium",
        t.Large = "large",
        ...
        function d(e) {
            ...
            l.useEffect)(function() {
                ...
                return n(),
                r.addListener ? r.addListener(n) : r.addEventListener("change", n),
                function() {
        ...
        function u() {
            return d("(min-width: ".concat(c[i.Small], "px)"))
        }
        function f() {
            return d("(min-width: ".concat(c[i.Medium], "px)"))
        }
        function v() {
            return d("(min-width: ".concat(c[i.Large], "px)"))
        }
        function h() {
            return d("(min-width: ".concat(c[i.XLarge], "px)"))
        }
        function x() {
            var e = u()
              , n = f()
              , r = v();
            return h() ? i.XLarge : r ? i.Large : n ? i.Medium : e ? i.Small : i.Mobile
        }
    }
}]);
