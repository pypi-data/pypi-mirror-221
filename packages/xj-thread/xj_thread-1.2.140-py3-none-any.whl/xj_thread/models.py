...
class Thread(models.Model):
    ...
    region_code = models.CharField(verbose_name='行政编码', max_length=50, db_column='region_code', help_text='完整的行政编码')
    ...
    is_subitem_thread = models.IntegerField(verbose_name='是否是分项', choices=bool_choice, default=0, blank=True, null=True, help_text='是否是主项信息的分项信息')
    main_thread = models.ForeignKey(to="Thread", on_delete=models.DO_NOTHING, related_name='+', blank=True, null=True, help_text='主项信息的ID')
    ...
    field_10 = models.CharField(verbose_name='char类型自定义字段-10', max_length=255, blank=True, null=True, help_text='')
...
class ThreadMainExtendField(models.Model):
    ...
    id = models.AutoField(verbose_name='信息ID', primary_key=True, help_text='')
    category = models.ForeignKey(verbose_name='类别ID', null=False, blank=False, to=ThreadCategory, db_column='category_id', related_name='+', on_delete=models.DO_NOTHING, help_text='')
    field = models.CharField(verbose_name='自定义字段', max_length=255, help_text='')  # 眏射ThreadExtendData表的键名
    field_index = models.CharField(verbose_name='冗余字段', max_length=255, help_text='', choices=field_index_choices)  # 眏射ThreadExtendData表的键名
    value = models.CharField(verbose_name='字段介绍', max_length=255, null=True, blank=True, help_text='')
    type = models.CharField(verbose_name='字段类型', max_length=255, blank=True, null=True, choices=type_choices, help_text='')
