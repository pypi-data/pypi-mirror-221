...
class ContentNegociationTC(PyramidCWTest):
    ...
    def test_content_negociation_alternate_eid_no_more_html(self):
        # cubicweb doesn't return HTML anymore
    ...
    def test_content_negociation_wrong_accept(self):
        # The mime-type isn't a RDF valid type, so we return basic html
