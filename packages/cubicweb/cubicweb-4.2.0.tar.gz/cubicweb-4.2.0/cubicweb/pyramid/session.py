...
`pyramid-session-redis`_ package, then you must configure pyramid to
...
def CWSessionFactory(
    ...
    .. warning::
        ...
        (pyramid_session_redis_ for example) if you need speed.

    .. _pyramid_session_redis: https://github.com/jvanasco/pyramid_session_redis
    """
