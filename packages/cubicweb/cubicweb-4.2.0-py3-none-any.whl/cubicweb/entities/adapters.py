...
class EntityRDFAdapter(EntityAdapter):
    ...
    @cachedproperty
    def uri(self):
        return URIRef(self.entity.absolute_url())
    ...
    def cw_triples(self):
        ...
        yield (self.uri, OWL.sameAs, URIRef(self.entity.cwuri))
...
class EntityRQLInterfaceAdapter(EntityAdapter):
    ...
    def cw_attr_metadata(self, attr, metadata):
        return self.entity.cw_attr_metadata(attr, metadata)

    def printable_value(
        self, attr, value=_marker, attrtype=None, format="text/html", displaytime=True
    ):
        if value is _marker:
            return self.entity.printable_value(
                attr, attrtype=attrtype, format=format, displaytime=displaytime
            )
        return self.entity.printable_value(attr, value, attrtype, format, displaytime)

    def dc_title(self):
        return self.entity.dc_title()

    def dc_long_title(self):
        return self.entity.dc_long_title()

    def dc_description(self):
        return self.entity.dc_description()

    def dc_authors(self):
        return self.entity.dc_authors()

    def dc_creator(self):
        return self.entity.dc_creator()

    def dc_date(self):
        return self.entity.dc_date()

    def dc_type(self):
        return self.entity.dc_type()

    def dc_language(self):
        return self.entity.dc_language()
