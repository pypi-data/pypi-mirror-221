...
size_t ctransformers_llm_get_total_state_size(LLM* llm) { return llm->GetStateSize(); }

void ctransformers_llm_clone_state(LLM* llm, void *data) { llm->CloneState(data); }

void ctransformers_llm_set_state(LLM* llm, void *data) { llm->SetState(data); }
