...
size_t gpt_neox_get_state_size(const gpt_neox_model &model) {
  size_t nbytes = 0;
...
void gpt_neox_clone_state(const gpt_neox_model &model, void *data) {
...
void gpt_neox_set_state(const gpt_neox_model &model, void *data) {
  uint8_t *data_bytes = static_cast<uint8_t *>(data);
  size_t nbytes;
