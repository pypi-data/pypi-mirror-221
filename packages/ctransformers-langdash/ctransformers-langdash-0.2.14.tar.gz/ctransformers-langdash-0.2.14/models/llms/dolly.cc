...
size_t dollyv2_get_state_size(const dollyv2_model &model) {
  size_t nbytes = 0;
...
void dollyv2_clone_state(const dollyv2_model &model, void *data) {
...
void dollyv2_set_state(const dollyv2_model &model, void *data) {
  uint8_t *data_bytes = static_cast<uint8_t *>(data);
  size_t nbytes;
