...
class GetHodlerResult(BaseModel):
    """
    GetHodlerResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetHodlerResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetHodlerResult:
        """Create an instance of GetHodlerResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetHodlerResult.parse_obj(obj)

        _obj = GetHodlerResult.parse_obj({
            "code": obj.get("code"),
