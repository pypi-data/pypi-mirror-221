...
class GetPredictionResult(BaseModel):
    """
    GetPredictionResult
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPredictionResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPredictionResult:
        """Create an instance of GetPredictionResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetPredictionResult.parse_obj(obj)

        _obj = GetPredictionResult.parse_obj({
            "code": obj.get("code"),
