    ...
    def query(self, *args, **kwargs):
        ...
        try:
            ...
            if o is not None and operation is not None:
                ...
                pi = o.profiler.start_query(self.call_info, operation, self.host, self.port, parameters, self.paramstyle)
        except:
            pass
    ...
    def _wrap_connect(connect):
        ...
        def handler(*args, **kwargs):
            ...
            try:
                ...
                if o is not None:
                    connection = ConnectionProxy(origin_connection, db_type, host, port, db_module.paramstyle)
                else:
