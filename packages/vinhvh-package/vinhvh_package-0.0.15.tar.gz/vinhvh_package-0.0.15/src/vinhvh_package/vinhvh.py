...
def save_file(df_result: pd.DataFrame, file_name: str = 'Program running result', folder: str = "Result", type: str = 'excel'):
    ...
    file_type : str, optional
        The type of file to save the DataFrame as. Can be one of 'excel', 'txt', or 'csv'.
...
def type_site(x: str):
    ...
    site_types = {
        ...
        'Macro': ['1', '2', '3', '4', '5', '6', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'M4BA', 'M4BB', 'M4BC', 'M4BD', 'M4BE', 'M4BF', 'M4BG', 'M4BH', 'M4BI', 'M4CA', 'M4CB', 'M4CC', 'M4CD', 'M4CE', 'U4BA', 'U4BB', 'U4BC', 'U4CA', 'U4CB', 'U4CC', 'A_LTE', 'B_LTE', 'C_LTE', 'D_LTE', 'E_LTE', 'F_LTE', '_LTE'],
