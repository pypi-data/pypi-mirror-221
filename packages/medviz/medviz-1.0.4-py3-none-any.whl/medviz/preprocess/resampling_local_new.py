...
def resample_trilinear(input_path, output_path, new_voxel_size, method="trilinear"):
    input_path = path_in(input_path)
    ...
    print("Resampled image voxel size", resampled_img.header.get_zooms()[:3])

    # Save the resampled image to thme output path
    save_path = save_path_file(output_path, suffix=".nii")
