...
def annotation(text, xy, xytext, arrowcolor='fg', color='fg', font=fontpath, fontsize=20, **kwargs):
...
class Basemap():
    ...
    # 繪製經緯線
    def drawparallels(self, parallels = np.arange(-90.,90,30.), labels=[1,0,0,0], fontsize=16, color='fg', linewidth=1.5, **kwargs):
        DP = self.basemap.drawparallels(parallels, labels=labels, fontsize=fontsize, color=colorlist(color), linewidth=linewidth, **kwargs)
    def drawmeridians(self, meridians = np.arange(-180.,180.,60.), labels=[0,0,0,1], fontsize=16, color='fg', linewidth=1.5, **kwargs):
        self.basemap.drawmeridians(meridians, labels=labels, fontsize=fontsize, color=colorlist(color), linewidth=linewidth, **kwargs)
    # 根據指定地區自動繪製經緯線
    def drawparallelsmeridians(self, zone='world', latinterval=15, loninterval=15, fontsize=16, color='fg', linewidth=1.5, **kwargs):
        import numpy as np
        if zone == 'taiwan':
    ...
    # 繪製等值線
    def contour(self, x, y, z, colors='fg', levels=10, linewidths=2, clabel=True, fontsize=12, color='fg', **kwargs):
    ...
    def colorbar(self, ticks,label=' ', orientation='vertical',shrink=0.95, aspect=20, labelfontsize=16, font=fontpath, color='fg',**kwargs):
        ...
        CB.outline.set_linewidth(2)
    # 繪製圖例
    def legend(self, loc='best', fontsize=18, labelcolor='fg', frameon=True, framealpha=1, facecolor='rfg', edgecolor='fg', edgewidth=2 ,roundedge=False, **kwargs):
...
class initsubplots():
    ...
    def ylabel(self, ylabel, color='fg', font=fontpath, fontsize=24*fontscale, **kwargs):
    ...
    # 繪製標題
    def title(self, title, color='fg', font=fontpath_bold, fontsize=24*fontscale, **kwargs):
    ...
    def lefttitle(self, title, color='1', font=fontpath_bold, fontsize=24*fontscale, **kwargs):
    ...
    def righttitle(self, title, color='2', font=fontpath_bold, fontsize=24*fontscale, **kwargs):
    ...
    def annotation(self, text, xy, xytext, arrowprops=dict(facecolor='black', shrink=0.05), color='fg', font=fontpath, fontsize=20*fontscale, **kwargs):
