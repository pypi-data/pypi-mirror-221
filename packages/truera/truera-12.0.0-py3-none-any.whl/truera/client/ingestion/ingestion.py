...
class ColumnSpec:
    ...
    Args:
        ...
        tags_column_name: Name of tags column
...
def add_data(
    ...
    *,
    ...
    project_score_type = remote_workspace._get_score_type()
    ...
    if isinstance(data, Table):
        ...
        data = format_dataframe(data, column_spec=column_spec)
...
def format_dataframe(
    data: pd.DataFrame, column_spec: ColumnSpec
) -> pd.DataFrame:
    # Format id column
    data = data.copy()
...
def to_parquet(data: pd.DataFrame, path: str, column_spec: 'ColumnSpec'):
