...
_RequiredS3DataConfigOutputTypeDef = TypedDict(
    "_RequiredS3DataConfigOutputTypeDef",
    {
        "path": str,
    },
)
_OptionalS3DataConfigOutputTypeDef = TypedDict(
    "_OptionalS3DataConfigOutputTypeDef",
    {
        "kmsKeyArn": str,
    },
    total=False,
...
class S3DataConfigOutputTypeDef(
    _RequiredS3DataConfigOutputTypeDef, _OptionalS3DataConfigOutputTypeDef
):
    pass
