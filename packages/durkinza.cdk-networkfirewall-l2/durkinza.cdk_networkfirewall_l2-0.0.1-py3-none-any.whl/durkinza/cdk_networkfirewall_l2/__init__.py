...
class FirewallProps:
    def __init__(
        ...
        *,
        ...
        :param description: (experimental) The descriptiong of the Firewall. Default: - undefined
    ...
    @builtins.property
    def description(self) -> typing.Optional[builtins.str]:
        '''(experimental) The descriptiong of the Firewall.
...
class IFirewallPolicy(_aws_cdk_ceddda9d.IResource, typing_extensions.Protocol):
    ...
    def firewall_policy_id(self) -> builtins.str:
        '''(experimental) The phyiscal name of the firewall policy.
...
class LoggingConfiguration(
    ...
    def logging_locations(self, value: typing.List[ILogLocation]) -> None:
        ...
        jsii.set(self, "loggingLocations", value)
...
class StatelessRule(
    ...
    def calculate_capacity(self) -> jsii.Number:
        '''(experimental) Calculate Rule Capacity Reqirements.
...
class StatelessRuleGroup(
    ...
    def from_stateless_rule_group_name(
        ...
        '''(experimental) Refernce existing Rule Group by Name.
...
class Firewall(
    ...
    def logging_cloud_watch_log_groups(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "loggingCloudWatchLogGroups", value)
    ...
    def logging_configurations(self, value: typing.List[ILoggingConfiguration]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "loggingConfigurations", value)
    ...
    def logging_kinesis_data_streams(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "loggingKinesisDataStreams", value)
    ...
    def logging_s3_buckets(self, value: typing.List[S3LogLocationProps]) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "loggingS3Buckets", value)
...
class Stateful5TupleRule(
    ...
    def __init__(
        ...
        *,
        ...
        :param rule_options: (experimental) Additional settings for a stateful rule, provided as keywords and setttings. Default: - undefined
...
class Stateful5TupleRuleProps(StatefulRuleBaseProps):
    ...
    def rule_options(
        ...
        '''(experimental) Additional settings for a stateful rule, provided as keywords and setttings.
...
class StatefulDomainListRule(
    ...
    '''(experimental) Generates a Statful Rule from a Domain List.
