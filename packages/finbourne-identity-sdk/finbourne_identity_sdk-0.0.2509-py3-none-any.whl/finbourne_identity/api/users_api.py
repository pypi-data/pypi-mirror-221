...
class UsersApi(object):
    ...
    def create_user_with_http_info(self, create_user_request, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.0.2509'
    ...
    def suspend_user(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] SuspendUser: Suspend user  # noqa: E501

        suspend the user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param id: The unique identifier for the User to suspend (required)
        :type id: str
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def suspend_user_with_http_info(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] SuspendUser: Suspend user  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `suspend_user`")  # noqa: E501

        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `suspend_user`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `suspend_user`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'id' in local_var_params and not re.search(r'^[a-zA-Z0-9\-_]+$', local_var_params['id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `id` when calling `suspend_user`, must conform to the pattern `/^[a-zA-Z0-9\-_]+$/`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/users/{id}/lifecycle/$suspend', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
