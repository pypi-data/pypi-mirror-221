...
class AdiEmsWebApiV2DtoNavigationNavigationProcedureSegment(Model):
    ...
    :param track_code: The procedure segment track code
    :type track_code: str
    ...
    def __init__(self, *, id: int=None, type: str=None, transition_id: str=None, sequence_number: int=None, track_code: str=None, waypoint_id: int=None, waypoint_desc_codes=None, waypoint_bearing: float=None, waypoint_distance: float=None, navaids=None, turn_direction: str=None, altitude_description: str=None, altitude1: str=None, altitude2: str=None, is_iaf: bool=None, next_segment_id: int=None, **kwargs) -> None:
