...
class AdiEmsWebApiV2DtoAnalyticFormula(Model):
    ...
    def __init__(self, *, body: str, name: str=None, description: str=None, units: str=None, used_analytics=None, used_analytic_name_for_metadata: str=None, **kwargs) -> None:
        super(AdiEmsWebApiV2DtoAnalyticFormula, self).__init__(**kwargs)
        self.name = name
        self.description = description
        self.units = units
        self.body = body
        self.used_analytics = used_analytics
        self.used_analytic_name_for_metadata = used_analytic_name_for_metadata
