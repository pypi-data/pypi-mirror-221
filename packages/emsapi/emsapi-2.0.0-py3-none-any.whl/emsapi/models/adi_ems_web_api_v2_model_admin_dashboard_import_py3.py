...
class AdiEmsWebApiV2ModelAdminDashboardImport(Model):
    ...
    :type dashboard: ~emsapi.models.AdiEmsWebApiV2ModelAdminDashboard
    ...
    :type messages: list[~emsapi.models.AdiEmsWebApiV2ModelApiMessage]
    ...
    def __init__(self, *, dashboard=None, messages=None, **kwargs) -> None:
        super(AdiEmsWebApiV2ModelAdminDashboardImport, self).__init__(**kwargs)
