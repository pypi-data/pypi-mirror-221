...
class AdiEmsWebApiV2DtoAnalyticSetAnalyticCollectionItem(Model):
    """A model that encapsulates the data for a single analytic in an analytic
    collection.

    :param analytic: The analytic that is represented by this analytic
     collection item
    ...
    def __init__(self, *, analytic=None, custom_name: str=None, color: str=None, custom_range=None, custom_digits_after_decimal: int=None, line_width: int=None, display_sample_marker: bool=None, sample_marker_shape: str=None, line_style: str=None, parameter_filtering_mode: str=None, interpolation_mode: str=None, **kwargs) -> None:
        super(AdiEmsWebApiV2DtoAnalyticSetAnalyticCollectionItem, self).__init__(**kwargs)
