...
class AdiEmsWebApiV2ModelAdminUser(Model):
    ...
    def __init__(self, *, username: str, id: int=None, lockout_policy_enabled: bool=None, roles=None, tableau_username: str=None, last_login=None, lockout_end_date_utc=None, access_failed_count: int=None, **kwargs) -> None:
