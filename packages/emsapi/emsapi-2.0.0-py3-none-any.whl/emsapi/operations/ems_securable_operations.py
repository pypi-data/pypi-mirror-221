...
class EmsSecurableOperations(object):
    """EmsSecurableOperations operations.
    ...
    def get_securables(
        ...
        """Retrieves a hierarchical tree of EMS securables and their related
        access rights.
        ...
        """
        # Construct URL
        url = self.get_securables.metadata['url']
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('AdiEmsWebApiV2DtoEmsSecurableEmsSecurableContainer', response)
        ...
        return deserialized
    get_securables.metadata = {'url': '/v2/ems-systems/{emsSystemId}/securables'}

    def get_access_for_securable(
            self, ems_system_id, securable_id, access_right, custom_headers=None, raw=False, **operation_config):
        ...
        :param access_right: The name of the access right for the securable.
         This has to be
         a valid access right for the specific type of securable.
        ...
        """
        # Construct URL
        url = self.get_access_for_securable.metadata['url']
        path_format_arguments = {
            'emsSystemId': self._serialize.url("ems_system_id", ems_system_id, 'int'),
        ...
        return deserialized
    get_access_for_securable.metadata = {'url': '/v2/ems-systems/{emsSystemId}/securables/{securableId}'}
