...
class SessionsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CountTasksByStatus = channel.unary_unary(
                '/armonik.api.grpc.v1.sessions.Sessions/CountTasksByStatus',
                request_serializer=sessions__common__pb2.CountTasksByStatusRequest.SerializeToString,
                response_deserializer=sessions__common__pb2.CountTasksByStatusResponse.FromString,
                )
...
class SessionsServicer(object):
    ...
    def CountTasksByStatus(self, request, context):
        """*
        Get count from tasks by status using a session id.
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SessionsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CountTasksByStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=sessions__common__pb2.CountTasksByStatusRequest.FromString,
                    response_serializer=sessions__common__pb2.CountTasksByStatusResponse.SerializeToString,
            ),
    }
...
class Sessions(object):
    ...
    def CountTasksByStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/armonik.api.grpc.v1.sessions.Sessions/CountTasksByStatus',
            sessions__common__pb2.CountTasksByStatusRequest.SerializeToString,
            sessions__common__pb2.CountTasksByStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
