...
<h2>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 6, col 5
...
''')
            for entry in sorted(chm.keys()): # generated from line 12, col 1
                _v = VFFSL(SL,"render_change",False)(chm[entry]) # '$render_change(chm[entry])' on line 13, col 1
...
''')
        ...
        for ct in changeorder: # generated from line 59, col 1
            _v = VFFSL(SL,"render_by_class",False)(changemap.pop(ct, ()), ct.label) # '$render_by_class(changemap.pop(ct, ()), ct.label)' on line 60, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_by_class(changemap.pop(ct, ()), ct.label)'))
            write('''
''')
        write('''
''')
        ...
        for ct,changes in changemap.items(): # generated from line 64, col 1
            _v = VFFSL(SL,"render_by_class",False)(changes, ct.label) # '$render_by_class(changes, ct.label)' on line 65, col 1
