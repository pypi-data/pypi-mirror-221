...
<div class="lrdata">
''')
        _v = VFFSL(SL,"method_table",False)(VFN(VFFSL(SL,"change",True),"get_rdata",False)()) # '$method_table($change.get_rdata())' on line 23, col 1
        if _v is not None: write(_filter(_v, rawExpr='$method_table($change.get_rdata())'))
        write('''
</div>
</div>
''')
