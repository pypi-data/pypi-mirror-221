...
class report(Template):
    ...
    def title(self, **KWS):
        ...
        _v = VFFSL(SL,"change.__class__.__name__",True) # '$change.__class__.__name__' on line 10, col 1
        if _v is not None: write(_filter(_v, rawExpr='$change.__class__.__name__'))
        write('''
''')
...
<title>''')
        _v = VFFSL(SL,"title",True) # '$title' on line 18, col 8
        if _v is not None: write(_filter(_v, rawExpr='$title'))
        write('''</title>
''')
        write('''
...
''')
        for ss in VFFSL(SL,"stylesheets",True): # generated from line 27, col 1
            ...
            _v = VFFSL(SL,"ss",True) # '$ss' on line 28, col 46
            if _v is not None: write(_filter(_v, rawExpr='$ss'))
            write('''" />
''')
        write('''
...
''')
        if not getattr(VFFSL(SL,"options",True), "html_no_jquery", False): # generated from line 34, col 1
            write('''<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
''')
        for js in VFFSL(SL,"javascripts",True): # generated from line 37, col 1
            write('''<script type="text/javascript" src="''')
            _v = VFFSL(SL,"js",True) # '$js' on line 38, col 37
            if _v is not None: write(_filter(_v, rawExpr='$js'))
            write('''"></script>
''')
        write('''
...
''')
        write('''<li>''')
        _v = VFFSL(SL,"title",True) # '$title' on line 64, col 5
        if _v is not None: write(_filter(_v, rawExpr='$title'))
        write('''</li>
</ul>
''')
...
<h1>''')
        _v = VFFSL(SL,"title",True) # '$title' on line 69, col 5
        if _v is not None: write(_filter(_v, rawExpr='$title'))
        write('''</h1>
</div>
''')
...
''')
        for child in VFN(VFFSL(SL,"change",True),"collect",False)(): # generated from line 82, col 1
            _v = VFFSL(SL,"render_change",False)(VFFSL(SL,"child",True)) # '$render_change($child)' on line 83, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_change($child)'))
            write('''
''')
        write('''</div>
''')
