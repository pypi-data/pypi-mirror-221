...
<h2>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 9, col 5
...
''')
            for entry in sorted(chm.keys()): # generated from line 15, col 1
                _v = VFFSL(SL,"render_change",False)(chm[entry]) # '$render_change(chm[entry])' on line 16, col 1
                if _v is not None: write(_filter(_v, rawExpr='$render_change(chm[entry])'))
                write('''
''')
            write('''
</div>
...
''')
        ...
        for ct in changeorder: # generated from line 61, col 1
            _v = VFFSL(SL,"render_by_class",False)(changemap.pop(ct, tuple()), ct.label) # '$render_by_class(changemap.pop(ct, tuple()), ct.label)' on line 62, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_by_class(changemap.pop(ct, tuple()), ct.label)'))
            write('''
''')
        write('''
''')
        ...
        for ct, changes in changemap.items(): # generated from line 66, col 1
            _v = VFFSL(SL,"render_by_class",False)(changes, ct.label) # '$render_by_class(changes, ct.label)' on line 67, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_by_class(changes, ct.label)'))
            write('''
''')
        write('''
''')
