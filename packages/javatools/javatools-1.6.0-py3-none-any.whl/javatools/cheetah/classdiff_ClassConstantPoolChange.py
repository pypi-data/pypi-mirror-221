...
''')
        if VFN(VFFSL(SL,"change",True),"is_change",False)(): # generated from line 10, col 1
            _v = VFFSL(SL,"render_dual_constant_pool",False)(VFN(VFFSL(SL,"change",True),"get_ldata",False)(), VFN(VFFSL(SL,"change",True),"get_rdata",False)()) # '$render_dual_constant_pool($change.get_ldata(), $change.get_rdata())' on line 11, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_dual_constant_pool($change.get_ldata(), $change.get_rdata())'))
            write('''
''')
        else: # generated from line 12, col 1
            _v = VFFSL(SL,"render_constant_pool",False)(VFN(VFFSL(SL,"change",True),"pretty_ldata",False)()) # '$render_constant_pool($change.pretty_ldata())' on line 13, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_constant_pool($change.pretty_ldata())'))
            write('''
''')
        write('''</div>
</div>
