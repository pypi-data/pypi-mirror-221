...
''')
        _v = VFFSL(SL,"sub_classname",False)(data["ClassNameChange"][0]) # '$sub_classname(data["ClassNameChange"][0])' on line 16, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_classname(data["ClassNameChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_flags",False)(data["ClassAccessflagsChange"][0]) # '$sub_flags(data["ClassAccessflagsChange"][0])' on line 17, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_flags(data["ClassAccessflagsChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_super",False)(data["ClassSuperclassChange"][0]) # '$sub_super(data["ClassSuperclassChange"][0])' on line 18, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_super(data["ClassSuperclassChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_inter",False)(data["ClassInterfacesChange"][0]) # '$sub_inter(data["ClassInterfacesChange"][0])' on line 19, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_inter(data["ClassInterfacesChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_version",False)(data["ClassVersionChange"][0]) # '$sub_version(data["ClassVersionChange"][0])' on line 20, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_version(data["ClassVersionChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_platform",False)(data["ClassPlatformChange"][0]) # '$sub_platform(data["ClassPlatformChange"][0])' on line 21, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_platform(data["ClassPlatformChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_signature",False)(data["ClassSignatureChange"][0]) # '$sub_signature(data["ClassSignatureChange"][0])' on line 22, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_signature(data["ClassSignatureChange"][0])'))
        write('''
''')
        _v = VFFSL(SL,"sub_deprecation",False)(data["ClassDeprecationChange"][0]) # '$sub_deprecation(data["ClassDeprecationChange"][0])' on line 23, col 1
        if _v is not None: write(_filter(_v, rawExpr='$sub_deprecation(data["ClassDeprecationChange"][0])'))
        write('''
</table>
...
''')
    ...
    def sub_classname(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 39, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 41, col 17
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 49, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
    ...
    def sub_flags(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 59, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 61, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
...
''')
    ...
    def sub_super(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 83, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 85, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 93, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
    ...
    def sub_inter(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 103, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 105, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 114, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( ", ".join(subch.pretty_ldata())))
...
''')
    ...
    def sub_version(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 125, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 127, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
...
''')
    ...
    def sub_platform(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 145, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 147, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 155, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
    ...
    def sub_signature(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 165, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 167, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 176, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
...
''')
    ...
    def sub_deprecation(self, subch, **KWS):
        ...
        if subch.is_change(): # generated from line 186, col 1
            write('''<tr>
<th rowspan="2">''')
            _v = VFFSL(SL,"label",True) # '$label' on line 188, col 17
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
...
''')
            ...
            write('''<tr>
<th>''')
            _v = VFFSL(SL,"label",True) # '$label' on line 196, col 5
            if _v is not None: write(_filter(_v, rawExpr='$label'))
            write('''</th>
<td>''')
            write(_filter( subch.pretty_ldata()))
