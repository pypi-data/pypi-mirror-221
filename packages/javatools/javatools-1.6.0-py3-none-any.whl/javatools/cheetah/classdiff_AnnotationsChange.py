...
''')
        if VFN(VFFSL(SL,"change",True),"is_change",False)(): # generated from line 9, col 1
            _v = VFFSL(SL,"render_dual_annotations",False)(VFN(VFFSL(SL,"change",True),"get_ldata",False)(), VFN(VFFSL(SL,"change",True),"get_rdata",False)()) # '$render_dual_annotations($change.get_ldata(), $change.get_rdata())' on line 10, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_dual_annotations($change.get_ldata(), $change.get_rdata())'))
            write('''
''')
        else: # generated from line 11, col 1
            _v = VFFSL(SL,"render_annotations",False)(VFN(VFFSL(SL,"change",True),"get_ldata",False)()) # '$render_annotations($change.get_ldata())' on line 12, col 1
            if _v is not None: write(_filter(_v, rawExpr='$render_annotations($change.get_ldata())'))
            write('''
''')
        write('''</div>
</div>
...
<div class="description">''')
        _v = VFFSL(SL,"change.label",True) # '$change.label' on line 20, col 26
        if _v is not None: write(_filter(_v, rawExpr='$change.label'))
        write('''</div>
''')
        write('''
