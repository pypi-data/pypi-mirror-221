...
''')
        ...
        write('''
''')
        _v = VFFSL(SL,"escape",False)(VFFSL(SL,"change.entry",True)) # '$escape($change.entry)' on line 32, col 1
        if _v is not None: write(_filter(_v, rawExpr='$escape($change.entry)'))
        write('''
