...
class KerykeionPoint(BaseModel):
    ...
    name: Union[Planet, Houses, Axis, Synod]
    quality:  Quality
    element: Element
    signs: List[Sign]
    ...
    abs_pos: float
    emoji: str
    point_type: Literal['Planet', 'House', 'Axis', 'Synod']
...
class KerykeionSubject(BaseModel):
    ...
    #Axes
    ascendant: KerykeionPoint
    midheaven: KerykeionPoint
