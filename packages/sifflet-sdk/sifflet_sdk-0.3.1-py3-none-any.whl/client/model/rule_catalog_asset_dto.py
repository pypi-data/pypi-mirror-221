...
class RuleCatalogAssetDto(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, criticality, id, multi_dimensional, name, rule_type, selectable, source_platform, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, criticality, id, multi_dimensional, name, rule_type, selectable, source_platform, *args, **kwargs):  # noqa: E501
        """RuleCatalogAssetDto - a model defined in OpenAPI
