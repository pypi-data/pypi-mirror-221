...
from client.model.data_quality_rule_summary_dto import DataQualityRuleSummaryDto
from client.model.data_stack_summary_dto import DataStackSummaryDto
from client.model.incident_heat_map_dto import IncidentHeatMapDto
from client.model.incident_summary_dto import IncidentSummaryDto
from client.model.int import Int
...
class StatisticsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_data_stack_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/statistics/data-stack',
        ...
        self.get_incidents_heatmap_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/statistics/incidents-heatmap',
        ...
        self.get_incidents_summary_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/statistics/incidents-summary',
        ...
        self.get_rules_summary_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/statistics/rules-summary',
    ...
    def get_incidents_heatmap(
        ...
        **kwargs
        ...
        Keyword Args:
            domain (str): Domain used for stats. [optional]
            history_days (Int): Historical depth for stats, in days. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
