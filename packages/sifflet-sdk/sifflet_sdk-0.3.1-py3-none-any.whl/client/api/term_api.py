...
from client.model.search_collection_tag_with_asset_count_dto import SearchCollectionTagWithAssetCountDto
from client.model.tag_dto import TagDto
from client.model.tag_with_assets_dto import TagWithAssetsDto
...
class TermApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_terms_with_count_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/terms/with-count',
        ...
        self.get_term_with_assets_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/terms/with-assets',
    ...
    def create_term(
        ...
        **kwargs
        ...
        >>> thread = api.create_term(tag_dto, async_req=True)
        >>> result = thread.get()
    ...
    def update_term(
        ...
        **kwargs
        ...
        >>> thread = api.update_term(id, tag_dto, async_req=True)
        >>> result = thread.get()
