...
from client.model.rule_run_result_dto import RuleRunResultDto
...
class RuleRunApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_sifflet_rule_failing_rows_by_run_and_group_endpoint = _Endpoint(
            settings={
                'response_type': (RuleRunResultDto,),
                'auth': [
                    'JWT'
                ],
        ...
        self.sifflet_rule_run_download_by_run_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/rules/{id}/runs/{runId}/_download',
        ...
        self.sifflet_rule_run_download_by_run_and_group_endpoint = _Endpoint(
            settings={
                'response_type': (file_type,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/rules/{id}/runs/{runId}/_download/{groupValue}',
                'operation_id': 'sifflet_rule_run_download_by_run_and_group',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_sifflet_rule_last_run(
        ...
        **kwargs
        ...
        """Get last run of a Sifflet rule by rule id  # noqa: E501
    ...
    def sifflet_rule_run_download_by_run_and_group(
        self,
        id,
        run_id,
        group_value,
        **kwargs
        ...
        """Download failing results of a Sifflet Rule run for a given group. The CSV created contains the first 20000 rows sent by the Database  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.sifflet_rule_run_download_by_run_and_group(id, run_id, group_value, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['group_value'] = \
            group_value
        return self.sifflet_rule_run_download_by_run_and_group_endpoint.call_with_http_info(**kwargs)
