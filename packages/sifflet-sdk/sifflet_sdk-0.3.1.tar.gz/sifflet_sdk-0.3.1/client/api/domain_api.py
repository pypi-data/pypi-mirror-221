...
from client.model.domain_dto import DomainDto
from client.model.search_collection_domain_dto import SearchCollectionDomainDto
...
class DomainApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_domain_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/domains/{id}',
        ...
        self.pre_count_domain_assets_endpoint = _Endpoint(
            settings={
                'response_type': (int,),
                'auth': [
                    'JWT'
                ],
                'endpoint_path': '/api/v1/domains/_pre-count-assets',
                'operation_id': 'pre_count_domain_assets',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_domain(
        ...
        **kwargs
        ...
        >>> thread = api.create_domain(domain_dto, async_req=True)
        >>> result = thread.get()
    ...
    def pre_count_domain_assets(
        self,
        domain_dto,
        **kwargs
    ):
        """Count asset that will be added to a domain  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.pre_count_domain_assets(domain_dto, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['domain_dto'] = \
            domain_dto
        return self.pre_count_domain_assets_endpoint.call_with_http_info(**kwargs)
    ...
    def update_domain(
        ...
        **kwargs
        ...
        >>> thread = api.update_domain(id, domain_dto, async_req=True)
        >>> result = thread.get()
