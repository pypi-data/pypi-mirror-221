...
def lazy_import():
    ...
    from client.model.as_code_workspace_dto_all_of import AsCodeWorkspaceDtoAllOf
    globals()['AsCodeObjectDto'] = AsCodeObjectDto
    globals()['AsCodeWorkspaceDtoAllOf'] = AsCodeWorkspaceDtoAllOf


class AsCodeWorkspaceDto(ModelComposed):
