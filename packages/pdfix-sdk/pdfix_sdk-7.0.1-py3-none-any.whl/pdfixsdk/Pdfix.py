...
class PdsPageObject(_PdfixBase):
    ...
    def TransformCTM(self, _matrix: PdfMatrix) -> bool: 
        global PdfixLib
        ret = PdfixLib.PdsPageObjectTransformCTM(self.obj, _matrix.GetIntStruct())
        return ret
...
class PdfDoc(_PdfixBase):
    ...
    def CreateXObjectFromPage(self, _page: PdfPage) -> PdsStream: 
        global PdfixLib
        ret = PdfixLib.PdfDocCreateXObjectFromPage(self.obj, _page.obj)
        if ret:
            return PdsStream(ret)
        else:
            return None
...
class PsCommand(_PdfixBase):
    ...
    def ArtifactContent(self, _page: PdfPage, _bbox: PdfRect, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandArtifactContent(self.obj, _page.obj, _bbox.GetIntStruct(), _cancel_proc, _cancel_data)
        return ret
    ...
    def DeleteTags(self, _struc_elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandDeleteTags(self.obj, _struc_elem.obj, _cancel_proc, _cancel_data)
        return ret
    ...
    def RemoveContentMarks(self, _page: PdfPage, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandRemoveContentMarks(self.obj, _page.obj, _cancel_proc, _cancel_data)
        return ret

    def SetStructureAttribute(self, _elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandSetStructureAttribute(self.obj, _elem.obj, _cancel_proc, _cancel_data)
        return ret

    def FixStructureSpaces(self, _elem: PdsStructElement, _cancel_proc, _cancel_data: int) -> bool: 
        global PdfixLib
        ret = PdfixLib.PsCommandFixStructureSpaces(self.obj, _elem.obj, _cancel_proc, _cancel_data)
        return ret
