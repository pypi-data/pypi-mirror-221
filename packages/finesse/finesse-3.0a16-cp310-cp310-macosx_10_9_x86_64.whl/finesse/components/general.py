...
from finesse.exceptions import ComponentNotConnected, FinesseException
...
class LocalDegreeOfFreedom:
    ...
    name : str
        ...
        correctly
    DC : Parameter
        The DC equivlent of the AC signal node of an element
    AC_IN, AC_OUT : SignalNode
        These are the signal equivalent of the DC parameter
    DC_2_AC_scaling : float
    ...
    def __init__(self, name, DC, AC_IN, DC_2_AC_scaling, AC_OUT=None):
        self.name = name
        self.DC = DC
        self.AC_IN = AC_IN
