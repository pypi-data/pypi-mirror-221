...
class Squeezer(Connector, FrequencyGenerator, NoiseGenerator):
    ...
    @property
    def lower(self):
        from finesse.utilities.misc import depreciation_warning

        depreciation_warning(
            "Squeezer lower node has been renamed to lower_conj as it excites the conjugate of the lower sideband",
            "3.0.0",
        )
