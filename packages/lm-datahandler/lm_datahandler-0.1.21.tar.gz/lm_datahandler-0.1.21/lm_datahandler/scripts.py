...
if __name__ == '__main__':
    ...
    # data_paths = r'E:\dataset\x7_disorders_new\data'
    ...
    #     #             ]
    #     analysis_result_save_path = os.path.join(r'E:\dataset\x7_disorders_new\analysis', j)
    #     local_datas_full_analyse(data_path, data_names, analysis_result_save_path, show_plots=False)

    local_datas_full_analyse(r'C:\Users\DELL\Downloads', ["17601237920_0726-23_16_35_0727-07_40_05_0.00_4"], r'C:\Users\DELL\Downloads', show_plots=False)
