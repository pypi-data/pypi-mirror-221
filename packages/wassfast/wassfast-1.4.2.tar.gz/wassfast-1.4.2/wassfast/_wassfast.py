...
def estimate_scattered_point_cloud( I0, I1, cam0mask, cam1mask, wp, _xd, _yd, I0p_first, config, processors, debug_mode, DEBUGDIR, settings ):
    _xdydchanged = False
    ...
    if debug_mode:
        cv.imwrite("%s/cam0P.jpg"%DEBUGDIR, I0p)
        cv.imwrite("%s/cam1P.jpg"%DEBUGDIR, I1p)
    ...
    if debug_mode:
        debug_featuresP(processors.matcher,I0p,I1p,outdir=DEBUGDIR)
...
def process_frame(q, timestamps, images, zz_mdct):
    ...
    p3dN, cam0mask, cam1mask, wp, _xd, _yd, I0p_first, xdydchanged = estimate_scattered_point_cloud( I0, I1, cam0mask, cam1mask, wp, _xd, _yd, I0p_first, config, processors, args.debug_mode, DEBUGDIR, settings)
