...
setup(
    name='invoicing-excel-pdf',  # * Your package will have this name
    packages=['invoicing'],  # * Name the package again
    version='1.0.0',  # * To be increased every time your change your library
    license='MIT',
    # Type of license. More here:
    # https://help.github.com/articles/licensing-a-repository
    description='This package can be used to convert Excel invoices to PDF '
                'invoices.',  # Short description of your library
    author='Nathan Dahan',  # Your name
    author_email='nathan.dahan@gmail.com',  # Your email
    url='https://github.com/NathanD38/app20-python-package',
