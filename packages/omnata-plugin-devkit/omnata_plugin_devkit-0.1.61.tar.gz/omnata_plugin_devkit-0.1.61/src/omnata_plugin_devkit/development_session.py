...
import pandas
import vcr
from omnata_plugin_runtime.api import (InboundSyncRequestPayload,
                                       OutboundSyncRequestPayload)
from omnata_plugin_runtime.configuration import (
    InboundSyncConfigurationParameters, OutboundSyncConfigurationParameters,
    StoredConfigurationValue, StoredMappingValue,
    SyncConfigurationParameters, SyncDirection)
from omnata_plugin_runtime.omnata_plugin import (InboundSyncRequest,
                                                 OmnataPlugin,
                                                 OutboundSyncRequest,
                                                 SyncRequest)
...
class DevelopmentSession:
    ...
    def prepare_outbound_scenario_from_sync(
        ...
        snowflake_connector = config.connect_to_snowflake(connection_name=snowcli_environment)
