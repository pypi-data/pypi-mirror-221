...
class BAC(object):
    ...
    def declareDevice(self, did, address, poll=15, filterOutOfService=False):
    ...
    def declareDeviceFromId(self, did, poll=15, filterOutOfService=False):
        ...
        if addresses:
            for adr in addresses:
                if adr[1]==did:
                    address=adr[0]
                    return self.declareDevice(did, address, poll=poll, filterOutOfService=filterOutOfService)

    def declareDeviceFromAddress(self, address, poll=15, filterOutOfService=False):
