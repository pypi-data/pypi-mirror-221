...
def configure_and_initialize_global_tpu(use_tfrt_host_runtime:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  r"""TODO: add doc.
...
TV_CopyToMesh_T = TypeVar("TV_CopyToMesh_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('copy_to_mesh')
def copy_to_mesh(input: _atypes.TensorFuzzingAnnotation[TV_CopyToMesh_T], layout: str, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CopyToMesh_T]:
  r"""TODO: add doc.
...
def copy_to_mesh_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CopyToMesh_T], layout: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CopyToMesh_T]:
  layout = _execute.make_str(layout, "layout")
...
TV_CopyToMeshGrad_T = TypeVar("TV_CopyToMeshGrad_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('copy_to_mesh_grad')
def copy_to_mesh_grad(input: _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T], forward_input: _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T], reference_layout:str="", name=None) -> _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T]:
  r"""TODO: add doc.
...
def copy_to_mesh_grad_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T], forward_input: _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T], reference_layout: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_CopyToMeshGrad_T]:
  if reference_layout is None:
    reference_layout = ""
  reference_layout = _execute.make_str(reference_layout, "reference_layout")
...
def d_tensor_set_global_tpu_array_eager_fallback(topology: _atypes.TensorFuzzingAnnotation[_atypes.String], name, ctx):
...
TV_Relayout_T = TypeVar("TV_Relayout_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('relayout')
def relayout(input: _atypes.TensorFuzzingAnnotation[TV_Relayout_T], layout: str, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Relayout_T]:
  r"""TODO: add doc.
...
def relayout_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Relayout_T], layout: str, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Relayout_T]:
  layout = _execute.make_str(layout, "layout")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [])
  _inputs_flat = [input]
  _attrs = ("layout", layout, "T", _attr_T)
...
TV_RelayoutLike_T = TypeVar("TV_RelayoutLike_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_RelayoutLike_U = TypeVar("TV_RelayoutLike_U", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

@_dispatch.add_fallback_dispatch_list
@_dispatch.add_type_based_api_dispatcher
@tf_export('relayout_like')
def relayout_like(input: _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_T], layout_input: _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_U], name=None) -> _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_T]:
  r"""TODO: add doc.
...
def relayout_like_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_T], layout_input: _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_U], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RelayoutLike_T]:
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [])
...
def shutdown_tpu_system(name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""TODO: add doc.
...
def shutdown_tpu_system_eager_fallback(name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _inputs_flat = []
  _attrs = None
