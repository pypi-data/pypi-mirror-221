...
def batch_function(in_tensors, captured_tensors, f, num_batch_threads, max_batch_size, batch_timeout_micros, Tout, max_enqueued_batches=10, allowed_batch_sizes=[], container="", shared_name="", batching_queue="", low_priority_max_batch_size=0, low_priority_batch_timeout_micros=0, low_priority_allowed_batch_sizes=[], low_priority_max_enqueued_batches=0, enable_large_batch_splitting=False, name=None):
