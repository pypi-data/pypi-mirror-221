...
from chalk.features.feature_set import Features, FeatureSetBase, is_feature_set_class
...
def _process_class(
    ...
    set_new_attribute(
        cls=cls, name="__chalk_features_raw__", value=classproperty(__features_raw__, cached=True)
    )
