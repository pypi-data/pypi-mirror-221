...
__all__ = (
    ...
    "ActiveDirectoryComputerAttributeOutputTypeDef",
    "ActiveDirectoryComputerAttributeTypeDef",
    "ComputeFarmConfigurationOutputTypeDef",
    ...
    "LicenseServiceConfigurationOutputTypeDef",
    ...
    "ScriptParameterKeyValueOutputTypeDef",
    "SharedFileSystemConfigurationOutputTypeDef",
    ...
    "StreamConfigurationSessionBackupOutputTypeDef",
    "StreamingSessionStorageRootOutputTypeDef",
    "StreamingSessionStorageRootTypeDef",
    "VolumeConfigurationOutputTypeDef",
    "StreamingImageEncryptionConfigurationTypeDef",
    "StudioComponentInitializationScriptOutputTypeDef",
    "StudioEncryptionConfigurationOutputTypeDef",
...
ActiveDirectoryComputerAttributeOutputTypeDef = TypedDict(
    "ActiveDirectoryComputerAttributeOutputTypeDef",
    {
        "name": str,
        "value": str,
...
ComputeFarmConfigurationOutputTypeDef = TypedDict(
    "ComputeFarmConfigurationOutputTypeDef",
    {
...
LicenseServiceConfigurationOutputTypeDef = TypedDict(
    "LicenseServiceConfigurationOutputTypeDef",
    {
        "endpoint": str,
    },
...
ScriptParameterKeyValueOutputTypeDef = TypedDict(
    "ScriptParameterKeyValueOutputTypeDef",
    {
        "key": str,
        "value": str,
...
SharedFileSystemConfigurationOutputTypeDef = TypedDict(
    "SharedFileSystemConfigurationOutputTypeDef",
    {
        "endpoint": str,
        "fileSystemId": str,
...
StreamConfigurationSessionBackupOutputTypeDef = TypedDict(
    "StreamConfigurationSessionBackupOutputTypeDef",
    {
        "maxBackupsToRetain": int,
        "mode": SessionBackupModeType,
...
StreamingSessionStorageRootOutputTypeDef = TypedDict(
    "StreamingSessionStorageRootOutputTypeDef",
    {
        "linux": str,
        "windows": str,
...
VolumeConfigurationOutputTypeDef = TypedDict(
    "VolumeConfigurationOutputTypeDef",
    {
        "iops": int,
        "size": int,
...
StudioComponentInitializationScriptOutputTypeDef = TypedDict(
    "StudioComponentInitializationScriptOutputTypeDef",
    {
        "launchProfileProtocolVersion": str,
        "platform": LaunchProfilePlatformType,
...
_RequiredStudioEncryptionConfigurationOutputTypeDef = TypedDict(
    "_RequiredStudioEncryptionConfigurationOutputTypeDef",
    {
        "keyType": StudioEncryptionConfigurationKeyTypeType,
    },
)
_OptionalStudioEncryptionConfigurationOutputTypeDef = TypedDict(
    "_OptionalStudioEncryptionConfigurationOutputTypeDef",
    {
        "keyArn": str,
    },
    total=False,
...
class StudioEncryptionConfigurationOutputTypeDef(
    _RequiredStudioEncryptionConfigurationOutputTypeDef,
    _OptionalStudioEncryptionConfigurationOutputTypeDef,
):
    pass
...
ActiveDirectoryConfigurationOutputTypeDef = TypedDict(
    "ActiveDirectoryConfigurationOutputTypeDef",
    {
        "computerAttributes": List[ActiveDirectoryComputerAttributeOutputTypeDef],
        "directoryId": str,
...
_OptionalStreamConfigurationSessionStorageOutputTypeDef = TypedDict(
    ...
    {
        "root": StreamingSessionStorageRootOutputTypeDef,
    },
    total=False,
)
...
StreamingSessionTypeDef = TypedDict(
    "StreamingSessionTypeDef",
    {
        ...
        "updatedAt": datetime,
        "updatedBy": str,
        "volumeConfiguration": VolumeConfigurationOutputTypeDef,
        "volumeRetentionMode": VolumeRetentionModeType,
    },
    total=False,
)
...
StudioTypeDef = TypedDict(
    "StudioTypeDef",
    {
        ...
        "statusMessage": str,
        "studioEncryptionConfiguration": StudioEncryptionConfigurationOutputTypeDef,
        "studioId": str,
        "studioName": str,
        "studioUrl": str,
        "tags": Dict[str, str],
...
StudioComponentConfigurationOutputTypeDef = TypedDict(
    "StudioComponentConfigurationOutputTypeDef",
    {
        ...
        "computeFarmConfiguration": ComputeFarmConfigurationOutputTypeDef,
        "licenseServiceConfiguration": LicenseServiceConfigurationOutputTypeDef,
        "sharedFileSystemConfiguration": SharedFileSystemConfigurationOutputTypeDef,
    },
    total=False,
)
...
_OptionalStreamConfigurationTypeDef = TypedDict(
    "_OptionalStreamConfigurationTypeDef",
    {
        ...
        "sessionBackup": StreamConfigurationSessionBackupOutputTypeDef,
        "sessionPersistenceMode": SessionPersistenceModeType,
...
StudioComponentTypeDef = TypedDict(
    "StudioComponentTypeDef",
    {
        ...
        "description": str,
        "ec2SecurityGroupIds": List[str],
        "initializationScripts": List[StudioComponentInitializationScriptOutputTypeDef],
        "name": str,
        "runtimeRoleArn": str,
        "scriptParameters": List[ScriptParameterKeyValueOutputTypeDef],
        "secureInitializationRoleArn": str,
