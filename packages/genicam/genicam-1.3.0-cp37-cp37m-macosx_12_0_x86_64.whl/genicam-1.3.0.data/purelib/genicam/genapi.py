...
reference_implementation_version = '3.4.1'
...
class CNodeWriteConcatenator(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, CNodeWriteConcatenator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, CNodeWriteConcatenator, name)
...
CNodeWriteConcatenator_swigregister = _genapi.CNodeWriteConcatenator_swigregister
CNodeWriteConcatenator_swigregister(CNodeWriteConcatenator)

class _NodeWriteConcatenator(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, _NodeWriteConcatenator, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, _NodeWriteConcatenator, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _genapi.new__NodeWriteConcatenator(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
_NodeWriteConcatenator_swigregister = _genapi._NodeWriteConcatenator_swigregister
_NodeWriteConcatenator_swigregister(_NodeWriteConcatenator)
...
class IPortStackedConstruct(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IPortStackedConstruct, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IPortStackedConstruct, name)
    ...
    __del__ = lambda self: None
IPortStackedConstruct_swigregister = _genapi.IPortStackedConstruct_swigregister
IPortStackedConstruct_swigregister(IPortStackedConstruct)
...
class IPortStacked(IPort):
    ...
    for _s in [IPort]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, IPortStacked, name, value)
    __swig_getmethods__ = {}
    for _s in [IPort]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, IPortStacked, name)
    ...
    __del__ = lambda self: None
IPortStacked_swigregister = _genapi.IPortStacked_swigregister
IPortStacked_swigregister(IPortStacked)

class AbstractPortStacked(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AbstractPortStacked, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AbstractPortStacked, name)
    __repr__ = _swig_repr
    ...
    def __init__(self):
        if self.__class__ == AbstractPortStacked:
            ...
            _self = self
        this = _genapi.new_AbstractPortStacked(_self, )
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def read(self, Address, pBuffer):
        return _genapi.AbstractPortStacked_read(self, Address, pBuffer)

    def write(self, Address, pBuffer):
        return _genapi.AbstractPortStacked_write(self, Address, pBuffer)

    def stacked_write(self, pEntries):
        return _genapi.AbstractPortStacked_stacked_write(self, pEntries)
    ...
    def __disown__(self):
        ...
        return weakref_proxy(self)
AbstractPortStacked_swigregister = _genapi.AbstractPortStacked_swigregister
AbstractPortStacked_swigregister(AbstractPortStacked)
...
class _ChunkAdapterGenDC(_ChunkAdapterU3V):
    __swig_setmethods__ = {}
    for _s in [_ChunkAdapterU3V]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, _ChunkAdapterGenDC, name, value)
    __swig_getmethods__ = {}
    for _s in [_ChunkAdapterU3V]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, _ChunkAdapterGenDC, name)
    __repr__ = _swig_repr

    def __init__(self, pNodeMap=None, MaxChunkCacheSize=-1):
        this = _genapi.new__ChunkAdapterGenDC(pNodeMap, MaxChunkCacheSize)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
_ChunkAdapterGenDC_swigregister = _genapi._ChunkAdapterGenDC_swigregister
_ChunkAdapterGenDC_swigregister(_ChunkAdapterGenDC)
...
class _SingleChunkData(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, _SingleChunkData, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, _SingleChunkData, name)
    __repr__ = _swig_repr
    __swig_setmethods__["ChunkID"] = _genapi._SingleChunkData_ChunkID_set
    __swig_getmethods__["ChunkID"] = _genapi._SingleChunkData_ChunkID_get
    if _newclass:
        ChunkID = _swig_property(_genapi._SingleChunkData_ChunkID_get, _genapi._SingleChunkData_ChunkID_set)
    __swig_setmethods__["ChunkOffset"] = _genapi._SingleChunkData_ChunkOffset_set
    __swig_getmethods__["ChunkOffset"] = _genapi._SingleChunkData_ChunkOffset_get
    if _newclass:
        ChunkOffset = _swig_property(_genapi._SingleChunkData_ChunkOffset_get, _genapi._SingleChunkData_ChunkOffset_set)
    __swig_setmethods__["ChunkLength"] = _genapi._SingleChunkData_ChunkLength_set
    __swig_getmethods__["ChunkLength"] = _genapi._SingleChunkData_ChunkLength_get
    if _newclass:
        ChunkLength = _swig_property(_genapi._SingleChunkData_ChunkLength_get, _genapi._SingleChunkData_ChunkLength_set)

    def __init__(self):
        this = _genapi.new__SingleChunkData()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
_SingleChunkData_swigregister = _genapi._SingleChunkData_swigregister
_SingleChunkData_swigregister(_SingleChunkData)
