...
class iFDO:
    ...
    def open_ifdo_file(file:str):  
        ...
        if not os.path.isfile(file):
            ...
            if os.path.isfile(file_yaml):
                ...
                raise miqtc.IfdoException("File not found")
    ...
    def set_image_set_name_field_from_project_event_sensor(self):
        ...
        new_image_set_name = self.constructImageSetName(self.ifdo_tmp[self.imageSetHeaderKey]['image-project']['name'],
                                                    self.ifdo_tmp[self.imageSetHeaderKey]['image-event']['name'],
                                                    self.ifdo_tmp[self.imageSetHeaderKey]['image-sensor']['name'])
