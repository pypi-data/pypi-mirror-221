...
class InvoiceSchedulesApi(object):
    ...
    def d_elete_invoice_schedule(self, schedule_key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.d_elete_invoice_schedule(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.d_elete_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
            return data

    def d_elete_invoice_schedule_with_http_info(self, schedule_key, **kwargs):  # noqa: E501
        """Delete an invoice schedule  # noqa: E501

        Deletes an invoice schedule in Pending status. The status of the invoice schedule to be deleted must be `Pending`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_invoice_schedule_with_http_info(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['schedule_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `d_elete_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_invoice_schedule(self, schedule_key, **kwargs):  # noqa: E501
        """Retrieve an invoice schedule  # noqa: E501

        Retrieves detailed information about an invoice schedule.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_schedule(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: InvoiceScheduleResponses
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
            return data

    def g_et_invoice_schedule_with_http_info(self, schedule_key, **kwargs):  # noqa: E501
        """Retrieve an invoice schedule  # noqa: E501

        Retrieves detailed information about an invoice schedule.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_schedule_with_http_info(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['schedule_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `g_et_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_invoice_schedule`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_invoice_schedule`, must be a value less than or equal to `40`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='InvoiceScheduleResponses',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_create_invoice_schedule(self, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_invoice_schedule(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTCreateInvoiceScheduleRequest request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_invoice_schedule_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_invoice_schedule_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_invoice_schedule_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create an invoice schedule  # noqa: E501

        Creates an invoice schedule.  ### Limitations  This API operation has the following limitations: * You can create at most 50 invoice schedule items in one request. * You can associate at most 10 orders with an invoice schedule in one request. * You can associate at most 300 subscriptions with an invoice schedule in one request, including those contained in orders and separate subscriptions.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_invoice_schedule_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_create_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_invoice_schedule`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_execute_invoice_schedule(self, schedule_key, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_execute_invoice_schedule(schedule_key, request, async_req=True)
        >>> result = thread.get()
        ...
        :param POSTExecuteInvoiceScheduleRequest request:  (required)
        :param str idempotency_key: Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: ExecuteInvoiceScheduleBillRunResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_execute_invoice_schedule_with_http_info(schedule_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_execute_invoice_schedule_with_http_info(schedule_key, request, **kwargs)  # noqa: E501
            return data

    def p_ost_execute_invoice_schedule_with_http_info(self, schedule_key, request, **kwargs):  # noqa: E501
        """Execute an invoice schedule  # noqa: E501

        Executes an invoice schedule immediately.  During the execution, a bill run is created and generates an invoice or a credit memo asynchronously.  When you use this API operation to execute an invoice schedule item, you have the flexibility to decide whether to specify a specific item ID.  - If you specify the unique ID of an invoice schedule item to be executed in the request, the corresponding invoice schedule item is executed. - If you do not specify the ID of any invoice schedule item in the request, the subscription end date is used as the target date to determine the next pending schedule item to be executed.   For more samples, see [Execute invoice schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Schedule/Billing_Schedule_tutorials/Execute_invoice_schedules).   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_execute_invoice_schedule_with_http_info(schedule_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['schedule_key', 'request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_execute_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `p_ost_execute_invoice_schedule`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ost_execute_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_execute_invoice_schedule`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_execute_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ExecuteInvoiceScheduleBillRunResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ut_pause_invoice_schedule(self, schedule_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_pause_invoice_schedule(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_pause_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_pause_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
            return data

    def p_ut_pause_invoice_schedule_with_http_info(self, schedule_key, **kwargs):  # noqa: E501
        """Pause an invoice schedule  # noqa: E501

        Pauses an invoice schedule immediately.  After one invoice schedule is paused, it cannot be automatically executed by Zuora Scheduler or by the [Execute an invoice schedule](https://www.zuora.com/developer/api-references/api/operation/POST_ExecuteInvoiceSchedule/) API operation.  If you want to run a paused invoice schedule, you can create a bill run with the target date greater than the next run date of the invoice schedule.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_pause_invoice_schedule_with_http_info(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_pause_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `p_ut_pause_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_pause_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_resume_invoice_schedule(self, schedule_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_resume_invoice_schedule(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_resume_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_resume_invoice_schedule_with_http_info(schedule_key, **kwargs)  # noqa: E501
            return data

    def p_ut_resume_invoice_schedule_with_http_info(self, schedule_key, **kwargs):  # noqa: E501
        """Resume an invoice schedule  # noqa: E501

        Resumes an invoice schedule in Paused status immediately.  After an invoice schedule is resumed, it can continue to be automatically executed by Zuora Scheduler or by the [Execute an invoice schedule](https://www.zuora.com/developer/api-references/api/operation/POST_ExecuteInvoiceSchedule/) API operation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_resume_invoice_schedule_with_http_info(schedule_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_resume_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `p_ut_resume_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_resume_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_invoice_schedule(self, schedule_key, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_invoice_schedule(schedule_key, request, async_req=True)
        >>> result = thread.get()
        ...
        :param PUTUpdateInvoiceScheduleRequest request:  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_update_invoice_schedule_with_http_info(schedule_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_update_invoice_schedule_with_http_info(schedule_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_update_invoice_schedule_with_http_info(self, schedule_key, request, **kwargs):  # noqa: E501
        """Update an invoice schedule  # noqa: E501

        Updates a pending invoice schedule.  You can use this API operation to update invoice schedules in the following aspects: - Update notes and pending invoice schedule items - Update orders associated with invoice schedules - Remove or add invoice schedule items  For more samples, see [Edit invoice schedules](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Billing_Schedule/Billing_Schedule_tutorials/Edit_invoice_schedules).  ### Restrictions and limitations   When updating invoice schedules through the REST API, keep the following restrictions and limitations in mind: - You can only update invoice schedule items in Pending status. - You can only add orders or specific subscriptions to pending invoice schedules, and remove orders or specific subscriptions from pending invoice schedules. - For the invoice schedule items that you want to update, you must include the new values for these items in the request. - For the invoice schedule items that you want to keep unchanged, you must include all the existing information about these items in the request. Otherwise, the existing invoice schedule items that you do not mention in the request are deleted. - For the orders that you want to keep unchanged for an invoice schedule, you must include all the existing order numbers associated with the invoice schedule in the request. Otherwise, the existing orders that you do not mention in the request are removed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_invoice_schedule_with_http_info(schedule_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['schedule_key', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_update_invoice_schedule" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'schedule_key' is set
        if self.api_client.client_side_validation and ('schedule_key' not in params or
                                                       params['schedule_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `schedule_key` when calling `p_ut_update_invoice_schedule`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_update_invoice_schedule`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_invoice_schedule`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
