...
class CustomScheduledEventsApi(object):
    ...
    def d_elete_scheduled_event_by_id_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_scheduled_event_by_id`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_scheduled_event_by_id_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_scheduled_event_by_id`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_scheduled_events_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id', 'event_type_name', 'api_object', 'api_field', 'active', 'start', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_scheduled_events`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('start' in params and params['start'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `start` when calling `g_et_scheduled_events`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `g_et_scheduled_events`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_scheduled_event(self, authorization, post_scheduled_event_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_scheduled_event(authorization, post_scheduled_event_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (required)
        :param PostScheduledEventRequest post_scheduled_event_request: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_scheduled_event_with_http_info(authorization, post_scheduled_event_request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_scheduled_event_with_http_info(authorization, post_scheduled_event_request, **kwargs)  # noqa: E501
            return data

    def p_ost_scheduled_event_with_http_info(self, authorization, post_scheduled_event_request, **kwargs):  # noqa: E501
        """Create a scheduled event  # noqa: E501

        To create a custom scheduled event, you must specify the base object, the base field and the scheduled time.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_scheduled_event_with_http_info(authorization, post_scheduled_event_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'post_scheduled_event_request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'post_scheduled_event_request' is set
        if self.api_client.client_side_validation and ('post_scheduled_event_request' not in params or
                                                       params['post_scheduled_event_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `post_scheduled_event_request` when calling `p_ost_scheduled_event`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_scheduled_event`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_scheduled_event`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'post_scheduled_event_request' in params:
            body_params = params['post_scheduled_event_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def u_pdate_scheduled_event_by_id(self, authorization, id, put_scheduled_event_request, **kwargs):  # noqa: E501
        """Update a scheduled event by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.u_pdate_scheduled_event_by_id(authorization, id, put_scheduled_event_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (required)
        :param str id: The ID of the scheduled event. (required)
        :param PutScheduledEventRequest put_scheduled_event_request: (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.u_pdate_scheduled_event_by_id_with_http_info(authorization, id, put_scheduled_event_request, **kwargs)  # noqa: E501
        else:
            (data) = self.u_pdate_scheduled_event_by_id_with_http_info(authorization, id, put_scheduled_event_request, **kwargs)  # noqa: E501
            return data

    def u_pdate_scheduled_event_by_id_with_http_info(self, authorization, id, put_scheduled_event_request, **kwargs):  # noqa: E501
        """Update a scheduled event by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.u_pdate_scheduled_event_by_id_with_http_info(authorization, id, put_scheduled_event_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'id', 'put_scheduled_event_request', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method u_pdate_scheduled_event_by_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in params or
                                                       params['authorization'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `authorization` when calling `u_pdate_scheduled_event_by_id`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `u_pdate_scheduled_event_by_id`")  # noqa: E501
        # verify the required parameter 'put_scheduled_event_request' is set
        if self.api_client.client_side_validation and ('put_scheduled_event_request' not in params or
                                                       params['put_scheduled_event_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `put_scheduled_event_request` when calling `u_pdate_scheduled_event_by_id`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `u_pdate_scheduled_event_by_id`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'put_scheduled_event_request' in params:
            body_params = params['put_scheduled_event_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
