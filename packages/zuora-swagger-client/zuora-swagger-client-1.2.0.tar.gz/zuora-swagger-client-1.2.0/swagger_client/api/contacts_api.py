...
class ContactsApi(object):
    ...
    def d_elete_contact(self, contact_id, **kwargs):  # noqa: E501
        """Delete a contact  # noqa: E501

        Deletes a contact.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_contact(contact_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.d_elete_contact_with_http_info(contact_id, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_contact_with_http_info(contact_id, **kwargs)  # noqa: E501
            return data

    def d_elete_contact_with_http_info(self, contact_id, **kwargs):  # noqa: E501
        """Delete a contact  # noqa: E501

        Deletes a contact.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_contact_with_http_info(contact_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['contact_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contact_id' not in params or
            ...
            raise ValueError("Missing the required parameter `contact_id` when calling `d_elete_contact`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_contact`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_contact(self, contact_id, **kwargs):  # noqa: E501
        """Retrieve a contact  # noqa: E501

        Retrieves detailed information about a specific contact.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_contact(contact_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_contact_with_http_info(contact_id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_contact_with_http_info(contact_id, **kwargs)  # noqa: E501
            return data

    def g_et_contact_with_http_info(self, contact_id, **kwargs):  # noqa: E501
        """Retrieve a contact  # noqa: E501

        Retrieves detailed information about a specific contact.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_contact_with_http_info(contact_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('contact_id' not in params or
                                                       params['contact_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `contact_id` when calling `g_et_contact`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_contact`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_create_contact(self, request, **kwargs):  # noqa: E501
        """Create a contact  # noqa: E501

        Creates a contact for a specified account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_contact(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTContactType request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_contact_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_contact_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_contact_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create a contact  # noqa: E501

        Creates a contact for a specified account.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_contact_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_create_contact" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_contact`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_contact`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_contact`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_contact(self, contact_id, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_contact(contact_id, request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str contact_id: The ID of the contact that you want to update.  (required)
        :param PUTContactType request:  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_contact_with_http_info(contact_id, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_contact_with_http_info(contact_id, request, **kwargs)  # noqa: E501
            return data

    def p_ut_contact_with_http_info(self, contact_id, request, **kwargs):  # noqa: E501
        """Update a contact  # noqa: E501

        Updates a contact for a specified account.  You can update contacts for cancelled accounts.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_contact_with_http_info(contact_id, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['contact_id', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('contact_id' not in params or
                                                       params['contact_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `contact_id` when calling `p_ut_contact`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_contact`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_contact`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_scrub_contact_with_http_info(self, contact_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_scrub_contact`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
