...
class InvoicesApi(object):
    ...
    def d_elete_delete_invoice(self, invoice_key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.d_elete_delete_invoice(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        :return: DeleteInvoiceResponseType
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.d_elete_delete_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_delete_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def d_elete_delete_invoice_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """Delete an invoice  # noqa: E501

        Deletes a specific invoice.  Whether to delete an invoice synchronously or asynchronously depends on the number of invoice items contained in the invoice. By default, if an invoice contains less than 100 items, the invoice is deleted synchronously. Otherwise, the invoice is deleted asynchronously. If you want to change the threshold, submit a request at <a href=\"http://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_delete_invoice_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_delete_invoice" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
            ...
            raise ValueError("Missing the required parameter `invoice_key` when calling `d_elete_delete_invoice`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_delete_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='DeleteInvoiceResponseType',  # noqa: E501
    ...
    def g_et_invoice_application_parts(self, invoice_key, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves information about the payments or credit memos that are applied to a specified invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_application_parts(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_invoice_application_parts_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_invoice_application_parts_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def g_et_invoice_application_parts_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """List all application parts of an invoice  # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves information about the payments or credit memos that are applied to a specified invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_application_parts_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `g_et_invoice_application_parts`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_invoice_application_parts`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_invoice_files(self, invoice_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_files(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_invoice_files_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_invoice_files_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def g_et_invoice_files_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """List all files of an invoice  # noqa: E501

        Retrieves the information about all PDF files of a specified invoice.   Invoice PDF files are returned in reverse chronological order by the value of the `versionNumber` field. **Note**: This API only retrieves the PDF files that have been generated. If the latest PDF file is being generated, it will not be included in the response. You can use the [Query](https://www.zuora.com/developer/api-references/api/operation/Action_POSTquery) action to get the latest PDF file, for example: `\"select Body from Invoice where Id = '2c93808457d787030157e0324aea5158'\"`. See [Query an Invoice Body](https://knowledgecenter.zuora.com/Central_Platform/API/G_SOAP_API/E1_SOAP_API_Object_Reference/Invoice/Query_an_Invoice_Body_Field) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_files_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page_size', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `g_et_invoice_files`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_invoice_files`, length must be less than or equal to `64`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_invoice_files`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_invoice_items(self, invoice_key, **kwargs):  # noqa: E501
        """List all items of an invoice  # noqa: E501

        Retrieves the information about all items of a specified invoice.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_items(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_invoice_items_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_invoice_items_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def g_et_invoice_items_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """List all items of an invoice  # noqa: E501

        Retrieves the information about all items of a specified invoice.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_invoice_items_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `g_et_invoice_items`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_invoice_items`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_invoice_items`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_taxation_items_of_invoice_item(self, invoice_key, item_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_taxation_items_of_invoice_item(invoice_key, item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_taxation_items_of_invoice_item_with_http_info(invoice_key, item_id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_taxation_items_of_invoice_item_with_http_info(invoice_key, item_id, **kwargs)  # noqa: E501
            return data

    def g_et_taxation_items_of_invoice_item_with_http_info(self, invoice_key, item_id, **kwargs):  # noqa: E501
        """List all taxation items of an invoice item  # noqa: E501

        Retrieves information about the taxation items of a specific invoice item.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_taxation_items_of_invoice_item_with_http_info(invoice_key, item_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'item_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page_size', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `g_et_taxation_items_of_invoice_item`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_taxation_items_of_invoice_item`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
    ...
    def get_get_invoice(self, invoice_key, **kwargs):  # noqa: E501
        """Retrieve an invoice  # noqa: E501

        Retrieves a specific invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_get_invoice(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_get_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.get_get_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def get_get_invoice_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """Retrieve an invoice  # noqa: E501

        Retrieves a specific invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_get_invoice_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `get_get_invoice`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `get_get_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_email_invoice(self, request, invoice_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_email_invoice(request, invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_email_invoice_with_http_info(request, invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_email_invoice_with_http_info(request, invoice_key, **kwargs)  # noqa: E501
            return data

    def p_ost_email_invoice_with_http_info(self, request, invoice_key, **kwargs):  # noqa: E501
        """Email an invoice  # noqa: E501

        Sends a posted invoice to the specified email addresses manually. ### Notes   - You must activate the **Manual Email For Invoice | Manual Email For Invoice** notification before emailing invoices. To include the invoice PDF in the email, select the **Include Invoice PDF** check box in the **Edit notification** dialog from the Zuora UI. See [Create and Edit Notifications](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/C_Create_Notifications#section_2) for more information.    - Zuora sends the email messages based on the email template you set. You can set the email template to use in the **Delivery Options** panel of the **Edit notification** dialog from the Zuora UI. By default, the **Invoice Posted Default Email Template** template is used. See [Create and Edit Email Templates](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/Create_Email_Templates) for more information.    - The invoices are sent only to the work email addresses or personal email addresses of the Bill To contact if the following conditions are all met:     * The `useEmailTemplateSetting` field is set to `false`.     * The email addresses are not specified in the `emailAddresses` field.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_email_invoice_with_http_info(request, invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['request', 'invoice_key', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ost_email_invoice`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_email_invoice`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_email_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_post_invoices(self, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_post_invoices(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTInvoicesBatchPostType request:  (required)
        :param str idempotency_key: Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_post_invoices_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_post_invoices_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_post_invoices_with_http_info(self, request, **kwargs):  # noqa: E501
        """Post invoices  # noqa: E501

        Posts multiple invoices.  You can post a maximum of 50 invoices in one single request. Additionally, you can also update invoice dates while posting the invoices.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_post_invoices_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ost_post_invoices`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_post_invoices`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_post_invoices`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_standalone_invoice(self, request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.p_ost_standalone_invoice_with_http_info(request, **kwargs)  # noqa: E501
            return data
    ...
    def p_ost_standalone_invoice_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ost_standalone_invoice`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_standalone_invoice`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_standalone_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_standalone_invoices(self, request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.p_ost_standalone_invoices_with_http_info(request, **kwargs)  # noqa: E501
            return data
    ...
    def p_ost_standalone_invoices_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ost_standalone_invoices`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_standalone_invoices`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_standalone_invoices`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_upload_file_for_invoice(self, invoice_key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_upload_file_for_invoice(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_upload_file_for_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_upload_file_for_invoice_with_http_info(invoice_key, **kwargs)  # noqa: E501
            return data

    def p_ost_upload_file_for_invoice_with_http_info(self, invoice_key, **kwargs):  # noqa: E501
        """Upload a file for an invoice  # noqa: E501

        Uploads an externally generated invoice PDF file for an invoice that is in Draft or Posted status. To use this operation, you must enable the Modify Invoice permission. See [Billing Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles) for more information. This operation has the following restrictions: - Only the PDF file format is supported. - The maximum size of the PDF file to upload is 4 MB. - A maximum of 50 PDF files can be uploaded for one invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_upload_file_for_invoice_with_http_info(invoice_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id', 'file']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ost_upload_file_for_invoice`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_upload_file_for_invoice`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_upload_file_for_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ostinv_taxation_items(self, invoice_key, body, **kwargs):  # noqa: E501
        """Create taxation items for an invoice  # noqa: E501

        Creates taxation items for an invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostinv_taxation_items(invoice_key, body, async_req=True)
        >>> result = thread.get()
        ...
        :param POSTTaxationItemList body:  (required)
        :param str idempotency_key: Specify a unique idempotency key if you want to perform an idempotent POST or PATCH request. Do not use this header in other request types.   With this header specified, the Zuora server can identify subsequent retries of the same request using this value, which prevents the same operation from being performed multiple times by accident.  
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostinv_taxation_items_with_http_info(invoice_key, body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostinv_taxation_items_with_http_info(invoice_key, body, **kwargs)  # noqa: E501
            return data

    def p_ostinv_taxation_items_with_http_info(self, invoice_key, body, **kwargs):  # noqa: E501
        """Create taxation items for an invoice  # noqa: E501

        Creates taxation items for an invoice.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostinv_taxation_items_with_http_info(invoice_key, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'body', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ostinv_taxation_items" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'invoice_key' is set
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ostinv_taxation_items`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `p_ostinv_taxation_items`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ostinv_taxation_items`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ostinv_taxation_items`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_batch_update_invoices_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        all_params = ['request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_batch_update_invoices`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_reverse_invoice(self, invoice_key, request, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Reverses a posted invoice.   **Restrictions**  You are not allowed to reverse an invoice if any of the following restrictions is met: * Payments and credit memos are applied to the invoice. * The invoice is split. * The invoice is not in Posted status. * The total amount of the invoice is less than 0 (a negative invoice). * Using Tax Connector for Extension Platform to calculate taxes. * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items.  See [Invoice Reversal](https://knowledgecenter.zuora.com/CB_Billing/IA_Invoices/Reverse_Posted_Invoices) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_reverse_invoice(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_reverse_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_reverse_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_reverse_invoice_with_http_info(self, invoice_key, request, **kwargs):  # noqa: E501
        """Reverse an invoice  # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Reverses a posted invoice.   **Restrictions**  You are not allowed to reverse an invoice if any of the following restrictions is met: * Payments and credit memos are applied to the invoice. * The invoice is split. * The invoice is not in Posted status. * The total amount of the invoice is less than 0 (a negative invoice). * Using Tax Connector for Extension Platform to calculate taxes. * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items.  See [Invoice Reversal](https://knowledgecenter.zuora.com/CB_Billing/IA_Invoices/Reverse_Posted_Invoices) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_reverse_invoice_with_http_info(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['invoice_key', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ut_reverse_invoice`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_reverse_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_invoice(self, invoice_key, request, **kwargs):  # noqa: E501
        """Update an invoice  # noqa: E501

        Updates a specific invoice.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_invoice(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_update_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_update_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_update_invoice_with_http_info(self, invoice_key, request, **kwargs):  # noqa: E501
        """Update an invoice  # noqa: E501

        Updates a specific invoice.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_invoice_with_http_info(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ut_update_invoice`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_write_off_invoice(self, invoice_key, request, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Writes off a posted invoice.   By writing off an invoice, a credit memo is created and applied to the invoice. The generated credit memo items and credit memo taxation items are applied to invoice items and invoice taxation items based on the configured default application rule. If an invoice is written off, the balance of each invoice item and invoice taxation item must be zero.  If you set the **Create credit memos mirroring invoice items billing rule** to **Yes**, you can write off an invoice even if all its items have zero balance.  **Restrictions**: You cannot write off an invoice if any of the following restrictions is met: * The balance of an invoice has been changed before Invoice Settlement is enabled.   For example, before Invoice Settlement is enabled, any credit balance adjustments, invoice item adjustments, or invoice adjustments have been applied to an invoice. * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items. See [Invoice Write-off](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/IA_Invoices/Invoice_Write-Off) for more information.           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_write_off_invoice(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_write_off_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_write_off_invoice_with_http_info(invoice_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_write_off_invoice_with_http_info(self, invoice_key, request, **kwargs):  # noqa: E501
        """Write off an invoice  # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Writes off a posted invoice.   By writing off an invoice, a credit memo is created and applied to the invoice. The generated credit memo items and credit memo taxation items are applied to invoice items and invoice taxation items based on the configured default application rule. If an invoice is written off, the balance of each invoice item and invoice taxation item must be zero.  If you set the **Create credit memos mirroring invoice items billing rule** to **Yes**, you can write off an invoice even if all its items have zero balance.  **Restrictions**: You cannot write off an invoice if any of the following restrictions is met: * The balance of an invoice has been changed before Invoice Settlement is enabled.   For example, before Invoice Settlement is enabled, any credit balance adjustments, invoice item adjustments, or invoice adjustments have been applied to an invoice. * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items. See [Invoice Write-off](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/IA_Invoices/Invoice_Write-Off) for more information.           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_write_off_invoice_with_http_info(invoice_key, request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('invoice_key' not in params or
                                                       params['invoice_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `invoice_key` when calling `p_ut_write_off_invoice`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_write_off_invoice`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
