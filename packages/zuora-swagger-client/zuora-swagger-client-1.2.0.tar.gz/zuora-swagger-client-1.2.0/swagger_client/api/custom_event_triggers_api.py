...
class CustomEventTriggersApi(object):
    ...
    def g_et_event_triggers_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id', 'base_object', 'event_type_name', 'active', 'start', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_event_trigger_with_http_info(self, authorization, post_event_trigger_request, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'post_event_trigger_request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('post_event_trigger_request' not in params or
                                                       params['post_event_trigger_request'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_event_trigger`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
    ...
    def p_ut_event_trigger_with_http_info(self, authorization, id, put_event_trigger_request, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'id', 'put_event_trigger_request', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('put_event_trigger_request' not in params or
                                                       params['put_event_trigger_request'] is None):  # noqa: E501
