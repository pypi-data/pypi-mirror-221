...
class CatalogGroupsApi(object):
    ...
    def d_elete_catalog_group_with_http_info(self, catalog_group_key, **kwargs):  # noqa: E501
        ...
        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Deletes a catalog group.   # noqa: E501
        ...
        all_params = ['catalog_group_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('catalog_group_key' not in params or
                                                       params['catalog_group_key'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_catalog_group`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_list_all_catalog_groups_with_http_info(self, **kwargs):  # noqa: E501
        ...
        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Retrieves basic information about all catalog groups.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_list_all_catalog_groups`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_list_all_catalog_groups`, must be a value less than or equal to `40`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_list_all_catalog_groups`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_retrieve_catalog_group_with_http_info(self, catalog_group_key, **kwargs):  # noqa: E501
        ...
        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Retrieves basic information about a catalog group.   # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_retrieve_catalog_group`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_create_catalog_group(self, request, **kwargs):  # noqa: E501
        ...
        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates a catalog group which groups a list of product rate plans.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_catalog_group(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTCatalogGroupRequest request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_catalog_group_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_catalog_group_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_catalog_group_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create a catalog group  # noqa: E501

        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Creates a catalog group which groups a list of product rate plans.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_catalog_group_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_catalog_group`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_catalog_group`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_catalog_group`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_catalog_group(self, catalog_group_key, request, **kwargs):  # noqa: E501
        ...
        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Updates a catalog group by its unique number or ID.  ### Notes - It is best practice to only specify the fields that you want to change in the request body. - If you specify an empty value for a field in the request body, the corresponding field in the catalog group is emptied. - The catalog group type cannot be changed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_catalog_group(catalog_group_key, request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str catalog_group_key: The unique number or ID of the catalog group to be updated.   (required)
        :param PUTCatalogGroup request:  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_update_catalog_group_with_http_info(catalog_group_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_update_catalog_group_with_http_info(catalog_group_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_update_catalog_group_with_http_info(self, catalog_group_key, request, **kwargs):  # noqa: E501
        """Update a catalog group  # noqa: E501

        **Note**: This operation is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).  Updates a catalog group by its unique number or ID.  ### Notes - It is best practice to only specify the fields that you want to change in the request body. - If you specify an empty value for a field in the request body, the corresponding field in the catalog group is emptied. - The catalog group type cannot be changed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_catalog_group_with_http_info(catalog_group_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['catalog_group_key', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_update_catalog_group`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_catalog_group`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
