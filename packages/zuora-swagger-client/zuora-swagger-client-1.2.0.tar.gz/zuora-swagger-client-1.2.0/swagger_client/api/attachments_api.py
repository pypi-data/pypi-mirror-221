...
class AttachmentsApi(object):
    ...
    def d_elete_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        all_params = ['attachment_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_attachments_list_with_http_info(self, object_type, object_key, **kwargs):  # noqa: E501
        ...
        all_params = ['object_type', 'object_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('object_key' not in params or
                                                       params['object_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `object_key` when calling `g_et_attachments_list`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_attachments_list`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_attachments_list`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def p_ost_attachments_with_http_info(self, associated_object_type, associated_object_key, file, **kwargs):  # noqa: E501
        ...
        all_params = ['associated_object_type', 'associated_object_key', 'file', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'description']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('associated_object_type' not in params or
                                                       params['associated_object_type'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('associated_object_key' not in params or
                                                       params['associated_object_key'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_attachments`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_attachments_with_http_info(self, attachment_id, **kwargs):  # noqa: E501
        ...
        all_params = ['attachment_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_attachments`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
