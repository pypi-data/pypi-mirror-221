...
class AggregateQueriesApi(object):
    ...
    def d_elete_batch_query_job(self, authorization, jobid, **kwargs):  # noqa: E501
        ...
        >>> thread = api.d_elete_batch_query_job(authorization, jobid, async_req=True)
        >>> result = thread.get()
        ...
        :param str jobid: Internal identifier of the query job.  (required)
        ...
        if kwargs.get('async_req'):
            return self.d_elete_batch_query_job_with_http_info(authorization, jobid, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_batch_query_job_with_http_info(authorization, jobid, **kwargs)  # noqa: E501
            return data

    def d_elete_batch_query_job_with_http_info(self, authorization, jobid, **kwargs):  # noqa: E501
        """Cancel a running aggregate query job  # noqa: E501

        Cancels the current AQuA job, only if the job is not complete. If the job is complete, an error is thrown.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_batch_query_job_with_http_info(authorization, jobid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'jobid', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_batch_query_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `d_elete_batch_query_job`")  # noqa: E501
        # verify the required parameter 'jobid' is set
        if self.api_client.client_side_validation and ('jobid' not in params or
                                                       params['jobid'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `jobid` when calling `d_elete_batch_query_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_batch_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='DeleteBatchQueryJobResponse',  # noqa: E501
    ...
    def g_et_batch_query_job(self, authorization, jobid, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_batch_query_job(authorization, jobid, async_req=True)
        >>> result = thread.get()
        ...
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :return: GetAggregateQueryJobResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_batch_query_job_with_http_info(authorization, jobid, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_batch_query_job_with_http_info(authorization, jobid, **kwargs)  # noqa: E501
            return data

    def g_et_batch_query_job_with_http_info(self, authorization, jobid, **kwargs):  # noqa: E501
        """Retrieve an aggregate query job  # noqa: E501

        Retrieves an aggregate query using the Job ID.  Note that the completed AQuA jobs that were created 180 days ago are deleted permanently from Zuora, so you cannot query these jobs through API or AQuA job finder.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_batch_query_job_with_http_info(authorization, jobid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_batch_query_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in params or
                                                       params['authorization'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `authorization` when calling `g_et_batch_query_job`")  # noqa: E501
        # verify the required parameter 'jobid' is set
        if self.api_client.client_side_validation and ('jobid' not in params or
                                                       params['jobid'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `jobid` when calling `g_et_batch_query_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_batch_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GetAggregateQueryJobResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def g_et_last_batch_query_job(self, authorization, partner, project, **kwargs):  # noqa: E501
        """Retrieve the last completed aggregate query job  # noqa: E501

        Returns the details of the last completed job.  The completed AQuA jobs that were created 180 days ago are deleted permanently from Zuora, so you cannot query these jobs through API or AQuA job finder.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_last_batch_query_job(authorization, partner, project, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (required)
        :param str partner: The unique ID of a data integration partner.   (required)
        :param str project: The unique ID of a data integration project for a particular partner.  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_last_batch_query_job_with_http_info(authorization, partner, project, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_last_batch_query_job_with_http_info(authorization, partner, project, **kwargs)  # noqa: E501
            return data

    def g_et_last_batch_query_job_with_http_info(self, authorization, partner, project, **kwargs):  # noqa: E501
        """Retrieve the last completed aggregate query job  # noqa: E501

        Returns the details of the last completed job.  The completed AQuA jobs that were created 180 days ago are deleted permanently from Zuora, so you cannot query these jobs through API or AQuA job finder.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_last_batch_query_job_with_http_info(authorization, partner, project, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'partner', 'project', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_last_batch_query_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in params or
                                                       params['authorization'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `authorization` when calling `g_et_last_batch_query_job`")  # noqa: E501
        # verify the required parameter 'partner' is set
        if self.api_client.client_side_validation and ('partner' not in params or
                                                       params['partner'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `partner` when calling `g_et_last_batch_query_job`")  # noqa: E501
        # verify the required parameter 'project' is set
        if self.api_client.client_side_validation and ('project' not in params or
                                                       params['project'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project` when calling `g_et_last_batch_query_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_last_batch_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_batch_query_job(self, authorization, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_batch_query_job(authorization, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (required)
        :param SubmitBatchQueryRequest body:  (required)
        ...
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :return: SubmitBatchQueryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_batch_query_job_with_http_info(authorization, body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_batch_query_job_with_http_info(authorization, body, **kwargs)  # noqa: E501
            return data

    def p_ost_batch_query_job_with_http_info(self, authorization, body, **kwargs):  # noqa: E501
        """Submit an aggregate query job  # noqa: E501

        Submits an AQuA job that contains an aggregated list of ZOQL and Export ZOQL queries.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_batch_query_job_with_http_info(authorization, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'body', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_batch_query_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in params or
                                                       params['authorization'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `authorization` when calling `p_ost_batch_query_job`")  # noqa: E501
        # verify the required parameter 'body' is set
        if self.api_client.client_side_validation and ('body' not in params or
                                                       params['body'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `body` when calling `p_ost_batch_query_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_batch_query_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_batch_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SubmitBatchQueryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
