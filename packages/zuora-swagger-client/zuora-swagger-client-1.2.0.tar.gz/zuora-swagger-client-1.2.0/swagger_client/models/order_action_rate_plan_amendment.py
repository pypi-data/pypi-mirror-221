...
class OrderActionRatePlanAmendment(object):
    ...
    def __init__(self, code=None, contract_effective_date=None, created_by=None, created_date=None, customer_acceptance_date=None, description=None, effective_date=None, id=None, name=None, service_activation_date=None, type=None, updated_by=None, updated_date=None, _configuration=None):  # noqa: E501
