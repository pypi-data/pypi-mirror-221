...
class CreateSubscription(object):
    ...
    def bill_to_contact_id(self):
        """Gets the bill_to_contact_id of this CreateSubscription.  # noqa: E501
        ...
        :return: The bill_to_contact_id of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_to_contact_id(self, bill_to_contact_id):
        """Sets the bill_to_contact_id of this CreateSubscription.

        The ID of the bill-to contact associated with the subscription.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param bill_to_contact_id: The bill_to_contact_id of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def invoice_separately(self):
        """Gets the invoice_separately of this CreateSubscription.  # noqa: E501

        Specifies whether the subscription appears on a separate invoice when Zuora generates invoices.   # noqa: E501

        :return: The invoice_separately of this CreateSubscription.  # noqa: E501
        :rtype: bool
        """
    ...
    def invoice_separately(self, invoice_separately):
        """Sets the invoice_separately of this CreateSubscription.

        Specifies whether the subscription appears on a separate invoice when Zuora generates invoices.   # noqa: E501

        :param invoice_separately: The invoice_separately of this CreateSubscription.  # noqa: E501
        :type: bool
        """
    ...
    def invoice_template_id(self):
        """Gets the invoice_template_id of this CreateSubscription.  # noqa: E501
        ...
        :return: The invoice_template_id of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def invoice_template_id(self, invoice_template_id):
        """Sets the invoice_template_id of this CreateSubscription.

        The ID of the invoice template associated with the subscription.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param invoice_template_id: The invoice_template_id of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def new_subscription_owner_account(self):
        """Gets the new_subscription_owner_account of this CreateSubscription.  # noqa: E501


        :return: The new_subscription_owner_account of this CreateSubscription.  # noqa: E501
    ...
    def new_subscription_owner_account(self, new_subscription_owner_account):
        """Sets the new_subscription_owner_account of this CreateSubscription.


        :param new_subscription_owner_account: The new_subscription_owner_account of this CreateSubscription.  # noqa: E501
    ...
    @property
    def notes(self):
        """Gets the notes of this CreateSubscription.  # noqa: E501

        Notes about the subscription. These notes are only visible to Zuora users.   # noqa: E501

        :return: The notes of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
        return self._notes
    ...
    def notes(self, notes):
        """Sets the notes of this CreateSubscription.

        Notes about the subscription. These notes are only visible to Zuora users.   # noqa: E501

        :param notes: The notes of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def payment_term(self):
        """Gets the payment_term of this CreateSubscription.  # noqa: E501
        ...
        :return: The payment_term of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_term(self, payment_term):
        """Sets the payment_term of this CreateSubscription.

        The name of the payment term associated with the subscription. For example, `Net 30`. The payment term determines the due dates of invoices.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param payment_term: The payment_term of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def sequence_set_id(self):
        """Gets the sequence_set_id of this CreateSubscription.  # noqa: E501
        ...
        :return: The sequence_set_id of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def sequence_set_id(self, sequence_set_id):
        """Sets the sequence_set_id of this CreateSubscription.

        The ID of the sequence set associated with the subscription.  **Note** : If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param sequence_set_id: The sequence_set_id of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def sold_to_contact_id(self):
        """Gets the sold_to_contact_id of this CreateSubscription.  # noqa: E501
        ...
        :return: The sold_to_contact_id of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def sold_to_contact_id(self, sold_to_contact_id):
        """Sets the sold_to_contact_id of this CreateSubscription.

        The ID of the sold-to contact associated with the subscription.  **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param sold_to_contact_id: The sold_to_contact_id of this CreateSubscription.  # noqa: E501
        :type: str
        """
    ...
    def subscribe_to_products(self):
        """Gets the subscribe_to_products of this CreateSubscription.  # noqa: E501

        List of offers or rate plans associated with the subscription. - For a rate plan, the following fields are available:   - `chargeOverrides`   - `clearingExistingFeatures`   - `customFields`   - `externallyManagedPlanId`   - `newRatePlanId`   - `productRatePlanId`   - `subscriptionProductFeatures`   - `uniqueToken` - For an offer, the following fields are available:   - `customFields`   - `newSubscriptionOfferId`   - `newSubscriptionOfferNumber`   - `productOfferId`   - `productOfferNumber`   - `ratePlanOverrides`   - `subscriptionOfferUniqueToken`      # noqa: E501

        :return: The subscribe_to_products of this CreateSubscription.  # noqa: E501
    ...
    def subscribe_to_products(self, subscribe_to_products):
        """Sets the subscribe_to_products of this CreateSubscription.

        List of offers or rate plans associated with the subscription. - For a rate plan, the following fields are available:   - `chargeOverrides`   - `clearingExistingFeatures`   - `customFields`   - `externallyManagedPlanId`   - `newRatePlanId`   - `productRatePlanId`   - `subscriptionProductFeatures`   - `uniqueToken` - For an offer, the following fields are available:   - `customFields`   - `newSubscriptionOfferId`   - `newSubscriptionOfferNumber`   - `productOfferId`   - `productOfferNumber`   - `ratePlanOverrides`   - `subscriptionOfferUniqueToken`      # noqa: E501

        :param subscribe_to_products: The subscribe_to_products of this CreateSubscription.  # noqa: E501
    ...
    def subscribe_to_rate_plans(self):
        """Gets the subscribe_to_rate_plans of this CreateSubscription.  # noqa: E501
        ...
        :return: The subscribe_to_rate_plans of this CreateSubscription.  # noqa: E501
    ...
    def subscribe_to_rate_plans(self, subscribe_to_rate_plans):
        """Sets the subscribe_to_rate_plans of this CreateSubscription.

        List of rate plans associated with the subscription.  **Note**: The `subscribeToRatePlans` field has been deprecated, this field is replaced by the `subscribeToProducts` field that supports both Rate Plans and Offers. In a new order request, you can use either `subscribeToRatePlans` or `subscribeToProducts`, not both.   # noqa: E501

        :param subscribe_to_rate_plans: The subscribe_to_rate_plans of this CreateSubscription.  # noqa: E501
    ...
    def subscription_number(self):
        """Gets the subscription_number of this CreateSubscription.  # noqa: E501
        ...
        :return: The subscription_number of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_number(self, subscription_number):
        """Sets the subscription_number of this CreateSubscription.

        Subscription number of the subscription. For example, A-S00000001.  If you do not set this field, Zuora will generate the subscription number.   # noqa: E501

        :param subscription_number: The subscription_number of this CreateSubscription.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def subscription_owner_account_number(self):
        """Gets the subscription_owner_account_number of this CreateSubscription.  # noqa: E501
        ...
        :return: The subscription_owner_account_number of this CreateSubscription.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_owner_account_number(self, subscription_owner_account_number):
        """Sets the subscription_owner_account_number of this CreateSubscription.

        Account number of an existing account that will own the subscription. For example, A00000001.  If you do not set this field or the `newSubscriptionOwnerAccount` field, the account that owns the order will also own the subscription. Zuora will return an error if you set this field and the `newSubscriptionOwnerAccount` field.   # noqa: E501

        :param subscription_owner_account_number: The subscription_owner_account_number of this CreateSubscription.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def terms(self):
        """Gets the terms of this CreateSubscription.  # noqa: E501


        :return: The terms of this CreateSubscription.  # noqa: E501
    ...
    def terms(self, terms):
        """Sets the terms of this CreateSubscription.


        :param terms: The terms of this CreateSubscription.  # noqa: E501
