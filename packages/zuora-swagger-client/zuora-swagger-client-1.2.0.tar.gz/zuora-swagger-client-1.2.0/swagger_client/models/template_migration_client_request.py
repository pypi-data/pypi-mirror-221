...
class TemplateMigrationClientRequest(object):
    ...
    def __init__(self, comments=None, description=None, email_ids=None, entity_uuid=None, meta_data=None, name=None, request=None, send_email=None, _configuration=None):  # noqa: E501
    ...
    def entity_uuid(self, entity_uuid):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and entity_uuid is None:
    ...
    def meta_data(self):
        ...
        Meta data information of the source templates.  # noqa: E501
