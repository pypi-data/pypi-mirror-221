...
class RefundPartResponseTypewithSuccess(object):
    ...
    def __init__(self, amount=None, created_by_id=None, created_date=None, credit_memo_id=None, id=None, payment_id=None, updated_by_id=None, updated_date=None, _configuration=None):  # noqa: E501
