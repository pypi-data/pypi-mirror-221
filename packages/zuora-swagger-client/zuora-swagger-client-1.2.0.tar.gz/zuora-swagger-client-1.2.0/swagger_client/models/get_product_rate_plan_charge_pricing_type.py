...
class GETProductRatePlanChargePricingType(object):
    ...
    def __init__(self, currency=None, discount_amount=None, discount_percentage=None, included_units=None, overage_price=None, price=None, tiers=None, _configuration=None):  # noqa: E501
