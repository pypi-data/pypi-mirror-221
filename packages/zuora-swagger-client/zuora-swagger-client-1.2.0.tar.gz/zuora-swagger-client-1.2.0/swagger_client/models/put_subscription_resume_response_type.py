...
class PUTSubscriptionResumeResponseType(object):
    ...
    def __init__(self, credit_memo_id=None, invoice_id=None, paid_amount=None, payment_id=None, resume_date=None, subscription_id=None, success=None, term_end_date=None, total_delta_tcv=None, _configuration=None):  # noqa: E501
        """PUTSubscriptionResumeResponseType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PUTSubscriptionResumeResponseType, dict):
