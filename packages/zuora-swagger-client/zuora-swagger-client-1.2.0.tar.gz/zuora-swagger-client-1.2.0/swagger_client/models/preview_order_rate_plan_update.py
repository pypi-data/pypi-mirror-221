...
class PreviewOrderRatePlanUpdate(object):
    ...
    def __init__(self, charge_updates=None, clearing_existing_features=None, custom_fields=None, product_rate_plan_number=None, rate_plan_id=None, specific_update_date=None, subscription_product_features=None, subscription_rate_plan_number=None, unique_token=None, _configuration=None):  # noqa: E501
    ...
    def charge_updates(self):
        ...
        Array of the JSON objects containing the information for a charge update in the `updateProduct` type of order action.  When previewing an `updateProduct` order action, either the `chargeNumber` or `uniqueToken` field is required to specify the charge to update.   # noqa: E501
    ...
    def clearing_existing_features(self):
        """Gets the clearing_existing_features of this PreviewOrderRatePlanUpdate.  # noqa: E501

        Specifies whether all features in the rate plan will be cleared.   # noqa: E501

        :return: The clearing_existing_features of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def clearing_existing_features(self, clearing_existing_features):
        """Sets the clearing_existing_features of this PreviewOrderRatePlanUpdate.

        Specifies whether all features in the rate plan will be cleared.   # noqa: E501

        :param clearing_existing_features: The clearing_existing_features of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :type: bool
        """
    ...
    def product_rate_plan_number(self):
        """Gets the product_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501

        Number of a product rate plan for this subscription.   # noqa: E501

        :return: The product_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_number(self, product_rate_plan_number):
        """Sets the product_rate_plan_number of this PreviewOrderRatePlanUpdate.

        Number of a product rate plan for this subscription.   # noqa: E501

        :param product_rate_plan_number: The product_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :type: str
        """
    ...
    def subscription_product_features(self):
        """Gets the subscription_product_features of this PreviewOrderRatePlanUpdate.  # noqa: E501
        ...
        :return: The subscription_product_features of this PreviewOrderRatePlanUpdate.  # noqa: E501
    ...
    def subscription_product_features(self, subscription_product_features):
        """Sets the subscription_product_features of this PreviewOrderRatePlanUpdate.

        List of features associated with the rate plan. The system compares the `subscriptionProductFeatures` and `featureId` fields in the request with the counterpart fields in a rate plan. The comparison results are as follows: * If there is no `subscriptionProductFeatures` field or the field is empty, features in the rate plan remain unchanged. But if the `clearingExistingFeatures` field is additionally set to true, all features in the rate plan are cleared. * If the `subscriptionProductFeatures` field contains the `featureId` nested fields, as well as the optional `description` and `customFields` nested fields, the features indicated by the featureId nested fields in the request overwrite all features in the rate plan.   # noqa: E501

        :param subscription_product_features: The subscription_product_features of this PreviewOrderRatePlanUpdate.  # noqa: E501
    ...
    def subscription_rate_plan_number(self):
        """Gets the subscription_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501

        Number of a rate plan for this subscription.   # noqa: E501

        :return: The subscription_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_rate_plan_number(self, subscription_rate_plan_number):
        """Sets the subscription_rate_plan_number of this PreviewOrderRatePlanUpdate.

        Number of a rate plan for this subscription.   # noqa: E501

        :param subscription_rate_plan_number: The subscription_rate_plan_number of this PreviewOrderRatePlanUpdate.  # noqa: E501
        :type: str
        """
