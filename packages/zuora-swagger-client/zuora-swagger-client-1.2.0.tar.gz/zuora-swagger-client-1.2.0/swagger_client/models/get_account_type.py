...
class GETAccountType(object):
    ...
    def __init__(self, basic_info=None, bill_to_contact=None, billing_and_payment=None, metrics=None, sold_to_contact=None, success=None, tax_info=None, _configuration=None):  # noqa: E501
