...
class GetScheduledEventResponse(object):
    ...
    def __init__(self, active=None, api_field=None, api_object=None, condition=None, cron_expression=None, description=None, display_name=None, id=None, name=None, namespace=None, parameters=None, _configuration=None):  # noqa: E501
