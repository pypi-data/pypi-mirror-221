...
class CreateChangePlan(object):
    ...
    def __init__(self, effective_policy=None, external_catalog_plan_id=None, new_product_rate_plan=None, product_rate_plan_id=None, product_rate_plan_number=None, rate_plan_id=None, reset_bcd=False, sub_type=None, subscription_rate_plan_number=None, _configuration=None):  # noqa: E501
        """CreateChangePlan - a model defined in Swagger"""  # noqa: E501
    ...
    def effective_policy(self, effective_policy):
        """Sets the effective_policy of this CreateChangePlan.

        The default value for the `effectivePolicy` field is as follows:   * If the rate plan change (from old to new) is an upgrade, the effective policy is `EffectiveImmediately` by default.   * If the rate plan change (from old to new) is a downgrade, the effective policy is `EffectiveEndOfBillingPeriod` by default.   * Otherwise, the effective policy is `SpecificDate` by default.  Note that if the `effectivePolicy` field is set to `EffectiveEndOfBillingPeriod`, you cannot set the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Subscriptions/W_Subscription_and_Amendment_Dates#Billing_Trigger_Dates\" target=\"_blank\">billing trigger dates</a> for the subscription as the system will automatically set the trigger dates to the end of billing period, and you cannot set the following billing trigger date settings to `Yes`:   * <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Customer_Acceptance_of_Orders.3F\" target=\"_blank\">Require Customer Acceptance of Orders?</a>   * <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Billing_Settings/Define_Default_Subscription_and_Order_Settings#Require_Service_Activation_of_Orders.3F\" target=\"_blank\">Require Service Activation of Orders?</a>   # noqa: E501

        :param effective_policy: The effective_policy of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def external_catalog_plan_id(self):
        """Gets the external_catalog_plan_id of this CreateChangePlan.  # noqa: E501
        ...
        :return: The external_catalog_plan_id of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def external_catalog_plan_id(self, external_catalog_plan_id):
        """Sets the external_catalog_plan_id of this CreateChangePlan.

        An external ID of the rate plan to be removed. You can use this field to specify an existing rate plan in your subscription. The value of the `externalCatalogPlanId` field must match one of the values that are predefined in the `externallyManagedPlanIds` field on a product rate plan. However, if there are multiple rate plans with the same `productRatePlanId` value existing in the subscription, you must use the `ratePlanId` field to remove the rate plan. The `externalCatalogPlanId` field cannot be used to distinguish multiple rate plans in this case.  **Note:** Please provide only one of `externalCatalogPlanId`, `ratePlanId` or `productRatePlanId`. If more than 1 field is provided then the request would fail.   # noqa: E501

        :param external_catalog_plan_id: The external_catalog_plan_id of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def new_product_rate_plan(self):
        """Gets the new_product_rate_plan of this CreateChangePlan.  # noqa: E501


        :return: The new_product_rate_plan of this CreateChangePlan.  # noqa: E501
    ...
    def new_product_rate_plan(self, new_product_rate_plan):
        """Sets the new_product_rate_plan of this CreateChangePlan.


        :param new_product_rate_plan: The new_product_rate_plan of this CreateChangePlan.  # noqa: E501
        :type: CreateOrderChangePlanRatePlanOverride
        """
        if self._configuration.client_side_validation and new_product_rate_plan is None:
    ...
    def product_rate_plan_id(self):
        """Gets the product_rate_plan_id of this CreateChangePlan.  # noqa: E501

        ID of the product rate plan that the removed rate plan is based on.   # noqa: E501

        :return: The product_rate_plan_id of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_id(self, product_rate_plan_id):
        """Sets the product_rate_plan_id of this CreateChangePlan.

        ID of the product rate plan that the removed rate plan is based on.   # noqa: E501

        :param product_rate_plan_id: The product_rate_plan_id of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_number(self):
        """Gets the product_rate_plan_number of this CreateChangePlan.  # noqa: E501

        Number of a product rate plan for this subscription.   # noqa: E501

        :return: The product_rate_plan_number of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_number(self, product_rate_plan_number):
        """Sets the product_rate_plan_number of this CreateChangePlan.

        Number of a product rate plan for this subscription.   # noqa: E501

        :param product_rate_plan_number: The product_rate_plan_number of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def rate_plan_id(self):
        """Gets the rate_plan_id of this CreateChangePlan.  # noqa: E501
        ...
        :return: The rate_plan_id of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def rate_plan_id(self, rate_plan_id):
        """Sets the rate_plan_id of this CreateChangePlan.

        ID of the rate plan to remove. This can be the latest version or any history version of ID. Note that the removal of a rate plan through the Change Plan order action supports the function of <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Subscriptions/Orders/Order_actions_tutorials/E2_Remove_rate_plan_on_subscription_before_future-dated_removals\" target=\"_blank\">removal before future-dated removals</a>, as in a Remove Product order action.   # noqa: E501

        :param rate_plan_id: The rate_plan_id of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def reset_bcd(self, reset_bcd):
        """Sets the reset_bcd of this CreateChangePlan.

        If resetBcd is true then reset the Account BCD to the effective date; if it is false keep the original BCD.   # noqa: E501

        :param reset_bcd: The reset_bcd of this CreateChangePlan.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def sub_type(self):
        """Gets the sub_type of this CreateChangePlan.  # noqa: E501
        ...
        :return: The sub_type of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_type(self, sub_type):
        """Sets the sub_type of this CreateChangePlan.

        Use this field to choose the sub type for your change plan order action.  However, if you do not set this field, the field will be automatically generated by the system according to the following rules:  When the old and new rate plans are within the same Grading catalog group: * If the grade of new plan is greater than that of the old plan, this is an \"Upgrade\". * If the grade of new plan is less than that of the old plan, this is a \"Downgrade\". * If the grade of new plan equals that of the old plan, this is a \"Crossgrade\".  When the old and new rate plans are not in the same Grading catalog group, or either has no group, this is \"PlanChanged\".   # noqa: E501

        :param sub_type: The sub_type of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def subscription_rate_plan_number(self):
        """Gets the subscription_rate_plan_number of this CreateChangePlan.  # noqa: E501

        Number of a rate plan for this subscription.   # noqa: E501

        :return: The subscription_rate_plan_number of this CreateChangePlan.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_rate_plan_number(self, subscription_rate_plan_number):
        """Sets the subscription_rate_plan_number of this CreateChangePlan.

        Number of a rate plan for this subscription.   # noqa: E501

        :param subscription_rate_plan_number: The subscription_rate_plan_number of this CreateChangePlan.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateChangePlan, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateChangePlan):
            return False
