...
class POSTOfferPriceBookItem(object):
    ...
    swagger_types = {
        ...
        'interval_prices': 'list[POSTOfferIntervalPrice]',
        'list_price_base': 'str',
        'overage_price': 'float',
        'price': 'float',
        'tiers': 'list[POSTOfferTier]'
    }
    ...
    def __init__(self, currency=None, default_quantity=None, included_units=None, interval_prices=None, list_price_base=None, overage_price=None, price=None, tiers=None, _configuration=None):  # noqa: E501
        """POSTOfferPriceBookItem - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def currency(self):
        """Gets the currency of this POSTOfferPriceBookItem.  # noqa: E501

        The currency for the price.   # noqa: E501

        :return: The currency of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this POSTOfferPriceBookItem.

        The currency for the price.   # noqa: E501

        :param currency: The currency of this POSTOfferPriceBookItem.  # noqa: E501
        :type: str
        """
    ...
    def default_quantity(self):
        """Gets the default_quantity of this POSTOfferPriceBookItem.  # noqa: E501

        The default quantity of the price book item.   This field is only applicable for one-time and recurring charges.   # noqa: E501

        :return: The default_quantity of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: float
        """
    ...
    def default_quantity(self, default_quantity):
        """Sets the default_quantity of this POSTOfferPriceBookItem.

        The default quantity of the price book item.   This field is only applicable for one-time and recurring charges.   # noqa: E501

        :param default_quantity: The default_quantity of this POSTOfferPriceBookItem.  # noqa: E501
        :type: float
        """
    ...
    def included_units(self):
        """Gets the included_units of this POSTOfferPriceBookItem.  # noqa: E501
        ...
        :return: The included_units of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: float
        """
    ...
    def included_units(self, included_units):
        """Sets the included_units of this POSTOfferPriceBookItem.

        The number of units included in the price book item.   This field is only applicable for charges with the Overage pricing charge model.   # noqa: E501

        :param included_units: The included_units of this POSTOfferPriceBookItem.  # noqa: E501
        :type: float
        """
    ...
    def interval_prices(self):
        """Gets the interval_prices of this POSTOfferPriceBookItem.  # noqa: E501
        ...
        :return: The interval_prices of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: list[POSTOfferIntervalPrice]
        """
        return self._interval_prices

    @interval_prices.setter
    def interval_prices(self, interval_prices):
        """Sets the interval_prices of this POSTOfferPriceBookItem.

        Container for the interval prices of the product rate plan charge.   This field is applicable only if you want to use interval prices for different periods.   # noqa: E501

        :param interval_prices: The interval_prices of this POSTOfferPriceBookItem.  # noqa: E501
        :type: list[POSTOfferIntervalPrice]
        """
    ...
    def list_price_base(self):
        """Gets the list_price_base of this POSTOfferPriceBookItem.  # noqa: E501

        The list price base of the price book item.   This field is only applicable for recurring charges.   # noqa: E501

        :return: The list_price_base of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: str
        """
    ...
    def list_price_base(self, list_price_base):
        """Sets the list_price_base of this POSTOfferPriceBookItem.

        The list price base of the price book item.   This field is only applicable for recurring charges.   # noqa: E501

        :param list_price_base: The list_price_base of this POSTOfferPriceBookItem.  # noqa: E501
        :type: str
        """
    ...
    def overage_price(self):
        """Gets the overage_price of this POSTOfferPriceBookItem.  # noqa: E501
        ...
        :return: The overage_price of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: float
        """
    ...
    def overage_price(self, overage_price):
        """Sets the overage_price of this POSTOfferPriceBookItem.

        The overage price of the price book item.   This field is only applicable for charges with the Overage or Tiered with Overage pricing charge model.   # noqa: E501

        :param overage_price: The overage_price of this POSTOfferPriceBookItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def price(self):
        """Gets the price of this POSTOfferPriceBookItem.  # noqa: E501
        ...
        :return: The price of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this POSTOfferPriceBookItem.

        The price of the price book item.   This field is only applicable for charges with the Flat Fee, Per Unit, or Delivery Pricing charge model.   # noqa: E501

        :param price: The price of this POSTOfferPriceBookItem.  # noqa: E501
        :type: float
        """
    ...
    @property
    def tiers(self):
        """Gets the tiers of this POSTOfferPriceBookItem.  # noqa: E501
        ...
        :return: The tiers of this POSTOfferPriceBookItem.  # noqa: E501
        :rtype: list[POSTOfferTier]
        """
        return self._tiers

    @tiers.setter
    def tiers(self, tiers):
        """Sets the tiers of this POSTOfferPriceBookItem.

        Container for the tiers of the price book item.   This field is only applicable for charges with the Tiered, Volume, or Tiered with Overage pricing charge model.   # noqa: E501

        :param tiers: The tiers of this POSTOfferPriceBookItem.  # noqa: E501
        :type: list[POSTOfferTier]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(POSTOfferPriceBookItem, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTOfferPriceBookItem):
            return False
