...
class OrderRampIntervalMetrics(object):
    ...
    def __init__(self, description=None, discount_tcb=None, discount_tcv=None, end_date=None, gross_tcb=None, gross_tcv=None, interval_delta_metrics=None, interval_metrics=None, name=None, net_tcb=None, net_tcv=None, start_date=None, _configuration=None):  # noqa: E501
