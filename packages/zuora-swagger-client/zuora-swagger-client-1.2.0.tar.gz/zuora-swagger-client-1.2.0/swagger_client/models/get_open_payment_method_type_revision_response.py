...
class GETOpenPaymentMethodTypeRevisionResponse(object):
    ...
    def __init__(self, entity_id=None, fields=None, internal_name=None, label=None, method_reference_id_field=None, revision=None, status=None, sub_type_field=None, tenant_id=None, user_reference_id_field=None, version=None, _configuration=None):  # noqa: E501
