...
class RampIntervalChargeDeltaMetrics(object):
    ...
    def __init__(self, charge_number=None, delta_discount_tcb=None, delta_discount_tcv=None, delta_gross_tcb=None, delta_gross_tcv=None, delta_mrr=None, delta_net_tcb=None, delta_net_tcv=None, delta_quantity=None, product_rate_plan_charge_id=None, subscription_number=None, _configuration=None):  # noqa: E501
