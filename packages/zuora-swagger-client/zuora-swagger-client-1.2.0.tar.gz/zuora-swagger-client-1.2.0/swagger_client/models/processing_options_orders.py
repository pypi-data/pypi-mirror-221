...
class ProcessingOptionsOrders(object):
    ...
    swagger_types = {
        ...
        'billing_options': 'ProcessingOptionsOrdersBillingOptions',
        'collect_payment': 'bool',
        'electronic_payment_options': 'ProcessingOptionsOrdersElectronicPaymentOptions',
        'refund': 'bool',
        'refund_amount': 'float',
        'refund_reason_code': 'str',
        'run_billing': 'bool',
        'write_off': 'bool',
        'write_off_behavior': 'ProcessingOptionsOrdersWriteOffBehavior'
    }
    ...
    def __init__(self, application_order=None, apply_credit=None, apply_credit_balance=None, billing_options=None, collect_payment=None, electronic_payment_options=None, refund=None, refund_amount=None, refund_reason_code=None, run_billing=None, write_off=None, write_off_behavior=None, _configuration=None):  # noqa: E501
        """ProcessingOptionsOrders - a model defined in Swagger"""  # noqa: E501
    ...
    def application_order(self):
        """Gets the application_order of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The application_order of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def application_order(self, application_order):
        """Sets the application_order of this ProcessingOptionsOrders.

        The priority order to apply credit memos and/or unapplied payments to an invoice. Possible item values are: `CreditMemo`, `UnappliedPayment`.  **Note:**   - This field is valid only if the `applyCredit` field is set to `true`.   - If no value is specified for this field, the default priority order is used, [\"CreditMemo\", \"UnappliedPayment\"], to apply credit memos first and then apply unapplied payments.   - If only one item is specified, only the items of the spedified type are applied to invoices. For example, if the value is `[\"CreditMemo\"]`, only credit memos are used to apply to invoices.   # noqa: E501

        :param application_order: The application_order of this ProcessingOptionsOrders.  # noqa: E501
        :type: list[str]
        """
    ...
    def apply_credit(self):
        """Gets the apply_credit of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The apply_credit of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
    ...
    def apply_credit(self, apply_credit):
        """Sets the apply_credit of this ProcessingOptionsOrders.

        Whether to automatically apply credit memos or unapplied payments, or both to an invoice.  If the value is true, the credit memo or unapplied payment on the order account will be automatically applied to the invoices generated by this order. The credit memo generated by this order will not be automatically applied to any invoices.             **Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501

        :param apply_credit: The apply_credit of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    def apply_credit_balance(self):
        """Gets the apply_credit_balance of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The apply_credit_balance of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
    ...
    def apply_credit_balance(self, apply_credit_balance):
        """Sets the apply_credit_balance of this ProcessingOptionsOrders.

        Indicates if any credit balance on a customer's account is automatically applied to invoices. If no value is specified then this field defaults to false. This feature is not available if you have enabled the Invoice Settlement feature.   # noqa: E501

        :param apply_credit_balance: The apply_credit_balance of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    def billing_options(self):
        """Gets the billing_options of this ProcessingOptionsOrders.  # noqa: E501


        :return: The billing_options of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: ProcessingOptionsOrdersBillingOptions
        """
        return self._billing_options

    @billing_options.setter
    def billing_options(self, billing_options):
        """Sets the billing_options of this ProcessingOptionsOrders.


        :param billing_options: The billing_options of this ProcessingOptionsOrders.  # noqa: E501
        :type: ProcessingOptionsOrdersBillingOptions
        """
    ...
    def collect_payment(self):
        """Gets the collect_payment of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The collect_payment of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
    ...
    def collect_payment(self, collect_payment):
        """Sets the collect_payment of this ProcessingOptionsOrders.

        Indicates if the current request needs to collect payments. This value can not be 'true' when 'runBilling' flag is 'false'.   # noqa: E501

        :param collect_payment: The collect_payment of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    def electronic_payment_options(self):
        """Gets the electronic_payment_options of this ProcessingOptionsOrders.  # noqa: E501


        :return: The electronic_payment_options of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: ProcessingOptionsOrdersElectronicPaymentOptions
        """
    ...
    def electronic_payment_options(self, electronic_payment_options):
        """Sets the electronic_payment_options of this ProcessingOptionsOrders.


        :param electronic_payment_options: The electronic_payment_options of this ProcessingOptionsOrders.  # noqa: E501
        :type: ProcessingOptionsOrdersElectronicPaymentOptions
        """
    ...
    @property
    def refund(self):
        """Gets the refund of this ProcessingOptionsOrders.  # noqa: E501

        Indicates whether to refund after subscription cancelation. Default is `false`.   **Note**: Before canceling a subscription with a refund, the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature must have been enabled to support refunding a subscription that is not invoiced separately.   # noqa: E501

        :return: The refund of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
        return self._refund
    ...
    def refund(self, refund):
        """Sets the refund of this ProcessingOptionsOrders.

        Indicates whether to refund after subscription cancelation. Default is `false`.   **Note**: Before canceling a subscription with a refund, the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature must have been enabled to support refunding a subscription that is not invoiced separately.   # noqa: E501

        :param refund: The refund of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    def refund_amount(self):
        """Gets the refund_amount of this ProcessingOptionsOrders.  # noqa: E501

        Indicates the amount to be refunded. Required if the `refund` field is `true`.   # noqa: E501

        :return: The refund_amount of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: float
        """
    ...
    def refund_amount(self, refund_amount):
        """Sets the refund_amount of this ProcessingOptionsOrders.

        Indicates the amount to be refunded. Required if the `refund` field is `true`.   # noqa: E501

        :param refund_amount: The refund_amount of this ProcessingOptionsOrders.  # noqa: E501
        :type: float
        """
    ...
    def refund_reason_code(self):
        """Gets the refund_reason_code of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The refund_reason_code of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: str
        """
    ...
    def refund_reason_code(self, refund_reason_code):
        """Sets the refund_reason_code of this ProcessingOptionsOrders.

        A code identifying the reason for the refund transaction. The value must be an existing payment refund reason code listed in **Payments Settings** > **Configure Reason Codes**. If you do not specify the field or leave the field with an empty value, Zuora uses the default payment refund reason code.   # noqa: E501

        :param refund_reason_code: The refund_reason_code of this ProcessingOptionsOrders.  # noqa: E501
        :type: str
        """
    ...
    def run_billing(self):
        """Gets the run_billing of this ProcessingOptionsOrders.  # noqa: E501
        ...
        :return: The run_billing of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_billing(self, run_billing):
        """Sets the run_billing of this ProcessingOptionsOrders.

        Indicates if the current request needs to generate an invoice. The invoice will be generated against all subscriptions included in this order.   # noqa: E501

        :param run_billing: The run_billing of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def write_off(self):
        """Gets the write_off of this ProcessingOptionsOrders.  # noqa: E501

        Indicates whether to write off the outstanding balance on the invoice after refund. Default is `false`.  **Note**: Before canceling a subscription with a refund and write-off, ensure that the following requirements are met: - The <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature must have been enabled to support refunding a subscription that is not invoiced separately. - The <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement\" target=\"_blank\">Invoice Settlement</a> feature must have been enabled for write-off.   # noqa: E501

        :return: The write_off of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: bool
        """
    ...
    def write_off(self, write_off):
        """Sets the write_off of this ProcessingOptionsOrders.

        Indicates whether to write off the outstanding balance on the invoice after refund. Default is `false`.  **Note**: Before canceling a subscription with a refund and write-off, ensure that the following requirements are met: - The <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement/C_Invoice_Item_Settlement\" target=\"_blank\">Invoice Item Settlement</a> feature must have been enabled to support refunding a subscription that is not invoiced separately. - The <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Billing_and_Invoicing/Invoice_Settlement\" target=\"_blank\">Invoice Settlement</a> feature must have been enabled for write-off.   # noqa: E501

        :param write_off: The write_off of this ProcessingOptionsOrders.  # noqa: E501
        :type: bool
        """
    ...
    def write_off_behavior(self):
        """Gets the write_off_behavior of this ProcessingOptionsOrders.  # noqa: E501


        :return: The write_off_behavior of this ProcessingOptionsOrders.  # noqa: E501
        :rtype: ProcessingOptionsOrdersWriteOffBehavior
        """
        return self._write_off_behavior

    @write_off_behavior.setter
    def write_off_behavior(self, write_off_behavior):
        """Sets the write_off_behavior of this ProcessingOptionsOrders.


        :param write_off_behavior: The write_off_behavior of this ProcessingOptionsOrders.  # noqa: E501
        :type: ProcessingOptionsOrdersWriteOffBehavior
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProcessingOptionsOrders, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProcessingOptionsOrders):
            return False
