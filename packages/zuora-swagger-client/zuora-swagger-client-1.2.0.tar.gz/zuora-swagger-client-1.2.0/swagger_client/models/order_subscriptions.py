...
class OrderSubscriptions(object):
    ...
    def __init__(self, base_version=None, custom_fields=None, externally_managed_by=None, new_version=None, order_actions=None, quote=None, ramp=None, sequence=None, subscription_number=None, subscription_owner_account_number=None, _configuration=None):  # noqa: E501
