...
class POSTCreateOrUpdateEmailTemplateRequestFormat(object):
    ...
    def email_body(self, email_body):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and email_body is None:
    ...
    def from_email_type(self, from_email_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and from_email_type is None:
    ...
    def to_email_type(self, to_email_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and to_email_type is None:
