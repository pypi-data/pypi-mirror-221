...
class POSTCreateOpenPaymentMethodTypeRequest(object):
    ...
    def __init__(self, entity_id=None, fields=None, internal_name=None, label=None, method_reference_id_field=None, sub_type_field=None, tenant_id=None, user_reference_id_field=None, _configuration=None):  # noqa: E501
        """POSTCreateOpenPaymentMethodTypeRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def entity_id(self):
        """Gets the entity_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501

        If this custom payment method type is specific to one entity only, provide the entity ID in this field in UUID format, such as `123e4567-e89b-12d3-a456-426614174000`. If no entity UUID is provided, the custom payment method type is available to the global entity and all the sub entities in the tenant.  You can get the entity ID through the [Multi-entity: List entities](https://www.zuora.com/developer/api-references/api/operation/GET_Entities) API operation or the **Manage Entity Profile** administration setting in the UI. To convert the format of the entity ID to UUID, separate the entity ID string in five groups with hyphens, in the form `<8-characters>-<4-characters>-<4-characters>-<4-characters>-<12-characters>` for a total of 36 characters.  Note: After the custom payment method type is created, you can only update this field to be empty.   # noqa: E501

        :return: The entity_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def entity_id(self, entity_id):
        """Sets the entity_id of this POSTCreateOpenPaymentMethodTypeRequest.

        If this custom payment method type is specific to one entity only, provide the entity ID in this field in UUID format, such as `123e4567-e89b-12d3-a456-426614174000`. If no entity UUID is provided, the custom payment method type is available to the global entity and all the sub entities in the tenant.  You can get the entity ID through the [Multi-entity: List entities](https://www.zuora.com/developer/api-references/api/operation/GET_Entities) API operation or the **Manage Entity Profile** administration setting in the UI. To convert the format of the entity ID to UUID, separate the entity ID string in five groups with hyphens, in the form `<8-characters>-<4-characters>-<4-characters>-<4-characters>-<12-characters>` for a total of 36 characters.  Note: After the custom payment method type is created, you can only update this field to be empty.   # noqa: E501

        :param entity_id: The entity_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fields(self):
        """Gets the fields of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The fields of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
    ...
    def fields(self, fields):
        """Sets the fields of this POSTCreateOpenPaymentMethodTypeRequest.

        An array containing field metadata of the custom payment method type.  Notes:   - All the following nested metadata must be provided in the request to define a field.    - At least one field must be defined in the fields array for a custom payment method type.    - Up to 20 fields can be defined in the fields array for a custom payment method type.   # noqa: E501

        :param fields: The fields of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
    ...
    def internal_name(self):
        """Gets the internal_name of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The internal_name of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_name(self, internal_name):
        """Sets the internal_name of this POSTCreateOpenPaymentMethodTypeRequest.

        A string to identify the custom payment method type in the API name of the payment method type.  This field must be alphanumeric, starting with a capital letter, excluding JSON preserved characters such as  * \\ ’ ”. Additionally, '_' or '-' is not allowed.  This field must be unique in a tenant.  This field is used along with the `tenantId` field by the system to construct and generate the API name of the custom payment method type in the following way:  `<internalName>__c_<tenantId>`  For example, if `internalName` is `AmazonPay`, and `tenantId` is `12368`, the API name of the custom payment method type will be `AmazonPay__c_12368`.  This field cannot be updated after the creation of the custom payment method type.   # noqa: E501

        :param internal_name: The internal_name of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and internal_name is None:
            raise ValueError("Invalid value for `internal_name`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                internal_name is not None and len(internal_name) > 19):
            raise ValueError("Invalid value for `internal_name`, length must be less than or equal to `19`")  # noqa: E501

        self._internal_name = internal_name

    @property
    def label(self):
        """Gets the label of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The label of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this POSTCreateOpenPaymentMethodTypeRequest.

        The label that is used to refer to this type in the Zuora UI.  This value must be alphanumeric, excluding JSON preserved characters such as  * \\ ’ ”    # noqa: E501

        :param label: The label of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and label is None:
            raise ValueError("Invalid value for `label`, must not be `None`")  # noqa: E501
        if (self._configuration.client_side_validation and
                label is not None and len(label) > 40):
            raise ValueError("Invalid value for `label`, length must be less than or equal to `40`")  # noqa: E501

        self._label = label

    @property
    def method_reference_id_field(self):
        """Gets the method_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The method_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def method_reference_id_field(self, method_reference_id_field):
        """Sets the method_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.

        The identification reference of the custom payment method.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Payment Method Data Source Exports and Data Query.  This field cannot be updated after the creation of the custom payment method type.   # noqa: E501

        :param method_reference_id_field: The method_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
        if self._configuration.client_side_validation and method_reference_id_field is None:
    ...
    def sub_type_field(self):
        """Gets the sub_type_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The sub_type_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_type_field(self, sub_type_field):
        """Sets the sub_type_field of this POSTCreateOpenPaymentMethodTypeRequest.

        The identification reference indicating the subtype of the custom payment method.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Data Source Exports and Data Query.  This field cannot be updated after the creation of the custom payment method type.   # noqa: E501

        :param sub_type_field: The sub_type_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tenant_id(self):
        """Gets the tenant_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The tenant_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def tenant_id(self, tenant_id):
        """Sets the tenant_id of this POSTCreateOpenPaymentMethodTypeRequest.

        Zuora tenant ID. If multi-entity is enabled in your tenant, this is the ID of the parent tenant of all the sub entities.  This field cannot be updated after the creation of the custom payment method type.   # noqa: E501

        :param tenant_id: The tenant_id of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
    ...
    def user_reference_id_field(self):
        """Gets the user_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        ...
        :return: The user_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def user_reference_id_field(self, user_reference_id_field):
        """Sets the user_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.

        The identification reference of the user or customer account.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Data Source Exports and Data Query.  This field cannot be updated after the creation of the custom payment method type.   # noqa: E501

        :param user_reference_id_field: The user_reference_id_field of this POSTCreateOpenPaymentMethodTypeRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(POSTCreateOpenPaymentMethodTypeRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTCreateOpenPaymentMethodTypeRequest):
            return False
