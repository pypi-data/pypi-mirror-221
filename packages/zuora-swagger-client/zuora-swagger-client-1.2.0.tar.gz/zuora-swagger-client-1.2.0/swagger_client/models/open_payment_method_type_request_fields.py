...
class OpenPaymentMethodTypeRequestFields(object):
    ...
    def __init__(self, checksum=None, default_value=None, description=None, editable=None, index=None, label=None, max_length=None, min_length=None, name=None, representer=None, required=None, type=None, visible=None, _configuration=None):  # noqa: E501
