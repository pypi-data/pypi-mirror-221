...
class CreateTemplateRequestContent(object):
    ...
    def __init__(self, content=None, custom_fields=None, custom_objects=None, description=None, name=None, notifications=None, selected_components=None, settings=None, template_tenant=None, workflows=None, _configuration=None):  # noqa: E501
    ...
    def template_tenant(self, template_tenant):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and template_tenant is None:
