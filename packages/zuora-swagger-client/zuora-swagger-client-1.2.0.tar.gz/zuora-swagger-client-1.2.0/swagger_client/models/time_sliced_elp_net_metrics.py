...
class TimeSlicedElpNetMetrics(object):
    ...
    def __init__(self, amount=None, end_date=None, generated_reason=None, invoice_owner=None, order_item_id=None, start_date=None, subscription_owner=None, tax=None, term_number=None, type=None, _configuration=None):  # noqa: E501
