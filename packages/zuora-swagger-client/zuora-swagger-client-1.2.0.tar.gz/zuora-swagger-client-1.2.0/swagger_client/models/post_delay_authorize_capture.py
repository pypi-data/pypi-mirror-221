...
class POSTDelayAuthorizeCapture(object):
    ...
    swagger_types = {
        ...
        'account_number': 'str',
        'amount': 'float',
        'gateway_options': 'POSTDelayAuthorizeCaptureGatewayOptions',
    ...
    def __init__(self, account_id=None, account_number=None, amount=None, gateway_options=None, gateway_order_id=None, mit_transaction_source=None, payment_gateway_id=None, soft_descriptor=None, soft_descriptor_phone=None, _configuration=None):  # noqa: E501
    ...
    def gateway_options(self):
        """Gets the gateway_options of this POSTDelayAuthorizeCapture.  # noqa: E501


        :return: The gateway_options of this POSTDelayAuthorizeCapture.  # noqa: E501
        :rtype: POSTDelayAuthorizeCaptureGatewayOptions
        """
        return self._gateway_options

    @gateway_options.setter
    def gateway_options(self, gateway_options):
        """Sets the gateway_options of this POSTDelayAuthorizeCapture.


        :param gateway_options: The gateway_options of this POSTDelayAuthorizeCapture.  # noqa: E501
        :type: POSTDelayAuthorizeCaptureGatewayOptions
        """
    ...
    def gateway_order_id(self, gateway_order_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and gateway_order_id is None:
    ...
    def mit_transaction_source(self):
        """Gets the mit_transaction_source of this POSTDelayAuthorizeCapture.  # noqa: E501
        ...
        :return: The mit_transaction_source of this POSTDelayAuthorizeCapture.  # noqa: E501
        :rtype: str
        """
    ...
    def mit_transaction_source(self, mit_transaction_source):
        """Sets the mit_transaction_source of this POSTDelayAuthorizeCapture.

        Payment transaction source used to differentiate the transaction source in Stored Credential Transaction framework.   - `C_Unscheduled`: Cardholder-initiated transaction (CIT) that does not occur on scheduled or regularly occurring dates.   - `M_Recurring`: Merchant-initiated transaction (MIT) that occurs at regular intervals.   - `M_Unscheduled`: Merchant-initiated transaction (MIT) that does not occur on scheduled or regularly occurring dates.   - `M_MOTO`: Mail Order Telephone Order (MOTO) payment transaction. This option is only available for credit card payments on Stripe v2. See [Overview of Stripe payment gateway integration](https://knowledgecenter.zuora.com/Zuora_Collect/Payment_gateway_integrations/Supported_payment_gateways/Stripe_Payment_Gateway/A_Overview_of_Stripe_payment_gateway_integration) for more information.   # noqa: E501

        :param mit_transaction_source: The mit_transaction_source of this POSTDelayAuthorizeCapture.  # noqa: E501
        :type: str
        """
        allowed_values = ["C_Unscheduled", "M_Recurring", "M_Unscheduled", "M_MOTO"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mit_transaction_source not in allowed_values):
            raise ValueError(
    ...
    def payment_gateway_id(self):
        """Gets the payment_gateway_id of this POSTDelayAuthorizeCapture.  # noqa: E501

        The ID of the payment gateway instance.  # noqa: E501

        :return: The payment_gateway_id of this POSTDelayAuthorizeCapture.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_gateway_id(self, payment_gateway_id):
        """Sets the payment_gateway_id of this POSTDelayAuthorizeCapture.

        The ID of the payment gateway instance.  # noqa: E501

        :param payment_gateway_id: The payment_gateway_id of this POSTDelayAuthorizeCapture.  # noqa: E501
        :type: str
        """
