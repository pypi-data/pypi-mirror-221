...
class RampIntervalChargeMetrics(object):
    ...
    def __init__(self, charge_number=None, discount_tcb=None, discount_tcv=None, end_date=None, gross_tcb=None, gross_tcv=None, mrr=None, net_tcb=None, net_tcv=None, product_rate_plan_charge_id=None, quantity=None, rate_plan_charge_id=None, start_date=None, subscription_number=None, _configuration=None):  # noqa: E501
