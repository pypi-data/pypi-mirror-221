...
class TemplateDetailResponse(object):
    ...
    def __init__(self, active=None, content=None, created_by=None, created_on=None, description=None, entity_name=None, environment=None, errors=None, id=None, name=None, status=None, tenant_name=None, _configuration=None):  # noqa: E501
