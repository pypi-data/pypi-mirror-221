...
class UpdateTask(object):
    ...
    def __init__(self, action_type=None, call_type=None, concurrent_limit=None, id=None, name=None, object=None, object_id=None, status=None, tags=None, workflow_id=None, _configuration=None):  # noqa: E501
