...
class EventTrigger(object):
    ...
    def __init__(self, active=None, base_object=None, condition=None, description=None, event_type=None, id=None, _configuration=None):  # noqa: E501
    ...
    def base_object(self, base_object):
        ...
        if (self._configuration.client_side_validation and
                base_object is not None and len(base_object) > 100):
            raise ValueError("Invalid value for `base_object`, length must be less than or equal to `100`")  # noqa: E501
        if (self._configuration.client_side_validation and
                base_object is not None and len(base_object) < 1):
            raise ValueError("Invalid value for `base_object`, length must be greater than or equal to `1`")  # noqa: E501
