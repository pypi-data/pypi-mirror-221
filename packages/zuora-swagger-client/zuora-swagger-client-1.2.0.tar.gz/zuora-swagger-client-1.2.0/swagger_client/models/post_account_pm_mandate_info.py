...
class POSTAccountPMMandateInfo(object):
    ...
    def existing_mandate_status(self):
        """Gets the existing_mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501

        Indicates whether the mandate is an existing mandate.   # noqa: E501

        :return: The existing_mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def existing_mandate_status(self, existing_mandate_status):
        """Sets the existing_mandate_status of this POSTAccountPMMandateInfo.

        Indicates whether the mandate is an existing mandate.   # noqa: E501

        :param existing_mandate_status: The existing_mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
        allowed_values = ["Yes", "No"]  # noqa: E501
        if (self._configuration.client_side_validation and
                existing_mandate_status not in allowed_values):
            raise ValueError(
    ...
    def mandate_creation_date(self):
        """Gets the mandate_creation_date of this POSTAccountPMMandateInfo.  # noqa: E501

        The date on which the mandate was created.   # noqa: E501

        :return: The mandate_creation_date of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: date
        """
    ...
    def mandate_creation_date(self, mandate_creation_date):
        """Sets the mandate_creation_date of this POSTAccountPMMandateInfo.

        The date on which the mandate was created.   # noqa: E501

        :param mandate_creation_date: The mandate_creation_date of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: date
        """
    ...
    @property
    def mandate_id(self):
        """Gets the mandate_id of this POSTAccountPMMandateInfo.  # noqa: E501

        The mandate ID.   # noqa: E501

        :return: The mandate_id of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mandate_id(self, mandate_id):
        """Sets the mandate_id of this POSTAccountPMMandateInfo.

        The mandate ID.   # noqa: E501

        :param mandate_id: The mandate_id of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mandate_reason(self):
        """Gets the mandate_reason of this POSTAccountPMMandateInfo.  # noqa: E501

        The reason of the mandate from the gateway side.   # noqa: E501

        :return: The mandate_reason of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mandate_reason(self, mandate_reason):
        """Sets the mandate_reason of this POSTAccountPMMandateInfo.

        The reason of the mandate from the gateway side.   # noqa: E501

        :param mandate_reason: The mandate_reason of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mandate_received_status(self):
        """Gets the mandate_received_status of this POSTAccountPMMandateInfo.  # noqa: E501

        Indicates whether the mandate is received from the gateway   # noqa: E501

        :return: The mandate_received_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mandate_received_status(self, mandate_received_status):
        """Sets the mandate_received_status of this POSTAccountPMMandateInfo.

        Indicates whether the mandate is received from the gateway   # noqa: E501

        :param mandate_received_status: The mandate_received_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
        allowed_values = ["Yes", "No"]  # noqa: E501
        if (self._configuration.client_side_validation and
                mandate_received_status not in allowed_values):
            raise ValueError(
    ...
    def mandate_status(self):
        """Gets the mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501

        The status of the mandate from the gateway side.   # noqa: E501

        :return: The mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mandate_status(self, mandate_status):
        """Sets the mandate_status of this POSTAccountPMMandateInfo.

        The status of the mandate from the gateway side.   # noqa: E501

        :param mandate_status: The mandate_status of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mandate_update_date(self):
        """Gets the mandate_update_date of this POSTAccountPMMandateInfo.  # noqa: E501

        The date on which the mandate was updated.   # noqa: E501

        :return: The mandate_update_date of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: date
        """
    ...
    def mandate_update_date(self, mandate_update_date):
        """Sets the mandate_update_date of this POSTAccountPMMandateInfo.

        The date on which the mandate was updated.   # noqa: E501

        :param mandate_update_date: The mandate_update_date of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: date
        """
    ...
    def mit_consent_agreement_ref(self):
        """Gets the mit_consent_agreement_ref of this POSTAccountPMMandateInfo.  # noqa: E501

        Reference for the consent agreement that you have established with the customer.     # noqa: E501

        :return: The mit_consent_agreement_ref of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mit_consent_agreement_ref(self, mit_consent_agreement_ref):
        """Sets the mit_consent_agreement_ref of this POSTAccountPMMandateInfo.

        Reference for the consent agreement that you have established with the customer.     # noqa: E501

        :param mit_consent_agreement_ref: The mit_consent_agreement_ref of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mit_consent_agreement_src(self):
        """Gets the mit_consent_agreement_src of this POSTAccountPMMandateInfo.  # noqa: E501
        ...
        :return: The mit_consent_agreement_src of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mit_consent_agreement_src(self, mit_consent_agreement_src):
        """Sets the mit_consent_agreement_src of this POSTAccountPMMandateInfo.

        Required if you set the `mitProfileAction` field. Specify how the consent agreement has been established with the customer. The allowed value is `External`. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `External` set to this field.   # noqa: E501

        :param mit_consent_agreement_src: The mit_consent_agreement_src of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mit_profile_action(self, mit_profile_action):
        """Sets the mit_profile_action of this POSTAccountPMMandateInfo.

        Specifies how Zuora creates and activates the stored credential profile. Only applicable if you set the `status` field to `Active`.  * `Activate` (default) - Use this value if you are creating the stored credential profile after receiving the customer's consent.    Zuora will create the stored credential profile then send a cardholder-initiated transaction (CIT) to the payment gateway to validate the stored credential profile. If the CIT succeeds, the status of the stored credential profile will be `Active`. If the CIT does not succeed, Zuora will not create a stored credential profile.      If the payment gateway does not support the stored credential transaction framework, the status of the stored credential profile will be `Agreed`.   * `Persist` - Use this value if the stored credential profile represents a stored credential profile in an external system. The status of the payment method's stored credential profile will be `Active`.  If you do not specify this field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Activate` set to this field.   # noqa: E501

        :param mit_profile_action: The mit_profile_action of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mit_profile_agreed_on(self):
        """Gets the mit_profile_agreed_on of this POSTAccountPMMandateInfo.  # noqa: E501

        The date on which the stored credential profile is agreed. The date format is `yyyy-mm-dd`.   # noqa: E501

        :return: The mit_profile_agreed_on of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: date
        """
    ...
    def mit_profile_agreed_on(self, mit_profile_agreed_on):
        """Sets the mit_profile_agreed_on of this POSTAccountPMMandateInfo.

        The date on which the stored credential profile is agreed. The date format is `yyyy-mm-dd`.   # noqa: E501

        :param mit_profile_agreed_on: The mit_profile_agreed_on of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: date
        """
    ...
    def mit_profile_type(self):
        """Gets the mit_profile_type of this POSTAccountPMMandateInfo.  # noqa: E501
        ...
        :return: The mit_profile_type of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mit_profile_type(self, mit_profile_type):
        """Sets the mit_profile_type of this POSTAccountPMMandateInfo.

        Indicates the type of the stored credential profile. If you do not specify the `mitProfileAction` field, Zuora will automatically create a stored credential profile for the payment method, with the default value `Recurring` set to this field.   # noqa: E501

        :param mit_profile_type: The mit_profile_type of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
    ...
    def mit_transaction_id(self):
        """Gets the mit_transaction_id of this POSTAccountPMMandateInfo.  # noqa: E501

        Specifies the ID of the transaction. Only applicable if you set the `mitProfileAction` field to `Persist`.   # noqa: E501

        :return: The mit_transaction_id of this POSTAccountPMMandateInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def mit_transaction_id(self, mit_transaction_id):
        """Sets the mit_transaction_id of this POSTAccountPMMandateInfo.

        Specifies the ID of the transaction. Only applicable if you set the `mitProfileAction` field to `Persist`.   # noqa: E501

        :param mit_transaction_id: The mit_transaction_id of this POSTAccountPMMandateInfo.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(POSTAccountPMMandateInfo, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTAccountPMMandateInfo):
            return False
