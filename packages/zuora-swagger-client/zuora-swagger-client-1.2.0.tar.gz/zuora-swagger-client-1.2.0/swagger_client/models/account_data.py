...
class AccountData(object):
    ...
    def __init__(self, account_number=None, auto_pay=None, batch=None, bill_cycle_day=None, bill_to_contact=None, communication_profile_id=None, credit_memo_template_id=None, crm_id=None, currency=None, custom_fields=None, debit_memo_template_id=None, invoice_template_id=None, name=None, notes=None, payment_method=None, payment_term=None, purchase_order_number=None, sequence_set_id=None, sold_to_contact=None, tax_info=None, _configuration=None):  # noqa: E501
