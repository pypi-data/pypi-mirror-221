...
class PostBillingPreviewRunParam(object):
    ...
    def __init__(self, assume_renewal=None, batch=None, batches=None, charge_type_to_exclude=None, including_draft_items=None, including_evergreen_subscription=None, storage_option=None, target_date=None, _configuration=None):  # noqa: E501
    ...
    def batch(self, batch):
        ...
        if (self._configuration.client_side_validation and
                batch is not None and len(batch) > 255):
    ...
    @property
    def batches(self):
        """Gets the batches of this PostBillingPreviewRunParam.  # noqa: E501
        ...
        :return: The batches of this PostBillingPreviewRunParam.  # noqa: E501
        :rtype: str
        """
    ...
    def batches(self, batches):
        """Sets the batches of this PostBillingPreviewRunParam.

        The customer batches to include in the billing preview run. You can specify multiple batches separated by comma. If not specified, all customer batches are included.  **Note**: This field is only available if you set the `zuora-version` request header to `314.0` or later.   # noqa: E501

        :param batches: The batches of this PostBillingPreviewRunParam.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                batches is not None and len(batches) > 1000):
            raise ValueError("Invalid value for `batches`, length must be less than or equal to `1000`")  # noqa: E501
    ...
    def including_draft_items(self):
        """Gets the including_draft_items of this PostBillingPreviewRunParam.  # noqa: E501
        ...
        :return: The including_draft_items of this PostBillingPreviewRunParam.  # noqa: E501
        :rtype: bool
        """
    ...
    def including_draft_items(self, including_draft_items):
        """Sets the including_draft_items of this PostBillingPreviewRunParam.

        Whether draft document items are included in the billing preview run. By default, draft document items are not included.  This field loads draft invoice items and credit memo items. The `chargeTypeToExclude`, `targetDate`, `includingEvergreenSubscription`, and `assumeRenewal` fields do not affect the behavior of the `includingDraftItems` field.   # noqa: E501

        :param including_draft_items: The including_draft_items of this PostBillingPreviewRunParam.  # noqa: E501
        :type: bool
        """
    ...
    def storage_option(self):
        """Gets the storage_option of this PostBillingPreviewRunParam.  # noqa: E501

        The saving options. The default value is `Csv`.        # noqa: E501

        :return: The storage_option of this PostBillingPreviewRunParam.  # noqa: E501
        :rtype: str
        """
    ...
    def storage_option(self, storage_option):
        """Sets the storage_option of this PostBillingPreviewRunParam.

        The saving options. The default value is `Csv`.        # noqa: E501

        :param storage_option: The storage_option of this PostBillingPreviewRunParam.  # noqa: E501
        :type: str
        """
        allowed_values = ["Csv", "Database"]  # noqa: E501
        if (self._configuration.client_side_validation and
                storage_option not in allowed_values):
            raise ValueError(
                "Invalid value for `storage_option` ({0}), must be one of {1}"  # noqa: E501
                .format(storage_option, allowed_values)
            )
    ...
    def target_date(self, target_date):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and target_date is None:
