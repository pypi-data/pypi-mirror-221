...
class CreditMemoTaxItemFromInvoiceTaxItemType(object):
    ...
    def __init__(self, amount=None, finance_information=None, jurisdiction=None, location_code=None, source_tax_item_id=None, tax_code=None, tax_code_description=None, tax_date=None, tax_exempt_amount=None, tax_name=None, tax_rate=None, tax_rate_description=None, tax_rate_type=None, _configuration=None):  # noqa: E501
    ...
    def tax_rate_type(self, tax_rate_type):
        ...
        if (self._configuration.client_side_validation and
                tax_rate_type not in allowed_values):
            raise ValueError(
