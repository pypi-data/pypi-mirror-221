...
class BatchesQueries(object):
    ...
    def __init__(self, api_version=None, batch_id=None, batch_type=None, deleted=None, full=None, name=None, query=None, record_count=None, status=None, _configuration=None):  # noqa: E501
        """BatchesQueries - a model defined in Swagger"""  # noqa: E501
    ...
    def api_version(self):
        """Gets the api_version of this BatchesQueries.  # noqa: E501
        ...
        :return: The api_version of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        """Sets the api_version of this BatchesQueries.

        The API version for the query. If an API version is not specified, the latest version is used by default. Using the latest WSDL version is most useful for reporting use cases. For integration purposes, specify the WSDL version to ensure consistent query behavior, that is, what is supported and included in the response returned by the API.  **Note**: As of API version 69 and later, Zuora changed the format of certain fields. See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/G_SOAP_API/AB_Getting_started_with_the__SOAP_API/C_Date_Field_Changes_in_the_SOAP_API\" target=\"_blank\">Date Field Changes in the SOAP API</a> for more information and a list of affected fields.   # noqa: E501

        :param api_version: The api_version of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def batch_id(self):
        """Gets the batch_id of this BatchesQueries.  # noqa: E501

        A 32-character ID of the query batch.   # noqa: E501

        :return: The batch_id of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
    ...
    def batch_id(self, batch_id):
        """Sets the batch_id of this BatchesQueries.

        A 32-character ID of the query batch.   # noqa: E501

        :param batch_id: The batch_id of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def batch_type(self):
        """Gets the batch_type of this BatchesQueries.  # noqa: E501

        The kind of batch job being submitted.   # noqa: E501

        :return: The batch_type of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
    ...
    def batch_type(self, batch_type):
        """Sets the batch_type of this BatchesQueries.

        The kind of batch job being submitted.   # noqa: E501

        :param batch_type: The batch_type of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def deleted(self):
        """Gets the deleted of this BatchesQueries.  # noqa: E501

        This field indicates that the AQuA incremental load will retrieve deleted records.  **Note**: AQuA API is subject to Zuora Data Retention Policy. The retention period of deleted data is 30 days. You can only retrieve deleted data for 30 days through AQuA.   # noqa: E501

        :return: The deleted of this BatchesQueries.  # noqa: E501
        :rtype: list[DeletedRecord1]
        """
        return self._deleted

    @deleted.setter
    def deleted(self, deleted):
        """Sets the deleted of this BatchesQueries.

        This field indicates that the AQuA incremental load will retrieve deleted records.  **Note**: AQuA API is subject to Zuora Data Retention Policy. The retention period of deleted data is 30 days. You can only retrieve deleted data for 30 days through AQuA.   # noqa: E501

        :param deleted: The deleted of this BatchesQueries.  # noqa: E501
        :type: list[DeletedRecord1]
        """
    ...
    @property
    def full(self):
        """Gets the full of this BatchesQueries.  # noqa: E501

        This field indicates a full or incremental load. `True` = Full and `False` = Incremental.             # noqa: E501

        :return: The full of this BatchesQueries.  # noqa: E501
        :rtype: bool
        """
        return self._full
    ...
    @full.setter
    def full(self, full):
        """Sets the full of this BatchesQueries.

        This field indicates a full or incremental load. `True` = Full and `False` = Incremental.             # noqa: E501

        :param full: The full of this BatchesQueries.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def name(self):
        """Gets the name of this BatchesQueries.  # noqa: E501

        Name of the query supplied in the request.   # noqa: E501

        :return: The name of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this BatchesQueries.

        Name of the query supplied in the request.   # noqa: E501

        :param name: The name of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def query(self):
        """Gets the query of this BatchesQueries.  # noqa: E501

        The requested query string.   # noqa: E501

        :return: The query of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
        return self._query
    ...
    def query(self, query):
        """Sets the query of this BatchesQueries.

        The requested query string.   # noqa: E501

        :param query: The query of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    def record_count(self):
        """Gets the record_count of this BatchesQueries.  # noqa: E501

        The number of records included in the query output file.   # noqa: E501

        :return: The record_count of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
    ...
    def record_count(self, record_count):
        """Sets the record_count of this BatchesQueries.

        The number of records included in the query output file.   # noqa: E501

        :param record_count: The record_count of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this BatchesQueries.  # noqa: E501
        ...
        :return: The status of this BatchesQueries.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this BatchesQueries.

        The status of the batch execution: - pending: The query was validated and submitted to the query executor for processing. - executing: The query is being processed. - completed: The query was successfully executed. - aborted: The query execution failed. - cancelled: The query was not processed.   # noqa: E501

        :param status: The status of this BatchesQueries.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BatchesQueries, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchesQueries):
            return False
