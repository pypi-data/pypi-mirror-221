...
class CreateOrderChargeOverrideBilling(object):
    ...
    def __init__(self, bill_cycle_day=None, bill_cycle_type=None, billing_period=None, billing_period_alignment=None, billing_timing=None, specific_billing_period=None, weekly_bill_cycle_day=None, _configuration=None):  # noqa: E501
        """CreateOrderChargeOverrideBilling - a model defined in Swagger"""  # noqa: E501
    ...
    def bill_cycle_day(self):
        """Gets the bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: int
        """
    ...
    def bill_cycle_day(self, bill_cycle_day):
        """Sets the bill_cycle_day of this CreateOrderChargeOverrideBilling.

        Day of the month that each billing period begins on. Only applicable if the value of the `billCycleType` field is `SpecificDayofMonth`.   # noqa: E501

        :param bill_cycle_day: The bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: int
        """
    ...
    def bill_cycle_type(self):
        """Gets the bill_cycle_type of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The bill_cycle_type of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_cycle_type(self, bill_cycle_type):
        """Sets the bill_cycle_type of this CreateOrderChargeOverrideBilling.

        Specifies how Zuora determines the day that each billing period begins on.    * `DefaultFromCustomer` - Each billing period begins on the bill cycle day of the account that owns the subscription.   * `SpecificDayofMonth` - Use the `billCycleDay` field to specify the day of the month that each billing period begins on.   * `SubscriptionStartDay` - Each billing period begins on the same day of the month as the start date of the subscription.   * `ChargeTriggerDay` - Each billing period begins on the same day of the month as the date when the charge becomes active.   * `SpecificDayofWeek` - Use the `weeklyBillCycleDay` field to specify the day of the week that each billing period begins on.   # noqa: E501

        :param bill_cycle_type: The bill_cycle_type of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: str
        """
    ...
    def billing_period(self):
        """Gets the billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period(self, billing_period):
        """Sets the billing_period of this CreateOrderChargeOverrideBilling.

        Billing frequency of the charge. The value of this field controls the duration of each billing period.  If the value of this field is `Specific_Months` or `Specific_Weeks`, use the `specificBillingPeriod` field to specify the duration of each billing period.   # noqa: E501

        :param billing_period: The billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: str
        """
        allowed_values = ["Month", "Quarter", "Semi_Annual", "Annual", "Eighteen_Months", "Two_Years", "Three_Years", "Five_Years", "Specific_Months", "Subscription_Term", "Week", "Specific_Weeks", "Specific_Days"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def billing_period_alignment(self):
        """Gets the billing_period_alignment of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The billing_period_alignment of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_period_alignment(self, billing_period_alignment):
        """Sets the billing_period_alignment of this CreateOrderChargeOverrideBilling.

        Specifies how Zuora determines when to start new billing periods. You can use this field to align the billing periods of different charges.  * `AlignToCharge` - Zuora starts a new billing period on the first billing day that falls on or after the date when the charge becomes active. * `AlignToSubscriptionStart` - Zuora starts a new billing period on the first billing day that falls on or after the start date of the subscription. * `AlignToTermStart` - For each term of the subscription, Zuora starts a new billing period on the first billing day that falls on or after the start date of the term.  See the `billCycleType` field for information about how Zuora determines the billing day.   # noqa: E501

        :param billing_period_alignment: The billing_period_alignment of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: str
        """
    ...
    def billing_timing(self):
        """Gets the billing_timing of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The billing_timing of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_timing(self, billing_timing):
        """Sets the billing_timing of this CreateOrderChargeOverrideBilling.

        Specifies whether to invoice for a billing period on the first day of the billing period (billing in advance) or the first day of the next billing period (billing in arrears).   # noqa: E501

        :param billing_timing: The billing_timing of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: str
        """
    ...
    def specific_billing_period(self):
        """Gets the specific_billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The specific_billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: int
        """
    ...
    def specific_billing_period(self, specific_billing_period):
        """Sets the specific_billing_period of this CreateOrderChargeOverrideBilling.

        Duration of each billing period in months or weeks, depending on the value of the `billingPeriod` field. Only applicable if the value of the `billingPeriod` field is `Specific_Months` or `Specific_Weeks`.   # noqa: E501

        :param specific_billing_period: The specific_billing_period of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: int
        """
    ...
    def weekly_bill_cycle_day(self):
        """Gets the weekly_bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        ...
        :return: The weekly_bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :rtype: str
        """
    ...
    def weekly_bill_cycle_day(self, weekly_bill_cycle_day):
        """Sets the weekly_bill_cycle_day of this CreateOrderChargeOverrideBilling.

        Day of the week that each billing period begins on. Only applicable if the value of the `billCycleType` field is `SpecificDayofWeek`.   # noqa: E501

        :param weekly_bill_cycle_day: The weekly_bill_cycle_day of this CreateOrderChargeOverrideBilling.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateOrderChargeOverrideBilling, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrderChargeOverrideBilling):
            return False
