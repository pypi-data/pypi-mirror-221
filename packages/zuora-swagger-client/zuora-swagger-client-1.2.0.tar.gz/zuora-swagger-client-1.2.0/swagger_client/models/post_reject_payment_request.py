...
class POSTRejectPaymentRequest(object):
    ...
    def __init__(self, gateway_reconciliation_reason=None, gateway_reconciliation_status=None, gateway_response=None, gateway_response_code=None, reference_id=None, second_reference_id=None, settled_on=None, _configuration=None):  # noqa: E501
        """POSTRejectPaymentRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def gateway_reconciliation_reason(self):
        """Gets the gateway_reconciliation_reason of this POSTRejectPaymentRequest.  # noqa: E501

        The reason of gateway reconciliation.   # noqa: E501

        :return: The gateway_reconciliation_reason of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_reconciliation_reason(self, gateway_reconciliation_reason):
        """Sets the gateway_reconciliation_reason of this POSTRejectPaymentRequest.

        The reason of gateway reconciliation.   # noqa: E501

        :param gateway_reconciliation_reason: The gateway_reconciliation_reason of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def gateway_reconciliation_status(self):
        """Gets the gateway_reconciliation_status of this POSTRejectPaymentRequest.  # noqa: E501

        The status of gateway reconciliation.   # noqa: E501

        :return: The gateway_reconciliation_status of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_reconciliation_status(self, gateway_reconciliation_status):
        """Sets the gateway_reconciliation_status of this POSTRejectPaymentRequest.

        The status of gateway reconciliation.   # noqa: E501

        :param gateway_reconciliation_status: The gateway_reconciliation_status of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def gateway_response(self):
        """Gets the gateway_response of this POSTRejectPaymentRequest.  # noqa: E501
        ...
        :return: The gateway_response of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_response(self, gateway_response):
        """Sets the gateway_response of this POSTRejectPaymentRequest.

        The transaction response returned by the gateway for this transaction. If the transaction was declined, this reason is provided in the message.   # noqa: E501

        :param gateway_response: The gateway_response of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def gateway_response_code(self):
        """Gets the gateway_response_code of this POSTRejectPaymentRequest.  # noqa: E501

        Response message Code returned by the gateway about the transaction status.   # noqa: E501

        :return: The gateway_response_code of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def gateway_response_code(self, gateway_response_code):
        """Sets the gateway_response_code of this POSTRejectPaymentRequest.

        Response message Code returned by the gateway about the transaction status.   # noqa: E501

        :param gateway_response_code: The gateway_response_code of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def reference_id(self):
        """Gets the reference_id of this POSTRejectPaymentRequest.  # noqa: E501

        Unique Id generated by the gateway for each transaction. Use this ID to find the respective Zuora Payment ID.    # noqa: E501

        :return: The reference_id of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def reference_id(self, reference_id):
        """Sets the reference_id of this POSTRejectPaymentRequest.

        Unique Id generated by the gateway for each transaction. Use this ID to find the respective Zuora Payment ID.    # noqa: E501

        :param reference_id: The reference_id of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def second_reference_id(self):
        """Gets the second_reference_id of this POSTRejectPaymentRequest.  # noqa: E501

        The second reference Id. Some gateway uses two unique transaction IDs.   # noqa: E501

        :return: The second_reference_id of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def second_reference_id(self, second_reference_id):
        """Sets the second_reference_id of this POSTRejectPaymentRequest.

        The second reference Id. Some gateway uses two unique transaction IDs.   # noqa: E501

        :param second_reference_id: The second_reference_id of this POSTRejectPaymentRequest.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    @property
    def settled_on(self):
        """Gets the settled_on of this POSTRejectPaymentRequest.  # noqa: E501

        The date and time of the transaction settlement. The format is `yyyy-mm-dd hh:mm:ss`.   # noqa: E501

        :return: The settled_on of this POSTRejectPaymentRequest.  # noqa: E501
        :rtype: datetime
        """
    ...
    def settled_on(self, settled_on):
        """Sets the settled_on of this POSTRejectPaymentRequest.

        The date and time of the transaction settlement. The format is `yyyy-mm-dd hh:mm:ss`.   # noqa: E501

        :param settled_on: The settled_on of this POSTRejectPaymentRequest.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(POSTRejectPaymentRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, POSTRejectPaymentRequest):
            return False
