...
class GETAccountSummaryType(object):
    ...
    def __init__(self, basic_info=None, bill_to_contact=None, invoices=None, payments=None, sold_to_contact=None, subscriptions=None, success=None, tax_info=None, usage=None, _configuration=None):  # noqa: E501
