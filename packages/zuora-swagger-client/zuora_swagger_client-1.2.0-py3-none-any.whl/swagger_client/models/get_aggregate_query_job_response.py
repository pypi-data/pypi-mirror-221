...
class GetAggregateQueryJobResponse(object):
    ...
    """
    swagger_types = {
        'batches': 'list[BatchesQueriesById]',
        'encrypted': 'str',
        'format': 'str',
        'id': 'str',
        'name': 'str',
    ...
    def __init__(self, batches=None, encrypted=None, format=None, id=None, name=None, partner=None, project=None, start_time=None, status=None, version=None, _configuration=None):  # noqa: E501
        """GetAggregateQueryJobResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def batches(self):
        """Gets the batches of this GetAggregateQueryJobResponse.  # noqa: E501

        A JSON array object that contains a list of batch objects.   # noqa: E501

        :return: The batches of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: list[BatchesQueriesById]
        """
        return self._batches

    @batches.setter
    def batches(self, batches):
        """Sets the batches of this GetAggregateQueryJobResponse.

        A JSON array object that contains a list of batch objects.   # noqa: E501

        :param batches: The batches of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: list[BatchesQueriesById]
        """
    ...
    @property
    def encrypted(self):
        """Gets the encrypted of this GetAggregateQueryJobResponse.  # noqa: E501

        If enabled, you must supply the formatting (zip or unzip) first and decrypt it to get the actual contents.           # noqa: E501

        :return: The encrypted of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def encrypted(self, encrypted):
        """Sets the encrypted of this GetAggregateQueryJobResponse.

        If enabled, you must supply the formatting (zip or unzip) first and decrypt it to get the actual contents.           # noqa: E501

        :param encrypted: The encrypted of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def format(self):
        """Gets the format of this GetAggregateQueryJobResponse.  # noqa: E501

        The format of the query. The default value is `csv`.   # noqa: E501

        :return: The format of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this GetAggregateQueryJobResponse.

        The format of the query. The default value is `csv`.   # noqa: E501

        :param format: The format of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this GetAggregateQueryJobResponse.  # noqa: E501
        ...
        :return: The id of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GetAggregateQueryJobResponse.

        The job ID created for the AQuA API request. The job ID can be used for querying for the query status.   The ID exists only if the JSON request can be parsed and validated successfully. Otherwise, the job ID is null.   # noqa: E501

        :param id: The id of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this GetAggregateQueryJobResponse.  # noqa: E501

        The name of the job. 32 character limit.   # noqa: E501

        :return: The name of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GetAggregateQueryJobResponse.

        The name of the job. 32 character limit.   # noqa: E501

        :param name: The name of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def partner(self):
        """Gets the partner of this GetAggregateQueryJobResponse.  # noqa: E501
        ...
        :return: The partner of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def partner(self, partner):
        """Sets the partner of this GetAggregateQueryJobResponse.

        The partner field indicates the unique ID of a data integration partner. The dropdown list of this field displays partner IDs for the past thirty days.  It must be used together with \"project\" field to uniquely identify a data integration target.  For example, if a continuous AQuA session is to retrieve data incrementally for a Salesforce.com Org 00170000011K3Ub, you can use partner as \"Salesforce\", and \"project\" as \"00170000011K3Ub.\"   This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null.  **Note**: Zuora highly recommends you use the stateless mode instead of the stateful mode to extract bulk data. See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/Bulk_data__extraction_from_Zuora_using_AQuA\" target=\"_blank\">Bulk data extraction from Zuora using AQuA</a> for best practices.  **Note**: Submit a request at <a href=\"http://support.zuora.com\" target=\"_blank\">Zuora Global Support</a> to obtain a partner ID.   # noqa: E501

        :param partner: The partner of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def project(self):
        """Gets the project of this GetAggregateQueryJobResponse.  # noqa: E501
        ...
        :return: The project of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def project(self, project):
        """Sets the project of this GetAggregateQueryJobResponse.

        The project field contains the unique ID of a data integration project for a particular partner. The dropdown list of this field displays project IDs for the past thirty days.  This field must be used together with partner field to uniquely identify a data integration target.   This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null.   # noqa: E501

        :param project: The project of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def start_time(self):
        """Gets the start_time of this GetAggregateQueryJobResponse.  # noqa: E501

        The start time of the query.    # noqa: E501

        :return: The start_time of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this GetAggregateQueryJobResponse.

        The start time of the query.    # noqa: E501

        :param start_time: The start_time of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this GetAggregateQueryJobResponse.  # noqa: E501
        ...
        :return: The status of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this GetAggregateQueryJobResponse.

        The status of the batch execution: - pending: The query was validated and submitted to the query executor for processing. - executing: The query is being processed. - completed: The query was successfully executed. - aborted: The query execution failed. - cancelled: The query was not processed.   # noqa: E501

        :param status: The status of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this GetAggregateQueryJobResponse.  # noqa: E501
        ...
        :return: The version of this GetAggregateQueryJobResponse.  # noqa: E501
        :rtype: float
        """
    ...
    def version(self, version):
        """Sets the version of this GetAggregateQueryJobResponse.

        The API version you want to use.   The supported versions are as follows:   - `1.1`. It supports both modes   - `1.0`. Default. It supports stateless modes only.  See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/BA_Stateless_and_Stateful_Modes\" target=\"_blank\">Stateless and stateful modes</a> for more information.   # noqa: E501

        :param version: The version of this GetAggregateQueryJobResponse.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetAggregateQueryJobResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetAggregateQueryJobResponse):
            return False
