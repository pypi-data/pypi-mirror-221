...
class GETPaymentItemPartTypewithSuccess(object):
    ...
    def __init__(self, amount=None, created_by_id=None, created_date=None, debit_memo_item_id=None, id=None, invoice_item_id=None, tax_item_id=None, updated_by_id=None, updated_date=None, _configuration=None):  # noqa: E501
