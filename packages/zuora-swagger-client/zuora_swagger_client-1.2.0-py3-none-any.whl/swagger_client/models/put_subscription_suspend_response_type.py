...
class PUTSubscriptionSuspendResponseType(object):
    ...
    def __init__(self, credit_memo_id=None, invoice_id=None, paid_amount=None, payment_id=None, resume_date=None, subscription_id=None, success=None, suspend_date=None, term_end_date=None, total_delta_tcv=None, _configuration=None):  # noqa: E501
