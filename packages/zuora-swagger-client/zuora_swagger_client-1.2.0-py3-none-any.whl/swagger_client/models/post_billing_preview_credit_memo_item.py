...
class POSTBillingPreviewCreditMemoItem(object):
    ...
    def __init__(self, amount=None, amount_without_tax=None, applied_to_item_id=None, charge_date=None, charge_number=None, charge_type=None, comment=None, id=None, processing_type=None, quantity=None, rate_plan_charge_id=None, service_end_date=None, service_start_date=None, sku=None, sku_name=None, subscription_id=None, subscription_number=None, unit_of_measure=None, _configuration=None):  # noqa: E501
