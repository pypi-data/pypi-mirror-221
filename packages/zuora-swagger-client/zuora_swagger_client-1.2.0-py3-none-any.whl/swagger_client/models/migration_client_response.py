...
class MigrationClientResponse(object):
    ...
    def __init__(self, email_ids=None, environment=None, id=None, migrated_by=None, migration_description=None, migration_end=None, migration_name=None, migration_start=None, response=None, source_tenant_description=None, source_tenant_name=None, status=None, type=None, _configuration=None):  # noqa: E501
    ...
    def migrated_by(self, migrated_by):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and migrated_by is None:
    ...
    def migration_description(self, migration_description):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and migration_description is None:
    ...
    def migration_end(self, migration_end):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and migration_end is None:
    ...
    def migration_name(self, migration_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and migration_name is None:
    ...
    def migration_start(self, migration_start):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and migration_start is None:
    ...
    def source_tenant_description(self, source_tenant_description):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and source_tenant_description is None:
    ...
    def source_tenant_name(self, source_tenant_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and source_tenant_name is None:
