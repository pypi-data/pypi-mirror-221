...
class PUTSrpRemoveType(object):
    ...
    def __init__(self, booking_date=None, contract_effective_date=None, customer_acceptance_date=None, external_catalog_plan_id=None, external_id_source_system=None, product_rate_plan_number=None, rate_plan_id=None, service_activation_date=None, subscription_rate_plan_number=None, _configuration=None):  # noqa: E501
    ...
    def booking_date(self):
        """Gets the booking_date of this PUTSrpRemoveType.  # noqa: E501
        ...
        :return: The booking_date of this PUTSrpRemoveType.  # noqa: E501
        :rtype: date
        """
    ...
    def booking_date(self, booking_date):
        """Sets the booking_date of this PUTSrpRemoveType.

        The booking date that you want to set for the amendment contract. The booking date of an amendment is the equivalent of the order date of an order. This field must be in the `yyyy-mm-dd` format. The default value is the current date when you make the API call.    # noqa: E501

        :param booking_date: The booking_date of this PUTSrpRemoveType.  # noqa: E501
        :type: date
        """
    ...
    def contract_effective_date(self, contract_effective_date):
        ...
        :type: date
        """
        if self._configuration.client_side_validation and contract_effective_date is None:
    ...
    def external_catalog_plan_id(self):
        """Gets the external_catalog_plan_id of this PUTSrpRemoveType.  # noqa: E501
        ...
        :return: The external_catalog_plan_id of this PUTSrpRemoveType.  # noqa: E501
        :rtype: str
        """
    ...
    def external_catalog_plan_id(self, external_catalog_plan_id):
        """Sets the external_catalog_plan_id of this PUTSrpRemoveType.

        An external ID of the rate plan to be removed. You can use this field to specify an existing rate plan in your subscription. The value of the `externalCatalogPlanId` field must match one of the values that are predefined in the `externallyManagedPlanIds` field on a product rate plan. However, if there are multiple rate plans with the same `productRatePlanId` value existing in the subscription, you must use the `ratePlanId` field to remove the rate plan. The `externalCatalogPlanId` field cannot be used to distinguish multiple rate plans in this case.  **Note:** If both `externalCatalogPlanId` and `ratePlanId` are provided. They must point to the same product rate plan. Otherwise, the request would fail.   # noqa: E501

        :param external_catalog_plan_id: The external_catalog_plan_id of this PUTSrpRemoveType.  # noqa: E501
        :type: str
        """
    ...
    def external_id_source_system(self):
        """Gets the external_id_source_system of this PUTSrpRemoveType.  # noqa: E501
        ...
        :return: The external_id_source_system of this PUTSrpRemoveType.  # noqa: E501
        :rtype: str
        """
    ...
    def external_id_source_system(self, external_id_source_system):
        """Sets the external_id_source_system of this PUTSrpRemoveType.

        The ID of the external source system. You can use this field and `externalCatalogPlanId` to specify a product rate plan that is imported from an external system.  **Note:** If both `externalCatalogPlanId`, `externalIdSourceSystem` and `productRatePlanId` are provided. They must point to the same product rate plan. Otherwise, the request would fail.   # noqa: E501

        :param external_id_source_system: The external_id_source_system of this PUTSrpRemoveType.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_number(self):
        """Gets the product_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501

        Number of a product rate plan for this subscription.   # noqa: E501

        :return: The product_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_number(self, product_rate_plan_number):
        """Sets the product_rate_plan_number of this PUTSrpRemoveType.

        Number of a product rate plan for this subscription.   # noqa: E501

        :param product_rate_plan_number: The product_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501
        :type: str
        """
    ...
    def subscription_rate_plan_number(self):
        """Gets the subscription_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501

        Number of a rate plan for this subscription.   # noqa: E501

        :return: The subscription_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_rate_plan_number(self, subscription_rate_plan_number):
        """Sets the subscription_rate_plan_number of this PUTSrpRemoveType.

        Number of a rate plan for this subscription.   # noqa: E501

        :param subscription_rate_plan_number: The subscription_rate_plan_number of this PUTSrpRemoveType.  # noqa: E501
        :type: str
        """
