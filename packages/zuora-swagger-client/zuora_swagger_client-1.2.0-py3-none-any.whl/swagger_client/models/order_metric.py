...
class OrderMetric(object):
    ...
    def __init__(self, charge_number=None, elp=None, mrr=None, origin_rate_plan_id=None, product_rate_plan_charge_id=None, product_rate_plan_id=None, quantity=None, tcb=None, tcv=None, _configuration=None):  # noqa: E501
