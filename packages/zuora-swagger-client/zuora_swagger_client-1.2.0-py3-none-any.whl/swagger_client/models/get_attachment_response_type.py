...
class GETAttachmentResponseType(object):
    ...
    def __init__(self, created_by=None, created_on=None, description=None, file_content_type=None, file_id=None, file_name=None, id=None, success=None, updated_by=None, updated_on=None, _configuration=None):  # noqa: E501
