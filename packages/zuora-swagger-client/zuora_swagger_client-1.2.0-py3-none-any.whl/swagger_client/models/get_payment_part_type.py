...
class GETPaymentPartType(object):
    ...
    def __init__(self, amount=None, created_by_id=None, created_date=None, debit_memo_id=None, id=None, invoice_id=None, success=None, updated_by_id=None, updated_date=None, _configuration=None):  # noqa: E501
