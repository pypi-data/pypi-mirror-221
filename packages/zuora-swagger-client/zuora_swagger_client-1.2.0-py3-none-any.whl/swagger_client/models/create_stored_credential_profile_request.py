...
class CreateStoredCredentialProfileRequest(object):
    ...
    def __init__(self, action=None, agreed_on=None, auth_gateway=None, card_security_code=None, consent_agreement_ref=None, consent_agreement_src=None, network_transaction_id=None, status=None, type=None, _configuration=None):  # noqa: E501
    ...
    def consent_agreement_src(self):
        ...
        Specifies how the consent agreement has been established with the customer. The allowed value is `External`.   # noqa: E501
    ...
    def consent_agreement_src(self, consent_agreement_src):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and consent_agreement_src is None:
            raise ValueError("Invalid value for `consent_agreement_src`, must not be `None`")  # noqa: E501
        allowed_values = ["External"]  # noqa: E501
        if (self._configuration.client_side_validation and
                consent_agreement_src not in allowed_values):
            raise ValueError(
    ...
    def type(self):
        ...
        Indicates the type of the stored credential profile to process recurring or unsecheduled transactions.   # noqa: E501
