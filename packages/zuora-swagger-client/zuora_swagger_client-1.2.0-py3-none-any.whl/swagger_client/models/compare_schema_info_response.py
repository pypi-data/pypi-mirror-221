...
class CompareSchemaInfoResponse(object):
    ...
    def __init__(self, custom_fields=None, custom_objects=None, data_access_control=None, meta_data=None, notifications=None, product_catalog=None, settings=None, workflows=None, _configuration=None):  # noqa: E501
