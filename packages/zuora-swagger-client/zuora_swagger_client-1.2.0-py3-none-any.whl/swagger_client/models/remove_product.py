...
class RemoveProduct(object):
    ...
    def __init__(self, external_catalog_plan_id=None, product_rate_plan_number=None, rate_plan_id=None, subscription_offer_id=None, subscription_offer_number=None, subscription_offer_unique_token=None, subscription_rate_plan_number=None, unique_token=None, _configuration=None):  # noqa: E501
    ...
    def external_catalog_plan_id(self):
        """Gets the external_catalog_plan_id of this RemoveProduct.  # noqa: E501
        ...
        :return: The external_catalog_plan_id of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def external_catalog_plan_id(self, external_catalog_plan_id):
        """Sets the external_catalog_plan_id of this RemoveProduct.

        An external ID of the rate plan to be removed. You can use this field to specify an existing rate plan in your subscription. The value of the `externalCatalogPlanId` field must match one of the values that are predefined in the `externallyManagedPlanIds` field on a product rate plan. However, if there are multiple rate plans with the same `productRatePlanId` value existing in the subscription, you must use the `ratePlanId` field to remove the rate plan. The `externalCatalogPlanId` field cannot be used to distinguish multiple rate plans in this case.  **Note:** If both `externalCatalogPlanId` and `ratePlanId` are provided. They must point to the same product rate plan. Otherwise, the request would fail.   # noqa: E501

        :param external_catalog_plan_id: The external_catalog_plan_id of this RemoveProduct.  # noqa: E501
        :type: str
        """
    ...
    def product_rate_plan_number(self):
        """Gets the product_rate_plan_number of this RemoveProduct.  # noqa: E501

        Number of a product rate plan for this subscription.   # noqa: E501

        :return: The product_rate_plan_number of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_number(self, product_rate_plan_number):
        """Sets the product_rate_plan_number of this RemoveProduct.

        Number of a product rate plan for this subscription.   # noqa: E501

        :param product_rate_plan_number: The product_rate_plan_number of this RemoveProduct.  # noqa: E501
        :type: str
        """
    ...
    def subscription_offer_id(self):
        """Gets the subscription_offer_id of this RemoveProduct.  # noqa: E501
        ...
        :return: The subscription_offer_id of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_offer_id(self, subscription_offer_id):
        """Sets the subscription_offer_id of this RemoveProduct.

        Internal identifier of the subscription offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :param subscription_offer_id: The subscription_offer_id of this RemoveProduct.  # noqa: E501
        :type: str
        """
    ...
    def subscription_offer_number(self):
        """Gets the subscription_offer_number of this RemoveProduct.  # noqa: E501

        Number of the subscription offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :return: The subscription_offer_number of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_offer_number(self, subscription_offer_number):
        """Sets the subscription_offer_number of this RemoveProduct.

        Number of the subscription offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :param subscription_offer_number: The subscription_offer_number of this RemoveProduct.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                subscription_offer_number is not None and len(subscription_offer_number) > 100):
            raise ValueError("Invalid value for `subscription_offer_number`, length must be less than or equal to `100`")  # noqa: E501

        self._subscription_offer_number = subscription_offer_number

    @property
    def subscription_offer_unique_token(self):
        """Gets the subscription_offer_unique_token of this RemoveProduct.  # noqa: E501

        Unique identifier of the subscription offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :return: The subscription_offer_unique_token of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_offer_unique_token(self, subscription_offer_unique_token):
        """Sets the subscription_offer_unique_token of this RemoveProduct.

        Unique identifier of the subscription offer.   **Note**: You must enable the Offers feature to access this field. The Offers feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :param subscription_offer_unique_token: The subscription_offer_unique_token of this RemoveProduct.  # noqa: E501
        :type: str
        """
    ...
    def subscription_rate_plan_number(self):
        """Gets the subscription_rate_plan_number of this RemoveProduct.  # noqa: E501

        Number of a rate plan for this subscription.   # noqa: E501

        :return: The subscription_rate_plan_number of this RemoveProduct.  # noqa: E501
        :rtype: str
        """
    ...
    def subscription_rate_plan_number(self, subscription_rate_plan_number):
        """Sets the subscription_rate_plan_number of this RemoveProduct.

        Number of a rate plan for this subscription.   # noqa: E501

        :param subscription_rate_plan_number: The subscription_rate_plan_number of this RemoveProduct.  # noqa: E501
        :type: str
        """
