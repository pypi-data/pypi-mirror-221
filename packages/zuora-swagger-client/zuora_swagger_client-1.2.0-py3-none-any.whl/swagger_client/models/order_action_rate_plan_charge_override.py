...
class OrderActionRatePlanChargeOverride(object):
    ...
    def __init__(self, billing=None, charge_number=None, custom_fields=None, description=None, end_date=None, pricing=None, product_rate_plan_charge_id=None, rev_rec_code=None, rev_rec_trigger_condition=None, revenue_recognition_rule_name=None, start_date=None, unique_token=None, _configuration=None):  # noqa: E501
    ...
    def revenue_recognition_rule_name(self, revenue_recognition_rule_name):
        ...
        if (self._configuration.client_side_validation and
                revenue_recognition_rule_name not in allowed_values):
            raise ValueError(
