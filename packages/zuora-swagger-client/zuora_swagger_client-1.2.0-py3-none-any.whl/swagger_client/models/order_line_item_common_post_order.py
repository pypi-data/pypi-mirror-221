...
class OrderLineItemCommonPostOrder(object):
    ...
    def amount_per_unit(self):
        ...
        The actual charged amount per unit for the Order Line Item.  If you set the `inlineDiscountType`, `inlineDiscountPerUnit`, and `listPricePerUnit` fields, the system will automatically generate the `amountPerUnit` field. You shall not set the `amountPerUnit` field by yourself.   # noqa: E501
    ...
    @property
    def bill_to(self):
        """Gets the bill_to of this OrderLineItemCommonPostOrder.  # noqa: E501
        ...
        :return: The bill_to of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def bill_to(self, bill_to):
        """Sets the bill_to of this OrderLineItemCommonPostOrder.

        The ID of a contact that belongs to the billing account of the order line item. Use this field to assign an existing account as the bill-to contact of an order line item.   # noqa: E501

        :param bill_to: The bill_to of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def billing_rule(self):
        """Gets the billing_rule of this OrderLineItemCommonPostOrder.  # noqa: E501

        The billing rule for the Order Line Item.   # noqa: E501

        :return: The billing_rule of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_rule(self, billing_rule):
        """Sets the billing_rule of this OrderLineItemCommonPostOrder.

        The billing rule for the Order Line Item.   # noqa: E501

        :param billing_rule: The billing_rule of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def inline_discount_per_unit(self):
        """Gets the inline_discount_per_unit of this OrderLineItemCommonPostOrder.  # noqa: E501
        ...
        :return: The inline_discount_per_unit of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: float
        """
    ...
    def inline_discount_per_unit(self, inline_discount_per_unit):
        """Sets the inline_discount_per_unit of this OrderLineItemCommonPostOrder.

        Use this field in accordance with the `inlineDiscountType` field, in the following manner: * If the `inlineDiscountType` field is set as `Percentage`, this field specifies the discount percentage for each unit of the order line item. For exmaple, if you specify `5` in this field, the discount percentage is 5%. * If the `inlineDiscountType` field is set as `FixedAmount`, this field specifies the discount amount on each unit of the order line item. For exmaple, if you specify `10` in this field, the discount amount on each unit of the order line item is 10.  Once you set the `inlineDiscountType`, `inlineDiscountPerUnit`, and `listPricePerUnit` fields, the system will automatically generate the `amountPerUnit` field. You shall not set the `amountPerUnit` field by yourself.   # noqa: E501

        :param inline_discount_per_unit: The inline_discount_per_unit of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: float
        """
    ...
    def inline_discount_type(self):
        """Gets the inline_discount_type of this OrderLineItemCommonPostOrder.  # noqa: E501
        ...
        :return: The inline_discount_type of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def inline_discount_type(self, inline_discount_type):
        """Sets the inline_discount_type of this OrderLineItemCommonPostOrder.

        Use this field to specify the inline discount type, which can be `Percentage`, `FixedAmount`, or `None`. The default value is `Percentage`.  Use this field together with the `inlineDiscountPerUnit` field to specify inline discounts for order line items. The inline discount is applied to the list price of an order line item.   Once you set the `inlineDiscountType`, `inlineDiscountPerUnit`, and `listPricePerUnit` fields, the system will automatically generate the `amountPerUnit` field. You shall not set the `amountPerUnit` field by yourself.   # noqa: E501

        :param inline_discount_type: The inline_discount_type of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def is_allocation_eligible(self):
        """Gets the is_allocation_eligible of this OrderLineItemCommonPostOrder.  # noqa: E501
        ...
        :return: The is_allocation_eligible of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_allocation_eligible(self, is_allocation_eligible):
        """Sets the is_allocation_eligible of this OrderLineItemCommonPostOrder.

        This field is used to identify if the charge segment is allocation eligible in revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :param is_allocation_eligible: The is_allocation_eligible of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: bool
        """
    ...
    def is_unbilled(self):
        """Gets the is_unbilled of this OrderLineItemCommonPostOrder.  # noqa: E501

        This field is used to dictate how to perform the accounting during revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :return: The is_unbilled of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_unbilled(self, is_unbilled):
        """Sets the is_unbilled of this OrderLineItemCommonPostOrder.

        This field is used to dictate how to perform the accounting during revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :param is_unbilled: The is_unbilled of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: bool
        """
    ...
    def item_category(self):
        """Gets the item_category of this OrderLineItemCommonPostOrder.  # noqa: E501

        The category for the Order Line Item, to indicate a product sale or return.   # noqa: E501

        :return: The item_category of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def item_category(self, item_category):
        """Sets the item_category of this OrderLineItemCommonPostOrder.

        The category for the Order Line Item, to indicate a product sale or return.   # noqa: E501

        :param item_category: The item_category of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def original_order_line_item_number(self):
        """Gets the original_order_line_item_number of this OrderLineItemCommonPostOrder.  # noqa: E501

        The number of the original sale order line item for a return order line item.    # noqa: E501

        :return: The original_order_line_item_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def original_order_line_item_number(self, original_order_line_item_number):
        """Sets the original_order_line_item_number of this OrderLineItemCommonPostOrder.

        The number of the original sale order line item for a return order line item.    # noqa: E501

        :param original_order_line_item_number: The original_order_line_item_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def original_order_number(self):
        """Gets the original_order_number of this OrderLineItemCommonPostOrder.  # noqa: E501

        The number of the original sale order for a return order line item.    # noqa: E501

        :return: The original_order_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def original_order_number(self, original_order_number):
        """Sets the original_order_number of this OrderLineItemCommonPostOrder.

        The number of the original sale order for a return order line item.    # noqa: E501

        :param original_order_number: The original_order_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def owner_account_number(self):
        """Gets the owner_account_number of this OrderLineItemCommonPostOrder.  # noqa: E501

        Use this field to assign an existing account as the owner of an order line item.   # noqa: E501

        :return: The owner_account_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def owner_account_number(self, owner_account_number):
        """Sets the owner_account_number of this OrderLineItemCommonPostOrder.

        Use this field to assign an existing account as the owner of an order line item.   # noqa: E501

        :param owner_account_number: The owner_account_number of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def sequence_set_id(self):
        """Gets the sequence_set_id of this OrderLineItemCommonPostOrder.  # noqa: E501
        ...
        :return: The sequence_set_id of this OrderLineItemCommonPostOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def sequence_set_id(self, sequence_set_id):
        """Sets the sequence_set_id of this OrderLineItemCommonPostOrder.

        The ID of the sequence set associated with the OrderLineItem.    **Note**: If you have the [Flexible Billing Attributes](https://knowledgecenter.zuora.com/Billing/Subscriptions/Flexible_Billing_Attributes) feature disabled, this field is unavailable in the request body and the value of this field is `null` in the response body.   # noqa: E501

        :param sequence_set_id: The sequence_set_id of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
    ...
    def sold_to(self, sold_to):
        """Sets the sold_to of this OrderLineItemCommonPostOrder.

        Use this field to assign an existing account as the sold-to contact of an order line item, by the following rules:  * If the `ownerAccountNumber` field is set, then this field must be the ID of a contact that belongs to the owner account of the order line item.  * If the `ownerAccountNumber` field is not set, then this field must be the ID of a contact that belongs to the billing account of the order line item.   # noqa: E501

        :param sold_to: The sold_to of this OrderLineItemCommonPostOrder.  # noqa: E501
        :type: str
        """
