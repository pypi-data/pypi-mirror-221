...
class CustomObjectDefinition(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, id=None, updated_by_id=None, updated_date=None, schema=None, type=None, _configuration=None):  # noqa: E501
