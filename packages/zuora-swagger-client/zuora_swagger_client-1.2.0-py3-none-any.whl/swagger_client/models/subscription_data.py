...
class SubscriptionData(object):
    ...
    def __init__(self, custom_fields=None, invoice_separately=None, notes=None, rate_plans=None, start_date=None, subscription_number=None, terms=None, _configuration=None):  # noqa: E501
