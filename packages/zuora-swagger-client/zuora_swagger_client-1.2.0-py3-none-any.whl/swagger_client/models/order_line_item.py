...
class OrderLineItem(object):
    ...
    swagger_types = {
        ...
        'fulfillments': 'list[FulfillmentGet]'
    }
    ...
    def fulfillments(self):
        """Gets the fulfillments of this OrderLineItem.  # noqa: E501

        Container for the fulfillments attached to an order line item.   # noqa: E501

        :return: The fulfillments of this OrderLineItem.  # noqa: E501
        :rtype: list[FulfillmentGet]
        """
        return self._fulfillments

    @fulfillments.setter
    def fulfillments(self, fulfillments):
        """Sets the fulfillments of this OrderLineItem.

        Container for the fulfillments attached to an order line item.   # noqa: E501

        :param fulfillments: The fulfillments of this OrderLineItem.  # noqa: E501
        :type: list[FulfillmentGet]
        """
