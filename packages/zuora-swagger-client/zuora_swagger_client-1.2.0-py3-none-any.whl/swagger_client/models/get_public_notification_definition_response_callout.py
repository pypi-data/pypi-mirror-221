...
class GETPublicNotificationDefinitionResponseCallout(object):
    ...
    def __init__(self, active=True, callout_auth=None, callout_baseurl=None, callout_params=None, callout_retry=True, description=None, event_type_name=None, http_method=None, id=None, name=None, required_auth=None, _configuration=None):  # noqa: E501
