...
class SubmitBatchQueryRequest(object):
    ...
    def __init__(self, date_time_utc=None, format=None, incremental_time=None, name=None, notify_url=None, null_replacement=None, offset=None, partner=None, project=None, queries=None, use_query_labels=None, version=None, _configuration=None):  # noqa: E501
        """SubmitBatchQueryRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def date_time_utc(self):
        """Gets the date_time_utc of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The date_time_utc of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def date_time_utc(self, date_time_utc):
        """Sets the date_time_utc of this SubmitBatchQueryRequest.

        When using WSDL 69 and later you can ensure that the exported output of dateTime records are rendered according to ISO-8601 generic UTC form by setting `dateTimeUtc` to `true`.  When `dateTimeUtc` is set to `true`, exports of dateTime data types will be rendered in the following generic format: `YYYY-MM-DDThh:mm:ss-hhmm` or `YYYY-MM-DDThh:mm:ss+hhmm`.  **Note**: Regardless of what batchType query is used (`zoql` or `zoqlexport`), the query response output for datetime data types can be standardized by setting dateTimeUtc to `true`. When `true`, the results will display datetime types with the format: YYYY-MM-DDThh:mm:ss+/-hhmm.   # noqa: E501

        :param date_time_utc: The date_time_utc of this SubmitBatchQueryRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def format(self):
        """Gets the format of this SubmitBatchQueryRequest.  # noqa: E501

        The format of the query. The default value is `csv`.   # noqa: E501

        :return: The format of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
        return self._format
    ...
    def format(self, format):
        """Sets the format of this SubmitBatchQueryRequest.

        The format of the query. The default value is `csv`.   # noqa: E501

        :param format: The format of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    def incremental_time(self):
        """Gets the incremental_time of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The incremental_time of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def incremental_time(self, incremental_time):
        """Sets the incremental_time of this SubmitBatchQueryRequest.

        Allows you to override the time from which a Stateful AQuA job incrementally retrieves records that have been created or modified, using the `incrementalTime` parameter. For example, if you set `incrementalTime` = `2015-01-21 10:30:01`, AQuA will retrieve records that have created or modified beginning at 10:30:01. If this parameter is not set, AQuA continues to use the Start Time of the last AQuA session to retrieve records incrementally.  The time zone of `incrementalTime` depends on which Zuora data center you use. For US Data Center customers, the time zone of `incrementalTime` is Pacific Time. For EU Data Center customers, the time zone of `incrementalTime` is UTC. If the time zone of your system is different from the time zone of `incrementalTime`, you will need to convert to the appropriate time zone before setting `incrementalTime`.  **Note**: This field can only be used in Stateful AQuA mode.   # noqa: E501

        :param incremental_time: The incremental_time of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this SubmitBatchQueryRequest.  # noqa: E501

        The name of the job. 32 character limit.   # noqa: E501

        :return: The name of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SubmitBatchQueryRequest.

        The name of the job. 32 character limit.   # noqa: E501

        :param name: The name of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def notify_url(self):
        """Gets the notify_url of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The notify_url of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def notify_url(self, notify_url):
        """Sets the notify_url of this SubmitBatchQueryRequest.

        If URL is provided, the AQuA job will call this `notifyUrl` once the job has completed. The value of `notifyUrl` needs to have `${JOBID}` and `${STATUS}` placeholders. These placeholders will be replaced by the actual job ID and status when returned in the response. Status will be `Completed` after the AQuA job is done.  If you submit an AQuA query with `notifyUrl` specified, the value of `notifyUrl` will be ignored if your organization has already <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/Callout_Notification_for_Completed_AQuA_Jobs\" target=\"_blank\">configured a callout notification through the Zuora user interface</a>.    # noqa: E501

        :param notify_url: The notify_url of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    def null_replacement(self):
        """Gets the null_replacement of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The null_replacement of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def null_replacement(self, null_replacement):
        """Sets the null_replacement of this SubmitBatchQueryRequest.

        The string used to represent null values in the query results. If you do not set this parameter, null values are represented by the empty string in the query results.   # noqa: E501

        :param null_replacement: The null_replacement of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def offset(self):
        """Gets the offset of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The offset of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: float
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this SubmitBatchQueryRequest.

        This field specifies the time offset for AQuA queries in stateful mode. It is an integer in the range 0 to 3,600 seconds.  For example, if you set this field to 600 seconds and you post a query in stateful mode at 2:00 AM, it will query against data created or updated between the completion time of the previous query and 1:50 AM.  The value of this field will override the value you configured in **Settings** > **Administration** > **AQuA API Stateful Mode Time Offset**.           # noqa: E501

        :param offset: The offset of this SubmitBatchQueryRequest.  # noqa: E501
        :type: float
        """
    ...
    @property
    def partner(self):
        """Gets the partner of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The partner of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def partner(self, partner):
        """Sets the partner of this SubmitBatchQueryRequest.

        The partner field indicates the unique ID of a data integration partner. The dropdown list of this field displays partner IDs for the past thirty days. It must be used together with \"project\" field to uniquely identify a data integration target.  For example, if a continuous AQuA session is to retrieve data incrementally for a Salesforce.com Org 00170000011K3Ub, you can use partner as \"Salesforce\", and \"project\" as \"00170000011K3Ub.\"  This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null.  **Note**: Zuora highly recommends you use the stateless mode instead of the stateful mode to extract bulk data. See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/Bulk_data__extraction_from_Zuora_using_AQuA\" target=\"_blank\">Bulk data extraction from Zuora using AQuA</a> for best practices. **Note**: Submit a request at <a href=\"http://support.zuora.com\" target=\"_blank\">Zuora Global Support</a> to obtain a partner ID.   # noqa: E501

        :param partner: The partner of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def project(self):
        """Gets the project of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The project of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def project(self, project):
        """Sets the project of this SubmitBatchQueryRequest.

        The project field contains the unique ID of a data integration project for a particular partner. The dropdown list of this field displays project IDs for the past thirty days.  This field must be used together with partner field to uniquely identify a data integration target.   This field is required only if you are using AQuA in stateful mode. Otherwise, if you are using AQuA in stateless mode, partner field can be null.   # noqa: E501

        :param project: The project of this SubmitBatchQueryRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def queries(self):
        """Gets the queries of this SubmitBatchQueryRequest.  # noqa: E501

        A JSON array object that contains a list of batch objects.   # noqa: E501

        :return: The queries of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: list[BatchQuery]
        """
        return self._queries

    @queries.setter
    def queries(self, queries):
        """Sets the queries of this SubmitBatchQueryRequest.

        A JSON array object that contains a list of batch objects.   # noqa: E501

        :param queries: The queries of this SubmitBatchQueryRequest.  # noqa: E501
        :type: list[BatchQuery]
        """
    ...
    def use_query_labels(self):
        """Gets the use_query_labels of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The use_query_labels of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_query_labels(self, use_query_labels):
        """Sets the use_query_labels of this SubmitBatchQueryRequest.

        When this optional flag is set to `true` the request will use object and field API names for the CSV header output instead of the field labels. Data integration projects should set `useQueryLabels` to `true` so that API names remain the same.  By default `useQueryLabels` is `false`, so that output CSV headers display the more user-friendly object and field labels.    # noqa: E501

        :param use_query_labels: The use_query_labels of this SubmitBatchQueryRequest.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def version(self):
        """Gets the version of this SubmitBatchQueryRequest.  # noqa: E501
        ...
        :return: The version of this SubmitBatchQueryRequest.  # noqa: E501
        :rtype: float
        """
    ...
    def version(self, version):
        """Sets the version of this SubmitBatchQueryRequest.

        The API version you want to use.   The supported versions are as follows:   - `1.1`. It supports both modes   - `1.0`. Default. It supports stateless modes only.  See <a href=\"https://knowledgecenter.zuora.com/Zuora_Central_Platform/API/AB_Aggregate_Query_API/BA_Stateless_and_Stateful_Modes\" target=\"_blank\">Stateless and stateful modes</a> for more information.   # noqa: E501

        :param version: The version of this SubmitBatchQueryRequest.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubmitBatchQueryRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubmitBatchQueryRequest):
            return False
