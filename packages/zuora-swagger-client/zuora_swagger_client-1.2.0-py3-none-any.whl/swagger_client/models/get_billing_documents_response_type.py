...
class GETBillingDocumentsResponseType(object):
    ...
    def __init__(self, account_id=None, amount=None, balance=None, document_date=None, document_number=None, document_type=None, id=None, status=None, _configuration=None):  # noqa: E501
