...
class POSTSubscriptionPreviewResponseType(object):
    ...
    def __init__(self, amount=None, amount_without_tax=None, charge_metrics=None, contracted_mrr=None, credit_memo=None, document_date=None, invoice=None, invoice_items=None, invoice_target_date=None, success=None, target_date=None, tax_amount=None, total_contracted_value=None, _configuration=None):  # noqa: E501
    ...
    def document_date(self):
        """Gets the document_date of this POSTSubscriptionPreviewResponseType.  # noqa: E501
        ...
        :return: The document_date of this POSTSubscriptionPreviewResponseType.  # noqa: E501
        :rtype: date
        """
    ...
    def document_date(self, document_date):
        """Sets the document_date of this POSTSubscriptionPreviewResponseType.

        The date of the billing document, in `yyyy-mm-dd` format. It represents the invoice date for invoices, credit memo date for credit memos, and debit memo date for debit memos.  - If this field is specified, the specified date is used as the billing document date.  - If this field is not specified, the date specified in the `targetDate` is used as the billing document date.   # noqa: E501

        :param document_date: The document_date of this POSTSubscriptionPreviewResponseType.  # noqa: E501
        :type: date
        """
