...
class CreditCard(object):
    ...
    def __init__(self, card_holder_info=None, card_number=None, card_type=None, expiration_month=None, expiration_year=None, security_code=None, _configuration=None):  # noqa: E501
    ...
    def card_type(self, card_type):
        ...
        if (self._configuration.client_side_validation and
                card_type not in allowed_values):
            raise ValueError(
    ...
    def expiration_month(self, expiration_month):
        ...
        """
        if (self._configuration.client_side_validation and
                expiration_month is not None and expiration_month > 12):  # noqa: E501
            raise ValueError("Invalid value for `expiration_month`, must be a value less than or equal to `12`")  # noqa: E501
        if (self._configuration.client_side_validation and
                expiration_month is not None and expiration_month < 1):  # noqa: E501
    ...
    def expiration_year(self, expiration_year):
        ...
        """
        if (self._configuration.client_side_validation and
                expiration_year is not None and expiration_year > 2500):  # noqa: E501
            raise ValueError("Invalid value for `expiration_year`, must be a value less than or equal to `2500`")  # noqa: E501
        if (self._configuration.client_side_validation and
                expiration_year is not None and expiration_year < 1980):  # noqa: E501
