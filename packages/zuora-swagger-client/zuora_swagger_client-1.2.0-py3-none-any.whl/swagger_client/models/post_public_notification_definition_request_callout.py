...
class POSTPublicNotificationDefinitionRequestCallout(object):
    ...
    def __init__(self, active=True, callout_auth=None, callout_baseurl=None, callout_params=None, callout_retry=True, description=None, event_type_name=None, http_method=None, name=None, required_auth=None, _configuration=None):  # noqa: E501
    ...
    def callout_baseurl(self, callout_baseurl):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and callout_baseurl is None:
    ...
    def event_type_name(self, event_type_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and event_type_name is None:
    ...
    def required_auth(self, required_auth):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and required_auth is None:
