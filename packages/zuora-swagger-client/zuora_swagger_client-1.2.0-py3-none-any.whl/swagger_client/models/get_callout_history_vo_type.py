...
class GETCalloutHistoryVOType(object):
    ...
    def __init__(self, attempted_num=None, create_time=None, event_category=None, event_context=None, notification=None, request_method=None, request_url=None, response_code=None, response_content=None, _configuration=None):  # noqa: E501
