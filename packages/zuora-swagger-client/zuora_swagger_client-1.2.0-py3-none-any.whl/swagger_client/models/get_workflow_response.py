...
class GetWorkflowResponse(object):
    ...
    def __init__(self, cpu_time=None, created_at=None, finished_at=None, id=None, messages=None, name=None, original_workflow_id=None, run_time=None, status=None, tasks=None, type=None, updated_at=None, _configuration=None):  # noqa: E501
