...
class PUTSubscriptionResumeType(object):
    ...
    def booking_date(self):
        """Gets the booking_date of this PUTSubscriptionResumeType.  # noqa: E501
        ...
        :return: The booking_date of this PUTSubscriptionResumeType.  # noqa: E501
        :rtype: date
        """
    ...
    def booking_date(self, booking_date):
        """Sets the booking_date of this PUTSubscriptionResumeType.

        The booking date that you want to set for the amendment contract when you resume the subscription. If `extendsTerm` is `true`, which means you also extend the term, then this field is also the booking date for the Terms and Conditions amendment contract.  This field must be in the `yyyy-mm-dd` format. The default value of this field is the current date when you make the API call.    # noqa: E501

        :param booking_date: The booking_date of this PUTSubscriptionResumeType.  # noqa: E501
        :type: date
        """
    ...
    @property
    def order_date(self):
        """Gets the order_date of this PUTSubscriptionResumeType.  # noqa: E501
        ...
        :return: The order_date of this PUTSubscriptionResumeType.  # noqa: E501
        :rtype: date
        """
    ...
    def order_date(self, order_date):
        """Sets the order_date of this PUTSubscriptionResumeType.

        The date when the order is signed. If no additinal contractEffectiveDate is provided, this order will use this order date as the contract effective date. This field must be in the `yyyy-mm-dd` format. This field is required for Orders customers only, not applicable to Orders Harmonization customers.   # noqa: E501

        :param order_date: The order_date of this PUTSubscriptionResumeType.  # noqa: E501
        :type: date
        """
    ...
    def resume_policy(self, resume_policy):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and resume_policy is None:
