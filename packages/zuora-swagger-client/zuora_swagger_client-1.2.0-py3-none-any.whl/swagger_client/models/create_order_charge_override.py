...
class CreateOrderChargeOverride(object):
    ...
    def billing(self):
        ...
        :rtype: CreateOrderChargeOverrideBilling
        """
    ...
    def is_allocation_eligible(self):
        """Gets the is_allocation_eligible of this CreateOrderChargeOverride.  # noqa: E501
        ...
        :return: The is_allocation_eligible of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_allocation_eligible(self, is_allocation_eligible):
        """Sets the is_allocation_eligible of this CreateOrderChargeOverride.

        This field is used to identify if the charge segment is allocation eligible in revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :param is_allocation_eligible: The is_allocation_eligible of this CreateOrderChargeOverride.  # noqa: E501
        :type: bool
        """
    ...
    def is_rollover(self):
        """Gets the is_rollover of this CreateOrderChargeOverride.  # noqa: E501
        ...
        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  The value is either \"True\" or \"False\". It determines whether the rollover fields are needed.   # noqa: E501
        ...
        :return: The is_rollover of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_rollover(self, is_rollover):
        """Sets the is_rollover of this CreateOrderChargeOverride.

        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  The value is either \"True\" or \"False\". It determines whether the rollover fields are needed.   # noqa: E501

        :param is_rollover: The is_rollover of this CreateOrderChargeOverride.  # noqa: E501
        :type: bool
        """
    ...
    def is_unbilled(self):
        """Gets the is_unbilled of this CreateOrderChargeOverride.  # noqa: E501

        This field is used to dictate how to perform the accounting during revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :return: The is_unbilled of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_unbilled(self, is_unbilled):
        """Sets the is_unbilled of this CreateOrderChargeOverride.

        This field is used to dictate how to perform the accounting during revenue recognition.  **Note**: This feature is in the **Early Adopter** phase. If you want to use the feature, submit a request at <a href=\"https://support.zuora.com/\" target=\"_blank\">Zuora Global Support</a>, and we will evaluate whether the feature is suitable for your use cases.   # noqa: E501

        :param is_unbilled: The is_unbilled of this CreateOrderChargeOverride.  # noqa: E501
        :type: bool
        """
    ...
    def pricing(self):
        ...
        :rtype: CreateOrderChargeOverridePricing
        """
    ...
    def product_rate_plan_charge_id(self, product_rate_plan_charge_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and product_rate_plan_charge_id is None:
    ...
    def product_rate_plan_charge_number(self):
        """Gets the product_rate_plan_charge_number of this CreateOrderChargeOverride.  # noqa: E501

        Number of a product rate-plan charge for this subscription.   # noqa: E501

        :return: The product_rate_plan_charge_number of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_charge_number(self, product_rate_plan_charge_number):
        """Sets the product_rate_plan_charge_number of this CreateOrderChargeOverride.

        Number of a product rate-plan charge for this subscription.   # noqa: E501

        :param product_rate_plan_charge_number: The product_rate_plan_charge_number of this CreateOrderChargeOverride.  # noqa: E501
        :type: str
        """
    ...
    def rev_rec_trigger_condition(self, rev_rec_trigger_condition):
        ...
        if (self._configuration.client_side_validation and
                rev_rec_trigger_condition not in allowed_values):
            raise ValueError(
    ...
    def rollover_apply(self):
        """Gets the rollover_apply of this CreateOrderChargeOverride.  # noqa: E501

        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  This field defines the priority of rollover, which is either first or last.   # noqa: E501

        :return: The rollover_apply of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: str
        """
    ...
    def rollover_apply(self, rollover_apply):
        """Sets the rollover_apply of this CreateOrderChargeOverride.

        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  This field defines the priority of rollover, which is either first or last.   # noqa: E501

        :param rollover_apply: The rollover_apply of this CreateOrderChargeOverride.  # noqa: E501
        :type: str
        """
        allowed_values = ["ApplyFirst", "ApplyLast"]  # noqa: E501
        if (self._configuration.client_side_validation and
                rollover_apply not in allowed_values):
            raise ValueError(
    ...
    def rollover_periods(self):
        """Gets the rollover_periods of this CreateOrderChargeOverride.  # noqa: E501

        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  This field defines the number of rollover periods, it is restricted to 3.   # noqa: E501

        :return: The rollover_periods of this CreateOrderChargeOverride.  # noqa: E501
        :rtype: float
        """
    ...
    def rollover_periods(self, rollover_periods):
        """Sets the rollover_periods of this CreateOrderChargeOverride.

        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  To use this field, you must set the `X-Zuora-WSDL-Version` request header to 114 or higher. Otherwise, an error occurs.  This field defines the number of rollover periods, it is restricted to 3.   # noqa: E501

        :param rollover_periods: The rollover_periods of this CreateOrderChargeOverride.  # noqa: E501
        :type: float
        """
    ...
    def validity_period_type(self, validity_period_type):
        ...
        **Note**: This field is only available if you have the [Prepaid with Drawdown](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown) feature enabled.  The period in which the prepayment units are valid to use as defined in a [prepayment charge](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/J_Billing_Operations/Prepaid_with_Drawdown/Create_prepayment_charge).   # noqa: E501
        ...
        if (self._configuration.client_side_validation and
                validity_period_type not in allowed_values):
            raise ValueError(
