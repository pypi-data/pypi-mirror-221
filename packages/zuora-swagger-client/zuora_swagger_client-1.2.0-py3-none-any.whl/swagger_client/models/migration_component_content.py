...
class MigrationComponentContent(object):
    ...
    swagger_types = {
        'attribute': 'str',
        'component_type': 'str',
        'current_target_response': 'JsonNode',
        'description': 'str',
        'disabled': 'str',
        'error_message': 'str',
        'http_methods': 'str',
        ...
        'migration_id': 'str',
        'path_pattern': 'str',
        'previous_target_response': 'JsonNode',
        'result': 'str',
        'segregation_key': 'str',
        'source_response': 'JsonNode',
        'status': 'str',
        'update_status': 'str'
    }
    ...
    def current_target_response(self):
        ...
        Current Target Response to be migrated.  # noqa: E501
    ...
    def previous_target_response(self):
        ...
        It caches the previous target response, which can be helpful if you want to revert the migration.  # noqa: E501
