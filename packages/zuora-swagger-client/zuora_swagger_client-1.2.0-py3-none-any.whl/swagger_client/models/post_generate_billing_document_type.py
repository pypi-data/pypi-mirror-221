...
class PostGenerateBillingDocumentType(object):
    ...
    def __init__(self, auto_post=False, auto_renew=False, charge_type_to_exclude=None, credit_memo_reason_code=None, effective_date=None, subscription_ids=None, target_date=None, _configuration=None):  # noqa: E501
    ...
    def credit_memo_reason_code(self):
        """Gets the credit_memo_reason_code of this PostGenerateBillingDocumentType.  # noqa: E501
        ...
        :return: The credit_memo_reason_code of this PostGenerateBillingDocumentType.  # noqa: E501
        :rtype: str
        """
    ...
    def credit_memo_reason_code(self, credit_memo_reason_code):
        """Sets the credit_memo_reason_code of this PostGenerateBillingDocumentType.

        A code identifying the reason for the credit memo transaction that is generated by the request. The value must be an existing reason code. If you do not pass the field or pass the field with empty value, Zuora uses the default reason code.  # noqa: E501

        :param credit_memo_reason_code: The credit_memo_reason_code of this PostGenerateBillingDocumentType.  # noqa: E501
        :type: str
        """
