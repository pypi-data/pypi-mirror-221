...
class GETOfferProductRatePlanCharge(object):
    ...
    """
    swagger_types = {
        'charge_configuration': 'GETOfferChargeConfiguration',
        'description': 'str',
        'id': 'str',
        'model': 'str',
        'name': 'str',
        'number': 'str',
        'price_book_items': 'list[GETOfferPriceBookItem]',
    ...
    attribute_map = {
        'charge_configuration': 'chargeConfiguration',
        'description': 'description',
        'id': 'id',
        'model': 'model',
        'name': 'name',
        'number': 'number',
        'price_book_items': 'priceBookItems',
        'product_rate_plan_id': 'productRatePlanId',
        'sequence': 'sequence',
        'type': 'type'
    }

    def __init__(self, charge_configuration=None, description=None, id=None, model=None, name=None, number=None, price_book_items=None, product_rate_plan_id=None, sequence=None, type=None, _configuration=None):  # noqa: E501
        """GETOfferProductRatePlanCharge - a model defined in Swagger"""  # noqa: E501
        if _configuration is None:
            _configuration = Configuration()
        self._configuration = _configuration

        self._charge_configuration = None
        self._description = None
        self._id = None
        self._model = None
        self._name = None
        self._number = None
        self._price_book_items = None
        self._product_rate_plan_id = None
        self._sequence = None
        self._type = None
        self.discriminator = None

        if charge_configuration is not None:
            self.charge_configuration = charge_configuration
        ...
        if number is not None:
            self.number = number
        if price_book_items is not None:
            self.price_book_items = price_book_items
    ...
    @property
    def charge_configuration(self):
        """Gets the charge_configuration of this GETOfferProductRatePlanCharge.  # noqa: E501


        :return: The charge_configuration of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: GETOfferChargeConfiguration
        """
        return self._charge_configuration

    @charge_configuration.setter
    def charge_configuration(self, charge_configuration):
        """Sets the charge_configuration of this GETOfferProductRatePlanCharge.


        :param charge_configuration: The charge_configuration of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: GETOfferChargeConfiguration
        """

        self._charge_configuration = charge_configuration

    @property
    def description(self):
        """Gets the description of this GETOfferProductRatePlanCharge.  # noqa: E501

        The description of the product rate plan charge.   # noqa: E501

        :return: The description of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this GETOfferProductRatePlanCharge.

        The description of the product rate plan charge.   # noqa: E501

        :param description: The description of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this GETOfferProductRatePlanCharge.  # noqa: E501

        The unique ID of the product rate plan charge.   # noqa: E501

        :return: The id of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GETOfferProductRatePlanCharge.

        The unique ID of the product rate plan charge.   # noqa: E501

        :param id: The id of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def model(self):
        """Gets the model of this GETOfferProductRatePlanCharge.  # noqa: E501

        The charge model of the product rate plan charge.   # noqa: E501

        :return: The model of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this GETOfferProductRatePlanCharge.

        The charge model of the product rate plan charge.   # noqa: E501

        :param model: The model of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this GETOfferProductRatePlanCharge.  # noqa: E501

        The name of the product rate plan charge.   # noqa: E501

        :return: The name of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GETOfferProductRatePlanCharge.

        The name of the product rate plan charge.   # noqa: E501

        :param name: The name of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def number(self):
        """Gets the number of this GETOfferProductRatePlanCharge.  # noqa: E501

        The unique number of the product rate plan charge.   # noqa: E501

        :return: The number of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this GETOfferProductRatePlanCharge.

        The unique number of the product rate plan charge.   # noqa: E501

        :param number: The number of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def price_book_items(self):
        """Gets the price_book_items of this GETOfferProductRatePlanCharge.  # noqa: E501


        :return: The price_book_items of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: list[GETOfferPriceBookItem]
        """
        return self._price_book_items

    @price_book_items.setter
    def price_book_items(self, price_book_items):
        """Sets the price_book_items of this GETOfferProductRatePlanCharge.


        :param price_book_items: The price_book_items of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: list[GETOfferPriceBookItem]
        """

        self._price_book_items = price_book_items

    @property
    def product_rate_plan_id(self):
        """Gets the product_rate_plan_id of this GETOfferProductRatePlanCharge.  # noqa: E501

        The unique ID of the product rate plan containing the product rate plan charge.   # noqa: E501

        :return: The product_rate_plan_id of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def product_rate_plan_id(self, product_rate_plan_id):
        """Sets the product_rate_plan_id of this GETOfferProductRatePlanCharge.

        The unique ID of the product rate plan containing the product rate plan charge.   # noqa: E501

        :param product_rate_plan_id: The product_rate_plan_id of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sequence(self):
        """Gets the sequence of this GETOfferProductRatePlanCharge.  # noqa: E501

        The sequence of the product rate plan charge in this offer.   This field is used in scenarios like adding a charge to the same offer for multiple times.   # noqa: E501

        :return: The sequence of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
    ...
    def sequence(self, sequence):
        """Sets the sequence of this GETOfferProductRatePlanCharge.

        The sequence of the product rate plan charge in this offer.   This field is used in scenarios like adding a charge to the same offer for multiple times.   # noqa: E501

        :param sequence: The sequence of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this GETOfferProductRatePlanCharge.  # noqa: E501

        The charge type of the product rate plan charge.   # noqa: E501

        :return: The type of this GETOfferProductRatePlanCharge.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this GETOfferProductRatePlanCharge.

        The charge type of the product rate plan charge.   # noqa: E501

        :param type: The type of this GETOfferProductRatePlanCharge.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GETOfferProductRatePlanCharge, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GETOfferProductRatePlanCharge):
            return False
