...
class ProxyGetImport(object):
    ...
    def __init__(self, created_by_id=None, created_date=None, id=None, import_type=None, imported_count=None, md5=None, name=None, original_resource_url=None, result_resource_url=None, status=None, status_reason=None, total_count=None, updated_by_id=None, updated_date=None, _configuration=None):  # noqa: E501
