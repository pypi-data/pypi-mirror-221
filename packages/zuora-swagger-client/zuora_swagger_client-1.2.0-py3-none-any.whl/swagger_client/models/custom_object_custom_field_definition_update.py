...
class CustomObjectCustomFieldDefinitionUpdate(object):
    ...
    def __init__(self, default=None, description=None, display_name=None, format=None, label=None, max_length=None, multiselect=None, origin=None, type=None, _configuration=None):  # noqa: E501
