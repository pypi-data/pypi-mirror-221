...
class InvoiceItemPreviewResultTaxationItems(object):
    ...
    def __init__(self, exempt_amount=None, id=None, jurisdiction=None, location_code=None, name=None, tax_amount=None, tax_code=None, tax_code_description=None, tax_date=None, tax_rate=None, tax_rate_description=None, tax_rate_type=None, _configuration=None):  # noqa: E501
