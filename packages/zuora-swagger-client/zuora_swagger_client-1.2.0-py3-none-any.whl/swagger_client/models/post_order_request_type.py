...
class POSTOrderRequestType(object):
    ...
    @property
    def category(self):
        """Gets the category of this POSTOrderRequestType.  # noqa: E501

        Category of the order to indicate a product sale or return. Default value is `NewSales`.   # noqa: E501

        :return: The category of this POSTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this POSTOrderRequestType.

        Category of the order to indicate a product sale or return. Default value is `NewSales`.   # noqa: E501

        :param category: The category of this POSTOrderRequestType.  # noqa: E501
        :type: str
        """
    ...
    def reason_code(self):
        """Gets the reason_code of this POSTOrderRequestType.  # noqa: E501
        ...
        :return: The reason_code of this POSTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def reason_code(self, reason_code):
        """Sets the reason_code of this POSTOrderRequestType.

        Values of reason code configured in **Billing Settings** > **Configure Reason Codes** through Zuora UI. Indicates the reason when a return order line item occurs.   # noqa: E501

        :param reason_code: The reason_code of this POSTOrderRequestType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def scheduling_options(self):
        """Gets the scheduling_options of this POSTOrderRequestType.  # noqa: E501


        :return: The scheduling_options of this POSTOrderRequestType.  # noqa: E501
    ...
    def scheduling_options(self, scheduling_options):
        """Sets the scheduling_options of this POSTOrderRequestType.


        :param scheduling_options: The scheduling_options of this POSTOrderRequestType.  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this POSTOrderRequestType.  # noqa: E501
        ...
        :return: The status of this POSTOrderRequestType.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this POSTOrderRequestType.

        The status of the order. The default value is `Completed`. The following values are supported: - `Draft`: The order is in draft status. - `Pending`: The order is in pending status. - `Completed`: The order is in completed status. - `Scheduled`: The order is in scheduled status and it is only valid if the Scheduled Orders feature is enabled. - `Executing`: The scheduled order is executed by a scheduler and it is only valid if the Scheduled Orders feature is enabled. - `Failed`: The scheduled order has failed.  **Note**: The Scheduled Orders feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :param status: The status of this POSTOrderRequestType.  # noqa: E501
        :type: str
        """
        allowed_values = ["Draft", "Pending", "Completed", "Scheduled", "Executing", "Failed"]  # noqa: E501
        if (self._configuration.client_side_validation and
