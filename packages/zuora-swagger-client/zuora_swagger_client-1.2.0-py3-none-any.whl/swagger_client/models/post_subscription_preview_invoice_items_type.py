...
class POSTSubscriptionPreviewInvoiceItemsType(object):
    ...
    def __init__(self, charge_amount=None, charge_description=None, charge_name=None, product_name=None, product_rate_plan_charge_id=None, quantity=None, service_end_date=None, service_start_date=None, tax_amount=None, taxation_items=None, unit_of_measure=None, _configuration=None):  # noqa: E501
