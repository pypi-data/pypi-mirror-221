...
class ConfigurationTemplateContent(object):
    ...
    def __init__(self, component_type=None, error=None, id=None, key=None, method=None, payload=None, result=None, segregation_key=None, template_id=None, url=None, _configuration=None):  # noqa: E501
