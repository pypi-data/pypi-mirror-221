...
class WorkflowDefinition(object):
    ...
    def __init__(self, active_version=None, callout_trigger=None, created_at=None, description=None, id=None, interval=None, name=None, ondemand_trigger=None, scheduled_trigger=None, status=None, timezone=None, updated_at=None, _configuration=None):  # noqa: E501
