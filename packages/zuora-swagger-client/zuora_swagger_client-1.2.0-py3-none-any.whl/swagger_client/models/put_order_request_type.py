...
class PUTOrderRequestType(object):
    ...
    swagger_types = {
        ...
        'order_number': 'str',
        'processing_options': 'ProcessingOptionsOrders',
        'reason_code': 'str',
        'scheduling_options': 'POSTOrderRequestTypeSchedulingOptions',
        'status': 'str',
        'subscriptions': 'list[POSTOrderAsyncRequestTypeSubscriptions]'
    }
    ...
    def __init__(self, category='NewSales', custom_fields=None, description=None, existing_account_number=None, externally_managed_by=None, new_account=None, order_date=None, order_line_items=None, order_number=None, processing_options=None, reason_code=None, scheduling_options=None, status=None, subscriptions=None, _configuration=None):  # noqa: E501
        """PUTOrderRequestType - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def category(self):
        """Gets the category of this PUTOrderRequestType.  # noqa: E501

        Category of the order to indicate a product sale or return. Default value is `NewSales`.   # noqa: E501

        :return: The category of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def category(self, category):
        """Sets the category of this PUTOrderRequestType.

        Category of the order to indicate a product sale or return. Default value is `NewSales`.   # noqa: E501

        :param category: The category of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        allowed_values = ["NewSales", "Return"]  # noqa: E501
    ...
    def custom_fields(self):
        """Gets the custom_fields of this PUTOrderRequestType.  # noqa: E501


        :return: The custom_fields of this PUTOrderRequestType.  # noqa: E501
    ...
    def custom_fields(self, custom_fields):
        """Sets the custom_fields of this PUTOrderRequestType.


        :param custom_fields: The custom_fields of this PUTOrderRequestType.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this PUTOrderRequestType.  # noqa: E501

        A description of the order.  # noqa: E501

        :return: The description of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this PUTOrderRequestType.

        A description of the order.  # noqa: E501

        :param description: The description of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def existing_account_number(self):
        """Gets the existing_account_number of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The existing_account_number of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def existing_account_number(self, existing_account_number):
        """Sets the existing_account_number of this PUTOrderRequestType.

        The account number that this order will be created under. It can be either the accountNumber or the account info provided. It will return an error if both are specified. Note that this actually specifies the invoice owner account of the subscriptions included in this order.   # noqa: E501

        :param existing_account_number: The existing_account_number of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def externally_managed_by(self):
        """Gets the externally_managed_by of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The externally_managed_by of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_by(self, externally_managed_by):
        """Sets the externally_managed_by of this PUTOrderRequestType.

        An enum field on the Subscription object to indicate the name of a third-party store. This field is used to represent subscriptions created through third-party stores.   # noqa: E501

        :param externally_managed_by: The externally_managed_by of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        allowed_values = ["Amazon", "Apple", "Google", "Roku"]  # noqa: E501
        if (self._configuration.client_side_validation and
                externally_managed_by not in allowed_values):
            raise ValueError(
    ...
    def new_account(self):
        """Gets the new_account of this PUTOrderRequestType.  # noqa: E501


        :return: The new_account of this PUTOrderRequestType.  # noqa: E501
        :rtype: Account
        """
    ...
    def new_account(self, new_account):
        """Sets the new_account of this PUTOrderRequestType.


        :param new_account: The new_account of this PUTOrderRequestType.  # noqa: E501
        :type: Account
        """
    ...
    @property
    def order_date(self):
        """Gets the order_date of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The order_date of this PUTOrderRequestType.  # noqa: E501
        :rtype: date
        """
    ...
    def order_date(self, order_date):
        """Sets the order_date of this PUTOrderRequestType.

        The date when the order is signed. All the order actions under this order will use this order date as the contract effective date if the contract effective date field is skipped or its value is left as null.  # noqa: E501

        :param order_date: The order_date of this PUTOrderRequestType.  # noqa: E501
        :type: date
        """
    ...
    def order_line_items(self):
        """Gets the order_line_items of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The order_line_items of this PUTOrderRequestType.  # noqa: E501
    ...
    def order_line_items(self, order_line_items):
        """Sets the order_line_items of this PUTOrderRequestType.

        [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) are non subscription based items created by an Order, representing transactional charges such as one-time fees, physical goods, or professional service charges that are not sold as subscription services.   With the Order Line Items feature enabled, you can now launch non-subscription and unified monetization business models in Zuora, in addition to subscription business models.  **Note:** The [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) feature is now generally available to all Zuora customers. You need to enable the [Orders](https://knowledgecenter.zuora.com/BC_Subscription_Management/Orders/AA_Overview_of_Orders#Orders) feature to access the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AA_Overview_of_Order_Line_Items) feature. As of Zuora Billing Release 313 (November 2021), new customers who onboard on [Orders](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/AA_Overview_of_Orders) will have the [Order Line Items](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items) feature enabled by default.           # noqa: E501

        :param order_line_items: The order_line_items of this PUTOrderRequestType.  # noqa: E501
    ...
    def order_number(self):
        """Gets the order_number of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The order_number of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def order_number(self, order_number):
        """Sets the order_number of this PUTOrderRequestType.

        The order number of the new order. If not provided, system will auto-generate a number for this order.    **Note:** Make sure the order number does not contain a slash.    # noqa: E501

        :param order_number: The order_number of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def processing_options(self):
        """Gets the processing_options of this PUTOrderRequestType.  # noqa: E501


        :return: The processing_options of this PUTOrderRequestType.  # noqa: E501
        :rtype: ProcessingOptionsOrders
        """
        return self._processing_options

    @processing_options.setter
    def processing_options(self, processing_options):
        """Sets the processing_options of this PUTOrderRequestType.


        :param processing_options: The processing_options of this PUTOrderRequestType.  # noqa: E501
        :type: ProcessingOptionsOrders
        """
    ...
    def reason_code(self):
        """Gets the reason_code of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The reason_code of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
    ...
    def reason_code(self, reason_code):
        """Sets the reason_code of this PUTOrderRequestType.

        Values of reason code configured in **Billing Settings** > **Configure Reason Codes** through Zuora UI. Indicates the reason when a return order line item occurs.   # noqa: E501

        :param reason_code: The reason_code of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
                reason_code is not None and len(reason_code) > 255):
            raise ValueError("Invalid value for `reason_code`, length must be less than or equal to `255`")  # noqa: E501

        self._reason_code = reason_code

    @property
    def scheduling_options(self):
        """Gets the scheduling_options of this PUTOrderRequestType.  # noqa: E501


        :return: The scheduling_options of this PUTOrderRequestType.  # noqa: E501
        :rtype: POSTOrderRequestTypeSchedulingOptions
        """
        return self._scheduling_options

    @scheduling_options.setter
    def scheduling_options(self, scheduling_options):
        """Sets the scheduling_options of this PUTOrderRequestType.


        :param scheduling_options: The scheduling_options of this PUTOrderRequestType.  # noqa: E501
        :type: POSTOrderRequestTypeSchedulingOptions
        """
    ...
    @property
    def status(self):
        """Gets the status of this PUTOrderRequestType.  # noqa: E501
        ...
        :return: The status of this PUTOrderRequestType.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PUTOrderRequestType.

        The status of the order. The default value is `Completed`. The following values are supported: - `Draft`: The order is in draft status. - `Pending`: The order is in pending status. - `Completed`: The order is in completed status. - `Scheduled`: The order is in scheduled status and it is only valid if the Scheduled Orders feature is enabled. - `Executing`: The scheduled order is executed by a scheduler and it is only valid if the Scheduled Orders feature is enabled. - `Failed`: The scheduled order has failed.  **Note**: The Scheduled Orders feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at <a href=\"https://support.zuora.com/hc/en-us\" target=\"_blank\">Zuora Global Support</a>.   # noqa: E501

        :param status: The status of this PUTOrderRequestType.  # noqa: E501
        :type: str
        """
        allowed_values = ["Draft", "Pending", "Completed", "Scheduled"]  # noqa: E501
        if (self._configuration.client_side_validation and
    ...
    def subscriptions(self):
        """Gets the subscriptions of this PUTOrderRequestType.  # noqa: E501

        Each item includes a set of order actions, which will be applied to the same base subscription.  # noqa: E501

        :return: The subscriptions of this PUTOrderRequestType.  # noqa: E501
        :rtype: list[POSTOrderAsyncRequestTypeSubscriptions]
        """
        return self._subscriptions

    @subscriptions.setter
    def subscriptions(self, subscriptions):
        """Sets the subscriptions of this PUTOrderRequestType.

        Each item includes a set of order actions, which will be applied to the same base subscription.  # noqa: E501

        :param subscriptions: The subscriptions of this PUTOrderRequestType.  # noqa: E501
        :type: list[POSTOrderAsyncRequestTypeSubscriptions]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PUTOrderRequestType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PUTOrderRequestType):
            return False
