...
class SubmitDataQueryRequest(object):
    ...
    def __init__(self, column_separator=None, compression=None, encryption_key=None, output=None, output_format=None, query=None, read_deleted=False, source_data=None, use_index_join=None, _configuration=None):  # noqa: E501
    ...
    def output_format(self, output_format):
        ...
        if (self._configuration.client_side_validation and
                output_format not in allowed_values):
            raise ValueError(
    ...
    def source_data(self):
        ...
        Specify the source that data queries run against. Currently, the only valid value is `LIVE`, representing the live transactional databases at Zuora (Data Query Live).   # noqa: E501
    ...
    def source_data(self, source_data):
        ...
        if (self._configuration.client_side_validation and
                source_data not in allowed_values):
            raise ValueError(
