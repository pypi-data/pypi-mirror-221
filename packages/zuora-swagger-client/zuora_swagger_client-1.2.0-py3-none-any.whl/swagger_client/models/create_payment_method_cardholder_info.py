...
class CreatePaymentMethodCardholderInfo(object):
    ...
    def __init__(self, address_line1=None, address_line2=None, card_holder_name=None, city=None, country=None, email=None, phone=None, state=None, zip_code=None, _configuration=None):  # noqa: E501
