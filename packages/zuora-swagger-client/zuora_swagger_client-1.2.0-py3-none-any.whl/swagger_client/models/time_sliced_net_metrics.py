...
class TimeSlicedNetMetrics(object):
    ...
    def __init__(self, amount=None, discount_charge_number=None, end_date=None, generated_reason=None, invoice_owner=None, order_item_id=None, start_date=None, subscription_owner=None, term_number=None, type=None, _configuration=None):  # noqa: E501
