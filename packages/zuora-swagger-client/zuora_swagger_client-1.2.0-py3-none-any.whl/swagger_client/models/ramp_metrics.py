...
class RampMetrics(object):
    ...
    def __init__(self, description=None, discount_tcb=None, discount_tcv=None, gross_tcb=None, gross_tcv=None, intervals=None, name=None, net_tcb=None, net_tcv=None, number=None, _configuration=None):  # noqa: E501
