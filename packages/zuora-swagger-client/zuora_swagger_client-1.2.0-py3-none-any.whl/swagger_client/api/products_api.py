...
class ProductsApi(object):
    ...
    def object_delete_product_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_delete_product`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_get_product_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_get_product`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_post_product(self, create_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_post_product_with_http_info(create_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_post_product_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_request' not in params or
            ...
            raise ValueError("Missing the required parameter `create_request` when calling `object_post_product`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `object_post_product`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_product`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_put_product(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_put_product_with_http_info(id, modify_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_put_product_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('modify_request' not in params or
            ...
            raise ValueError("Missing the required parameter `modify_request` when calling `object_put_product`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_product`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
