...
class ProductRatePlansApi(object):
    ...
    def g_et_product_rate_plan(self, id, **kwargs):  # noqa: E501
        ...
        :param str id: The ID, external ID, or the natural key of the product rate plan to be retrieved. For example, `402888e67f8b3a68017f8bbb2a06062d`, `Apple0001`, or `PRP-00000008`.  (required)
    ...
    def g_et_product_rate_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_product_rate_plans_with_http_info(self, product_key, **kwargs):  # noqa: E501
        ...
        all_params = ['product_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('product_key' not in params or
                                                       params['product_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `product_key` when calling `g_et_product_rate_plans`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_product_rate_plans`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_product_rate_plans`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def g_et_product_rate_plans_by_external_id(self, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_product_rate_plans_by_external_id(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The external ID of the product rate plan to be retrieved. For example, `Apple0001`.  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: GETProductRatePlanWithExternalIdMultiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_product_rate_plans_by_external_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_product_rate_plans_by_external_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def g_et_product_rate_plans_by_external_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """List product rate plans by external ID  # noqa: E501

        Retrieves information about one or multiple product rate plans by external ID.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_product_rate_plans_by_external_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_product_rate_plans_by_external_id" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `g_et_product_rate_plans_by_external_id`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_product_rate_plans_by_external_id`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GETProductRatePlanWithExternalIdMultiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def object_delete_product_rate_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_delete_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_get_product_rate_plan_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_entity_ids', 'zuora_track_id', 'x_zuora_wsdl_version', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_get_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_post_product_rate_plan(self, create_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_post_product_rate_plan_with_http_info(create_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_post_product_rate_plan_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        all_params = ['create_request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'reject_unknown_fields', 'zuora_entity_ids', 'zuora_track_id', 'x_zuora_wsdl_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('create_request' not in params or
                                                       params['create_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `create_request` when calling `object_post_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `object_post_product_rate_plan`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_put_product_rate_plan(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_put_product_rate_plan_with_http_info(id, modify_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_put_product_rate_plan_with_http_info(self, id, modify_request, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'modify_request', 'accept_encoding', 'content_encoding', 'authorization', 'reject_unknown_fields', 'zuora_entity_ids', 'zuora_track_id', 'x_zuora_wsdl_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('modify_request' not in params or
                                                       params['modify_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `modify_request` when calling `object_put_product_rate_plan`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_product_rate_plan`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
