...
class OffersApi(object):
    ...
    def d_elete_offer(self, offer_key, **kwargs):  # noqa: E501
        """Delete an offer  # noqa: E501

        Deletes an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_offer(offer_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str offer_key: The unique number or ID of the offer to be deleted.  (required)
        ...
        if kwargs.get('async_req'):
            return self.d_elete_offer_with_http_info(offer_key, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_offer_with_http_info(offer_key, **kwargs)  # noqa: E501
            return data

    def d_elete_offer_with_http_info(self, offer_key, **kwargs):  # noqa: E501
        """Delete an offer  # noqa: E501

        Deletes an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_offer_with_http_info(offer_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['offer_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_offer" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'offer_key' is set
        if self.api_client.client_side_validation and ('offer_key' not in params or
                                                       params['offer_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `offer_key` when calling `d_elete_offer`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_offer`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'offer_key' in params:
            path_params['offer-key'] = params['offer_key']  # noqa: E501
    ...
    def g_et_list_offers(self, **kwargs):  # noqa: E501
        """List offers  # noqa: E501

        Retrieves basic information about all offers.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_list_offers(async_req=True)
        >>> result = thread.get()
        ...
        :return: ListAllOffersResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_list_offers_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.g_et_list_offers_with_http_info(**kwargs)  # noqa: E501
            return data

    def g_et_list_offers_with_http_info(self, **kwargs):  # noqa: E501
        """List offers  # noqa: E501

        Retrieves basic information about all offers.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_list_offers_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page_size', 'page']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_list_offers" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_list_offers`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_list_offers`, must be a value less than or equal to `40`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_list_offers`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListAllOffersResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def g_et_retrieve_offer(self, offer_key, **kwargs):  # noqa: E501
        """Retrieve an offer  # noqa: E501

        Retrieves basic information about an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_retrieve_offer(offer_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str offer_key: The unique number or ID of the offer to be retrieved.  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_retrieve_offer_with_http_info(offer_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_retrieve_offer_with_http_info(offer_key, **kwargs)  # noqa: E501
            return data

    def g_et_retrieve_offer_with_http_info(self, offer_key, **kwargs):  # noqa: E501
        """Retrieve an offer  # noqa: E501

        Retrieves basic information about an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_retrieve_offer_with_http_info(offer_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_retrieve_offer" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'offer_key' is set
        if self.api_client.client_side_validation and ('offer_key' not in params or
                                                       params['offer_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `offer_key` when calling `g_et_retrieve_offer`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_retrieve_offer`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='GETOfferResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_create_offer(self, request, **kwargs):  # noqa: E501
        """Create an offer  # noqa: E501

        Creates an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_offer(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTOfferRequest request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_offer_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_offer_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_offer_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create an offer  # noqa: E501

        Creates an offer.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_offer_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_create_offer" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_offer`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_offer`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_offer`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='POSTOfferResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
