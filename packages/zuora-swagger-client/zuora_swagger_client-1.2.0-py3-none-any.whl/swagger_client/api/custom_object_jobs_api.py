...
class CustomObjectJobsApi(object):
    ...
    def g_et_all_custom_object_bulk_jobs(self, authorization, **kwargs):  # noqa: E501
        ...
        :param str status: The status of bulk jobs to be retrieved.
    ...
    def g_et_all_custom_object_bulk_jobs_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'accept_encoding', 'content_encoding', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version', 'page_size', 'cursor', 'status']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_all_custom_object_bulk_jobs`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_all_custom_object_bulk_jobs`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_custom_object_bulk_job_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'id', 'accept_encoding', 'content_encoding', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_custom_object_bulk_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_custom_object_bulk_job_errors_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_custom_object_bulk_job_errors`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_atch_custom_object_bulk_job(self, authorization, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_atch_custom_object_bulk_job(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken).  (required)
        :param str id: The ID of the custom object bulk job that you want to cancel. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_atch_custom_object_bulk_job_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_atch_custom_object_bulk_job_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def p_atch_custom_object_bulk_job_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """Cancel a custom object bulk job  # noqa: E501

        Cancel a custom object bulk job. Note that you can cancel a custom object bulk job only if the job status is `accepted` or `pending`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_atch_custom_object_bulk_job_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'id', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_atch_custom_object_bulk_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if self.api_client.client_side_validation and ('authorization' not in params or
                                                       params['authorization'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `authorization` when calling `p_atch_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `p_atch_custom_object_bulk_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_atch_custom_object_bulk_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_atch_custom_object_bulk_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_custom_object_bulk_job(self, authorization, custom_object_bulk_job_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.p_ost_custom_object_bulk_job_with_http_info(authorization, custom_object_bulk_job_request, **kwargs)  # noqa: E501
            return data
    ...
    def p_ost_custom_object_bulk_job_with_http_info(self, authorization, custom_object_bulk_job_request, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'custom_object_bulk_job_request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('custom_object_bulk_job_request' not in params or
                                                       params['custom_object_bulk_job_request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `custom_object_bulk_job_request` when calling `p_ost_custom_object_bulk_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_custom_object_bulk_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_custom_object_bulk_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'custom_object_bulk_job_request' in params:
            body_params = params['custom_object_bulk_job_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def p_ost_upload_file_for_custom_object_bulk_job(self, authorization, content_type, id, file, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.p_ost_upload_file_for_custom_object_bulk_job_with_http_info(authorization, content_type, id, file, **kwargs)  # noqa: E501
            return data
    ...
    def p_ost_upload_file_for_custom_object_bulk_job_with_http_info(self, authorization, content_type, id, file, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'content_type', 'id', 'file', 'idempotency_key', 'accept_encoding', 'content_encoding', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('file' not in params or
            ...
            raise ValueError("Missing the required parameter `file` when calling `p_ost_upload_file_for_custom_object_bulk_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_upload_file_for_custom_object_bulk_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_upload_file_for_custom_object_bulk_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
