...
class DataQueriesApi(object):
    ...
    def d_elete_data_query_job_with_http_info(self, authorization, job_id, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'job_id', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('job_id' in params and
                                                       len(params['job_id']) > 64):
            raise ValueError("Invalid value for parameter `job_id` when calling `d_elete_data_query_job`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('job_id' in params and
                                                       len(params['job_id']) < 64):
            raise ValueError("Invalid value for parameter `job_id` when calling `d_elete_data_query_job`, length must be greater than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_data_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_data_query_job_with_http_info(self, authorization, job_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('job_id' in params and
            ...
            raise ValueError("Invalid value for parameter `job_id` when calling `g_et_data_query_job`, length must be less than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('job_id' in params and
                                                       len(params['job_id']) < 36):
            raise ValueError("Invalid value for parameter `job_id` when calling `g_et_data_query_job`, length must be greater than or equal to `36`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_data_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_data_query_jobs_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'accept_encoding', 'content_encoding', 'zuora_entity_ids', 'zuora_track_id', 'query_status', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_data_query_jobs`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_data_query_jobs`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_data_query_job(self, authorization, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.p_ost_data_query_job_with_http_info(authorization, body, **kwargs)  # noqa: E501
            return data
    ...
    def p_ost_data_query_job_with_http_info(self, authorization, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_data_query_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_data_query_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
