...
class BillRunApi(object):
    ...
    def d_elete_delete_bill_run(self, bill_run_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.d_elete_delete_bill_run(bill_run_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.d_elete_delete_bill_run_with_http_info(bill_run_id, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_delete_bill_run_with_http_info(bill_run_id, **kwargs)  # noqa: E501
            return data

    def d_elete_delete_bill_run_with_http_info(self, bill_run_id, **kwargs):  # noqa: E501
        """Delete a bill run  # noqa: E501

        Deletes a bill run. You can only delete bill runs in `Canceled` or `Error` status.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_delete_bill_run_with_http_info(bill_run_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['bill_run_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_delete_bill_run" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'bill_run_id' is set
        if self.api_client.client_side_validation and ('bill_run_id' not in params or
                                                       params['bill_run_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bill_run_id` when calling `d_elete_delete_bill_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_delete_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='GetBillRunResponseType',  # noqa: E501
    ...
    def g_et_bill_run(self, bill_run_id, **kwargs):  # noqa: E501
        """Retrieve a bill run  # noqa: E501

        Retrieves the information about a specific bill run.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_bill_run(bill_run_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_bill_run_with_http_info(bill_run_id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_bill_run_with_http_info(bill_run_id, **kwargs)  # noqa: E501
            return data

    def g_et_bill_run_with_http_info(self, bill_run_id, **kwargs):  # noqa: E501
        """Retrieve a bill run  # noqa: E501

        Retrieves the information about a specific bill run.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_bill_run_with_http_info(bill_run_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('bill_run_id' not in params or
                                                       params['bill_run_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bill_run_id` when calling `g_et_bill_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_create_bill_run(self, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_bill_run(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTCreateBillRunRequestType request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_bill_run_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_bill_run_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_bill_run_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create a bill run  # noqa: E501

        Creates an ad-hoc bill run or a scheduled bill run.   - Support to create ad-hoc or scheduled bill runs by batch   - Support to create ad-hoc or scheduled bill runs for a single account (all subscriptions under this account)   - Support to create a bill run by subscription (50 or less subscriptions under the same account)  To use this operation, you must have the <a href=\"https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/d_Billing_Roles\" target=\"_blank\">Create Bill Runs billing permission</a>.   **Restrictions and limitations**  When using this operation to create bill runs, keep the following restrictions and limitations in mind: - When creating batch-level bill runs, you must specify `batches` and cannot specify `billRunFilters`. - When creating account-level bill runs, you must specify `billRunFilters` and cannot specify `batches`. Only one single account is allowed. - When creating subscription-level bill runs, you must specify `billRunFilters` and cannot specify `batches`. All subscriptions must belong to the same account. At most 50 subscriptions are allowed. - If more than 500 bill runs created through this operation are in `Pending` status, you cannot use this operation to create any more bill runs.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_bill_run_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_create_bill_run" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_bill_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_bill_run`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_email_billing_documentsfrom_bill_run(self, bill_run_key, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_email_billing_documentsfrom_bill_run(bill_run_key, request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_email_billing_documentsfrom_bill_run_with_http_info(bill_run_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_email_billing_documentsfrom_bill_run_with_http_info(bill_run_key, request, **kwargs)  # noqa: E501
            return data

    def p_ost_email_billing_documentsfrom_bill_run_with_http_info(self, bill_run_key, request, **kwargs):  # noqa: E501
        """Email billing documents generated from a bill run  # noqa: E501

        Manually emails all the billing documents that are generated from a specified bill run to your customers.    Bill runs can generate invoices and credit memos based on your [invoice and credit memo generation rule](https://knowledgecenter.zuora.com/CB_Billing/Invoice_Settlement/Credit_and_Debit_Memos/Rules_for_Generating_Invoices_and_Credit_Memos). Credit memos are only available if you have the Invoice Settlement feature enabled.   Using this API operation, the billing documents are sent to the email addresses specified in the **To Email** field of the email templates. The email template used for each billing document is set in the **Delivery Options** panel of the **Edit notification** dialog from the Zuora UI. See [Edit Email Templates](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/Create_Email_Templates) for more information about how to edit the **To Email** field in the email template.      ### Notes   - Even though no field is required in the Request body, you still need to specify `{}` in the request. Otherwise, an error will be returned.     - You can only email posted billing documents.     - You must activate the following notifications before emailing invoices and credit memos:     - **Manual Email For Invoice | Manual Email For Invoice**      - **Email Credit Memo | Manually email Credit Memo**     - To include the invoice PDF in the email, select the **Include Invoice PDF** check box in the **Edit notification** dialog from the Zuora UI. To include the credit memo PDF in the email, select the **Include Credit Memo PDF** check box in the **Edit notification** dialog from the Zuora UI. See [Create and Edit Notifications](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/C_Create_Notifications#section_2) for more information.      - Zuora sends the email messages based on the email template you set. You can set the email template to use in the **Delivery Options** panel of the **Edit notification** dialog from the Zuora UI. By default, the following templates are used for billing documents:     - Invoices: **Invoice Posted Default Email Template**     - Credit memos: **Manual Email for Credit Memo Default Template**        See [Create and Edit Email Templates](https://knowledgecenter.zuora.com/CF_Users_and_Administrators/Notifications/Create_Email_Templates) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_email_billing_documentsfrom_bill_run_with_http_info(bill_run_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['bill_run_key', 'request', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('bill_run_key' not in params or
                                                       params['bill_run_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bill_run_key` when calling `p_ost_email_billing_documentsfrom_bill_run`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_email_billing_documentsfrom_bill_run`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_email_billing_documentsfrom_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_cancel_bill_run(self, bill_run_id, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_cancel_bill_run(bill_run_id, request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str bill_run_id: The unique ID of a bill run.  (required)
        :param Request1 request:  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_cancel_bill_run_with_http_info(bill_run_id, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_cancel_bill_run_with_http_info(bill_run_id, request, **kwargs)  # noqa: E501
            return data

    def p_ut_cancel_bill_run_with_http_info(self, bill_run_id, request, **kwargs):  # noqa: E501
        """Cancel a bill run  # noqa: E501

        Cancels a bill run in Draft status.  When cancelling a scheduled bill run, keep the following information in mind: - If you set `cancelOnce` to `true`, only the current bill run is cancelled. The other future scheduled bill runs will be automatically executed based on the schedule. - If you set `cancelOnce` to `false`, all future recurring bill runs are cancelled.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_cancel_bill_run_with_http_info(bill_run_id, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['bill_run_id', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_cancel_bill_run" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'bill_run_id' is set
        if self.api_client.client_side_validation and ('bill_run_id' not in params or
                                                       params['bill_run_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bill_run_id` when calling `p_ut_cancel_bill_run`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_cancel_bill_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_cancel_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CancelBillRunResponseType',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ut_post_bill_run(self, bill_run_id, request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_post_bill_run(bill_run_id, request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_post_bill_run_with_http_info(bill_run_id, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_post_bill_run_with_http_info(bill_run_id, request, **kwargs)  # noqa: E501
            return data

    def p_ut_post_bill_run_with_http_info(self, bill_run_id, request, **kwargs):  # noqa: E501
        """Post a bill run  # noqa: E501

        Posts a bill run asynchronously. To post a bill run, the current bill run must be in `Completed` status.  When a bill run is being posted, its status is changed to `PostInProgress`. After all invoices for this bill run are posted, its status is changed to `Posted`.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_post_bill_run_with_http_info(bill_run_id, request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_post_bill_run" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'bill_run_id' is set
        if self.api_client.client_side_validation and ('bill_run_id' not in params or
                                                       params['bill_run_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `bill_run_id` when calling `p_ut_post_bill_run`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_post_bill_run`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_post_bill_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
