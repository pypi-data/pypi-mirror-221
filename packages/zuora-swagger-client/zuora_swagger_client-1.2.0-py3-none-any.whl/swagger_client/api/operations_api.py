...
class OperationsApi(object):
    ...
    def g_et_operation_job(self, job_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.g_et_operation_job(job_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: GetOperationJobResponseType
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_operation_job_with_http_info(job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_operation_job_with_http_info(job_id, **kwargs)  # noqa: E501
            return data

    def g_et_operation_job_with_http_info(self, job_id, **kwargs):  # noqa: E501
        """Retrieve an operation job  # noqa: E501

        Retrieves information about a specific operation job.  Currently, you can only use this API operation to retrieve the status information about invoice deletion operation jobs.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_operation_job_with_http_info(job_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method g_et_operation_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('job_id' not in params or
            ...
            raise ValueError("Missing the required parameter `job_id` when calling `g_et_operation_job`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_operation_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='GetOperationJobResponseType',  # noqa: E501
    ...
    def p_ost_billing_preview_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_billing_preview`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_billing_preview`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_transaction_invoice_payment_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_transaction_invoice_payment`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_transaction_invoice_payment`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
