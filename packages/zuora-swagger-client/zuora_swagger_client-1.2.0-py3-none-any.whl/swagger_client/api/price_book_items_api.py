...
class PriceBookItemsApi(object):
    ...
    def d_elete_price_book_item(self, price_book_item_key, **kwargs):  # noqa: E501
        """Delete a price book item  # noqa: E501

        Deletes a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_price_book_item(price_book_item_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str price_book_item_key: The unique number or ID of the price book item to be deleted.  (required)
        ...
        if kwargs.get('async_req'):
            return self.d_elete_price_book_item_with_http_info(price_book_item_key, **kwargs)  # noqa: E501
        else:
            (data) = self.d_elete_price_book_item_with_http_info(price_book_item_key, **kwargs)  # noqa: E501
            return data

    def d_elete_price_book_item_with_http_info(self, price_book_item_key, **kwargs):  # noqa: E501
        """Delete a price book item  # noqa: E501

        Deletes a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.d_elete_price_book_item_with_http_info(price_book_item_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['price_book_item_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method d_elete_price_book_item" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'price_book_item_key' is set
        if self.api_client.client_side_validation and ('price_book_item_key' not in params or
                                                       params['price_book_item_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `price_book_item_key` when calling `d_elete_price_book_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_price_book_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}

        path_params = {}
        if 'price_book_item_key' in params:
            path_params['price-book-item-key'] = params['price_book_item_key']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/price-book-items/{price-book-item-key}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def g_et_list_price_book_items(self, **kwargs):  # noqa: E501
        """List price book items  # noqa: E501

        Retrieves basic information about all price book items.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_list_price_book_items(async_req=True)
        >>> result = thread.get()
        ...
        :param str offer: Used if you want to filter the PBIs associated with one offer. Can be offer id or number 
        :param str charge: Used if you want to filter the PBIs of a charge. Charge id for now. 
        :return: ListAllPriceBookItemsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_list_price_book_items_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.g_et_list_price_book_items_with_http_info(**kwargs)  # noqa: E501
            return data

    def g_et_list_price_book_items_with_http_info(self, **kwargs):  # noqa: E501
        """List price book items  # noqa: E501

        Retrieves basic information about all price book items.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_list_price_book_items_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page_size', 'page', 'offer', 'charge']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_list_price_book_items" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_list_price_book_items`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 40):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `g_et_list_price_book_items`, must be a value less than or equal to `40`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_list_price_book_items`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        if 'offer' in params:
            query_params.append(('offer', params['offer']))  # noqa: E501
        if 'charge' in params:
            query_params.append(('charge', params['charge']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ListAllPriceBookItemsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def g_et_retrieve_price_book_item(self, price_book_item_key, **kwargs):  # noqa: E501
        """Retrieve a price book item  # noqa: E501

        Retrieves basic information about a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_retrieve_price_book_item(price_book_item_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str price_book_item_key: The unique number or ID of the price book item to be retrieved.  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: GETPriceBookItemResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_retrieve_price_book_item_with_http_info(price_book_item_key, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_retrieve_price_book_item_with_http_info(price_book_item_key, **kwargs)  # noqa: E501
            return data

    def g_et_retrieve_price_book_item_with_http_info(self, price_book_item_key, **kwargs):  # noqa: E501
        """Retrieve a price book item  # noqa: E501

        Retrieves basic information about a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_retrieve_price_book_item_with_http_info(price_book_item_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_retrieve_price_book_item" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'price_book_item_key' is set
        if self.api_client.client_side_validation and ('price_book_item_key' not in params or
                                                       params['price_book_item_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `price_book_item_key` when calling `g_et_retrieve_price_book_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_retrieve_price_book_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/price-book-items/{price-book-item-key}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='GETPriceBookItemResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_create_price_book_item(self, request, **kwargs):  # noqa: E501
        """Create a price book item  # noqa: E501

        Creates a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_price_book_item(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTPriceBookItemRequest request:  (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_price_book_item_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_price_book_item_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def p_ost_create_price_book_item_with_http_info(self, request, **kwargs):  # noqa: E501
        """Create a price book item  # noqa: E501

        Creates a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_price_book_item_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_create_price_book_item" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `p_ost_create_price_book_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_create_price_book_item`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_create_price_book_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_update_price_book_item(self, price_book_item_key, request, **kwargs):  # noqa: E501
        """Update a price book item  # noqa: E501

        Update a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_price_book_item(price_book_item_key, request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str price_book_item_key: The unique number or ID of the price book item to be updated.  (required)
        :param PUTPriceBookItemRequest request:  (required)
        :param str accept_encoding: Include the `Accept-Encoding: gzip` header to compress responses as a gzipped file. It can significantly reduce the bandwidth required for a response.   If specified, Zuora automatically compresses responses that contain over 1000 bytes of data, and the response contains a `Content-Encoding` header with the compression algorithm so that your client can decompress it. 
        :param str content_encoding: Include the `Content-Encoding: gzip` header to compress a request. With this header specified, you should upload a gzipped file for the request payload instead of sending the JSON payload. 
        :param str authorization: The value is in the `Bearer {token}` format where {token} is a valid OAuth token generated by calling [Create an OAuth token](https://www.zuora.com/developer/api-references/api/operation/createToken). 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_update_price_book_item_with_http_info(price_book_item_key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_update_price_book_item_with_http_info(price_book_item_key, request, **kwargs)  # noqa: E501
            return data

    def p_ut_update_price_book_item_with_http_info(self, price_book_item_key, request, **kwargs):  # noqa: E501
        """Update a price book item  # noqa: E501

        Update a price book item.  **Note**: You can use this operation only if you have the <a href=\"https://knowledgecenter.zuora.com/Zuora_Billing/Subscriptions/Product_Catalog/Offers\" target=\"_blank\">Offers</a> feature enabled.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_update_price_book_item_with_http_info(price_book_item_key, request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['price_book_item_key', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ut_update_price_book_item" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'price_book_item_key' is set
        if self.api_client.client_side_validation and ('price_book_item_key' not in params or
                                                       params['price_book_item_key'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `price_book_item_key` when calling `p_ut_update_price_book_item`")  # noqa: E501
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `p_ut_update_price_book_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_update_price_book_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/v1/price-book-items/{price-book-item-key}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
