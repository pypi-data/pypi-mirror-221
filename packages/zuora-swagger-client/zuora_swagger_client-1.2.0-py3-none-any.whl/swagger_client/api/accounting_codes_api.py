...
class AccountingCodesApi(object):
    ...
    def d_elete_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        all_params = ['ac_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('ac_id' not in params or
                                                       params['ac_id'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_all_accounting_codes_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_all_accounting_codes`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_all_accounting_codes`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def p_ost_accounting_code_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_accounting_code`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_accounting_code_with_http_info(self, ac_id, request, **kwargs):  # noqa: E501
        ...
        all_params = ['ac_id', 'request', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_activate_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_activate_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_deactivate_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_deactivate_accounting_code`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
