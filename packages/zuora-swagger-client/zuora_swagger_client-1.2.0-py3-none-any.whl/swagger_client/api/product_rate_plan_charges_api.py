...
class ProductRatePlanChargesApi(object):
    ...
    def object_delete_product_rate_plan_charge_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_delete_product_rate_plan_charge`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_get_product_rate_plan_charge_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_get_product_rate_plan_charge`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_post_product_rate_plan_charge(self, create_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_post_product_rate_plan_charge_with_http_info(create_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_post_product_rate_plan_charge_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_request' not in params or
            ...
            raise ValueError("Missing the required parameter `create_request` when calling `object_post_product_rate_plan_charge`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `object_post_product_rate_plan_charge`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_product_rate_plan_charge`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_put_product_rate_plan_charge(self, modify_request, id, **kwargs):  # noqa: E501
        """CRUD: Update a product rate plan charge  # noqa: E501

        Updates the information about a product rate plan charge.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_product_rate_plan_charge(modify_request, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.object_put_product_rate_plan_charge_with_http_info(modify_request, id, **kwargs)  # noqa: E501
        else:
            (data) = self.object_put_product_rate_plan_charge_with_http_info(modify_request, id, **kwargs)  # noqa: E501
            return data

    def object_put_product_rate_plan_charge_with_http_info(self, modify_request, id, **kwargs):  # noqa: E501
        """CRUD: Update a product rate plan charge  # noqa: E501

        Updates the information about a product rate plan charge.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_product_rate_plan_charge_with_http_info(modify_request, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['modify_request', 'id', 'accept_encoding', 'content_encoding', 'authorization', 'reject_unknown_fields', 'zuora_entity_ids', 'zuora_track_id', 'x_zuora_wsdl_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('modify_request' not in params or
            ...
            raise ValueError("Missing the required parameter `modify_request` when calling `object_put_product_rate_plan_charge`")  # noqa: E501
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_put_product_rate_plan_charge`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
