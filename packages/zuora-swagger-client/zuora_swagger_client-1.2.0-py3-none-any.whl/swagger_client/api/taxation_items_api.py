...
class TaxationItemsApi(object):
    ...
    def d_elete_taxation_item_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_taxation_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_taxation_item_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_taxation_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def object_post_taxation_item(self, create_request, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.object_post_taxation_item_with_http_info(create_request, **kwargs)  # noqa: E501
            return data
    ...
    def object_post_taxation_item_with_http_info(self, create_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('create_request' not in params or
            ...
            raise ValueError("Missing the required parameter `create_request` when calling `object_post_taxation_item`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `object_post_taxation_item`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `object_post_taxation_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_taxation_item_with_http_info(self, body, id, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_taxation_item`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
