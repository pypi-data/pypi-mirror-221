...
class JournalRunsApi(object):
    ...
    def d_elete_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        all_params = ['jr_number', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `d_elete_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_journal_run_with_http_info(self, request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_journal_run`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ut_journal_run_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ut_journal_run`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
