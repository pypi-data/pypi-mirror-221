...
class BillingDocumentsApi(object):
    ...
    def g_et_billing_document_files_deletion_job_with_http_info(self, job_id, **kwargs):  # noqa: E501
        ...
        all_params = ['job_id', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
            ...
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_billing_document_files_deletion_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def g_et_billing_documents(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_billing_documents(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_billing_documents_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.g_et_billing_documents_with_http_info(**kwargs)  # noqa: E501
            return data

    def g_et_billing_documents_with_http_info(self, **kwargs):  # noqa: E501
        """List billing documents for an account  # noqa: E501

        Retrieves the information about all billing documents associated with a specified account. The billing documents contain invoices, credit memos, and debit memos.  To retrieve information about credit memos and debit memos, you must have the Invoice Settlement feature enabled.   You can use query parameters to restrict the data returned in the response.  Examples: - /billing-documents?accountId=4028905f5e4feb38015e50af9aa002d1&sort=+documentDate - /billing-documents?accountId=4028905f5e4feb38015e50af9aa002d1&status=Posted - /billing-documents?accountNumber=A00000001&sort=+documentDate - /billing-documents?accountNumber=A00000001&status=Posted   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_billing_documents_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'page', 'page_size', 'account_id', 'account_number', 'document_date', 'status', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `g_et_billing_documents`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('page' in params and params['page'] < 1):  # noqa: E501
            raise ValueError("Invalid value for parameter `page` when calling `g_et_billing_documents`, must be a value greater than or equal to `1`")  # noqa: E501
    ...
    def p_ost_billing_document_files_deletion_job_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('idempotency_key' in params and
            ...
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_billing_document_files_deletion_job`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_billing_document_files_deletion_job`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
    ...
    def p_ost_generate_billing_documents(self, body, key, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_generate_billing_documents(body, key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_generate_billing_documents_with_http_info(body, key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_generate_billing_documents_with_http_info(body, key, **kwargs)  # noqa: E501
            return data

    def p_ost_generate_billing_documents_with_http_info(self, body, key, **kwargs):  # noqa: E501
        """Generate billing documents by account ID  # noqa: E501

        Generates draft or posted billing documents for a specified account. You can also generate billing documents for specified subscriptions of a specified account. The billing documents contain invoices and credit memos. To generate credit memos, you must have the Invoice Settlement feature enabled.  **Note**: You cannot generate billing documents for cancelled or suspended subscriptions.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_generate_billing_documents_with_http_info(body, key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'key', 'idempotency_key', 'accept_encoding', 'content_encoding', 'authorization', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('key' not in params or
            ...
            raise ValueError("Missing the required parameter `key` when calling `p_ost_generate_billing_documents`")  # noqa: E501

        if self.api_client.client_side_validation and ('idempotency_key' in params and
                                                       len(params['idempotency_key']) > 255):
            raise ValueError("Invalid value for parameter `idempotency_key` when calling `p_ost_generate_billing_documents`, length must be less than or equal to `255`")  # noqa: E501
        if self.api_client.client_side_validation and ('zuora_track_id' in params and
                                                       len(params['zuora_track_id']) > 64):
            raise ValueError("Invalid value for parameter `zuora_track_id` when calling `p_ost_generate_billing_documents`, length must be less than or equal to `64`")  # noqa: E501
        collection_formats = {}
