...
# (see guiqwt303/__init__.py for details)
...
LIBNAME = 'guiqwt303'
from guiqwt303 import __version__
from guiqwt303 import __description__
# Remove module from list to allow building doc from build dir
del sys.modules['guiqwt303']

LONG_DESCRIPTION = """\
guiqwt: Python tools for curve and image plotting
=================================================

.. image:: http://pythonhosted.org/guiqwt303/_images/panorama.png
...
.. _documentation: http://pythonhosted.org/guiqwt303/
.. _changelog: https://github.com/PierreRaybaut/guiqwt303/blob/master/CHANGELOG.md
.. _CECILL License: https://github.com/PierreRaybaut/guiqwt303/blob/master/Licence_CeCILL_V2-en.txt
...
plotting Qwt C++ library, included in guiqwt303 base source code) and on the
scientific modules NumPy and SciPy, ``guiqwt303`` is a Python library providing
...
.. _README: https://github.com/PierreRaybaut/guiqwt303/blob/master/README.md
"""
...
SCRIPTS = _create_script_list('guiqwt303-tests') + _create_script_list('sift')
...
setup(name=LIBNAME, version=__version__,
      ...
      install_requires=["NumPy>=1.3", "SciPy>=0.7", "guidata==1.7.7",
                        "PythonQwt==0.5.5", "Pillow"],
      extras_require = {
                        'Doc':  ["Sphinx>=1.1"],
                        'DICOM':  ["pydicom>=0.9.3"],
                        },
      entry_points={'gui_scripts':
                    ['guiqwt303-tests-py%d = guiqwt303.tests:run'\
                     % sys.version_info.major,
                     'sift-py%d = guiqwt303.tests.sift:run'\
                     % sys.version_info.major,]},
