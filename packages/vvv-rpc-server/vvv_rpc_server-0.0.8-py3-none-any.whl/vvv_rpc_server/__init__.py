...
def get_v_path_info():
    ...
    return v_chrome_file, v_chrome_main_file, v_chrome_exec_path, v_chrome_target, v_chrome_exec, v_chrome_update, v_configpath

def install():
    v_chrome_file, v_chrome_main_file, v_chrome_exec_path, v_chrome_target, v_chrome_exec, v_chrome_update, v_configpath = get_v_path_info()
