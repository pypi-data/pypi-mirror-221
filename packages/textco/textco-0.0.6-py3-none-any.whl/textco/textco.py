...
def textco():
  ...
  print("count, wordcloud, classify, qa, summary, emotion")
  print()
  print("enjoy! [Please be noted that enjoy is not a function!!]")
  print("**********************************************************")
...
def wordcloud():
  ...
  # Step 3: Extract keywords from the preprocessed text
  ...
  # Step 4: Generate the word cloud using extracted keywords
  ...
  if __name__ == "__main__":
      ...
      text_data = data_frame['abstract'].tolist()
