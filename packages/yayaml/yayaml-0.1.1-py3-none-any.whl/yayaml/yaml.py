...
yaml_unsafe = ruamel.yaml.YAML(typ="unsafe")
...
def add_representer(
    ...
    *,
    ...
    if _yaml is None:
        ...
        yaml_unsafe.representer.add_representer(t, resolved_representer)
    else:
...
def add_constructor(
    ...
    *,
    ...
    if _yaml is None:
        ...
        yaml_unsafe.constructor.add_constructor(tag, constructor)
    else:
