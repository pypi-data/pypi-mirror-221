...
class UserProfile(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_role", b"account_role", "display_name", b"display_name", "id", b"id", "job_function", b"job_function", "job_level", b"job_level"]) -> None: ...
