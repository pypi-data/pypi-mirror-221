...
class Variation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["environment_id", b"environment_id", "name", b"name", "spec", b"spec", "traffic", b"traffic"]) -> None: ...
