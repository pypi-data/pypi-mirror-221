...
class TrafficConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["audience_routes_entries", b"audience_routes_entries", "fallback_variation", b"fallback_variation", "selected_variation_name", b"selected_variation_name", "variations", b"variations"]) -> None: ...
...
class DeploymentBrief(google.protobuf.message.Message):
    ...
    UNDEPLOYMENT_TIMESTAMP_FIELD_NUMBER: builtins.int
    build_id: builtins.str
    ...
    """Variation Name"""
    @property
    def undeployment_timestamp(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """The undeployment date"""
    def __init__(
        self,
        *,
        build_id: builtins.str = ...,
        ...
        environment_id: builtins.str = ...,
        variation_name: builtins.str = ...,
        undeployment_timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["deployment_timestamp", b"deployment_timestamp", "undeployment_timestamp", b"undeployment_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "deployed_by", b"deployed_by", "deployment_timestamp", b"deployment_timestamp", "environment_id", b"environment_id", "failure_message", b"failure_message", "failure_reason_code", b"failure_reason_code", "status", b"status", "technical_details", b"technical_details", "undeployment_timestamp", b"undeployment_timestamp", "variation_name", b"variation_name"]) -> None: ...
