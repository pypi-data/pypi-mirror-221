...
#     # note: numpy uses 8 bits as smallest,
#     # so 'bit' type does nothing for bool.
#     ome_xml = ome.to_xml()
...
#
#
# # def load_volume(im_path_info, ch, vol_num, memmap):
# #     start = im_path_info.vols_per_buffer * vol_num
# #     end = start + im_path_info.vols_per_buffer
# # memmap[start:end, ch, ...] = load_tif(
# #     tif_frame, ch, im_path_info.num_channels
# # )
# # for idx, tif_frame in enumerate(im_path_info.data_tifs):
# #     im_volume[start:end, ...] = load_tif(
# #         tif_frame, ch, im_path_info.num_channels
# #     )
# # return im_volume
#
...
#         for vol_num in range(im_path_info.num_volumes):
#             if im_path_info.num_channels > 1:
#                 skewed_memmap[vol_num, ch_num, ...] = load_volume(
#                     im_path_info,
#                     ch_num,
#                     vol_num,
#                     skewed_memmap[vol_num, ch_num, ...],
#                 )[vol_num, ...]
#             else:
#                 skewed_memmap[vol_num, ...] = load_volume(
#                     im_path_info, ch_num, vol_num
#                 )[vol_num, ...]
#         # if im_path_info.num_channels > 1:
