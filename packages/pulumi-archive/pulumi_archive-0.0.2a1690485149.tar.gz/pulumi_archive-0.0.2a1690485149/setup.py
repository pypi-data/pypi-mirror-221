    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the archive resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource archive {PLUGIN_VERSION}`
                """)
            else:
                raise
...
def readme():
    try:
        ...
        return "archive Pulumi Package - Development Version"


setup(name='pulumi_archive',
      python_requires='>=3.7',
      version=VERSION,
