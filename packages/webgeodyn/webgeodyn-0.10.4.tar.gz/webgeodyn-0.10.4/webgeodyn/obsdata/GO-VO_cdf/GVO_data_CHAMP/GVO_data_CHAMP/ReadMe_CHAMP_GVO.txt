...
CH_OPER_VOBS_1M_2_20000815T000000_20100915T000000_0102.cdf
CH_OPER_VOBS_4M.cdf
...
%==========================================================================
The GVO processing using the CHAMP data are in accordance with the document SW-DS-DTU-GS-005_2-1_GVO_DPA
- GVO model setup:
...
%==========================================================================
The GVO CHAMP cdf files have a format in accordance with GVO Swarm cdf files described in the document SW-DS-DTU-GS-004_2-1_GVO_PDD.

1) 1-month GVOs
    Data used:
    - CHAMP MAG-L3 data (available from https://isdc.gfz-potsdam.de/homepage/) 
    - Down-sampled to 5 sec data sampling rate
    - No data selection criteria applied
	
    B_OB: observed field time series
    - covers period: 2001-2010
...
2) 4-month GVOs
    Data used
    - CHAMP MAG-L3 data, 5 sec data sampling rate
