...
GVO altitudes are computed at their mean orbital altitude (GVO). 
Afterwards they have been relocated to a common altitude of 700km as follows:   

GVO OBS altitude correction del_OBS using internal SH degrees: 
        B_COR = CHAOS(1-20)+LCS1(20-185) 
	del_OBS      = B_COR(700km) - B_COR(GVO)
	B_OBS(700km) = B_OBS(GVO) + del_OBS

GVO CORE altitude correction del_CORE using internal SH degrees: 
        B_COR = CHAOS(1-20)-LCS1(14-20) 
...
1) 4-month GVOs
    Data used
    - Oersted data (available from ftp://ftp.spacecenter.dk/data/magnetic-satellites/Oersted/), 5 sec data sampling rate, 1999-2004
    - CHAMP MAG-L3 data (available from https://isdc.gfz-potsdam.de/homepage/), 5 sec data sampling rate, 2000-2010
    - CRYOSAT-2 CHAOS calibrated data (Olsen et al., 2020), 5 sec data sampling rate, 2010-2018
    - Swarm Level 1b data, SW_OPER_MAGA_LR_1B, versions 0505/0506, 5 sec data sampling rate, 2014-2020
