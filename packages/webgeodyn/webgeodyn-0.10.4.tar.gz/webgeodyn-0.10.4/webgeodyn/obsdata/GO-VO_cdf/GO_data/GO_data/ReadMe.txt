...
GObs_1M_19970115T000000_20221215T000000_0107.cdf
GObs_4M_19970301T000000_20221101T000000_0107.cdf

Consists of data from 210 stations
...
%==========================================================================
The GObs time series are derived from version 0132 (from August 2022) of the ground observatory hourly means between 1997 and 2022 from the database AUX_OBS prepared by the British Geological Survey (BGS): ftp://ftp.nerc-murchison.ac.uk/geomag/Swarm/AUX_OBS/hour/ 
...
1) 1-month GObs
    ...
    -  Robust 1 monthly means from HMV, after subtracting CM4 SQ field predictions and CHAOS-7.11 external field predictions, with input from RC index RC_1997-2022_Sept_v3.dat. In the literature these are revered to as revised monthly means - see Olsen et al. (2014) for details. 
    ...
    bias_crust: 
    - observatory bias computed as the median of residuals between B_CF and CHAOS-7.11 field predictions to SH degree 14 for each component at each observatory
...
2) 4-month GObs
    ...
    B_CF: core field time series
    -  Robust 4 monthly means from HMV, after subtracting CM4 SQ predictions and CHAOS-7.11 external field model, with input from RC index RC_1997-2022_Sept_v3.dat These are  4-monthly versions of the revised monthly means of Olsen et al. (2014). 
    ...
    bias_crust: 
    - estimated observatory bias (mostly from the crust) computed as median of residuals between B_CF and CHAOS-7.11 field predictions to SH degree 14 for each component at each observatory
...
3) 1-year GObs
    ...
    B_CF: core field time series
    -  Robust annual means from HMV, after subtracting CM4 SQ predictions and CHAOS-7.11 external field model, with input from RC index RC_1997-2022_Sept_v3.dat These are  annual versions of the revised monthly means of Olsen et al. (2014). 
