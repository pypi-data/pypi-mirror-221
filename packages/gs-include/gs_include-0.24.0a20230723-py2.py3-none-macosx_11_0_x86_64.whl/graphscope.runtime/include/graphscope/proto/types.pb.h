...
PROTOBUF_NAMESPACE_OPEN
template <>
::gs::rpc::QueryArgs* Arena::CreateMaybeMessage<::gs::rpc::QueryArgs>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
const std::string& ClusterType_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(ClusterType_descriptor(), value);
}
...
const std::string& DataType_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(DataType_descriptor(), value);
}
...
const std::string& OutputType_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(OutputType_descriptor(), value);
}
...
const std::string& OperationType_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(OperationType_descriptor(), value);
}
...
const std::string& ParamKey_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(ParamKey_descriptor(), value);
}
...
inline const std::string& ModifyType_Name(ModifyType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ModifyType_descriptor,
                                                 0, 5>(
      static_cast<int>(value));
}
...
inline const std::string& ReportType_Name(ReportType value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<ReportType_descriptor,
                                                 0, 16>(
      static_cast<int>(value));
}
...
class QueryArgs final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::PROTOBUF_NAMESPACE_ID::Any>& _internal_args() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::PROTOBUF_NAMESPACE_ID::Any>* _internal_mutable_args();
  public:
