...
@action('heaserver-activity-recentlyaccessed-get-actual', rel='hea-actual', path='{+actual_object_uri}', root='')
async def get_recently_accessed(request: web.Request) -> web.Response:
    ...
    async with _lock:
        async for a in mongoservicelib.get_all_gen(request,
                                                ...
                                                mongoattributes={'$and': [{'new_object_type_name': {'$eq': type_}},
                                                                        {'$or': [{'volume_id': {'$exists': False}},
                                                                                {'volume_id': {'$in': volume_ids + [None]}}]}]},
            ...
            if desktop_object_action.new_object_id in recently_accessed_object_ids:
                continue
            ...
            recently_accessed_view.created = desktop_object_action.new_object_created
            recently_accessed_view.modified = desktop_object_action.new_object_modified
