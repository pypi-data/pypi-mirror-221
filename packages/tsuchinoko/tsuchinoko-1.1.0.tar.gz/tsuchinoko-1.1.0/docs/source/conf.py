...
# -*- coding: utf-8 -*-
#
# Tsuchinoko documentation build configuration file, created by
...
version = tsuchinoko.__version__
# The full version, including alpha/beta/rc tags.
release = tsuchinoko.__version__
...
latex_documents = [
    (master_doc, 'tsuchinoko.tex', 'Tsuchinoko Documentation',
     'Contributors', 'manual'),
]
