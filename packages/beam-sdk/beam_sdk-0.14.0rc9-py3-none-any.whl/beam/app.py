...
class Image:
    def __init__(
        self,
        python_version: str = PythonVersion.Python38,
...
class Volume:
    def __init__(
        self, name: str, path: str, volume_type: VolumeType = VolumeType.Shared
    ):
        self.name = name
        self.app_path = path
...
class App:
    ...
    def _parse_path(self, path: str, handler: str = ""):
        parsed_path = path
    ...
    def _get_function_path(self, func: Union[Callable, str] = None):
    ...
    def task_queue(
        ...
        loader: Union[Callable, str] = None,
        ...
        def decorator(func):
            ...
            parsed_path = self._parse_path(path, handler_path)
