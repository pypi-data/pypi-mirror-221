...
@click.option('--cache-dir', help='Path of states file.', type=click.Path(file_okay=False, exists=False), is_eager=True,
              default=Path.home().joinpath('.cache', 'git-timemachine'))
