<template>
  <div id="mission-turnarounds" :class="$style['mission-turnarounds']">
    <div :class="$style['mission-turnarounds__table-wrapper']">
      <div ref="tableWrapperRef" class="overflow-x-auto !overflow-y-visible max-h-[52rem]">
        <table
          class="relative"
...
.mission-turnarounds {
  ...
  &__title {
    @apply text-center text-base font-medium text-grey-900 py-2 #{!important};
  }
  ...
  .service-table {
    ...
    th,
    td {
      @apply p-3 text-xs border-r border-grey-opacity-800/25;
      &:not(:last-child) {
        @apply min-w-[8rem];
      }
    }
