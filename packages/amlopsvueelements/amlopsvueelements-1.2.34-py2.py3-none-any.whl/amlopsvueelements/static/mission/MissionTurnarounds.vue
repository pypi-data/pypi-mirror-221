<template>
  <div id="mission-turnarounds" :class="$style['mission-turnarounds']">
    <div :class="$style['mission-turnarounds__table-wrapper']">
      ...
      <div
        ref="tableWrapperRef"
        class="overflow-x-auto !overflow-y-visible max-h-[52rem] border-b border-grey-opacity-800/25"
      >
        <table
          class="relative"
...
.mission-turnarounds {
  ...
  &__title {
    @apply text-center font-medium text-grey-900 py-2 #{!important};
  }
  ...
  .service-table {
    ...
    th,
    td {
      @apply p-3 text-sm border-r border-grey-opacity-800/25;
      &:not(:last-child) {
        @apply min-w-[8rem];
      }
    }
    ...
    thead {
      .service-table__header-row {
        ...
        th {
          @apply border-r-0 px-0 text-grey-900;
          &:first-child {
            @apply p-3;
          }
        }
    ...
    tbody {
      .service-table__body-row {
        ...
        td {
          @apply text-center border border-l-0 border-grey-opacity-800/25;
          &:last-child {
            @apply border-r-0;
          }
        }
