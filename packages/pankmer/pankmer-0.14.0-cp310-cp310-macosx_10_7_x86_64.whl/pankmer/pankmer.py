...
from pankmer.tree import tree, adj_to_jaccard, adj_to_overlap, adj_to_qv, adj_to_qv_symmetric
...
def main():
    ...
    tree_parser.add_argument(
        '--metric', choices=('intersection', 'jaccard', 'overlap', 'qv', 'qv_symmetric'),
    ...
    similarity_parser.add_argument(
        '--metric', choices=('jaccard', 'overlap', 'qv', 'qv_symmetric'),
