...
class AngleRoi():
    ...
    def setROI(self, x: float, y: float, index: int):
        if index == 1:
            self.line1.setROI(x, y, x, y)
        elif index == 2:
            self.line1.setROI(self.line1.line().p1().x(), self.line1.line().p1().y(), x, y)
            self.line2.setROI(x, y, x, y)
        elif index == 3:
            self.line2.setROI(self.line2.line().p1().x(), self.line2.line().p1().y(), x, y)
