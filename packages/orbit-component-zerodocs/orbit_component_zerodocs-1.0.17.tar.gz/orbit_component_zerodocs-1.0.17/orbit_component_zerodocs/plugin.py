...
class Args (ArgsBase):
    ...
    def setup (self):
        self._parser.add_argument("--zd-follow", nargs=5, type=str, help='Map a local source path unto the cache for previewing', metavar="(PATH, API, PROVIDER, PROJECT, BRANCH)")
        return self
