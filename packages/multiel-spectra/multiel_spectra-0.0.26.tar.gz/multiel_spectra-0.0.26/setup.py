...
setup(
    ...
    url='https://github.com/Fernandogarciagoatcoder/multiel_spectra',
    project_urls={
        'Documentation': 'https://github.com/Fernandogarciagoatcoder/multiel_spectra',
        'Bug Reports':
        'https://github.com/Fernandogarciagoatcoder/multiel_spectra',
        'Source Code': 'https://github.com/Fernandogarciagoatcoder/multiel_spectra',
        # 'Funding': '',
        # 'Say Thanks!': '',
    },
    package_dir={'': 'src'},
