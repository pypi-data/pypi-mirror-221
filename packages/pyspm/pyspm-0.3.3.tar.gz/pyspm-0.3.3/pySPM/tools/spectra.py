...
from PyQt5.QtWidgets import QMainWindow, QShortcut, QApplication, QFileDialog, QTableWidgetItem
...
class SpectraViewer(QMainWindow):
    ...
    def plot_labels(self, colors=['r', 'g', 'b']):
        ...
        for i, (mi, Ei) in enumerate(P):
            ...
            self.labels.append(
                self.ax.annotate(Ei, (mi, y), (5, 0), rotation=90, va='top', ha='left', textcoords='offset pixels'))
            if dmi > 0:
