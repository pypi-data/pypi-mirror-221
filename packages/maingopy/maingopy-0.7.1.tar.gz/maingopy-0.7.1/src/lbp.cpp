...
void
LowerBoundingSolver::pass_data_position_to_solver(const std::shared_ptr<std::vector<std::set<unsigned int>>> datasetsIn, const unsigned int indexFirstDataIn)
{
...
void
LowerBoundingSolver::update_datasets_and_storedSubgraphs(std::set<unsigned int> &newDataset)
{
