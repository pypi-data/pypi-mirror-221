...
// modified at AVT.SVT, 17.04.2019

#define MANGLINGFILE "clpNameMangling.h"
#include MANGLINGFILE
#define MANGLINGMACRO FCCLP_GLOBAL
#define MANGLINGMACRO_ FCCLP_GLOBAL_
...
#define COINUTILS_HAS_STDINT_H

/* Default maximum pooled allocation size */
#undef COINUTILS_MEMPOOL_MAXPOOLED
...
#define F77_FUNC MANGLINGMACRO

/* As F77_FUNC, but for C identifiers containing underscores. */
#define F77_FUNC_ MANGLINGMACRO_
