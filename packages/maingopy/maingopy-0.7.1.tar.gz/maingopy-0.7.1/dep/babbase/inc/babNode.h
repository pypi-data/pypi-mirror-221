...
/**
    ...
    * It also contains a pruning score.
    */
class BabNode {
  ...
  public:
    /**
        ...
        */
    BabNode(double pruningScoreIn, const std::vector<double>& lbdsIn, const std::vector<double>& ubdsIn, const unsigned int indexDatasetIn, const int idIn, const unsigned depthIn, const bool augmentData):
        _pruningScore(pruningScoreIn), _lowerBounds(lbdsIn), _upperBounds(ubdsIn), _indexDataset(indexDatasetIn), _idNumber(idIn), _depth(depthIn), _augmentData(augmentData) {}
    ...
    /**
        ...
        * @param[in] augmentData tells whether dataset of this node is augmented in current iteration (see growing datasets)
        */
    BabNode(double pruningScoreIn, const std::vector<OptimizationVariable>& variablesIn, const unsigned int indexDatasetIn, const int idIn, const unsigned depthIn, const bool augmentData):
        _pruningScore(pruningScoreIn), _indexDataset(indexDatasetIn), _idNumber(idIn), _depth(depthIn), _augmentData(augmentData)
    {
    ...
    /**
        ...
        */
    BabNode():
        _pruningScore(std::numeric_limits<double>::infinity()), _depth(0), _idNumber(0), _indexDataset(0), _augmentData(false) {}
