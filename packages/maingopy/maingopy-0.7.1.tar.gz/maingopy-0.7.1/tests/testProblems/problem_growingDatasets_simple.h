...
*
*/
class Model_growing_simple: public maingo::MAiNGOmodel {

  public:
    Model_growing_simple();
...
Model_growing_simple::get_variables()
{
...
std::vector<double>
Model_growing_simple::get_initial_point()
{
...
Model_growing_simple::Model_growing_simple()
{
...
Model_growing_simple::evaluate(const std::vector<Var> &optVars)
{
