...
class PolarsAI(Shortcuts):
    ...
    def __init__(
        ...
        __init__ method of the Class PolarsAI
    ...
    def clear_cache(self):
        """
        Clears the cache of the PolarssAI instance.
        """
        if self._cache:
            self._cache.clear()
    ...
    def process_id(self) -> str:
        """Return the id of this PolarsAI object."""
    ...
    def last_prompt_id(self) -> str:
        ...
        if self._prompt_id is None:
            raise ValueError("PolarsAI has not been run yet.")
