...
from qctrlcommons.node.composite.signal_utils import validate_optimizable_parameter
...
class PwcSignals:
    """
    Class for the PWC Signal nodes.
    """
    ...
    def cosine_pulse_pwc(
        ...
        if flat_duration is not None:
            check_argument(
                ...
                "The flat duration must be positive and less than the end time of the "
                "pulse minus the start time.",
                {
                    "flat_duration": flat_duration,
