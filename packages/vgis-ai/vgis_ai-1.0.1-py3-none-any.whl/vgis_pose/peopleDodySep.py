...
# 个人账号
# # 百度API_Key
# baidu_ak = "rOgIZsoijcPHGm8nIeEhnwns"
# # 百度Secret_Key
# baidu_sk = "W885bpiWGwDG6aWxCo1rEVuE0eFzX95R"
# # 百度Access Token
# baidu_auth = "24.8d9d521f58585baba6516f971bc56d43.2592000.1641705429.282335-25164389"

# 公司企业账号
# 百度API_Key
baidu_ak = "IxOVNeGoHirQaMjymTIbLUoq"
# 百度Secret_Key
baidu_sk = "u60veGmbv9P87xXXXw1rVT0XgXWvhGuN"
# 百度Access Token
...
# 多注册几个账号进行轮换使用
def reg_body_outline_by_baidu(in_file_path, out_file_path):
    global baidu_auth
...
def getBodyOutlinePic(file_dir):
    # FileHelper = FileOperator()
    # ImageHelper = ImageOperator()
    # file_dir = "E:\\tiqu"
    ...
    for each_pic in all_pic_list:
        ...
        if file_size_mb <= 4:
            ...
            try:
                ...
                reg_body_outline_by_baidu(in_file_path, out_file_path)
...
if __name__ == '__main__':
    ...
    # tiqu_file_dir = "E:\\人像分割\\小琴"
    # getBodyOutlinePic(tiqu_file_dir)
    outline_file_path = "E:\\人像分割\\小琴\\第1疗程\\第1次\\DSCF0536_调整大小_tiqu.JPG"
