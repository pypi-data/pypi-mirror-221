...
from PyQt6.QtCore import QCoreApplication, QMetaObject, QRect, QSize, QPoint, Qt, pyqtSlot
from PyQt6.QtGui import QFont, QGuiApplication
from trajectopy.gui.models.entry import TrajectoryEntry
...
class SettingsGUI(QtWidgets.QMainWindow):
    ...
    def setupUi(self) -> None:
        ...
        spacerItem4 = QtWidgets.QSpacerItem(
            20, 40, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding
        )
        ...
        spacerItem8 = QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding
        )
        ...
        self.comparisonFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.relative_all_pairs_label)
        self.relativeAllPairs = QtWidgets.QCheckBox(self.comparisonVerticalLayoutWidget)
        self.relativeAllPairs.setText("")
        self.relativeAllPairs.setChecked(False)
        self.relativeAllPairs.setObjectName("relativeAllPairs")
        self.comparisonFormLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.relativeAllPairs)
    ...
    def retranslateUi(self) -> None:
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.alignmentTab), _translate("MainWindow", "Alignment"))
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.approximationTab), _translate("MainWindow", "Approximation")
        )
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.comparisonTab), _translate("MainWindow", "Comparison"))
        ...
        self.relative_tdist_label.setText(_translate("MainWindow", "Temporal Pose Distance [s]:"))
        self.relative_dist_label.setText(_translate("MainWindow", "Pose Distance [m]:"))
    ...
    def update_comparison_view(self) -> None:
        self.matchingMaxTimeDiff.setValue(
            self.trajectory_entry.settings.comparison.type.matching_settings.max_time_diff
        )
        self.matchingMaxDistDiff.setValue(
            self.trajectory_entry.settings.comparison.type.matching_settings.max_distance
        )
        self.relativeTDist.setValue(self.trajectory_entry.settings.comparison.relative_pair_time_difference)
        self.relativeDist.setValue(self.trajectory_entry.settings.comparison.relative_pair_distance)
        self.relativeAllPairs.setChecked(self.trajectory_entry.settings.comparison.use_all_pose_pairs)
    ...
    def update_comparison_model(self) -> None:
        self.trajectory_entry.settings.comparison.type.matching_settings.max_time_diff = (
            self.matchingMaxTimeDiff.value()
        )
        self.trajectory_entry.settings.comparison.type.matching_settings.max_distance = (
            self.matchingMaxDistDiff.value()
        )
        self.trajectory_entry.settings.comparison.relative_pair_distance = self.relativeDist.value()
        self.trajectory_entry.settings.comparison.relative_pair_time_difference = self.relativeTDist.value()
        self.trajectory_entry.settings.comparison.use_all_pose_pairs = self.relativeAllPairs.isChecked()

        self.trajectory_entry.settings.alignment.preprocessing.matching_settings.max_time_diff = (
            self.matchingMaxTimeDiff.value()
        )
        self.trajectory_entry.settings.alignment.preprocessing.matching_settings.max_distance = (
            self.matchingMaxDistDiff.value()
        )
