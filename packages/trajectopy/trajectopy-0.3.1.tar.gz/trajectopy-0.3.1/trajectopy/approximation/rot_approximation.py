...
from trajectopy.util.datahandling import rndodd
from scipy.spatial.transform import Slerp, Rotation

from trajectopy.util.spatialsorter import detect_laps_by_length
...
def _average_rot(x: float, lap_slerp: list[Tuple[Slerp, RotationSet]]) -> np.ndarray:
    """
