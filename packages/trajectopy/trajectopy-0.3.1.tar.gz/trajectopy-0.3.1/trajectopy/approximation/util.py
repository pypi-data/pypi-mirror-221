...
def sparse_least_squares(design_matrix: csr_matrix, observations: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
...
def least_squares(
    design_matrix: np.ndarray, observations: np.ndarray, sigma_ll: np.ndarray = np.array([])
) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
    """
    ...
    # solve normal equations
    x_s = np.linalg.solve(design_matrix.T @ sigma_ll @ design_matrix, design_matrix.T @ sigma_ll @ observations)
