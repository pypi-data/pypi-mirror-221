...
from trajectopy.util.path import VERSION_FILE_PATH


VERSION = open(VERSION_FILE_PATH, "r").read()
YEAR = "2023"
...
class TrajectopyGUI(QtWidgets.QMainWindow):
    ...
    def setup_ui_manager_connections(self):
        ...
        self.ui_manager.session_request.connect(self.session_manager.handle_request)
    ...
    def setupUi(self):
        ...
        self.trajectoryTableView = TrajectoryTableView(
            parent=self.verticalLayoutWidget, trajectory_table_model=self.trajectory_table_model
        )
        ...
        spacerItem1 = QtWidgets.QSpacerItem(
            0, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum
        )
