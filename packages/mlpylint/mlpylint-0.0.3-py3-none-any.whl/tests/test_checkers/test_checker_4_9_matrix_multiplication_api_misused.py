...
REGISTERED_CHECKERS = [MatrixMultiplicationAPIMisused]


def test_checker_4_9_matrix_multiplication_api_misused():
    print(" Testing... \n")

    file_path = 'file_checker_4_9_matrix_multiplication_api_misused.py'
