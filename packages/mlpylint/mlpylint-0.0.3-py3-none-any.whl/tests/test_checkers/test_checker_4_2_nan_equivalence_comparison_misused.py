...
REGISTERED_CHECKERS = [NaNEquivalenceComparisonMisusedChecker]


def test_checker_4_2_nan_equivalence_comparison_misused():
    print(" Testing... \n")

    file_path = 'file_checker_4_2_nan_equivalence_comparison_misused.py'
