...
@task_recipe(
    ...
    field_props={
        ...
        "pos_pron_tags": ListProps(title="Possessive pronoun tags", description="List of fine-grained tag values for possessive pronoun to use in patterns", placeholder="Type labels here..."),
...
def coref(
    *,
    ...
    disable_matcher.add_patterns([{"pattern": [disable_token], "label": ""}])
