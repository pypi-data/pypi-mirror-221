...
def data(train_set=[], train_labels=[], test_set=[], test_labels=[], val_set=[], val_labels=[],
  ...
  if len(train_set) > 0:
    with open(run_dir_global+'/train_set.pkl', 'wb') as f:
        dill.dump(model, f)
    '''
  ...
  if len(val_set) > 0:
    with open(run_dir_global+'/val_set.pkl', 'wb') as f:
        dill.dump(model, f)
    '''
  ...
  if len(test_set) > 0:
    with open(run_dir_global+'/test_set.pkl', 'wb') as f:
        dill.dump(model, f)
    '''
  ...
  if len(train_labels) > 0:
    ...
    with open(run_dir_global+'/train_labels.pkl', 'wb') as f:
        dill.dump(model, f)
  ...
  if len(val_labels) > 0:
    ...
    with open(run_dir_global+'/val_labels.pkl', 'wb') as f:
        dill.dump(model, f)
  ...
  if len(test_labels) > 0:
    ...
    with open(run_dir_global+'/test_labels.pkl', 'wb') as f:
        dill.dump(model, f)
