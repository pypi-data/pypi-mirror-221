...
from libquery_extensions import (
    BritishLibraryImagesOnline as _BritishLibraryImagesOnline,
)
...
class BritishLibraryImagesOnline(_BritishLibraryImagesOnline):
    """
    The querier for the `British Library Images Online` data source.
    """
