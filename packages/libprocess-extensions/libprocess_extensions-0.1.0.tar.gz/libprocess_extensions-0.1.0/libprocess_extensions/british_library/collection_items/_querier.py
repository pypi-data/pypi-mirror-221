...
from libquery_extensions import (
    BritishLibraryCollectionItems as _BritishLibraryCollectionItems,
)
...
class BritishLibraryCollectionItems(_BritishLibraryCollectionItems):
    """
    The querier for the `British Library Collection Items` data source.
    """
