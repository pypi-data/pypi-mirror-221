...
from climify_api.auth import AuthenticationMethod, LoginAuthService, IAuthService
...
class ApiClient:
    ...
    def __init__(
        ...
        if configuration.authentication_method == AuthenticationMethod.CLIENT_CREDENTIALS and auth_service is None:
            auth_service = LoginAuthService(
    ...
    def __call_api(
        ...
        # auth setting
        self.update_params_for_auth(used_headers, access_token)
    ...
    def update_params_for_auth(self, headers: typing.Optional[HTTPHeaderDict], access_token: str):
        """Adds authorization token header using the IAuthService instance provided in the constructor, ¨
        or the given access_token
        ...
        """
        headers.add(
            'authorization', f'Bearer {access_token or self._auth_service.get_access_token()}'
        )
