...
class ServiceApi(object):
    ...
    def api_service_clusters_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ClusterStatus]',  # noqa: E501
    ...
    def api_service_dailymeasures_measures_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[DatedMeasureName] measures: names of the measures to retrieve
        :param datetime start_date: first date to retrieve in measures list
        :param datetime end_date: last date to retrieve in measures list
        :param str api_version: The requested API version
        :return: list[DatedMeasure]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def api_service_dailymeasures_measures_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[DatedMeasure]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def api_service_datastorageunits_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[DataStoragUnit]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def api_service_errorscount_offset_id_get(self, offset_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int offset_id: Only entries with Id greater than offsetId will be used (required)
        :param str api_version: The requested API version
        :return: int
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_service_lasterrors_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int number_of_items: number of errors to retrieve. 3 by default
        :param str api_version: The requested API version
    ...
    def api_service_lastwarnings_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int number_of_items: number of warnings to retrieve. 3 by default.
        :param str api_version: The requested API version
        :return: LogEntry
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_service_logcount_offset_id_severities_get(self, offset_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int offset_id: Only entries with Id greater than offsetId will be used (required)
        :param list[str] severities: Severities expected on the log entries, if not specified, all of them are recovered
        :param str api_version: The requested API version
        :return: dict(str, int)
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_service_measures_measures_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param list[MeasureName] measures:
        :param str api_version: The requested API version
        :return: list[Measure]
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_service_measures_measures_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Measure]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def api_service_services_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str api_version: The requested API version
        :return: list[LlagarServiceResponse]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def api_service_services_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[LlagarServiceResponse]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
