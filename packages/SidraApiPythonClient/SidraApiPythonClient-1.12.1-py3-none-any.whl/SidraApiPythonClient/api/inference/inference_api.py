...
class InferenceApi(object):
    ...
    def api_inference_datatype_post(self, **kwargs):  # noqa: E501
        ...
        :param DataTypeInferenceDto body:
        :param str api_version: The requested API version
        :return: DataTypeInferenceResponse
    ...
    def api_inference_datatype_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='DataTypeInferenceResponse',  # noqa: E501
    ...
    def api_inference_db_extract_metadata_inference_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param DbExtractInferenceOptions body: Inference options
        :param str api_version: The requested API version
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def api_inference_dbextractinference_post(self, **kwargs):  # noqa: E501
        ...
        :param DbExtractInferenceOptions body: Inference options
        :param str api_version: The requested API version
        :return: list[EntityAttributesDto]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def api_inference_dbextractinference_post_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[EntityAttributesDto]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def api_inference_infer_get(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str file_uri: The uri of the blob storage where the file is.
        :param bool has_header: Indicates if the file contains headers in the first line.
        :param str separator: Indicates field separator. If not indicated, the most repeated will be chosen.
        :param int id_provider: Id Provider
        :param str api_version: The requested API version
    ...
    def api_inference_infer_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[AttributeDto]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
