...
from SidraApiPythonClient.authentication import Authentication
...
class Configuration:
    ...
    def __init__(self, host, auth_url, scope, client_id, client_secret):
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("SidraApiPythonClient")
    ...
    def get_oauth2_token(self, api_client):
        ...
        if self.last_token is None or self.last_token_timestamp < time.time():
            self.last_token = Authentication(
            ...
            self.last_token_timestamp = float(jwt.decode(self.last_token, 'secret', algorithms=['RS256'], verify=False)['exp'])
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 1.12.0.post19".\
