    ...
    def construction(self):
        for industry_type in ['申万', '中信']:
            for industry_level in [1, 2]:
                ...
                industry_nmv_list, industry_ret_list = [], []
                for idx, industry_id in enumerate(self.industry_list):
                    stock_daily_k_ind = stock_daily_k[stock_daily_k['INDUSTRY_ID'] == industry_id]
                    stock_daily_k_ind = stock_daily_k_ind[['TRADE_DATE', 'TICKER_SYMBOL', 'PCT_CHANGE', 'NEG_MARKET_VALUE']].dropna()
                ...
                date_list = [date for date in stock_finance['END_DATE'].unique().tolist() if date >= self.start_date and date <= self.end_date and (date[4:6] == '06' or date[4:6] == '12')]
                ...
                date_list = growth['END_DATE'].unique().tolist()
                ...
                style_nav.to_excel('{0}style_construction/{1}_{2}/style_nav.xlsx'.format(self.data_path, industry_type, industry_level))
...
if __name__ == '__main__':
    ...
    # insert_ytm(data_path, '20230531', '20230630')
    ...
    # StyleConstruction('20091231', '20230630', '20230331', data_path).construction()