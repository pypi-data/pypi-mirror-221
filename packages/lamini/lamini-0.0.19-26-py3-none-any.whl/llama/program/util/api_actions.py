...
def gen_submit_training_job(
    id, model_name, prompt_key, enable_peft, finetune_args, prompt_templates
):
    # Assume that all values have the same program
    params = {
        "id": id,
...
def gen_training_job_status(job_id: str):
    params = {
        "job_id": job_id,
    }
...
def gen_cancel_training_job(job_id: str):
    params = {
        "job_id": job_id,
    }
...
def gen_training_eval(job_id: str):
    params = {
        "job_id": job_id,
    }
...
def gen_job_results(job_id: str, output_type=None):
    # Assume that all values have the same program
    params = {
        "job_id": job_id,
    }
