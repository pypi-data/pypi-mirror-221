...
def sqlalchemy_add_result_more_fetch():
    ...
    def method_rprint(self: RResult) -> None:
        """
        Print result in table format.
        """
    ...
    CursorResult.rprint = method_rprint
    ...
    class RResult(CursorResult):
        ...
        fetch_table = CursorResult.fetch_table
        fetch_dict = CursorResult.fetch_dict
        fetch_df = CursorResult.fetch_df
        fetch_json = CursorResult.fetch_json
        fetch_sql = CursorResult.fetch_sql
        fetch_html = CursorResult.fetch_html
        fetch_csv = CursorResult.fetch_csv
        fetch_excel = CursorResult.fetch_excel
        rprint = CursorResult.rprint
