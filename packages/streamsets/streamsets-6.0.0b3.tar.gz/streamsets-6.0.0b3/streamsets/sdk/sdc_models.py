...
class Stage:
    ...
    def add_output(self, *other_stages, event_lane=False, allow_empty_stages=False):
        ...
        for other_stage in other_stages:
            if not event_lane:
                if self.output_streams == self.output_lanes_idx:
                    self.output_lanes_idx = 0
    ...
    def disconnect_output_lanes(self, stages=None, all_stages=False):
    ...
    def connect_inputs(self, stages=None, event_lane=False):
        ...
        for stage in stages:
            stage.add_output(self, event_lane=event_lane)

    def connect_outputs(self, stages=None, event_lane=False):
        ...
        self.add_output(*stages, event_lane=event_lane)
...
class PipelineBuilder:
    ...
    def add_fragment(self, fragment, parameter_name_prefix=None):
        ...
        return self._all_stages.get(stage_instance['stageName'], Stage)(stage=stage_instance,
                                                                        ...
                                                                        output_streams=
                                                                        stage_definition.get('outputStreams', 0))
