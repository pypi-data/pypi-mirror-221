...
from . import sch_api
from .constants import SNOWFLAKE_STAGE_RENAME_ALIASES
...
class SchSdcStage(SdcStage):
    """
        Args:
            ...
            label (:obj:`str`, optional): Label of the stage. Default: ``None``
            supported_connection_types (:obj:`list`, optional): List of :obj:`str` instances of supported connection
                types. Default: ``None``
    """
    def __init__(self, stage, pipeline=None, label=None, output_streams=None, supported_connection_types=None):
        self._supported_connection_types = supported_connection_types
        self._pipeline = pipeline
        super().__init__(stage, label, output_streams)
...
class Pipeline(BaseModel):
        ...
        if not self._data_internal['libraryDefinitions']:
            ...
            if not self._data_internal['libraryDefinitions']:
                try:
                    ...
                    self._data_internal['libraryDefinitions'] = authoring_engine._instance.api_client.get_definitions()
                    ...
                    raise ValueError('Editing pipeline {} is not supported when the engine is not accessible,'
                                     ...
                                     .format(self.pipeline_id, self.sdc_id)) from e
    ...
    def add_stage(self, label=None, name=None, type=None, library=None):
        ...
        try:
            pipeline_builder = (self._control_hub.get_pipeline_builder(engine_type=executor_type.get(self.executor_type)
