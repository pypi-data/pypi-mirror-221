...
class Stage:
    ...
    def connect_inputs(self, stages=None):
        ...
        for stage in stages:
            stage.add_output(self, event_lane=True)

    def connect_outputs(self, stages=None):
        ...
        self.add_output(*stages, event_lane=True)
