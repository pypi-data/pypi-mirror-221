...
"""
        ...
        return
    elif "MODE" in os.environ and os.environ["MODE"] == "MODALBUILD":
        subprocess.run([sys.executable, "-m", "pip", "install", "modal-client"], timeout=900)
        return "ok"
    elif "MODE" in os.environ and os.environ["MODE"] == "MODAL":
        return "ok"
...
if "MODE" in os.environ and os.environ["MODE"] == "MODAL":
    import modal
    from modal import web_endpoint, Stub

    image = modal.Image.from_aws_ecr(os.environ["IMAGE_URL"])
    stub = Stub(os.environ["PROJECT_NAME"], image=image)
...
__all__ = [
    ...
    "download_from_file_record",
    "download_from_registered_file",
    "map",
    "set_vars",
    "DISPATCHER_URL",
    "TOKEN",
