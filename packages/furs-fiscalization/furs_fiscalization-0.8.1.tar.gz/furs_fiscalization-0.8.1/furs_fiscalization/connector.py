...
FURS_TEST_CERT = os.path.join(os.path.dirname(__file__), 'certs/blagajne-test-tls.cer')
FURS_PRODUCTION_CERT = os.path.join(os.path.dirname(__file__), 'certs/blagajne-tls.cer')
