# python build stubs for package go_goose
...
mod = Module('_go_goose')
mod.add_include('"go_goose_go.h"')
...
add_checked_function(mod, 'go_goose_ExtractCleanText', retval('int64_t'), [param('char*', 'recordID'), param('char*', 'rawHtml')])

mod.generate(open('go_goose.c', 'w'))
