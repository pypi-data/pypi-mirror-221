...
int main(int argc, char** argv)
{
  ...
  CSSBenchAddVarI(0, (char*) "  \"kernel_repetitions\":%u", repeat);
  CSSBenchAddVarI(1, (char*) "  \"dim_n\":%u", N);
  CSSBenchAddVarI(2, (char*) "  \"dim_nxn\":%u", N*N);
  ...
  /* Run kernel. */CSSBenchStartCounter(0);
