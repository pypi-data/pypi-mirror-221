...
class LidarMountingPosition(Dnv):
    """LidarMountingPosition - The offset of the Lidar device from it&#39;s attachment point, in the component&#39;s axis system.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = LidarMountingPosition.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = LidarMountingPosition.from_json('{ ... }')
        """
...
LidarMountingPosition.update_forward_refs()
