...
class TimeVsWindMeanSpeed(Dnv):
    """TimeVsWindMeanSpeed - A line or row in a look-up table, specifying a value of MeanSpeed for a specified Time.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TimeVsWindMeanSpeed.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TimeVsWindMeanSpeed.from_json('{ ... }')
        """
...
TimeVsWindMeanSpeed.update_forward_refs()
