...
class BladeHydrodynamicOutputs(Dnv):
    """BladeHydrodynamicOutputs - Loads selected
    
    Attributes:
    ----------
    WaterKinematics : bool, default=False
        If true, output water blade kinematics (tidal only)
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = BladeHydrodynamicOutputs.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = BladeHydrodynamicOutputs.from_json('{ ... }')
        """
...
BladeHydrodynamicOutputs.update_forward_refs()
