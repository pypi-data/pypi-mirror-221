...
class BladeAerodynamicOutputs(Dnv):
    """BladeAerodynamicOutputs - Loads selected
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = BladeAerodynamicOutputs.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = BladeAerodynamicOutputs.from_json('{ ... }')
        """
...
BladeAerodynamicOutputs.update_forward_refs()
