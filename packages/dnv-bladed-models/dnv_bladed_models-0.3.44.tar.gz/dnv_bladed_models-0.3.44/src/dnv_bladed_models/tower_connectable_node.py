...
class TowerConnectableNode(ConnectableNode):
    """TowerConnectableNode - The definition of a connectable node on a tower component.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TowerConnectableNode.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TowerConnectableNode.from_json('{ ... }')
        """
