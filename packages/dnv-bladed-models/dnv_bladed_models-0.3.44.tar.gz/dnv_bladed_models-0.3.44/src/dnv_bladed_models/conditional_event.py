...
class ConditionalEvent(Event):
    """ConditionalEvent - An event which may occur during the simulation if its conditions are met.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = ConditionalEvent.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = ConditionalEvent.from_json('{ ... }')
        """
