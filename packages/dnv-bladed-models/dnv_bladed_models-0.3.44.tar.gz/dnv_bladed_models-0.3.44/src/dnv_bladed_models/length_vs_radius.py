...
class LengthVsRadius(Dnv):
    """LengthVsRadius - A line or row in a look-up table specifying the nacelle cover&#39;s radius for a given length.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = LengthVsRadius.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = LengthVsRadius.from_json('{ ... }')
        """
...
LengthVsRadius.update_forward_refs()
