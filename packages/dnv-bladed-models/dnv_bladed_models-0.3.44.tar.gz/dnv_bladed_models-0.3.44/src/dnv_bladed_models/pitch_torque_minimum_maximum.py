...
class PitchTorqueMinimumMaximum(Dnv):
    """PitchTorqueMinimumMaximum - The constant limits on the torque produced by the rotary drive.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = PitchTorqueMinimumMaximum.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = PitchTorqueMinimumMaximum.from_json('{ ... }')
        """
...
PitchTorqueMinimumMaximum.update_forward_refs()
