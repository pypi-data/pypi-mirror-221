...
class RateVsFrictionTorque(Dnv):
    """RateVsFrictionTorque - A line or row in a look-up table, specifying a value of FrictionTorque for a specified Rate.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = RateVsFrictionTorque.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = RateVsFrictionTorque.from_json('{ ... }')
        """
...
RateVsFrictionTorque.update_forward_refs()
