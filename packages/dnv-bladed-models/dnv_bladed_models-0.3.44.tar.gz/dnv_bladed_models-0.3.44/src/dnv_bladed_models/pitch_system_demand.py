...
class PitchSystemDemand(Dnv):
    """PitchSystemDemand - The common propeties of the pitch and rate demand responses.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = PitchSystemDemand.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = PitchSystemDemand.from_json('{ ... }')
        """
