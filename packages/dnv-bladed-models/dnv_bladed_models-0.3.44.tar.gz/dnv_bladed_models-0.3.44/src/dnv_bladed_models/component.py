...
class Component_ComponentTypeEnum(str, Enum):
    ...
    PASSIVE_YAW_SYSTEM = "PassiveYawSystem"
    LINEAR_SPRING_YAW_SYSTEM = "LinearSpringYawSystem"
    HYDRAULIC_ACCUMULATOR_YAW_SYSTEM = "HydraulicAccumulatorYawSystem"
    TORQUE_CONTROLLED_YAW_SYSTEM = "TorqueControlledYawSystem"
    ACTUATED_YAW_SYSTEM = "ActuatedYawSystem"
    NACELLE = "Nacelle"
    DRIVETRAIN = "Drivetrain"
    FIXED_SPEED_GENERATOR = "FixedSpeedGenerator"
    VARIABLE_SLIP_GENERATOR = "VariableSlipGenerator"
    VARIABLE_SPEED_GENERATOR = "VariableSpeedGenerator"
    COUNTERWEIGHT_HUB = "CounterweightHub"
    INDEPENDENT_PITCH_HUB = "IndependentPitchHub"
    SINGLE_ACTUATOR_COLLECTIVE_HUB = "SingleActuatorCollectiveHub"
...
class Component(Dnv):
    """Component - The common properties of all components.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = Component.from_file('/path/to/file')
        """
