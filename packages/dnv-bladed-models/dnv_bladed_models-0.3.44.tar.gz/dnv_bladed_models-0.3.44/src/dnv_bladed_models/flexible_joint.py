...
class FlexibleJoint(Dnv):
    """FlexibleJoint - The common properties of a linear spring damper.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = FlexibleJoint.from_file('/path/to/file')
        """
...
FlexibleJoint.update_forward_refs()
