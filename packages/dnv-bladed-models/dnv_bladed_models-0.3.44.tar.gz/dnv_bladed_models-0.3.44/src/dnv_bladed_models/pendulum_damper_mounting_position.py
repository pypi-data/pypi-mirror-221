...
class PendulumDamperMountingPosition(Dnv):
    """PendulumDamperMountingPosition - The offset of the pendulum damper from it&#39;s attachment point, in the component&#39;s axis system.
    ...
    def from_file(
        ...
        Returns
        -------
        PendulumDamperMountingPosition
            The model object.
        ...
        Examples
        --------
        >>> model = PendulumDamperMountingPosition.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = PendulumDamperMountingPosition.from_json('{ ... }')
        """
