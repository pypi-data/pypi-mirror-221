...
class SupportStructurePointLoading(AppliedLoad):
    """SupportStructurePointLoading - 
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = SupportStructurePointLoading.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = SupportStructurePointLoading.from_json('{ ... }')
        """
