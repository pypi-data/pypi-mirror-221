...
class GeneratorShortCircuit(Dnv):
    """GeneratorShortCircuit - The definition of the safety system behaviour when there is a short circuit.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = GeneratorShortCircuit.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = GeneratorShortCircuit.from_json('{ ... }')
        """
...
GeneratorShortCircuit.update_forward_refs()
