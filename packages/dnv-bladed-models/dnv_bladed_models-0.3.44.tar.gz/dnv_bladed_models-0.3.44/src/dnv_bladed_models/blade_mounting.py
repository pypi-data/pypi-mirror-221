...
class BladeMounting(Dnv):
    """BladeMounting - The blade mounting angles, outboard of pitch bearing.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = BladeMounting.from_file('/path/to/file')
        """
...
BladeMounting.update_forward_refs()
