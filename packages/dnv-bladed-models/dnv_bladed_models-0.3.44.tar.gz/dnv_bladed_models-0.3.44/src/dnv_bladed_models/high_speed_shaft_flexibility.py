...
class HighSpeedShaftFlexibility(Dnv):
    """HighSpeedShaftFlexibility - The parameters defining the high-speed shaft torsional flexibility.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = HighSpeedShaftFlexibility.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = HighSpeedShaftFlexibility.from_json('{ ... }')
        """
...
HighSpeedShaftFlexibility.update_forward_refs()
