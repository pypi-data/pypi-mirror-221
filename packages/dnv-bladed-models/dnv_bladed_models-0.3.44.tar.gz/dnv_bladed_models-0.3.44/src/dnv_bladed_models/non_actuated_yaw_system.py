...
class NonActuatedYawSystem(YawSystem):
    """NonActuatedYawSystem - Common properties of the simple yaw models that do not model the yaw actuators.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = NonActuatedYawSystem.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = NonActuatedYawSystem.from_json('{ ... }')
        """
...
NonActuatedYawSystem.update_forward_refs()
