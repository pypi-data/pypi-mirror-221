...
class TimeVsWindDirection(Dnv):
    """TimeVsWindDirection - A line or row in a look-up table, specifying a value of Direction for a specified Time.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TimeVsWindDirection.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TimeVsWindDirection.from_json('{ ... }')
        """
...
TimeVsWindDirection.update_forward_refs()
