...
class NearShoreCurrent(Dnv):
    """NearShoreCurrent - The definition of a current which is constant with depth.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = NearShoreCurrent.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = NearShoreCurrent.from_json('{ ... }')
        """
