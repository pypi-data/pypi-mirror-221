...
class AppliedZForceVsFrictionTorque(Dnv):
    """AppliedZForceVsFrictionTorque - A line or row in a look-up table, specifying a value of FrictionTorque for a specified AppliedForce.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = AppliedZForceVsFrictionTorque.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = AppliedZForceVsFrictionTorque.from_json('{ ... }')
        """
...
AppliedZForceVsFrictionTorque.update_forward_refs()
