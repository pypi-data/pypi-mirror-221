...
class PitchSafetyLimitSwitches(Dnv):
    """PitchSafetyLimitSwitches - The limit switch positions of the safety system.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = PitchSafetyLimitSwitches.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = PitchSafetyLimitSwitches.from_json('{ ... }')
        """
...
PitchSafetyLimitSwitches.update_forward_refs()
