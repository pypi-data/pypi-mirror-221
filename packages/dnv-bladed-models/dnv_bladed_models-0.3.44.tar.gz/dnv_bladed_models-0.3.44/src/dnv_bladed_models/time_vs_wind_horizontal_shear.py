...
class TimeVsWindHorizontalShear(Dnv):
    """TimeVsWindHorizontalShear - A line or row in a look-up table, specifying a value of HorizontalShear for a specified Time.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TimeVsWindHorizontalShear.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TimeVsWindHorizontalShear.from_json('{ ... }')
        """
...
TimeVsWindHorizontalShear.update_forward_refs()
