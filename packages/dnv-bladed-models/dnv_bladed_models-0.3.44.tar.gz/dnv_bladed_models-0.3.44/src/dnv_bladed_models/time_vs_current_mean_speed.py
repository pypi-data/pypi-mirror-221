...
class TimeVsCurrentMeanSpeed(Dnv):
    """TimeVsCurrentMeanSpeed - A line or row in a look-up table, specifying a value of MeanSpeed for a specified Time.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TimeVsCurrentMeanSpeed.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TimeVsCurrentMeanSpeed.from_json('{ ... }')
        """
...
TimeVsCurrentMeanSpeed.update_forward_refs()
