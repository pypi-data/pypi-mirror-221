...
class ElectricalLosses(Dnv):
    """ElectricalLosses - The electrical losses in the generator.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = ElectricalLosses.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = ElectricalLosses.from_json('{ ... }')
        """
