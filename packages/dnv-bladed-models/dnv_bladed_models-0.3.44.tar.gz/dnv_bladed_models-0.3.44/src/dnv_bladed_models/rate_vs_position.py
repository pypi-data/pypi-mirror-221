...
class RateVsPosition(Dnv):
    """RateVsPosition - A line or row in a look-up table, specifying a value of Position for a specified Rate.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = RateVsPosition.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = RateVsPosition.from_json('{ ... }')
        """
...
RateVsPosition.update_forward_refs()
