...
class SkewWakeModel(Dnv):
    """SkewWakeModel - Common properties for all skew wake models.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = SkewWakeModel.from_file('/path/to/file')
        """
...
SkewWakeModel.update_forward_refs()
