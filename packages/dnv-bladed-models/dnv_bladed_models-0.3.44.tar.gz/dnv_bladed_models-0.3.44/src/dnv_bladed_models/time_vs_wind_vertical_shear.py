...
class TimeVsWindVerticalShear(Dnv):
    """TimeVsWindVerticalShear - A line or row in a look-up table, specifying a value of VerticalShear for a specified Time.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = TimeVsWindVerticalShear.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = TimeVsWindVerticalShear.from_json('{ ... }')
        """
...
TimeVsWindVerticalShear.update_forward_refs()
