...
class PitchPositionVsMinimumAndMaximumMoment(Dnv):
    """PitchPositionVsMinimumAndMaximumMoment - The limits on the torque of the rotary drive as they vary with position.
    ...
    def from_file(
        ...
        Returns
        -------
        PitchPositionVsMinimumAndMaximumMoment
            The model object.
        ...
        Examples
        --------
        >>> model = PitchPositionVsMinimumAndMaximumMoment.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = PitchPositionVsMinimumAndMaximumMoment.from_json('{ ... }')
        """
