...
class DimensionlessRange(Dnv):
    """DimensionlessRange - The range of tip speed ratios to consider.
    ...
    def from_file(
        ...
        Examples
        --------
        >>> model = DimensionlessRange.from_file('/path/to/file')
        """
    ...
    def from_json(
        ...
        Examples
        --------
        >>> model = DimensionlessRange.from_json('{ ... }')
        """
