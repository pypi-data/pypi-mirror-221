...
def run_stochastic_optimization(
    ...
    :func:`Graph.random.choices <boulderopal.graph.random.choices>`
        Create random samples from the data that you provide.
    :func:`Graph.random.colored_noise_stf_signal <boulderopal.graph.random.colored_noise_stf_signal>`
        Generate noise trajectories from power spectral density.
    :func:`Graph.random.normal <boulderopal.graph.random.normal>`
        Create a sample of normally distributed random numbers.
    :func:`Graph.random.uniform <boulderopal.graph.random.uniform>`
