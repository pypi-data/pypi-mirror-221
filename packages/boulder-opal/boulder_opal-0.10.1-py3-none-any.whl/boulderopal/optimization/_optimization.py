...
def run_optimization(
    ...
    result = run_optimization_workflow(
        graph=graph,
        optimization_count=ScalarDType.INT(
            optimization_count, "optimization_count", min_=0
        ),
        ...
        max_iteration_count=nullable(
            ScalarDType.INT, max_iteration_count, "max_iteration_count", min_=0
        ),
        cost_tolerance=nullable(
            ScalarDType.REAL, cost_tolerance, "cost_tolerance", min_=0
        ),
