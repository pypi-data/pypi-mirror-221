...
class URL:
    """
    url = HttpMax.URL("HTTPS://jo%40email.com:a%20secret@müller.de:1234/pa%20th?search=ab#anchorlink")
    ...
    * `url.host` is normalized to always be lowercased. Internationalized domain
      ...
      url = HttpMax.URL("http://中国.icom.museum")
      assert url.host == "中国.icom.museum"
      url = HttpMax.URL("http://xn--fiqs8s.icom.museum")
      assert url.host == "中国.icom.museum"
    ...
    * `url.port` is either None or an integer. URLs that include the default port for
      ...
      assert HttpMax.URL("http://example.com") == HttpMax.URL("http://example.com:80")
      assert HttpMax.URL("http://example.com").port is None
      assert HttpMax.URL("http://example.com:80").port is None
    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can only
    ...
    def __init__(
        ...
        if isinstance(url, str):
            ...
            raise TypeError(
                f"Invalid type for url.  Expected str or HttpMax.URL, got {type(url)}: {url!r}"
            )
    ...
    def host(self) -> str:
        ...
        url = HttpMax.URL("http://www.EXAMPLE.org")
        ...
        url = HttpMax.URL("https://[::ffff:192.168.0.1]")
    ...
    def port(self) -> typing.Optional[int]:
        ...
        assert HttpMax.URL("http://www.example.com") == HttpMax.URL("http://www.example.com:80")
        assert HttpMax.URL("http://www.example.com:80").port is None
        """
    ...
    def path(self) -> str:
        ...
        url = HttpMax.URL("https://example.com/pa%20th")
        assert url.path == "/pa th"
        """
    ...
    def query(self) -> bytes:
        ...
        url = HttpMax.URL("https://example.com/?filter=some%20search%20terms")
    ...
    def raw(self) -> RawURL:
        ...
        In older versions of `HttpMax` this was used in the low-level transport API.
    ...
    def copy_with(self, **kwargs: typing.Any) -> "URL":
        ...
        url = HttpMax.URL("https://www.example.com").copy_with(username="jo@gmail.com", password="a secret")
    ...
    def join(self, url: URLTypes) -> "URL":
        ...
        url = HttpMax.URL("https://www.example.com/test")
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def keys(self) -> typing.KeysView[str]:
        ...
        q = HttpMax.QueryParams("a=123&a=456&b=789")
    ...
    def set(self, key: str, value: typing.Any = None) -> "QueryParams":
        ...
        q = HttpMax.QueryParams("a=123")
        q = q.set("a", "456")
        assert q == HttpMax.QueryParams("a=456")
        """
        q = QueryParams()
    ...
    def add(self, key: str, value: typing.Any = None) -> "QueryParams":
        ...
        q = HttpMax.QueryParams("a=123")
        q = q.add("a", "456")
        assert q == HttpMax.QueryParams("a=123&a=456")
        """
        q = QueryParams()
        q._dict = dict(self._dict)
    ...
    def merge(self, params: typing.Optional[QueryParamTypes] = None) -> "QueryParams":
        ...
        q = HttpMax.QueryParams("a=123")
        q = q.merge({"b": "456"})
        assert q == HttpMax.QueryParams("a=123&b=456")

        q = HttpMax.QueryParams("a=123")
        q = q.merge({"a": "456", "b": "789"})
        assert q == HttpMax.QueryParams("a=456&b=789")
        """
    ...
    def __str__(self) -> str:
        ...
        See https://github.com/encode/HttpMax/issues/2536 and
