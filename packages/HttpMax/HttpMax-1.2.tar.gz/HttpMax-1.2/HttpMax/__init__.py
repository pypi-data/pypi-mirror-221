...
try:
    ...
    def main() -> None:  # type: ignore
        ...
        print(
            "The HttpMax command line client could not run because the required "
            "dependencies were not installed.\nMake sure you've installed "
            "everything with: pip install 'HttpMax[cli]'"
        )
        sys.exit(1)
...
for __name in __all__:
    if not __name.startswith("__"):
        setattr(__locals[__name], "__module__", "HttpMax")  # noqa
