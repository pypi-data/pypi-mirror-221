...
class URLPattern:
    ...
    >>> pattern.matches(HttpMax.URL("http://example.com"))
    True

    # Witch scheme matching...
    >>> pattern = URLPattern("https")
    >>> pattern.matches(HttpMax.URL("https://example.com"))
    True
    >>> pattern.matches(HttpMax.URL("http://example.com"))
    False
    ...
    >>> pattern.matches(HttpMax.URL("http://example.com"))
    False
    >>> pattern.matches(HttpMax.URL("https://other.com"))
    False
    ...
    >>> pattern.matches(HttpMax.URL("https://example.com:1234"))
    True
    >>> pattern.matches(HttpMax.URL("https://example.com"))
    False
    """
