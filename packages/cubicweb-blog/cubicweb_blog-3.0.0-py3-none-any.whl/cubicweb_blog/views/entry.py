...
class BlogEntryBlogView(EntityView):
    ...
    toolbar_components = (
        primary.PrimaryView.content_navigation_components.im_func
        if PY2
        else primary.PrimaryView.content_navigation_components
    )
...
class BlogEntryPostMetaData(EntityView):
    ...
    def cell_call(self, row, col):
        ...
        if "comments" in schema and "BlogEntry" in schema.rschema("comments").objects():
