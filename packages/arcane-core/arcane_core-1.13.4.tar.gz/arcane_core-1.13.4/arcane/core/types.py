...
ImportTypeLiteral = Literal[
    ...
    "MAGENTO","SHOPIFY", "PRESTASHOP", "UPLOAD_FROM_DEVICE", "SNOWFLAKE", "GA_4",
    "ARCANE_FTP", "PIANO","SHOPIFY_API"
]
...
class ChannelType(Enum):
    ...
    pass_culture_livre = 'pass_culture_livre'
    pass_culture_cd = 'pass_culture_cd'
    sftp = 'sftp'
    big_query = 'big_query'
...
ChannelTypeLiteral = Literal['mct', 'mct_legacy', 'googleads', 'facebook', 'facebook_flight', 'bing',
                             ...
                             'bazaar_voice', 'idealo', 'audience_google_ads', 'audience_facebook',
                             'pass_culture', 'pass_culture_livre', 'pass_culture_cd',
...
AdditionalFeatureLiteral = Literal['import_frequency_hourly', 'import_frequency_quarter_hour']
