...
class Terminal:
    ...
    def rotate_gate_arrow(self, arrow_attr, pos, course, step=8, endpos=80,
        ...
        if arrow_info['busy']:
            print(f'Шлагбаум {arrow_attr} занят')
            return
        else:
            print(f"Шлагбаум {arrow_attr} ставим на занят")
            arrow_info['busy'] = True
        print(f'Шлагбаум {arrow_attr} вертим от {arrow_info["pos"]} до {endpos}')
        while arrow_info['pos'] != endpos:
            ...
            arrow_info['pos'] += step
            sleep(sleeptime)
        print(f"Шлагбаум {arrow_attr} ставим на свободен")
