...
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_hybrid_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_hybrid_tf_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_separate_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_separate_tf_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_shared_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_concat_attention_shared_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_dot_attention_shared_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_general_attention_shared_normal_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_shared_tf_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_general_attention_shared_tf_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_concat_attention_shared_tf_exp2
from openpy_fxts.mdls_to_fx.hybrids.classes.vae.dlm_vae import lstm_luongs_dot_attention_shared_tf_exp2
...
class hybrid_normal_exp2:
    ...
    def prediction(self, model_new):
        aux = hybrid_normal_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
...
class hybrid_tf_exp2:
    ...
    def prediction(self, model_new):
        aux = hybrid_tf_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class separate_normal_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_separate_normal_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        aux = separate_normal_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class separate_tf_exp2:
    ...
    def prediction(self, model_new):
        aux = separate_tf_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_normal_exp2:
    ...
    def prediction(self, model_new):
        ...
        aux = shared_normal_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_normal_luongs_concat_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_concat_attention_shared_normal_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_normal_luongs_concat_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_normal_luongs_dot_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_dot_attention_shared_normal_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_normal_luongs_dot_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_normal_luongs_general_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_general_attention_shared_normal_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_normal_luongs_general_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_tf_exp2:
    ...
    def prediction(self, model_new):
        ...
        aux = shared_tf_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_tf_luongs_general_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_general_attention_shared_tf_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_tf_luongs_general_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_tf_luongs_concat_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_concat_attention_shared_tf_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_tf_luongs_concat_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
...
class shared_tf_luongs_dot_attention_exp2:
    ...
    def build_model(self, filepath):
        ...
        train_dict, val_dict, _ = _scaler_data(train_dict, val_dict)
        model = lstm_luongs_dot_attention_shared_tf_exp2(
            self.n_in,
            self.n_out,
            self.features,
            self.units
    ...
    def prediction(self, model_new):
        ...
        aux = shared_tf_luongs_dot_attention_exp2(self.n_in, self.n_out, self.val_size, self.test_size, self.dataset)
        test_dict = _lstm_train_data_transform(
            df=self.dataset,
            n_in=self.n_in,
            n_out=self.n_out,
