...
from openpy_fxts.mdls_to_fx.get_arch_dicts import _get_config_encdec
from openpy_fxts.layers.layers_class import type_rnn, multi_rnn_drop, multi_conv1d_pool_flat_drop


class encdec_rnn(tkm.Model):
    ...
    def __init__(
        ...
        super(encdec_rnn, self).__init__()
        if config is None:
            config = _get_config_encdec('encdec_rnn')
...
class encdec_birnn(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_encdec('encdec_birnn')
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
        self.encoder = multi_rnn_drop(
...
class encdec_conv1d_birnn(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_encdec('encdec_conv1d_birnn')
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
