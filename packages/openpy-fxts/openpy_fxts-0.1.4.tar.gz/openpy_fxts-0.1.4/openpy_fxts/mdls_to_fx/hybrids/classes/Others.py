from tcn import TCN
from openpy_fxts.layers.layers_class import dense_multi_out, time2vec_birnn_layer, multi_time2vec_birnn, type_rnn
from openpy_fxts.base_tf import tkl, tkm
from openpy_fxts.mdls_to_fx.get_arch_dicts import _get_config_mlp
