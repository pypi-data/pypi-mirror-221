...
from openpy_fxts.mdls_to_fx.utils import _callbacks, _learning_curve, _values_preliminary
from openpy_fxts.mdls_to_fx.utils import _values_preliminary, _values_preliminary_2D
from openpy_fxts.mdls_to_fx.utils import _mdl_characteristics, _process_values_preliminary
...
class Seq2Seq_Conv2D_RNN_class:
    ...
    def train_model(
        ...
        if self.config_data['plt_history']:
            _learning_curve(history, self.name_model, self.config_data['time_init'], filepath=filepath)
