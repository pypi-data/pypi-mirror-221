...
from openpy_fxts.layers.layers_class import multi_conv1d_pool_flat_drop, dense_multi_out
...
class conv1D_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_conv1d_others('conv1D_dense')
        ...
        self.multi_conv1d = multi_conv1d_pool_flat_drop(
            ...
            is_drop=config['dropout']['activate'], rate=config['dropout']['rate'],
            maxpooling_1d=True, pool_size=config['pool_size'])
...
class multi_conv1D_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_conv1d_others('multi_conv1D_dense')
