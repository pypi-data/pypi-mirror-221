...
from openpy_fxts.layers.layers_class import dense_multi_out, rnn_drop, type_rnn
from openpy_fxts.layers.layers_class import multi_rnn_drop, multi_conv1d_pool_flat_drop, multi_timedist_conv1d_flat
from openpy_fxts.layers.attention_class import attention
from openpy_fxts.mdls_to_fx.get_arch_dicts import _get_config_conv1d_others


class timedist_conv1d_rnn_dense(tkm.Model):
    ...
    def __init__(
        ...
        super(timedist_conv1d_rnn_dense, self).__init__()
        if config is None:
            config = _get_config_conv1d_others('timedist_conv1d_rnn_dense')
...
class conv1d_rnn_dense(tkm.Model):
    ...
    def __init__(
        ...
        super(conv1d_rnn_dense, self).__init__()
        if config is None:
            config = _get_config_conv1d_others('conv1d_rnn_dense')
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
...
class conv1d_birnn_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_conv1d_others('conv1d_birnn_dense')
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
...
class conv1d_birnn_attention_dense(tkm.Model):
    ...
    def __init__(
        ...
        if config is None:
            config = _get_config_conv1d_others('conv1d_birnn_attention_dense')
        self.n_future = n_future,
        self.n_out_ft = n_out_ft,
        self.config = config
        self.hidden_conv1d = multi_conv1d_pool_flat_drop(
