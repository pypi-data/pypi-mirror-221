...
class Calib(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Cam = property(_PaIRS_PIV.Calib_Cam_get, _PaIRS_PIV.Calib_Cam_set)
    ...
    PercRaggioRicerca = property(_PaIRS_PIV.Calib_PercRaggioRicerca_get, _PaIRS_PIV.Calib_PercRaggioRicerca_set)
...
class CalData(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    cam = property(_PaIRS_PIV.CalData_cam_get, _PaIRS_PIV.CalData_cam_set)
    xOr = property(_PaIRS_PIV.CalData_xOr_get, _PaIRS_PIV.CalData_xOr_set)
    yOr = property(_PaIRS_PIV.CalData_yOr_get, _PaIRS_PIV.CalData_yOr_set)
    z = property(_PaIRS_PIV.CalData_z_get, _PaIRS_PIV.CalData_z_set)
    angCol = property(_PaIRS_PIV.CalData_angCol_get, _PaIRS_PIV.CalData_angCol_set)
    angRow = property(_PaIRS_PIV.CalData_angRow_get, _PaIRS_PIV.CalData_angRow_set)
    xOrShift = property(_PaIRS_PIV.CalData_xOrShift_get, _PaIRS_PIV.CalData_xOrShift_set)
    yOrShift = property(_PaIRS_PIV.CalData_yOrShift_get, _PaIRS_PIV.CalData_yOrShift_set)
    remPointsUp = property(_PaIRS_PIV.CalData_remPointsUp_get, _PaIRS_PIV.CalData_remPointsUp_set)
    remPointsDo = property(_PaIRS_PIV.CalData_remPointsDo_get, _PaIRS_PIV.CalData_remPointsDo_set)
    remPointsLe = property(_PaIRS_PIV.CalData_remPointsLe_get, _PaIRS_PIV.CalData_remPointsLe_set)
    remPointsRi = property(_PaIRS_PIV.CalData_remPointsRi_get, _PaIRS_PIV.CalData_remPointsRi_set)
    W = property(_PaIRS_PIV.CalData_W_get, _PaIRS_PIV.CalData_W_set)
    H = property(_PaIRS_PIV.CalData_H_get, _PaIRS_PIV.CalData_H_set)
    dColPix = property(_PaIRS_PIV.CalData_dColPix_get, _PaIRS_PIV.CalData_dColPix_set)
    dRigPix = property(_PaIRS_PIV.CalData_dRigPix_get, _PaIRS_PIV.CalData_dRigPix_set)
    nPointsPlane = property(_PaIRS_PIV.CalData_nPointsPlane_get, _PaIRS_PIV.CalData_nPointsPlane_set)
    flagPlane = property(_PaIRS_PIV.CalData_flagPlane_get, _PaIRS_PIV.CalData_flagPlane_set)
    costPlanes = property(_PaIRS_PIV.CalData_costPlanes_get, _PaIRS_PIV.CalData_costPlanes_set)
    X = property(_PaIRS_PIV.CalData_X_get, _PaIRS_PIV.CalData_X_set)
    Y = property(_PaIRS_PIV.CalData_Y_get, _PaIRS_PIV.CalData_Y_set)
    Xc = property(_PaIRS_PIV.CalData_Xc_get, _PaIRS_PIV.CalData_Xc_set)
    Yc = property(_PaIRS_PIV.CalData_Yc_get, _PaIRS_PIV.CalData_Yc_set)
    x = property(_PaIRS_PIV.CalData_x_get, _PaIRS_PIV.CalData_x_set)
    y = property(_PaIRS_PIV.CalData_y_get, _PaIRS_PIV.CalData_y_set)
    flag = property(_PaIRS_PIV.CalData_flag_get, _PaIRS_PIV.CalData_flag_set)
    cost = property(_PaIRS_PIV.CalData_cost_get, _PaIRS_PIV.CalData_cost_set)

    def __init__(self):
        _PaIRS_PIV.CalData_swiginit(self, _PaIRS_PIV.new_CalData())
    __swig_destroy__ = _PaIRS_PIV.delete_CalData

# Register CalData in _PaIRS_PIV:
_PaIRS_PIV.CalData_swigregister(CalData)
class _Punto(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class CalibOut(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    dimMat = property(_PaIRS_PIV.CalibOut_dimMat_get, _PaIRS_PIV.CalibOut_dimMat_set)
    numPiani = property(_PaIRS_PIV.CalibOut_numPiani_get, _PaIRS_PIV.CalibOut_numPiani_set)
    cost = property(_PaIRS_PIV.CalibOut_cost_get, _PaIRS_PIV.CalibOut_cost_set)
    costPlanes = property(_PaIRS_PIV.CalibOut_costPlanes_get, _PaIRS_PIV.CalibOut_costPlanes_set)
    da = property(_PaIRS_PIV.CalibOut_da_get, _PaIRS_PIV.CalibOut_da_set)

    def __init__(self):
        _PaIRS_PIV.CalibOut_swiginit(self, _PaIRS_PIV.new_CalibOut())
    __swig_destroy__ = _PaIRS_PIV.delete_CalibOut

# Register CalibOut in _PaIRS_PIV:
_PaIRS_PIV.CalibOut_swigregister(CalibOut)
class Cal(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    data = property(_PaIRS_PIV.Cal_data_get, _PaIRS_PIV.Cal_data_set)
    out = property(_PaIRS_PIV.Cal_out_get, _PaIRS_PIV.Cal_out_set)
    ...
    def calibrate(self):
        return _PaIRS_PIV.Cal_calibrate(self)
