...
_RequiredAutocommitPeriodOutputTypeDef = TypedDict(
    "_RequiredAutocommitPeriodOutputTypeDef",
    {
        "Type": AutocommitPeriodTypeType,
    },
)
_OptionalAutocommitPeriodOutputTypeDef = TypedDict(
    "_OptionalAutocommitPeriodOutputTypeDef",
    {
        "Value": int,
    },
    total=False,
...
class AutocommitPeriodOutputTypeDef(
    _RequiredAutocommitPeriodOutputTypeDef, _OptionalAutocommitPeriodOutputTypeDef
):
    pass
...
_RequiredCompletionReportOutputTypeDef = TypedDict(
    "_RequiredCompletionReportOutputTypeDef",
    {
        "Enabled": bool,
    },
)
_OptionalCompletionReportOutputTypeDef = TypedDict(
    "_OptionalCompletionReportOutputTypeDef",
    {
        "Path": str,
...
class CompletionReportOutputTypeDef(
    _RequiredCompletionReportOutputTypeDef, _OptionalCompletionReportOutputTypeDef
):
    pass
...
_RequiredRetentionPeriodOutputTypeDef = TypedDict(
    "_RequiredRetentionPeriodOutputTypeDef",
    {
        "Type": RetentionPeriodTypeType,
    },
)
_OptionalRetentionPeriodOutputTypeDef = TypedDict(
    "_OptionalRetentionPeriodOutputTypeDef",
    {
        "Value": int,
    },
    total=False,
...
class RetentionPeriodOutputTypeDef(
    _RequiredRetentionPeriodOutputTypeDef, _OptionalRetentionPeriodOutputTypeDef
):
    pass
