...
class Client:
    ...
    def party_set_custom_game_settings(
        self, settings: t.Mapping
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def party_invite_by_display_name(
        self, name: t.Text, tag: t.Text
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def party_request_to_join(
        self, party_id: t.Text, other_puuid: t.Text
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def coregame_fetch_match_loadouts(
        self, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def coregame_fetch_team_chat_muc_token(
        self, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def coregame_fetch_allchat_muc_token(
        self, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def coregame_disassociate_player(
        self, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def pregame_fetch_match_loadouts(
        self, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def pregame_select_character(
        self, agent_id: t.Text, match_id: t.Optional[t.Text] = None
    ) -> t.Mapping[str, t.Any]:
        """
    ...
    def contracts_unlock_item_progress(
        self, progression_id: t.Text
    ) -> t.Mapping[str, t.Any]:
        """
