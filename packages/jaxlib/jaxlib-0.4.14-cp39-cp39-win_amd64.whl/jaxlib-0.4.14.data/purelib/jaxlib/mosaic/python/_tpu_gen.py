...
class LoadOp(_ods_ir.OpView):
  ...
  def __init__(self, result, base, indices, sublane_mask, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class StoreOp(_ods_ir.OpView):
  ...
  def __init__(self, valueToStore, base, indices, sublane_mask, *, mask=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
