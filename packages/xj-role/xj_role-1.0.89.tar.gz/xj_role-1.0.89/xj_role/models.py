...
class RoleUserGroup(models.Model):
    ...
    parent_group = models.ForeignKey(verbose_name='父组ID', to="self", unique=False, blank=True, null=True, on_delete=models.DO_NOTHING)
...
class RoleApi(models.Model):
    ...
    method = models.CharField(verbose_name='请求类型', max_length=15, choices=method_choices, blank=True, null=True, help_text='')
    name = models.CharField(verbose_name='路由名称', max_length=500, blank=True, null=True, help_text='')
    is_using = models.IntegerField(verbose_name='是否使用', default=1, choices=using_choices, blank=True, null=True, help_text='')
    is_delete = models.IntegerField(verbose_name='是否删除', default=0, choices=using_choices, blank=True, null=True, help_text='')
    is_open_api = models.IntegerField(verbose_name='开放接口', default=1, choices=using_choices, blank=True, null=True, help_text='是否是开发API，该API在没有登录的情况可直接访问。')
    description = models.CharField(verbose_name='API使用介绍', max_length=5000, default="", blank=True, null=True, help_text='')
...
class RoleMenu(models.Model):
    ...
    is_using = models.IntegerField(verbose_name='是否启用', default=1, choices=bool_choices, blank=True, null=True, help_text='')
    is_delete = models.IntegerField(verbose_name='是否删除', default=0, choices=bool_choices, blank=True, null=True, help_text='')
    is_jump_link = models.IntegerField(verbose_name='链接菜单', default=0, choices=bool_choices, blank=True, null=True, help_text='是否为跳转链接菜单')
    sort = models.IntegerField(verbose_name='排序', blank=True, null=True, help_text='')
    created_time = models.DateTimeField(verbose_name='创建时间', auto_now_add=True, blank=True, null=True, help_text='')
...
class RolePermission(models.Model):
    ...
    data_set_type = models.CharField(verbose_name="数据集类型", max_length=50, choices=data_set_type_choices, blank=True, null=True)
