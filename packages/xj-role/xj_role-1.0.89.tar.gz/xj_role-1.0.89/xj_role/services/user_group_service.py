...
from ..utils.custom_tool import format_params_handle, parse_json, format_list_handle, force_transform_type, filter_fields_handler
...
class UserGroupService(object):
    ...
    @staticmethod
    def group_list(params: dict, need_pagination: bool = True, only_first: bool = False, filter_fields: bool = None, **kwargs):
        """
        用户的分组列表，分页查询。
        ...
        params = format_params_handle(
            param_dict=params,
            filter_filed_list=["id|int", "user_group_id|int", "user_id|int", "user_id_list|list_int", "id_list|list_int", "group", "group_name", "parent_group_id|int"],
            alias_dict={"group_name": "group_name__contains", "group": "group__contains", "user_id_list": "user_id__in", "id_list": "id__in"},
        ...
        return {"page": int(page), "size": int(size), "count": int(total), "total": total, "list": list(finish_set.object_list)}, None
