...
import minican
from minican import __version__
...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser('python -m minican.viewer',
    ...
    optional.add_argument('-d', '--decode', dest='decode',
                          help='R|Specify how to convert the raw bytes into real values.'
                               ...
                               '\n  $ python -m minican.viewer -d "100:<BHL"'
    ...
    optional.add_argument('-f', '--filter', help='R|Space separated CAN filters for the given CAN interface:'
                          ...
                          '\n      python -m minican.viewer -f 100:7FC 200:7F0'
...
def main():  # pragma: no cover
    ...
    bus = minican.Bus(parsed_args.channel, **config)
