...
class Notifier(object):
    ...
    def __init__(self, bus, listeners, timeout=1.0, loop=None):
        ...
        :param minican.BusABC bus: A :ref:`bus` or a list of buses to listen to.
    ...
    def add_listener(self, listener):
        ...
        :param minican.Listener listener: Listener to be added to
    ...
    def remove_listener(self, listener):
        ...
        :param minican.Listener listener: Listener to be removed from
                         the list to be notified
