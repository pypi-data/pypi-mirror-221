...
class DeployResources(Model):
    ...
    def __init__(self, workloads=None, services=None, configs=None, persistent_volume_claims=None, ingress=None, service_monitors=None, roles=None, role_bindings=None):  # noqa: E501
