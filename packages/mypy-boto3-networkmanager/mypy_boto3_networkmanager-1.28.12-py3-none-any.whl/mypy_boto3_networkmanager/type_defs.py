...
Usage::
    ...
    ```python
    from mypy_boto3_networkmanager.type_defs import AWSLocationOutputTypeDef

    data: AWSLocationOutputTypeDef = {...}
    ```
"""
import sys
...
__all__ = (
    ...
    "TagOutputTypeDef",
    "BandwidthOutputTypeDef",
    "BandwidthTypeDef",
    "BgpOptionsTypeDef",
    "ConnectAttachmentOptionsOutputTypeDef",
    ...
    "CoreNetworkSegmentEdgeIdentifierOutputTypeDef",
...
AWSLocationOutputTypeDef = TypedDict(
    "AWSLocationOutputTypeDef",
    {
        "Zone": str,
        "SubnetArn": str,
...
BandwidthOutputTypeDef = TypedDict(
    "BandwidthOutputTypeDef",
    {
        "UploadSpeed": int,
        "DownloadSpeed": int,
...
ConnectAttachmentOptionsOutputTypeDef = TypedDict(
    "ConnectAttachmentOptionsOutputTypeDef",
    {
...
CoreNetworkSegmentEdgeIdentifierOutputTypeDef = TypedDict(
    "CoreNetworkSegmentEdgeIdentifierOutputTypeDef",
    {
        "CoreNetworkId": str,
        "SegmentName": str,
...
LinkTypeDef = TypedDict(
    "LinkTypeDef",
    {
        ...
        "Description": str,
        "Type": str,
        "Bandwidth": BandwidthOutputTypeDef,
        "Provider": str,
        "CreatedAt": datetime,
        "State": LinkStateType,
        "Tags": List[TagOutputTypeDef],
...
DeviceTypeDef = TypedDict(
    "DeviceTypeDef",
    {
        ...
        "DeviceArn": str,
        "GlobalNetworkId": str,
        "AWSLocation": AWSLocationOutputTypeDef,
        "Description": str,
        "Type": str,
        "Vendor": str,
        "Model": str,
...
GetNetworkRoutesResponseTypeDef = TypedDict(
    ...
    {
        "RouteTableArn": str,
        "CoreNetworkSegmentEdge": CoreNetworkSegmentEdgeIdentifierOutputTypeDef,
...
ConnectAttachmentTypeDef = TypedDict(
    "ConnectAttachmentTypeDef",
    {
        "Attachment": AttachmentTypeDef,
        "TransportAttachmentId": str,
        "Options": ConnectAttachmentOptionsOutputTypeDef,
    },
    total=False,
)
...
VpcAttachmentTypeDef = TypedDict(
    "VpcAttachmentTypeDef",
    {
        "Attachment": AttachmentTypeDef,
        "SubnetArns": List[str],
        "Options": VpcOptionsOutputTypeDef,
    },
    total=False,
)
