...
"""Defines the VIS lights table using the SQLAlchemy ORM."""
...
class Light(Base):
    """An object to represent rows in the lights table for VIS.  Each row represents
    a single 'on' period for one light."""
