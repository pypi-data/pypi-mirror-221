...
from honeyhive.api.models.datasets import UploadDataset, DatasetResponse, ListDatasetResponse, FetchDataset
...
def get_datasets(
    ...
    return client.get_datasets(name=name, task=project, prompt=prompt, purpose=purpose)
