...
#########################################################################################################
"""
1. python pih_mio_content_setup.py sdist --dist-dir pih_mio_content_dist bdist_wheel --dist-dir pih_mio_content_dist build --build-base pih_mio_content_build
2. twine upload --repository pypi pih_mio_content_dist/*
3. pip install pih -U
"""
folder = "//pih/facade/pih_mio_content_dist"
...
setup(
    name=j((PIH.NAME, PIH.MIO.NAME, "content"), "_"),
    version=PIH.VERSION.local(),
    description="PIH MIO library",
