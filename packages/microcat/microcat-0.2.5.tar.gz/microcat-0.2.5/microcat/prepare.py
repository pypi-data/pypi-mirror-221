...
CONFIGS_DIR = os.path.join(MICROCAT_DIR,'single','config')
DEFAULT_DATA_DIR = os.path.join(MICROCAT_DIR,'single', 'data')
...
data_folder = os.path.join(MICROCAT_DIR,'single','data')
