...
class FeatureSet:
    ...
    @classmethod
    def from_listable_feature_set(cls, stub: CoreServiceStub, listable_feature_set):
        fs = pb.FeatureSet()
        ...
        fs.flow = "" if listable_feature_set.flow == 0 else FeatureSetFlow[listable_feature_set.flow].name
