...
class FeatureDatabase():
    ...
    def _group_features(features):
        ...
        Args:
            features:
                ...
                bbb.features.calculator.PREFIX_SEPARATOR value. The prefix will
                be used as the feature set names.
    ...
    def _get_join_sql_query(self, names):
        '''
        Get the SQL query to (inner) join the given table names. This will
        always include the BBB table and all tables will be joined on the InChi
        primary key.
