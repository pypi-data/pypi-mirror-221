...
class Querier(BaseQuerier):
    """
    The querier for the `Telefact` data source.
    """
    ...
    def fetch_metadata(self, queries: List[str], html_dir: str = None) -> None:
        fetch_metadata(queries, self.metadata_path, html_dir=html_dir)
