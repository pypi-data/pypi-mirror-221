...
class ModifyNatFirewallControlPolicyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'ModifyNatFirewallControlPolicy','cloudfirewall')
	...
	def get_DomainResolveType(self): # String
		return self.get_query_params().get('DomainResolveType')

	def set_DomainResolveType(self, DomainResolveType):  # String
