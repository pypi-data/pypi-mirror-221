...
class ModifyVpcFirewallControlPolicyPositionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'ModifyVpcFirewallControlPolicyPosition','cloudfirewall')
	...
	def get_OldOrder(self): # String
		return self.get_query_params().get('OldOrder')

	def set_OldOrder(self, OldOrder):  # String
		self.add_query_param('OldOrder', OldOrder)
