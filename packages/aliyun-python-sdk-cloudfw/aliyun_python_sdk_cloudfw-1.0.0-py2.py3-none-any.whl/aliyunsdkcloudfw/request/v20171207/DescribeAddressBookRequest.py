...
class DescribeAddressBookRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'DescribeAddressBook','cloudfirewall')
	...
	def get_ContainPort(self): # String
		return self.get_query_params().get('ContainPort')

	def set_ContainPort(self, ContainPort):  # String
		self.add_query_param('ContainPort', ContainPort)
