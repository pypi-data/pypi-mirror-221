...
class DescribeOutgoingDestinationIPRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'DescribeOutgoingDestinationIP','cloudfirewall')
	...
	def get_TagIdNew(self): # String
		return self.get_query_params().get('TagIdNew')

	def set_TagIdNew(self, TagIdNew):  # String
		self.add_query_param('TagIdNew', TagIdNew)
