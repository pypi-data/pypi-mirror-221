...
class DescribeAssetListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'DescribeAssetList','cloudfirewall')
	...
	def get_NewResourceTag(self): # String
		return self.get_query_params().get('NewResourceTag')

	def set_NewResourceTag(self, NewResourceTag):  # String
		self.add_query_param('NewResourceTag', NewResourceTag)
	def get_Type(self): # String
		return self.get_query_params().get('Type')

	def set_Type(self, Type):  # String
		self.add_query_param('Type', Type)
	def get_SgStatus(self): # String
		return self.get_query_params().get('SgStatus')

	def set_SgStatus(self, SgStatus):  # String
		self.add_query_param('SgStatus', SgStatus)
