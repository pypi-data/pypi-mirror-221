...
class ModifyNatFirewallControlPolicyPositionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'ModifyNatFirewallControlPolicyPosition','cloudfirewall')
	...
	def get_NewOrder(self): # Integer
		return self.get_query_params().get('NewOrder')

	def set_NewOrder(self, NewOrder):  # Integer
