...
class DescribeVpcFirewallListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'DescribeVpcFirewallList','cloudfirewall')
	...
	def get_ConnectSubType(self): # String
		return self.get_query_params().get('ConnectSubType')

	def set_ConnectSubType(self, ConnectSubType):  # String
		self.add_query_param('ConnectSubType', ConnectSubType)
	...
	def get_PeerUid(self): # String
		return self.get_query_params().get('PeerUid')

	def set_PeerUid(self, PeerUid):  # String
		self.add_query_param('PeerUid', PeerUid)
