...
class DescribeVpcFirewallDefaultIPSConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudfw', '2017-12-07', 'DescribeVpcFirewallDefaultIPSConfig','cloudfirewall')
