...
class ApplicationsApi(object):
    ...
    def query_application(self, application_id, application_query_request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.query_application(application_id, application_query_request, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.query_application_with_http_info(application_id, application_query_request, **kwargs)  # noqa: E501

    def query_application_with_http_info(self, application_id, application_query_request, **kwargs):  # noqa: E501
        """Interact with an application.  # noqa: E501
        ...
        >>> thread = api.query_application_with_http_info(application_id, application_query_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and local_var_params.get('application_query_request') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `application_query_request` when calling `query_application`")  # noqa: E501
