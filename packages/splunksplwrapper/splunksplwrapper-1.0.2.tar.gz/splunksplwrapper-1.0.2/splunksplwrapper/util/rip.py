...
class RESTInPeace:
    ...
    def __init__(
        self, splunk_spl_wrapper_rest_connector, user_namespace=None, app_namespace=None
    ):
        """
        Pass in a logged-in Splunk SPL Wrapper rest connector. Every call afterwards
        will use this connector. Namespaces should be encapsulated inside
        the connector.
        """

        self.conn = splunk_spl_wrapper_rest_connector
