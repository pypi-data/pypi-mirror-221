...
from splunksplwrapper.exceptions import UnsupportedConnectorError
from splunksplwrapper.exceptions.command_execution import CommandExecutionFailure
from splunksplwrapper.log import Logging
from splunksplwrapper.util.rip import RESTInPeace


class Splunk(Logging):
    """
    ...
    def __init__(self, name):
        ...
        super().__init__()
        self.logger.debug(f"Splunk SPL Wrapper Splunk created:{self}")
    ...
    def confs(self, contype=None, username=None, password=None):
        ...
        @rtype: L{Confs}
        """
        from splunksplwrapper.manager.confs import Confs
    ...
    def inputs(self, contype=None, username=None):
        ...
        @rtype: L{Inputs}
        """
        from splunksplwrapper.manager.inputs import Inputs
    ...
    def indexes(self, contype=None, username=None, password=None):
        ...
        @rtype: L{Indexes}
        """
        from splunksplwrapper.manager.indexes import Indexes
    ...
    def roles(self, contype=None, username=None):
        ...
        @rtype: L{Roles}
        """
        from splunksplwrapper.manager.roles import Roles
    ...
    def saved_searches(self, contype=None, username=None):
        ...
        @rtype: L{SavedSearch}
        """
        from splunksplwrapper.manager.saved_searches import SavedSearches
    ...
    def users(self, contype=None, username=None):
        ...
        @rtype: L{Users}
        """
        from splunksplwrapper.manager.users import Users
