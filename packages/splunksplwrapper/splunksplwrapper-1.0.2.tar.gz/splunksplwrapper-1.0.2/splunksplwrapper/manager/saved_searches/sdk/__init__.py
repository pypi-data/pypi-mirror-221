...
from splunksplwrapper.manager.saved_searches import SavedSearches, SavedSearchNotFound
from splunksplwrapper.manager.saved_searches.sdk.saved_search import (
    ...
    def __getitem__(self, saved_search_name):
        ...
        for saved_search in self:
            if saved_search.name == saved_search_name:
                return saved_search
        raise SavedSearchNotFound(saved_search_name)
