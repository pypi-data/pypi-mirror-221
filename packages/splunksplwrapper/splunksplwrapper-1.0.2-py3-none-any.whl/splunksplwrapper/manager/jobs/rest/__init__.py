...
from splunksplwrapper.manager.jobs import (
    CONTROL,
    EVENTS,
    PATH_PERFIX,
    RESULTS,
...
from splunksplwrapper.manager.jobs.rest.job import RESTJobWrapper
from splunksplwrapper.util.string_unicode_convert import normalize_to_str
