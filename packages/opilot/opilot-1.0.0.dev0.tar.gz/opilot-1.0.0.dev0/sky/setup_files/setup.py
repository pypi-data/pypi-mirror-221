...
setuptools.setup(
    ...
    license='Apache 2.0',
    readme='README.md',
    description='OpenPilot: An intercloud broker for the clouds',
    ...
    project_urls={
        'Homepage': 'https://github.com/openlmai/openpilot',
        'Issues': 'https://github.com/openlmai/openpilot/issues',
        'Discussion': 'https://github.com/openlmai/openpilot/discussions',
        'Documentation': 'https://openpilot.readthedocs.io/en/latest/',
    },
)
