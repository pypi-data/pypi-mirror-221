from typing import Any, Dict, List, Tuple, Union, cast, Type
import distutils.core  # pylint: disable = no-name-in-module, import-error, deprecated-module
import os
...
from pkg_resources.extern.packaging.version import (  # pylint: disable=import-error,no-name-in-module
	Version as BaseVersion,
)


try:
	# for setuptools>=65.5.1,<67.0.0
	from pkg_resources.extern.packaging.version import LegacyVersion

	Version = Union[BaseVersion, LegacyVersion]
except ImportError:
	Version: Type = BaseVersion  # type: ignore[no-redef]
...
class MinVersion(BaseVersion):  # type: ignore
...
class MaxVersion(BaseVersion):  # type: ignore
	def __init__(self) -> None:
		self._key = self
