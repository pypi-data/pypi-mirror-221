...
class TestCase(unittest.TestCase):
    ...
    def run_class_serialization_test(self, instance, custom_objects=None):
        from keras_core.src.saving import custom_object_scope
        from keras_core.src.saving import deserialize_keras_object
        from keras_core.src.saving import serialize_keras_object
...
def create_keras_tensors(input_shape, dtype):
    from keras_core.src.backend.common import keras_tensor
...
def create_eager_tensors(input_shape, dtype):
    from keras_core.src.backend import random
