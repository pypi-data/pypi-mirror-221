...
class EvaluationFunctionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "code", "return_type", "id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "code", "return_type", "id", "created_at", "updated_at", ], str]):
