...
class ZoneList:
    ...
    def markup_image_with_zones(self, image: np.ndarray, show_labels: bool = ..., show_boundaries: bool = ..., fill_zones: bool = ..., line_thickness: int = ..., font_size: float = ..., font_thickness: int = ...) -> np.ndarray: ...
