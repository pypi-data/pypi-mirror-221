...
from kolibri.backend.tensorflow.tasks.structured.synthetic import CTGANSynthesizer as CTGAN

from kolibri.synthetic_data.base import BaseSingleTableSynthesizer
from kolibri.synthetic_data.utils import detect_discrete_columns
...
class CTGANSynthesizer(BaseSingleTableSynthesizer):
    ...
    def __init__(self, metadata, enforce_min_max_values=True, enforce_rounding=True, locales=None,
                 ...
                 generator_lr=2e-4, discriminator_lr=2e-4,batch_size=500,
