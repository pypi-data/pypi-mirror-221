...
from kolibri.synthetic_data.copulas import GaussianCopulaSynthesizer
from kolibri.synthetic_data.ctgan import CTGANSynthesizer
from kolibri.synthetic_data.utils import (
...
class CopulaGANSynthesizer(CTGANSynthesizer):
    ...
    * ``gaussian_kde``: Use a GaussianKDE distribution. This model is non-parametric,
    ...
    Args:
        metadata (Kolibri.single_table_metadata.SingleTableMetadata):
