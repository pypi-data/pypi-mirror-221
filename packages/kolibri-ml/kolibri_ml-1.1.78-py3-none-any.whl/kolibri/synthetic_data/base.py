...
from kolibri.errors import AggregateConstraintsError
from kolibri.synthetic_data.data_processor import DataProcessor
from kolibri.errors import ConstraintsNotMetError, SynthesizerInputError
from kolibri.errors import InvalidDataError
from kolibri.synthetic_data.utils import check_num_rows, handle_sampling_error, validate_file_path
from kdmt.numerical import is_numerical_type, is_boolean_type
from kdmt.dates import is_datetime_type, validate_datetime_format
from kolibri.utils.common import groupby_list
...
class BaseSynthesizer:
    ...
    Args:
        metadata (kolibri.synthetic_data.metadata.SingleTableMetadata):
    ...
    def add_custom_constraint_class(self, class_object, class_name):
        ...
        Args:
            class_object (kolibri.synthetic_data.base_constraint.Constraint):
    ...
    def fit_processed_data(self, processed_data, epochs):
        ...
        """
        self._fit(processed_data, epochs)
        self._fitted = True
        self._fitted_date = datetime.datetime.today().strftime('%Y-%m-%d')
        self._fitted_sdv_version = pkg_resources.get_distribution('kolibri-ml').version
    ...
    def fit(self, data, epochs):
        ...
        self.fit_processed_data(processed_data, epochs)
