...
class ExcelMetadata:
    ...
    @classmethod
    def generate_excel_file_from_data(cls, df_schema, df_tables_list, manifest_excel_file):
        """
        ...
        for header_num, header in enumerate(headers):
            ws_table_list.write(0, header_num, header)
        ...
        for i, width in enumerate(max_length):
            ws_table_list.set_column(i, i, width)
