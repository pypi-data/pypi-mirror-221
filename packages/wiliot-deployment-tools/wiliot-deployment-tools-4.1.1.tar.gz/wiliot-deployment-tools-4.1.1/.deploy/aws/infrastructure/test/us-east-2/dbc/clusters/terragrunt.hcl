  ...
  clusters = {
    system-network = {
      ...
      init_scripts = [
        {
          s3 = {
            destination = "s3://wiliot-dbc-us-east-2-test-monitoring-and-logs/monitoring/init-scripts/initialize-metrics.sh",
            region      = "us-east-2"
          }
        },
        {
          s3 = {
            destination = "s3://wiliot-dbc-us-east-2-test-monitoring-and-logs/clusters/init-scripts/system-network/install_packages.sh",
            region      = "us-east-2"
          }
        }
      ],
