...
_RequiredElasticsearchSettingsOutputTypeDef = TypedDict(
    "_RequiredElasticsearchSettingsOutputTypeDef",
    {
        "ServiceAccessRoleArn": str,
        "EndpointUri": str,
    },
)
_OptionalElasticsearchSettingsOutputTypeDef = TypedDict(
    "_OptionalElasticsearchSettingsOutputTypeDef",
    {
        "FullLoadErrorPercentage": int,
        "ErrorRetryDuration": int,
        "UseNewMappingType": bool,
...
class ElasticsearchSettingsOutputTypeDef(
    _RequiredElasticsearchSettingsOutputTypeDef, _OptionalElasticsearchSettingsOutputTypeDef
):
    pass
...
_RequiredNeptuneSettingsOutputTypeDef = TypedDict(
    "_RequiredNeptuneSettingsOutputTypeDef",
    {
        "S3BucketName": str,
        "S3BucketFolder": str,
    },
)
_OptionalNeptuneSettingsOutputTypeDef = TypedDict(
    "_OptionalNeptuneSettingsOutputTypeDef",
    {
        "ServiceAccessRoleArn": str,
        "ErrorRetryDuration": int,
        "MaxFileSize": int,
...
class NeptuneSettingsOutputTypeDef(
    _RequiredNeptuneSettingsOutputTypeDef, _OptionalNeptuneSettingsOutputTypeDef
):
    pass
...
_RequiredRedisSettingsOutputTypeDef = TypedDict(
    "_RequiredRedisSettingsOutputTypeDef",
    {
        "ServerName": str,
        "Port": int,
    },
)
_OptionalRedisSettingsOutputTypeDef = TypedDict(
    "_OptionalRedisSettingsOutputTypeDef",
    {
        "SslSecurityProtocol": SslSecurityProtocolValueType,
        "AuthType": RedisAuthTypeValueType,
        "AuthUserName": str,
...
class RedisSettingsOutputTypeDef(
    _RequiredRedisSettingsOutputTypeDef, _OptionalRedisSettingsOutputTypeDef
):
    pass
...
_RequiredTimestreamSettingsOutputTypeDef = TypedDict(
    "_RequiredTimestreamSettingsOutputTypeDef",
    {
        "DatabaseName": str,
        "MemoryDuration": int,
        "MagneticDuration": int,
...
_OptionalTimestreamSettingsOutputTypeDef = TypedDict(
    "_OptionalTimestreamSettingsOutputTypeDef",
    {
        "CdcInsertsAndUpdates": bool,
        "EnableMagneticStoreWrites": bool,
    },
...
class TimestreamSettingsOutputTypeDef(
    _RequiredTimestreamSettingsOutputTypeDef, _OptionalTimestreamSettingsOutputTypeDef
):
    pass
