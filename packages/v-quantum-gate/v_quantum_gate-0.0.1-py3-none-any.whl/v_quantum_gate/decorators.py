# Copyright 2019 The v_quantum_gate Developers
#
...
from .circuit import v_quantum_gateGlobalSetting
...
def circuitmacro(func: Union[Callable, str, None] = None,
    ...
    equivalent to this:
        ...
        def egg(c):
            ...
        v_quantum_gateGlobalSetting.register_macro('egg', egg, allow_overwrite=True)
    ...
    is equivalent with
        ...
        def egg(c):
            ...
        v_quantum_gateGlobalSetting.register_macro('bacon', egg, allow_overwrite=True)
    ...
    call v_quantum_gateGlobalSetting.register_macro with allow_overwrite=False.
    ...
    if callable(func):
        ...
        v_quantum_gateGlobalSetting.register_macro(name, func, allow_overwrite)
        return func
