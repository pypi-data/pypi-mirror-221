...
def circuit_to_unitary(circ: 'Circuit', *runargs, **runkwargs) -> np.ndarray:
    ...
    warnings.warn(
        "v_quantum_gate.util.circuit_to_unitary is moved to " +
        "v_quantum_gate.circuit_funcs.circuit_to_unitary.circuit_to_unitary.",
        DeprecationWarning)
    from v_quantum_gate.circuit_funcs.circuit_to_unitary import circuit_to_unitary as f
