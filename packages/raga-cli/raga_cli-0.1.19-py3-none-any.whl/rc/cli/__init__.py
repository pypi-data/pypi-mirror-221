...
def upload_log():
    ...
    MINIO_SECRET = get_config_value_by_key('minio_secret_key')
    MINIO_ACCESS = get_config_value_by_key('minio_access_key')
    ...
    minio_client = minio.Minio(MINIO_URL,
                               access_key=MINIO_ACCESS,
                               secret_key=MINIO_SECRET,
                               secure=False)

    minio_client.fput_object(bucket_name=CLOUD_STORAGE_BUCKET, object_name=dest, file_path=log_file_path)          
