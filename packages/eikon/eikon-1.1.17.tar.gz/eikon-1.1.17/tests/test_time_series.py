...
from eikon.vendor.requests_async import Session
from eikon.vendor.requests_async.models import Response
...
class Test_Time_Series(TestCase):
    ...
    def test_get_timeseries_wrong_parameters(self):
        ...
        """Check ValueError exception is raised when start_date = newer then end_date"""
        self.assertRaises(ValueError, eikon.get_timeseries, 'IBM.N', None, "2022-04-15T15:04:05", "2022-04-14T15:04:05")
