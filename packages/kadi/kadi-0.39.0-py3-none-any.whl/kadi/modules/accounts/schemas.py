...
class IdentitySchema(KadiSchema):
    ...
    def _has_visible_email(self, obj):
        # Only set the email address as visible if the current user is a sysadmin or
        # matches the user to be serialized.
        return (
    ...
    def _get_email(self, obj):
        if self._has_visible_email(obj):
            return obj.email
